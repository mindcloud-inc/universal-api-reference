# Aquaforest PDF Universal API Authentication

Every Aquaforest PDF API request through MindCloud uses a MindCloud API key and the `connectionId` of a Aquaforest PDF connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Aquaforest PDF connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Aquaforest PDF action](README.md#actions-10) with your API key and `connectionId`.
