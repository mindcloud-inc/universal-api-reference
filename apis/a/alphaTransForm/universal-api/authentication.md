# Alpha TransForm Universal API Authentication

Every Alpha TransForm API request through MindCloud uses a MindCloud API key and the `connectionId` of a Alpha TransForm connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Alpha TransForm connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Alpha TransForm action](README.md#actions-40) with your API key and `connectionId`.
