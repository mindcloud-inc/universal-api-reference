# Automatic Data Extraction Universal API Authentication

Every Automatic Data Extraction API request through MindCloud uses a MindCloud API key and the `connectionId` of a Automatic Data Extraction connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Automatic Data Extraction connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Automatic Data Extraction action](README.md#actions-84) with your API key and `connectionId`.
