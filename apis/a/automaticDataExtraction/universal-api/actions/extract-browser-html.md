# Automatic Data Extraction: Extract Browser HTML

Extracts browser HTML in Automatic Data Extraction.

```
GET https://connect.mindcloud.co/v1/universal/automaticDataExtraction/latest/actions/extract-browser-html
```
...
Through the native Automatic Data Extraction API, this operation is `POST /extract` (base URL `https://api.zyte.com/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/extract-browser-html.md) for the provider-specific parameters and requirements.
