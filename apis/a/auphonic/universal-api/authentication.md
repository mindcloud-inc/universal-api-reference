# Auphonic Universal API Authentication

Every Auphonic API request through MindCloud uses a MindCloud API key and the `connectionId` of a Auphonic connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Auphonic connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Auphonic action](README.md#actions-22) with your API key and `connectionId`.
