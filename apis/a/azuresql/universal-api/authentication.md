# Azure SQL Universal API Authentication

Every Azure SQL API request through MindCloud uses a MindCloud API key and the `connectionId` of a Azure SQL connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Azure SQL connection.
