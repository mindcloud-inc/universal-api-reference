# AntsRoute: Get Customer by ID

Retrieves a customer from AntsRoute by ID.

```
GET https://connect.mindcloud.co/v1/universal/antsRoute/latest/actions/get-customer-by-id
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/antsRoute/latest/actions/get-customer-by-id?connectionId=$CONNECTION_ID&id=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/antsRoute/latest/actions/get-customer-by-id?${params}`, {
  headers: {
