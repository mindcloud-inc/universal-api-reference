# Create float column with Appwrite
...
- **Method:** `POST`
- **Path:** `/tablesdb/{databaseId}/tables/{tableId}/columns/float`
- **Base URL:** `https://cloud.appwrite.io/v1`
- **Official documentation:** [Create float column](https://appwrite.io/docs/references/cloud/server-rest/tablesdb)
