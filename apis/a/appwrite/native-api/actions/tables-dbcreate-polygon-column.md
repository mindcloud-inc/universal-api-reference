# Create polygon column with Appwrite
...
- **Method:** `POST`
- **Path:** `/tablesdb/{databaseId}/tables/{tableId}/columns/polygon`
- **Base URL:** `https://cloud.appwrite.io/v1`
- **Official documentation:** [Create polygon column](https://appwrite.io/docs/references/cloud/server-rest/tablesdb)
