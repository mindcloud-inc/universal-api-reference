# Create user with MD5 password with Appwrite
...
- **Official documentation:** [Create user with MD5 password](https://appwrite.io/docs/references/cloud/server-rest/users)
...
| `password` | body | `string` | yes | User password hashed using MD5. |
