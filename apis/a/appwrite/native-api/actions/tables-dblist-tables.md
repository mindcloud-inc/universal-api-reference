# List tables with Appwrite

Retrieves a list of tables from your Appwrite project.
...
- **Official documentation:** [List tables](https://appwrite.io/docs/references/cloud/server-rest/tablesdb)
