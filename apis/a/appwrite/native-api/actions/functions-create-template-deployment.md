...
- **Official documentation:** [Create template deployment](https://appwrite.io/docs/references/cloud/server-rest/functions)
...
| `rootDirectory` | body | `string` | yes | Path to function code in the template repo. |
