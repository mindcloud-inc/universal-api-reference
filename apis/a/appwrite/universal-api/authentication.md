# Appwrite Universal API Authentication

Every Appwrite API request through MindCloud uses a MindCloud API key and the `connectionId` of a Appwrite connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Appwrite connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Appwrite action](README.md#actions-375) with your API key and `connectionId`.
