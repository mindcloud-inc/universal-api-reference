# Appwrite: Create account

Creates a new account in your Appwrite project.

```
POST https://connect.mindcloud.co/v1/universal/appwrite/latest/actions/account-create
```
...
Through the native Appwrite API, this operation is `POST /account` (base URL `https://cloud.appwrite.io/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/account-create.md) for the provider-specific parameters and requirements.
