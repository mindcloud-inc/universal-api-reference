...
```
POST https://connect.mindcloud.co/v1/universal/appwrite/latest/actions/functions-create-duplicate-deployment
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/appwrite/latest/actions/functions-create-duplicate-deployment" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/appwrite/latest/actions/functions-create-duplicate-deployment', {
  method: 'POST',
  headers: {
