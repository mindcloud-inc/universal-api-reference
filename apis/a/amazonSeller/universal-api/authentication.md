# Amazon Seller Universal API Authentication

Every Amazon Seller API request through MindCloud uses a MindCloud API key and the `connectionId` of a Amazon Seller connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Amazon Seller connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Amazon Seller action](README.md#actions-37) with your API key and `connectionId`.
