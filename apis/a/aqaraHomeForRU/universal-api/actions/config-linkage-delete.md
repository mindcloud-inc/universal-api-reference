# Aqara Home for RU: Delete Linkage

Deletes a linkage from Aqara Home for RU.

```
DELETE https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/config-linkage-delete
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/config-linkage-delete?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/config-linkage-delete?${params}`, {
  headers: {
