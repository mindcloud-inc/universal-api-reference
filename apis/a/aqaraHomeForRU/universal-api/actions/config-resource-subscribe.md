# Aqara Home for RU: Subscribe Resource

Subscribes to resource updates in Aqara Home for RU.

```
POST https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/config-resource-subscribe
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/config-resource-subscribe" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/config-resource-subscribe', {
  method: 'POST',
  headers: {
