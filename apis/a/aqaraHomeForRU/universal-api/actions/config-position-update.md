# Aqara Home for RU: Update Position

Updates a position in Aqara Home for RU.

```
PUT https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/config-position-update
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/config-position-update" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/config-position-update', {
  method: 'PUT',
  headers: {
