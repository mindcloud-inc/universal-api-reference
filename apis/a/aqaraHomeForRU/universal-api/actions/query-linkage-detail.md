# Aqara Home for RU: Query Linkage Detail

Retrieves linkage details from Aqara Home for RU.

```
GET https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/query-linkage-detail
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/query-linkage-detail?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/query-linkage-detail?${params}`, {
  headers: {
