# Aqara Home for RU: Create Position

Creates a position in Aqara Home for RU.

```
POST https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/config-position-create
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/config-position-create" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/aqaraHomeForRU/latest/actions/config-position-create', {
  method: 'POST',
  headers: {
