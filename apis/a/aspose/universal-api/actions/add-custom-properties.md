# Aspose: Add Custom Properties

Creates custom document properties in Aspose.

```
POST https://connect.mindcloud.co/v1/universal/aspose/latest/actions/add-custom-properties
```
...
| `properties` | object | yes | The document properties payload. |
...
Through the native Aspose API, this operation is `POST /slides/:name/documentproperties` (base URL `https://api.aspose.cloud/v3.0`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/add-custom-properties.md) for the provider-specific parameters and requirements.
