# Advanced Scraper Universal API Authentication

Every Advanced Scraper API request through MindCloud uses a MindCloud API key and the `connectionId` of a Advanced Scraper connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Advanced Scraper connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Advanced Scraper action](README.md#actions-1) with your API key and `connectionId`.
