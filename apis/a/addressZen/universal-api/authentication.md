# AddressZen Universal API Authentication

Every AddressZen API request through MindCloud uses a MindCloud API key and the `connectionId` of a AddressZen connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your AddressZen connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [AddressZen action](README.md#actions-2) with your API key and `connectionId`.
