# Automate Team - Task Management Universal API Authentication

Every Automate Team - Task Management API request through MindCloud uses a MindCloud API key and the `connectionId` of a Automate Team - Task Management connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Automate Team - Task Management connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Automate Team - Task Management action](README.md#actions-5) with your API key and `connectionId`.
