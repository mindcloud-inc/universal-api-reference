# Arize AX: List Datasets

Retrieves datasets from Arize AX.

```
GET https://connect.mindcloud.co/v1/universal/arizeAX/latest/actions/list-datasets
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/arizeAX/latest/actions/list-datasets?${params}`, {
  headers: {
