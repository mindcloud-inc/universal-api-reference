...
```
GET https://connect.mindcloud.co/v1/universal/airiamAI/latest/actions/get-model
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/airiamAI/latest/actions/get-model?connectionId=$CONNECTION_ID&baseModel=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/airiamAI/latest/actions/get-model?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `baseModel` | string | yes | Model base identifier from the baseModel field, such as inflection-3-pi. |
...
Through the native Airiam AI API, this operation is `GET /api/v1/models/:baseModel` (base URL `https://platform.sectorflow.ai`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-model.md) for the provider-specific parameters and requirements.
