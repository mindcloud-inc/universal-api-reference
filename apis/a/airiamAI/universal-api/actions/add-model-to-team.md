# Airiam AI: Add Model To Team

Adds a model to the team in Airiam AI.

```
PUT https://connect.mindcloud.co/v1/universal/airiamAI/latest/actions/add-model-to-team
```
...
| --- | --- | --- | --- |
| `id` | string | yes | Model ID to add to the team. |
...
Through the native Airiam AI API, this operation is `POST /api/v1/models/add-to-team` (base URL `https://platform.sectorflow.ai`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/add-model-to-team.md) for the provider-specific parameters and requirements.
