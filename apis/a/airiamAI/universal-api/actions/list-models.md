# Airiam AI: List Models

Retrieves a list of models from Airiam AI.

```
GET https://connect.mindcloud.co/v1/universal/airiamAI/latest/actions/list-models
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/airiamAI/latest/actions/list-models?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/airiamAI/latest/actions/list-models?${params}`, {
  headers: {
...
| `modelRating` | number | no | Filter models by rating. |
...
Through the native Airiam AI API, this operation is `GET /api/v1/models` (base URL `https://platform.sectorflow.ai`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-models.md) for the provider-specific parameters and requirements.
