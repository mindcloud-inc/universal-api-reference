# Apple Map Links Universal API Authentication

Every Apple Map Links API request through MindCloud uses a MindCloud API key and the `connectionId` of a Apple Map Links connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Apple Map Links connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Apple Map Links action](README.md#actions-17) with your API key and `connectionId`.
