# Amiibo API: List Amiibo Type



```
GET https://connect.mindcloud.co/v1/universal/amiiboAPI/latest/actions/list-amiibo-type
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/amiiboAPI/latest/actions/list-amiibo-type?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/amiiboAPI/latest/actions/list-amiibo-type?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `name` | string | no | Optional Amiibo type name filter. |
