# Amiibo API Universal API Authentication

Every Amiibo API API request through MindCloud uses a MindCloud API key and the `connectionId` of a Amiibo API connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Amiibo API connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Amiibo API action](README.md#actions-12) with your API key and `connectionId`.
