# AiVOOV Universal API Authentication

Every AiVOOV API request through MindCloud uses a MindCloud API key and the `connectionId` of a AiVOOV connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your AiVOOV connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [AiVOOV action](README.md#actions-2) with your API key and `connectionId`.
