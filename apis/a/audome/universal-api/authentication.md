# Audome Universal API Authentication

Every Audome API request through MindCloud uses a MindCloud API key and the `connectionId` of a Audome connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Audome connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Audome action](README.md#actions-9) with your API key and `connectionId`.
