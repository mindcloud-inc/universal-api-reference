# Asset Panda Universal API Authentication

Every Asset Panda API request through MindCloud uses a MindCloud API key and the `connectionId` of a Asset Panda connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Asset Panda connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Asset Panda action](README.md#actions-50) with your API key and `connectionId`.
