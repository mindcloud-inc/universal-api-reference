# Asset Panda: Delete Report

Deletes a report from Asset Panda.

```
DELETE https://connect.mindcloud.co/v1/universal/assetPanda/latest/actions/delete-report
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/assetPanda/latest/actions/delete-report?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/assetPanda/latest/actions/delete-report?${params}`, {
  headers: {
