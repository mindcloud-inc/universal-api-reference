# Asset Panda: Create User

Creates a new user in Asset Panda.

```
POST https://connect.mindcloud.co/v1/universal/assetPanda/latest/actions/create-user
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/assetPanda/latest/actions/create-user" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/assetPanda/latest/actions/create-user', {
  method: 'POST',
  headers: {
