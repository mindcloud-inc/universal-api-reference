# Aloware Universal API Authentication

Every Aloware API request through MindCloud uses a MindCloud API key and the `connectionId` of a Aloware connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Aloware connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Aloware action](README.md#actions-11) with your API key and `connectionId`.
