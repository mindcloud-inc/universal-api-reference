# Ambee Universal API Authentication

Every Ambee API request through MindCloud uses a MindCloud API key and the `connectionId` of a Ambee connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Ambee connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Ambee action](README.md#actions-19) with your API key and `connectionId`.
