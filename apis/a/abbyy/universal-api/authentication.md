# Abbyy Universal API Authentication

Every Abbyy API request through MindCloud uses a MindCloud API key and the `connectionId` of a Abbyy connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Abbyy connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Abbyy action](README.md#actions-13) with your API key and `connectionId`.
