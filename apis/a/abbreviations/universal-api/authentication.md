# Abbreviations Universal API Authentication

Every Abbreviations API request through MindCloud uses a MindCloud API key and the `connectionId` of a Abbreviations connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Abbreviations connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Abbreviations action](README.md#actions-2) with your API key and `connectionId`.
