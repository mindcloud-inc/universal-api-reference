# Acumatica: Get Shipment



```
GET https://connect.mindcloud.co/v1/universal/acumatica/latest/actions/get-shipment
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/acumatica/latest/actions/get-shipment?connectionId=$CONNECTION_ID&id=cb1c3b2c-d87f-e411-beca-00b56d0561c2" \
...
const params = new URLSearchParams({
  connectionId,
  "id": "cb1c3b2c-d87f-e411-beca-00b56d0561c2"
});

const response = await fetch(`https://connect.mindcloud.co/v1/universal/acumatica/latest/actions/get-shipment?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `id` | string | yes | The Acumatica entity ID (GUID) returned in the record's id field. Example: `cb1c3b2c-d87f-e411-beca-00b56d0561c2`. |
...
Through the native Acumatica API, this operation is `GET /entity/{{credentials.endpointName}}/{{credentials.endpointVersion}}/Shipment/:id` (base URL `{{credentials.uRL}}`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-shipment.md) for the provider-specific parameters and requirements.
