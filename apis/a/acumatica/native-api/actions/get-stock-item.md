# Get Stock Item with Acumatica

## Endpoint

- **Method:** `GET`
- **Path:** `/entity/{endpointName}/{endpointVersion}/StockItem/:id`
- **Base URL:** `{uRL}`
- **Official documentation:** [Get Stock Item](https://beacon.acumatica.com/r/Integration-Development-Guide/REST-API-Examples/Basic-Requests/Retrieve-a-Record-by-ID)
