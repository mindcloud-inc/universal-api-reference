...
- **Base URL:** `{uRL}`
- **Official documentation:** [List Contacts](https://beacon.acumatica.com/r/Integration-Development-Guide/REST-API-Examples/Basic-Requests/Retrieve-Records-by-Conditions)
