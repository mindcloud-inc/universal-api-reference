# Get Shipment with Acumatica

## Endpoint

- **Method:** `GET`
- **Path:** `/entity/{endpointName}/{endpointVersion}/Shipment/:id`
- **Base URL:** `{uRL}`
- **Official documentation:** [Get Shipment](https://beacon.acumatica.com/r/Integration-Development-Guide/REST-API-Examples/Basic-Requests/Retrieve-a-Record-by-ID)
