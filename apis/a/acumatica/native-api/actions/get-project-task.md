# Get Project Task with Acumatica

## Endpoint

- **Method:** `GET`
- **Path:** `/entity/{endpointName}/{endpointVersion}/ProjectTask/:id`
- **Base URL:** `{uRL}`
- **Official documentation:** [Get Project Task](https://beacon.acumatica.com/r/Integration-Development-Guide/REST-API-Examples/Basic-Requests/Retrieve-a-Record-by-ID)
