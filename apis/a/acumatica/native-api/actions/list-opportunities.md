# List Opportunities with Acumatica
...
- **Base URL:** `{uRL}`
- **Official documentation:** [List Opportunities](https://beacon.acumatica.com/r/Integration-Development-Guide/REST-API-Examples/Basic-Requests/Retrieve-Records-by-Conditions)
