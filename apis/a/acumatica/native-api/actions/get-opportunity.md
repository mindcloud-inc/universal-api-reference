# Get Opportunity with Acumatica

## Endpoint

- **Method:** `GET`
- **Path:** `/entity/{endpointName}/{endpointVersion}/Opportunity/:id`
- **Base URL:** `{uRL}`
- **Official documentation:** [Get Opportunity](https://beacon.acumatica.com/r/Integration-Development-Guide/REST-API-Examples/Basic-Requests/Retrieve-a-Record-by-ID)
