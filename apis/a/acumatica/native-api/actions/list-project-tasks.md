# List Project Tasks with Acumatica

## Endpoint

- **Method:** `GET`
- **Path:** `/entity/{endpointName}/{endpointVersion}/ProjectTask`
- **Base URL:** `{uRL}`
- **Official documentation:** [List Project Tasks](https://beacon.acumatica.com/r/Integration-Development-Guide/REST-API-Examples/Basic-Requests/Retrieve-Records-by-Conditions)
