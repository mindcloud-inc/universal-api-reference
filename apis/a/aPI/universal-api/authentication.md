# 44API Universal API Authentication

Every 44API API request through MindCloud uses a MindCloud API key and the `connectionId` of a 44API connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your 44API connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [44API action](README.md#actions-3) with your API key and `connectionId`.
