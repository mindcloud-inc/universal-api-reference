# Agent700 Universal API Authentication

Every Agent700 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Agent700 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Agent700 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Agent700 action](README.md#actions-80) with your API key and `connectionId`.
