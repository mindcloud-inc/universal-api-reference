# api4ai Universal API Authentication

Every api4ai API request through MindCloud uses a MindCloud API key and the `connectionId` of a api4ai connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your api4ai connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [api4ai action](README.md#actions-50) with your API key and `connectionId`.
