# Auth0 Management Universal API Authentication

Every Auth0 Management API request through MindCloud uses a MindCloud API key and the `connectionId` of a Auth0 Management connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Auth0 Management connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Auth0 Management action](README.md#actions-31) with your API key and `connectionId`.
