# Apaleo Official Universal API Authentication

Every Apaleo Official API request through MindCloud uses a MindCloud API key and the `connectionId` of a Apaleo Official connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Apaleo Official connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Apaleo Official action](README.md#actions-1) with your API key and `connectionId`.
