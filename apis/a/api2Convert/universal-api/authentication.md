# Api2Convert Universal API Authentication

Every Api2Convert API request through MindCloud uses a MindCloud API key and the `connectionId` of a Api2Convert connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Api2Convert connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Api2Convert action](README.md#actions-34) with your API key and `connectionId`.
