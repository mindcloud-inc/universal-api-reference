# Algolia Universal API Authentication

Every Algolia API request through MindCloud uses a MindCloud API key and the `connectionId` of a Algolia connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Algolia connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Algolia action](README.md#actions-40) with your API key and `connectionId`.
