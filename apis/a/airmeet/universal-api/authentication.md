# Airmeet Universal API Authentication

Every Airmeet API request through MindCloud uses a MindCloud API key and the `connectionId` of a Airmeet connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Airmeet connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Airmeet action](README.md#actions-28) with your API key and `connectionId`.
