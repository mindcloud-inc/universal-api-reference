# Atlas AI Revenue Engine Universal API Authentication

Every Atlas AI Revenue Engine API request through MindCloud uses a MindCloud API key and the `connectionId` of a Atlas AI Revenue Engine connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Atlas AI Revenue Engine connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Atlas AI Revenue Engine action](README.md#actions-24) with your API key and `connectionId`.
