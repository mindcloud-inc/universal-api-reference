# AdPage Universal API Authentication

Every AdPage API request through MindCloud uses a MindCloud API key and the `connectionId` of a AdPage connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your AdPage connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [AdPage action](README.md#actions-3) with your API key and `connectionId`.
