# AnnounceKit Universal API Authentication

Every AnnounceKit API request through MindCloud uses a MindCloud API key and the `connectionId` of a AnnounceKit connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your AnnounceKit connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [AnnounceKit action](README.md#actions-4) with your API key and `connectionId`.
