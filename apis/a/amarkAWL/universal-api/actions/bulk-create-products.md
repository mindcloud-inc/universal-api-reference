# Amark: Bulk Create Products



```
POST https://connect.mindcloud.co/v1/universal/amarkAWL/latest/actions/bulk-create-products
```
...
Through the native Amark API, this operation is `POST /Product/BulkCreate` (base URL `{{credentials.environment}}`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/bulk-create-products.md) for the provider-specific parameters and requirements.
