# AI/ML API Universal API Authentication

Every AI/ML API API request through MindCloud uses a MindCloud API key and the `connectionId` of a AI/ML API connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your AI/ML API connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [AI/ML API action](README.md#actions-25) with your API key and `connectionId`.
