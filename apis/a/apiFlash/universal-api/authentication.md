# ApiFlash Universal API Authentication

Every ApiFlash API request through MindCloud uses a MindCloud API key and the `connectionId` of a ApiFlash connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ApiFlash connection.
