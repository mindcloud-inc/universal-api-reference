# Abstract VAT Validator Universal API Authentication

Every Abstract VAT Validator API request through MindCloud uses a MindCloud API key and the `connectionId` of a Abstract VAT Validator connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Abstract VAT Validator connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Abstract VAT Validator action](README.md#actions-3) with your API key and `connectionId`.
