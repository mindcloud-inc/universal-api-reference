# AvoSMS: Delete Contact List

Deletes an existing contact list from AvoSMS.

```
DELETE https://connect.mindcloud.co/v1/universal/avoSMS/latest/actions/delete-contact-list
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/avoSMS/latest/actions/delete-contact-list?connectionId=$CONNECTION_ID&listContactId=69cc2daf52244" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/avoSMS/latest/actions/delete-contact-list?${params}`, {
  headers: {
