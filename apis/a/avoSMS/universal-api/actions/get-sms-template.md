# AvoSMS: Get SMS Template

Retrieves an SMS template from AvoSMS.

```
GET https://connect.mindcloud.co/v1/universal/avoSMS/latest/actions/get-sms-template
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/avoSMS/latest/actions/get-sms-template?connectionId=$CONNECTION_ID&modelId=69cc2dbd29f21" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/avoSMS/latest/actions/get-sms-template?${params}`, {
  headers: {
