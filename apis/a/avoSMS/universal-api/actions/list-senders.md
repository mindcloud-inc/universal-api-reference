...
Retrieves senders from AvoSMS.

```
GET https://connect.mindcloud.co/v1/universal/avoSMS/latest/actions/list-senders
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/avoSMS/latest/actions/list-senders?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/avoSMS/latest/actions/list-senders?${params}`, {
  headers: {
