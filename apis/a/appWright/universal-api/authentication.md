# AppWright Universal API Authentication

Every AppWright API request through MindCloud uses a MindCloud API key and the `connectionId` of a AppWright connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your AppWright connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [AppWright action](README.md#actions-3) with your API key and `connectionId`.
