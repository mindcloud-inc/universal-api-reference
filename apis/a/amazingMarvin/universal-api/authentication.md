# Amazing Marvin Universal API Authentication

Every Amazing Marvin API request through MindCloud uses a MindCloud API key and the `connectionId` of a Amazing Marvin connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Amazing Marvin connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Amazing Marvin action](README.md#actions-25) with your API key and `connectionId`.
