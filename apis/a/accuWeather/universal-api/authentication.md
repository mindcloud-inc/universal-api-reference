# AccuWeather Universal API Authentication

Every AccuWeather API request through MindCloud uses a MindCloud API key and the `connectionId` of a AccuWeather connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your AccuWeather connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [AccuWeather action](README.md#actions-64) with your API key and `connectionId`.
