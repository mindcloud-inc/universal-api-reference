# Alpha Vantage Universal API Authentication

Every Alpha Vantage API request through MindCloud uses a MindCloud API key and the `connectionId` of a Alpha Vantage connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Alpha Vantage connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Alpha Vantage action](README.md#actions-124) with your API key and `connectionId`.
