# AI21 Labs Universal API Authentication

Every AI21 Labs API request through MindCloud uses a MindCloud API key and the `connectionId` of a AI21 Labs connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your AI21 Labs connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [AI21 Labs action](README.md#actions-30) with your API key and `connectionId`.
