# AI21 Labs: Generate Blog Draft

Creates a blog draft run in AI21 Labs.

```
POST https://connect.mindcloud.co/v1/universal/aI21Labs/latest/actions/generate-blog-draft
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/aI21Labs/latest/actions/generate-blog-draft" \
  -H "Authorization: Bearer $MINDCLOUD_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
  "connectionId": "$CONNECTION_ID",
  "input": "Provide the topic, audience, and any key points for the blog draft."
}'
```

```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/aI21Labs/latest/actions/generate-blog-draft', {
  method: 'POST',
  headers: {
...
| --- | --- | --- | --- |
| `input` | string | yes | The ideas, source material, or requirements for the blog draft. Example: `Provide the topic, audience, and any key points for the blog draft.`. |
