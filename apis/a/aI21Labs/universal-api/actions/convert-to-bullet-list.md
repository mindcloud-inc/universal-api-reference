# AI21 Labs: Convert To Bullet List

Creates a bullet list conversion run in AI21 Labs.

```
POST https://connect.mindcloud.co/v1/universal/aI21Labs/latest/actions/convert-to-bullet-list
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/aI21Labs/latest/actions/convert-to-bullet-list" \
  -H "Authorization: Bearer $MINDCLOUD_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
  "connectionId": "$CONNECTION_ID",
  "input": "Paste the content you want rewritten as concise bullets."
}'
```

```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/aI21Labs/latest/actions/convert-to-bullet-list', {
  method: 'POST',
  headers: {
...
| --- | --- | --- | --- |
| `input` | string | yes | The content to convert into a bullet list. Example: `Paste the content you want rewritten as concise bullets.`. |
