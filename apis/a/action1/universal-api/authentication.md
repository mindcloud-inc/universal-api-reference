# Action1 Universal API Authentication

Every Action1 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Action1 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Action1 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Action1 action](README.md#actions-24) with your API key and `connectionId`.
