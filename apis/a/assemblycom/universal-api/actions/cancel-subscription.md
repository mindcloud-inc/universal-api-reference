# Assembly.com: Cancel Subscription

Cancels an existing subscription in Assembly.com.

```
PUT https://connect.mindcloud.co/v1/universal/assemblycom/latest/actions/cancel-subscription
```
...
| --- | --- | --- | --- |
| `id` | string | yes | The unique ID of the subscription to cancel. |
...
Through the native Assembly.com API, this operation is `POST /subscriptions/:id/cancel` (base URL `https://api.assembly.com/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/cancel-subscription.md) for the provider-specific parameters and requirements.
