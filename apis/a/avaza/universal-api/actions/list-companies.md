# Avaza: List Companies

Retrieves companies from Avaza.

```
GET https://connect.mindcloud.co/v1/universal/avaza/latest/actions/list-companies
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/avaza/latest/actions/list-companies?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/avaza/latest/actions/list-companies?${params}`, {
  headers: {
