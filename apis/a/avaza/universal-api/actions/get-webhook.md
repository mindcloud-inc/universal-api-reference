...
Retrieves webhook from Avaza.

```
GET https://connect.mindcloud.co/v1/universal/avaza/latest/actions/get-webhook
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/avaza/latest/actions/get-webhook?connectionId=$CONNECTION_ID&id=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/avaza/latest/actions/get-webhook?${params}`, {
  headers: {
