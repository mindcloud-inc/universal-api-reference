# Avaza: Get Account Details

Retrieves account details from Avaza.

```
GET https://connect.mindcloud.co/v1/universal/avaza/latest/actions/get-account-details
```
