# Avaza: List Estimates

Retrieves estimates from Avaza.

```
GET https://connect.mindcloud.co/v1/universal/avaza/latest/actions/list-estimates
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/avaza/latest/actions/list-estimates?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/avaza/latest/actions/list-estimates?${params}`, {
  headers: {
