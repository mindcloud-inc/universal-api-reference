# Avaza: Update Leave Booking

Updates an existing leave booking in Avaza.

```
PUT https://connect.mindcloud.co/v1/universal/avaza/latest/actions/update-leave-booking
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/avaza/latest/actions/update-leave-booking" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/avaza/latest/actions/update-leave-booking', {
  method: 'PUT',
  headers: {
