# Avaza Universal API Authentication

Every Avaza API request through MindCloud uses a MindCloud API key and the `connectionId` of a Avaza connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Avaza connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Avaza action](README.md#actions-94) with your API key and `connectionId`.
