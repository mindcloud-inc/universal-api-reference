# Amazon Vendor Universal API Authentication

Every Amazon Vendor API request through MindCloud uses a MindCloud API key and the `connectionId` of a Amazon Vendor connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Amazon Vendor connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Amazon Vendor action](README.md#actions-12) with your API key and `connectionId`.
