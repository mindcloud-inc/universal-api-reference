# Airslate Universal API Authentication

Every Airslate API request through MindCloud uses a MindCloud API key and the `connectionId` of a Airslate connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Airslate connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Airslate action](README.md#actions-84) with your API key and `connectionId`.
