# Aqara Home for EU: Enable Linkage



```
PUT https://connect.mindcloud.co/v1/universal/aqaraHomeForEU/latest/actions/config-linkage-enable
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/aqaraHomeForEU/latest/actions/config-linkage-enable" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/aqaraHomeForEU/latest/actions/config-linkage-enable', {
  method: 'PUT',
  headers: {
