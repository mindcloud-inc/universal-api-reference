# Aqara Home for EU: Create Scene



```
POST https://connect.mindcloud.co/v1/universal/aqaraHomeForEU/latest/actions/config-scene-create
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/aqaraHomeForEU/latest/actions/config-scene-create" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/aqaraHomeForEU/latest/actions/config-scene-create', {
  method: 'POST',
  headers: {
