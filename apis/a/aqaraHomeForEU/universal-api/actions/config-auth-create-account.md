# Aqara Home for EU: Create Account



```
POST https://connect.mindcloud.co/v1/universal/aqaraHomeForEU/latest/actions/config-auth-create-account
```
