# Aqara Home for EU Universal API Authentication

Every Aqara Home for EU API request through MindCloud uses a MindCloud API key and the `connectionId` of a Aqara Home for EU connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Aqara Home for EU connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Aqara Home for EU action](README.md#actions-30) with your API key and `connectionId`.
