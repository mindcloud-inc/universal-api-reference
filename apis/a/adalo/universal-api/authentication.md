# Adalo Universal API Authentication

Every Adalo API request through MindCloud uses a MindCloud API key and the `connectionId` of a Adalo connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Adalo connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Adalo action](README.md#actions-1) with your API key and `connectionId`.
