# Alt Text Generator Universal API Authentication

Every Alt Text Generator API request through MindCloud uses a MindCloud API key and the `connectionId` of a Alt Text Generator connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Alt Text Generator connection.
