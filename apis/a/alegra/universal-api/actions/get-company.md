...
```
GET https://connect.mindcloud.co/v1/universal/alegra/latest/actions/get-company
```
...
Through the native Alegra API, this operation is `GET /company` (base URL `https://api.alegra.com/api/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-company.md) for the provider-specific parameters and requirements.
