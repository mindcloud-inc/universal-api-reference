# Alegra Universal API Authentication

Every Alegra API request through MindCloud uses a MindCloud API key and the `connectionId` of a Alegra connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Alegra connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Alegra action](README.md#actions-30) with your API key and `connectionId`.
