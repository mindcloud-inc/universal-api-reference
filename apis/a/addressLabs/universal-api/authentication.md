# Address Labs Universal API Authentication

Every Address Labs API request through MindCloud uses a MindCloud API key and the `connectionId` of a Address Labs connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Address Labs connection.
