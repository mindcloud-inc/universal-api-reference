# AltText.Ai Universal API Authentication

Every AltText.Ai API request through MindCloud uses a MindCloud API key and the `connectionId` of a AltText.Ai connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your AltText.Ai connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [AltText.Ai action](README.md#actions-10) with your API key and `connectionId`.
