...
```
GET https://connect.mindcloud.co/v1/universal/appFollow/latest/actions/list-app-collections
```
...
Through the native AppFollow API, this operation is `GET /api/v2/account/apps` (base URL `https://api.appfollow.io`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-app-collections.md) for the provider-specific parameters and requirements.
