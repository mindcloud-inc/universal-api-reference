# Amberscript Universal API Authentication

Every Amberscript API request through MindCloud uses a MindCloud API key and the `connectionId` of a Amberscript connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Amberscript connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Amberscript action](README.md#actions-15) with your API key and `connectionId`.
