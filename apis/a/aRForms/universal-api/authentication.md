# ARForms Universal API Authentication

Every ARForms API request through MindCloud uses a MindCloud API key and the `connectionId` of a ARForms connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ARForms connection.
