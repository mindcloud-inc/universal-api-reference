# Autotask Universal API Authentication

Every Autotask API request through MindCloud uses a MindCloud API key and the `connectionId` of a Autotask connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Autotask connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Autotask action](README.md#actions-25) with your API key and `connectionId`.
