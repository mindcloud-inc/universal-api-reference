# List Project Attachments with Autotask

## Endpoint

- **Method:** `GET`
- **Path:** `/ProjectAttachments/query`
- **Base URL:** `https://webservices14.autotask.net/ATServicesRest/v1.0`
- **Official documentation:** [List Project Attachments](https://www.autotask.net/help/DeveloperHelp/Content/APIs/REST/Entities/ProjectAttachmentsEntity.htm)
