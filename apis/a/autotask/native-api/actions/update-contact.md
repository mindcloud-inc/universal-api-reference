...
- **Official documentation:** [Update Contact](https://www.autotask.net/help/developerhelp/Content/APIs/REST/Entities/ContactsEntity.htm)
...
| --- | --- | --- | --- | --- |
| `id` | body | `number` | yes | — |
| `firstName` | body | `string` | no | Maximum length: 20. |
| `lastName` | body | `string` | no | Maximum length: 20. |
| `isActive` | body | `number` | no | — |
...
| `companylocationID` | body | `number` | no | If address fields are blank, Autotask can populate them from this company location. |
