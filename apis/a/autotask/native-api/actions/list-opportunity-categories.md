# List Opportunity Categories with Autotask

## Endpoint

- **Method:** `GET`
- **Path:** `/OpportunityCategories/query`
- **Base URL:** `https://webservices14.autotask.net/ATServicesRest/v1.0`
- **Official documentation:** [List Opportunity Categories](https://autotask.net/help/developerhelp/content/apis/rest/Entities/OpportunityCategories.htm)
