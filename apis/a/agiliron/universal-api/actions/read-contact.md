# Agiliron: Read Contact

Retrieves contact records from Agiliron.

```
GET https://connect.mindcloud.co/v1/universal/agiliron/latest/actions/read-contact
```
...
Through the native Agiliron API, this operation is `GET Contact` (base URL `https://{{credentials.yourCompany}}.agiliron.net/agiliron/api-40.php/`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/read-contact.md) for the provider-specific parameters and requirements.
