# Agiliron: Add Account

Creates a new account in Agiliron.

```
POST https://connect.mindcloud.co/v1/universal/agiliron/latest/actions/add-account
```
...
Through the native Agiliron API, this operation is `POST Accounts` (base URL `https://{{credentials.yourCompany}}.agiliron.net/agiliron/api-40.php/`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/add-account.md) for the provider-specific parameters and requirements.
