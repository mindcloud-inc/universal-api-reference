# Agile CRM: Update Contact

Updates an existing contact in Agile CRM.

```
PUT https://connect.mindcloud.co/v1/universal/agileCRM/latest/actions/update-contact
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/agileCRM/latest/actions/update-contact" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/agileCRM/latest/actions/update-contact', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `id` | list | yes | Example: `5742825943269376`. |
| `firstName` | string | no | Example: `John`. |
| `lastName` | string | no | Example: `Porkinson`. |
...
Through the native Agile CRM API, this operation is `PUT /contacts/edit-properties` (base URL `https://mindcloud.agilecrm.com/dev/api`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/update-contact.md) for the provider-specific parameters and requirements.
