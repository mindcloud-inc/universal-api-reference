# Aspire: Get API Version

Retrieves the current API version from Aspire.

```
GET https://connect.mindcloud.co/v1/universal/aspire/latest/actions/get-api-version
```
