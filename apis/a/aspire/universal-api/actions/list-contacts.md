# Aspire: List Contacts



```
GET https://connect.mindcloud.co/v1/universal/aspire/latest/actions/list-contacts
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/aspire/latest/actions/list-contacts?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/aspire/latest/actions/list-contacts?${params}`, {
  headers: {
