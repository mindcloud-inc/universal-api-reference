...
| [Create Partial Payment – Stripe to Aspire Sync](actions/create-partial-payment-stripe-to-aspire-sync.md) | `POST PartialPayments` | [docs](https://guide.youraspire.com/v1-api/apidocs/en/partialpayments-4) |
...
| [List Payments – Stripe to Aspire Sync](actions/list-payments-stripe-to-aspire-sync.md) | `GET Payments` | [docs](https://guide.youraspire.com/apidocs/payments-4) |
