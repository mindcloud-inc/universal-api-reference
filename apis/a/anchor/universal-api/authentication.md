# Anchor Universal API Authentication

Every Anchor API request through MindCloud uses a MindCloud API key and the `connectionId` of a Anchor connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Anchor connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Anchor action](README.md#actions-24) with your API key and `connectionId`.
