# Asteroids NeoWs Universal API Authentication

Every Asteroids NeoWs API request through MindCloud uses a MindCloud API key and the `connectionId` of a Asteroids NeoWs connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Asteroids NeoWs connection.
