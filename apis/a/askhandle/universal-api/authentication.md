# AskHandle Universal API Authentication

Every AskHandle API request through MindCloud uses a MindCloud API key and the `connectionId` of a AskHandle connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your AskHandle connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [AskHandle action](README.md#actions-16) with your API key and `connectionId`.
