# Apple News and Music Universal API Authentication

Every Apple News and Music API request through MindCloud uses a MindCloud API key and the `connectionId` of a Apple News and Music connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Apple News and Music connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Apple News and Music action](README.md#actions-65) with your API key and `connectionId`.
