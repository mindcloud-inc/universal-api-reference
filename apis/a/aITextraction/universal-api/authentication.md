# AI Textraction Universal API Authentication

Every AI Textraction API request through MindCloud uses a MindCloud API key and the `connectionId` of a AI Textraction connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your AI Textraction connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [AI Textraction action](README.md#actions-1) with your API key and `connectionId`.
