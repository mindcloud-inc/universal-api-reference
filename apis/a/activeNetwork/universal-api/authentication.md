# Active Network Universal API Authentication

Every Active Network API request through MindCloud uses a MindCloud API key and the `connectionId` of a Active Network connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Active Network connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Active Network action](README.md#actions-9) with your API key and `connectionId`.
