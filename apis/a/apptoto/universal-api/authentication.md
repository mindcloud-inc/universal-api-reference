# Apptoto Universal API Authentication

Every Apptoto API request through MindCloud uses a MindCloud API key and the `connectionId` of a Apptoto connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Apptoto connection.
