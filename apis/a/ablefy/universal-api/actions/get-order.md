...
Retrieves an order from Ablefy.

```
GET https://connect.mindcloud.co/v1/universal/ablefy/latest/actions/get-order
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/ablefy/latest/actions/get-order?connectionId=$CONNECTION_ID&id=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/ablefy/latest/actions/get-order?${params}`, {
  headers: {
