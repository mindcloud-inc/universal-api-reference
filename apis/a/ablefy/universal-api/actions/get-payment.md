...
```
GET https://connect.mindcloud.co/v1/universal/ablefy/latest/actions/get-payment
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/ablefy/latest/actions/get-payment?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/ablefy/latest/actions/get-payment?${params}`, {
  headers: {
