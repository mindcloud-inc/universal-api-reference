# Atlar Universal API Authentication

Every Atlar API request through MindCloud uses a MindCloud API key and the `connectionId` of a Atlar connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Atlar connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Atlar action](README.md#actions-175) with your API key and `connectionId`.
