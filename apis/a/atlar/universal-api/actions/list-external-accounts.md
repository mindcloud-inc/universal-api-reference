# Atlar: List external accounts

Retrieves external accounts from Atlar.

```
GET https://connect.mindcloud.co/v1/universal/atlar/latest/actions/list-external-accounts
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/atlar/latest/actions/list-external-accounts?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/atlar/latest/actions/list-external-accounts?${params}`, {
  headers: {
