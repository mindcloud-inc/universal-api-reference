# Atlar: Reject credit transfer

Rejects a credit transfer in Atlar.

```
POST https://connect.mindcloud.co/v1/universal/atlar/latest/actions/reject-credit-transfer
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/atlar/latest/actions/reject-credit-transfer" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/atlar/latest/actions/reject-credit-transfer', {
  method: 'POST',
  headers: {
