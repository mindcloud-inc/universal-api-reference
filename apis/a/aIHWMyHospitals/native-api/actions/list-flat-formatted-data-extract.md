# List Flat Formatted Data Extract with AIHW MyHospitals
...
- **Method:** `GET`
- **Path:** `/api/v1/flat-formatted-data-extract/{measure-category-code}`
- **Base URL:** `https://myhospitalsapi.aihw.gov.au`
- **Official documentation:** [List Flat Formatted Data Extract](https://myhospitalsapi.aihw.gov.au/swagger/v1/swagger.json)
