...
- **Official documentation:** [Update Customer](https://www.dropbox.com/scl/fi/75586ygs35arfb7d3cvxi/API-Endpoints-1.2.pdf?rlkey=ztci7pf4nuasegnybjreqsqe2&dl=0#page=13)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `customerId` | body | `string` | no | Existing Ascora customer ID to update. |
...
| `customerType.name` | body | `string` | no | Ascora customer type name. |
| `leadSource.name` | body | `string` | no | Ascora lead source name. |
