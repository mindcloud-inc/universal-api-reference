# Ascora: Add Kits To Quote

Adds kits to a quote in Ascora.

```
PUT https://connect.mindcloud.co/v1/universal/ascora/latest/actions/add-kits-to-quote
```
...
Through the native Ascora API, this operation is `POST /Quotes/AddKits` (base URL `https://api.ascora.com.au`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/add-kits-to-quote.md) for the provider-specific parameters and requirements.
