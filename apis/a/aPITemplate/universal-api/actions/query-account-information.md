# API Template: Query Account Information

Retrieves account information from API Template.

```
GET https://connect.mindcloud.co/v1/universal/aPITemplate/latest/actions/query-account-information
```
...
Through the native API Template API, this operation is `GET /v2/account-information` (base URL `https://rest.apitemplate.io`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/query-account-information.md) for the provider-specific parameters and requirements.
