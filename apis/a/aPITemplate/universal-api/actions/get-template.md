...
Retrieves a PDF template from API Template.

```
GET https://connect.mindcloud.co/v1/universal/aPITemplate/latest/actions/get-template
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/aPITemplate/latest/actions/get-template?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/aPITemplate/latest/actions/get-template?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `templateId` | string | no | Template ID to fetch. |
