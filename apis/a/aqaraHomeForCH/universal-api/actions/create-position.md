# Aqara Home for CH: Create Position

Creates a new position in Aqara Home for CH.

```
POST https://connect.mindcloud.co/v1/universal/aqaraHomeForCH/latest/actions/create-position
```
...
| --- | --- | --- |
| `positionId` | string | Position id returned after creation. |
