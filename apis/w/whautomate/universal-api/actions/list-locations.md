# Whautomate: List Locations

Retrieves locations from Whautomate.

```
GET https://connect.mindcloud.co/v1/universal/whautomate/latest/actions/list-locations
```
