# Whautomate: Add Client

Creates a new client in Whautomate.

```
POST https://connect.mindcloud.co/v1/universal/whautomate/latest/actions/add-client
```
...
Through the native Whautomate API, this operation is `POST /v1/clients` (base URL `https://api.whautomate.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/add-client.md) for the provider-specific parameters and requirements.
