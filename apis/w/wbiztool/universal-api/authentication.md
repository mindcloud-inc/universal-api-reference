# Wbiztool Universal API Authentication

Every Wbiztool API request through MindCloud uses a MindCloud API key and the `connectionId` of a Wbiztool connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Wbiztool connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Wbiztool action](README.md#actions-23) with your API key and `connectionId`.
