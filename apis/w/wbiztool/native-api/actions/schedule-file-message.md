# Schedule File Message with Wbiztool
...
- **Official documentation:** [Schedule File Message](https://wbiztool.com/docs/schedule-message-api/)
...
| `file_url` | body | `string` | yes | Public file URL to include with the scheduled message. |
| `file_name` | body | `string` | no | Optional display name for the attached file. |
| `msg` | body | `string` | yes | Caption text to schedule with the file. |
