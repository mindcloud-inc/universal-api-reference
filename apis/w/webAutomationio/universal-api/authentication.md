# WebAutomation.io Universal API Authentication

Every WebAutomation.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a WebAutomation.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your WebAutomation.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [WebAutomation.io action](README.md#actions-12) with your API key and `connectionId`.
