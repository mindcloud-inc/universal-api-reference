# Wistia: Update Folder

Updates an existing folder in Wistia.

```
PUT https://connect.mindcloud.co/v1/universal/wistia/latest/actions/update-folder
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/wistia/latest/actions/update-folder" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/wistia/latest/actions/update-folder', {
  method: 'PUT',
  headers: {
