# Wistia: Delete Folder

Deletes an existing folder from Wistia.

```
DELETE https://connect.mindcloud.co/v1/universal/wistia/latest/actions/delete-folder
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/wistia/latest/actions/delete-folder?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/wistia/latest/actions/delete-folder?${params}`, {
  headers: {
