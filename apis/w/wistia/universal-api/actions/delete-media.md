...
Deletes an existing media item from Wistia.

```
DELETE https://connect.mindcloud.co/v1/universal/wistia/latest/actions/delete-media
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/wistia/latest/actions/delete-media?connectionId=$CONNECTION_ID&mediaHashedId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/wistia/latest/actions/delete-media?${params}`, {
  headers: {
