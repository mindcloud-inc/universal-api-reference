# Wistia: Archive Media

Archives one or more media items in Wistia.

```
PUT https://connect.mindcloud.co/v1/universal/wistia/latest/actions/archive-media
```
...
Through the native Wistia API, this operation is `PUT /modern/medias/archive` (base URL `https://api.wistia.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/archive-media.md) for the provider-specific parameters and requirements.
