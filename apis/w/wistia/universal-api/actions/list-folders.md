...
Retrieves folders from the Wistia account.

```
GET https://connect.mindcloud.co/v1/universal/wistia/latest/actions/list-folders
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/wistia/latest/actions/list-folders?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/wistia/latest/actions/list-folders?${params}`, {
  headers: {
