# Wistia: Create Folder

Creates a new folder in Wistia.

```
POST https://connect.mindcloud.co/v1/universal/wistia/latest/actions/create-folder
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/wistia/latest/actions/create-folder" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/wistia/latest/actions/create-folder', {
  method: 'POST',
  headers: {
