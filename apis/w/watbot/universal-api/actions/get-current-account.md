# Watbot: Get Current Account

Retrieves current account details from Watbot.

```
GET https://connect.mindcloud.co/v1/universal/watbot/latest/actions/get-current-account
```
...
Through the native Watbot API, this operation is `GET /getMe` (base URL `https://watbot.ru/api/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-current-account.md) for the provider-specific parameters and requirements.
