# Worktivity: Create Employee

Creates a new employee in Worktivity.

```
POST https://connect.mindcloud.co/v1/universal/worktivity/latest/actions/create-employee
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/worktivity/latest/actions/create-employee" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/worktivity/latest/actions/create-employee', {
  method: 'POST',
  headers: {
