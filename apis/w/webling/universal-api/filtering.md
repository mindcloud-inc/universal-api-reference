# Webling Universal API Filtering

Filterable list actions accept a `where` query parameter written as an RSQL expression. MindCloud translates it into the filtering format Webling expects, and each action page lists the fields available to filter.
...
## Webling actions that support filtering
