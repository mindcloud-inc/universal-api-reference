# WhatsBoost Universal API Authentication

Every WhatsBoost API request through MindCloud uses a MindCloud API key and the `connectionId` of a WhatsBoost connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your WhatsBoost connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [WhatsBoost action](README.md#actions-54) with your API key and `connectionId`.
