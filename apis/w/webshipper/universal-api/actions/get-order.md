# Webshipper: Get Order

Retrieves an order from Webshipper.

```
GET https://connect.mindcloud.co/v1/universal/webshipper/latest/actions/get-order
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/webshipper/latest/actions/get-order?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/webshipper/latest/actions/get-order?${params}`, {
  headers: {
...
| `attributes.orderLines[].package.barcodeUsageId` | object |  |
| `attributes.orderLines[].package.barcodeUsageType` | object |  |
| `attributes.orderLines[].package.colliType` | object |  |
| `attributes.orderLines[].package.createdAt` | string |  |
| `attributes.orderLines[].package.extRef` | object |  |
| `attributes.orderLines[].package.id` | number |  |
| `attributes.orderLines[].package.labellessCode` | object |  |
| `attributes.orderLines[].package.shipmentId` | number |  |
| `attributes.orderLines[].package.updatedAt` | string |  |
| `attributes.orderLines[].package.weight` | number |  |
| `attributes.orderLines[].package.weightUnit` | string |  |
| `attributes.orderLines[].packageId` | number |  |
...
Through the native Webshipper API, this operation is `GET /orders/:id` (base URL `https://{{credentials.accountName}}.api.webshipper.io/v2`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-order.md) for the provider-specific parameters and requirements.
