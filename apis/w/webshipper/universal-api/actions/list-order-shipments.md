# Webshipper: List Order Shipments



```
GET https://connect.mindcloud.co/v1/universal/webshipper/latest/actions/list-order-shipments
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/webshipper/latest/actions/list-order-shipments?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/webshipper/latest/actions/list-order-shipments?${params}`, {
  headers: {
...
Through the native Webshipper API, this operation is `GET /orders/:id/shipments` (base URL `https://{{credentials.accountName}}.api.webshipper.io/v2`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-order-shipments.md) for the provider-specific parameters and requirements.
