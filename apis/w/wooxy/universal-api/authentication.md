# Wooxy Universal API Authentication

Every Wooxy API request through MindCloud uses a MindCloud API key and the `connectionId` of a Wooxy connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Wooxy connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Wooxy action](README.md#actions-41) with your API key and `connectionId`.
