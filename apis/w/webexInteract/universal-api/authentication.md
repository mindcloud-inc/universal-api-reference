# Webex Interact Universal API Authentication

Every Webex Interact API request through MindCloud uses a MindCloud API key and the `connectionId` of a Webex Interact connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Webex Interact connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Webex Interact action](README.md#actions-22) with your API key and `connectionId`.
