# Wrike Universal API Authentication

Every Wrike API request through MindCloud uses a MindCloud API key and the `connectionId` of a Wrike connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Wrike connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Wrike action](README.md#actions-24) with your API key and `connectionId`.
