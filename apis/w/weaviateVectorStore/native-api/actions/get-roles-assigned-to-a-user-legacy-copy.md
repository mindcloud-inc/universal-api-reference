# Get Roles Assigned to a User (Legacy Copy) with Weaviate Vector Store
...
- **Official documentation:** [Get Roles Assigned to a User (Legacy Copy)](https://docs.weaviate.io/weaviate/api/rest)
