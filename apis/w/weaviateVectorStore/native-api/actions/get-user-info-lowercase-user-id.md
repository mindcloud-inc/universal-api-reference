# Get User Info (Lowercase User ID) with Weaviate Vector Store
...
- **Official documentation:** [Get User Info (Lowercase User ID)](https://docs.weaviate.io/weaviate/api/rest)
