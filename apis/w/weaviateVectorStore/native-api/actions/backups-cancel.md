# Cancel a backup with Weaviate Vector Store
...
- **Official documentation:** [Cancel a backup](https://docs.weaviate.io/weaviate/api/rest)
...
| `id` | path | `string` | yes | The unique identifier of the backup to cancel. Must be URL-safe and compatible with filesystem paths (only lowercase, numbers, underscore, minus characters allowed). |
