...
A consolidated summary of Weaviate Vector Store's API configuration and 160 documented operations, with links to official documentation.
...
## Endpoints (160 documented)

| Operation | Method & path | Vendor docs |
| --- | --- | --- |
| [Activate a user](actions/activate-a-user.md) | `POST /users/db/:user_id/activate` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Activate a user](actions/activateuser.md) | `POST /users/db/:user_id/activate` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Add a property to a collection](actions/add-a-property-to-a-collection.md) | `POST /schema/:className/properties` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Add an object reference](actions/add-an-object-reference.md) | `POST /objects/:id/references/:propertyName` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Add an Object Reference with Class Name (Legacy Copy)](actions/add-an-object-reference-with-class-name-legacy-copy.md) | `POST /objects/:className/:id/references/:propertyName` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [Add permissions to a role](actions/add-permissions-to-a-role.md) | `POST /authz/roles/:id/add-permissions` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [Create a new tenant](actions/create-a-new-tenant.md) | `POST /schema/:className/tenants` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Create a new user](actions/create-a-new-user.md) | `POST /users/db/:user_id` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [Deactivate a user](actions/deactivate-a-user.md) | `POST /users/db/:user_id/deactivate` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [Delete a collection (and all associated data)](actions/delete-a-collection-and-all-associated-data.md) | `DELETE /schema/:className` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Delete a collection's vector index.](actions/delete-a-collections-vector-index.md) | `DELETE /schema/:className/vectors/:vectorIndexName/index` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Delete a property's inverted index](actions/delete-a-propertys-inverted-index.md) | `DELETE /schema/:className/properties/:propertyName/index/:indexName` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Delete a user](actions/delete-a-user.md) | `DELETE /users/db/:user_id` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Delete an alias](actions/delete-an-alias.md) | `DELETE /aliases/:aliasName` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Delete an object](actions/delete-an-object.md) | `DELETE /objects/:className/:id` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Delete an object reference](actions/delete-an-object-reference.md) | `DELETE /objects/:id/references/:propertyName` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Delete an Object Reference with Class Name (Legacy Copy)](actions/delete-an-object-reference-with-class-name-legacy-copy.md) | `DELETE /objects/:className/:id/references/:propertyName` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [Delete Tenants (Legacy Copy)](actions/delete-tenants-legacy-copy.md) | `DELETE /schema/:className/tenants` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [Get a single collection](actions/get-a-single-collection.md) | `GET /schema/:className` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Get a specific tenant](actions/get-a-specific-tenant.md) | `GET /schema/:className/tenants/:tenantName` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Get an alias](actions/get-an-alias.md) | `GET /aliases/:aliasName` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Get an object](actions/get-an-object.md) | `GET /objects/:className/:id` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [Get groups that have a specific role assigned](actions/get-groups-that-have-a-specific-role-assigned.md) | `GET /authz/roles/:id/group-assignments` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Get node status by collection](actions/get-node-status-by-collection.md) | `GET /nodes/:className` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [Get roles assigned to a specific group](actions/get-roles-assigned-to-a-specific-group.md) | `GET /authz/groups/:id/roles/:groupType` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Get roles assigned to a user](actions/get-roles-assigned-to-a-user.md) | `GET /authz/users/:id/roles` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Get Roles Assigned to a User (Legacy Copy)](actions/get-roles-assigned-to-a-user-legacy-copy.md) | `GET /authz/users/:id/roles/:userType` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Get the list of tenants](actions/get-the-list-of-tenants.md) | `GET /schema/:className/tenants` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Get the shards status of a collection](actions/get-the-shards-status-of-a-collection.md) | `GET /schema/:className/shards` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Get User Info (Lowercase User ID)](actions/get-user-info-lowercase-user-id.md) | `GET /users/db/:user_id` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Get users assigned to a role](actions/get-users-assigned-to-a-role.md) | `GET /authz/roles/:id/users` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Get Users Assigned to a Role (Legacy Copy)](actions/get-users-assigned-to-a-role-legacy-copy.md) | `GET /authz/roles/:id/user-assignments` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [List all groups of a specific type](actions/list-all-groups-of-a-specific-type.md) | `GET /authz/groups/:groupType` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [Patch an object](actions/patch-an-object.md) | `PATCH /objects/:className/:id` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Remove permissions from a role](actions/remove-permissions-from-a-role.md) | `POST /authz/roles/:id/remove-permissions` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [Replace an object](actions/replace-an-object.md) | `PUT /objects/:className/:id` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Replace Object](actions/replace-object.md) | `PUT /v1/objects/:id` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Replace object references](actions/replace-object-references.md) | `PUT /objects/:id/references/:propertyName` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Replace Object References with Class Name (Legacy Copy)](actions/replace-object-references-with-class-name-legacy-copy.md) | `PUT /objects/:className/:id/references/:propertyName` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [Retrieve a replication operation](actions/retrieve-a-replication-operation.md) | `GET /replication/replicate/:id` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [Rotate API key of a user](actions/rotate-api-key-of-a-user.md) | `POST /users/db/:user_id/rotate-key` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
...
| [Tokenize text using a property's configuration](actions/tokenize-text-using-a-propertys-configuration.md) | `POST /schema/:className/properties/:propertyName/tokenize` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Update a shard status](actions/update-a-shard-status.md) | `PUT /schema/:className/shards/:shardName` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Update a tenant](actions/update-a-tenant.md) | `PUT /schema/:className/tenants` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Update an alias](actions/update-an-alias.md) | `PUT /aliases/:aliasName` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
| [Update collection definition](actions/update-collection-definition.md) | `PUT /schema/:className` | [docs](https://docs.weaviate.io/weaviate/api/rest) |
