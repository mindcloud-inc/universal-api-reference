# Workiz Universal API Authentication

Every Workiz API request through MindCloud uses a MindCloud API key and the `connectionId` of a Workiz connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Workiz connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Workiz action](README.md#actions-20) with your API key and `connectionId`.
