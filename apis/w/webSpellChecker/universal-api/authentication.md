# WebSpellChecker Universal API Authentication

Every WebSpellChecker API request through MindCloud uses a MindCloud API key and the `connectionId` of a WebSpellChecker connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your WebSpellChecker connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [WebSpellChecker action](README.md#actions-18) with your API key and `connectionId`.
