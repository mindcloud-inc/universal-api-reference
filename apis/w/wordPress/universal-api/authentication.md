# WordPress Universal API Authentication

Every WordPress API request through MindCloud uses a MindCloud API key and the `connectionId` of a WordPress connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your WordPress connection.
