# Wisewand: List projects

Retrieves projects from your Wisewand workspace.

```
GET https://connect.mindcloud.co/v1/universal/wisewand/latest/actions/list-projects
```
...
Through the native Wisewand API, this operation is `GET /v1/projects/` (base URL `https://api.wisewand.ai`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-projects.md) for the provider-specific parameters and requirements.
