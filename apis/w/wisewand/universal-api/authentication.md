# Wisewand Universal API Authentication

Every Wisewand API request through MindCloud uses a MindCloud API key and the `connectionId` of a Wisewand connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Wisewand connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Wisewand action](README.md#actions-83) with your API key and `connectionId`.
