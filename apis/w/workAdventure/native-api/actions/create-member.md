# Create member with WorkAdventure
...
- **Official documentation:** [Create member](https://docs.workadventu.re/developer/inbound-api)
...
| `name` | body | `string` | yes | Name of the Woka. |
| `email` | body | `string` | yes | Email of the member. |
