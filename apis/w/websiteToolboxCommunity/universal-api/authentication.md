# Website Toolbox Community Universal API Authentication

Every Website Toolbox Community API request through MindCloud uses a MindCloud API key and the `connectionId` of a Website Toolbox Community connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Website Toolbox Community connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Website Toolbox Community action](README.md#actions-35) with your API key and `connectionId`.
