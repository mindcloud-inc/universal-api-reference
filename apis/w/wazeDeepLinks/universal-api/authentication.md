# Waze Deep Links Universal API Authentication

Every Waze Deep Links API request through MindCloud uses a MindCloud API key and the `connectionId` of a Waze Deep Links connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Waze Deep Links connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Waze Deep Links action](README.md#actions-6) with your API key and `connectionId`.
