# Webpushr: Send Push to All Subscribers



```
POST https://connect.mindcloud.co/v1/universal/webpushr/latest/actions/send-push-to-all-subscribers
```
...
Through the native Webpushr API, this operation is `POST /notification/send/all` (base URL `https://api.webpushr.com/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/send-push-to-all-subscribers.md) for the provider-specific parameters and requirements.
