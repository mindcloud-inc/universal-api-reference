...
- **Official documentation:** [Update Client](https://api.wasi.co/docs/en/guide/clients.html)
...
| `id_client` | path | `number` | yes | Wasi client ID to update. |
