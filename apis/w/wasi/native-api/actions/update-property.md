...
- **Method:** `POST`
- **Path:** `/property/update/:id_property`
- **Base URL:** `https://api.wasi.co/v1`
- **Official documentation:** [Update Property](https://api.wasi.co/docs/en/guide/properties.html)
...
| `id_property` | path | `number` | yes | Wasi property ID to update. |
