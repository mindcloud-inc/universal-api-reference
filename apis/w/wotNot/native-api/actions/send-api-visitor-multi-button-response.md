# Send API Visitor Multi-Button Response with WotNot
...
- **Official documentation:** [Send API Visitor Multi-Button Response](https://help.wotnot.io/deploy/publishing-agents/api)
...
| `message.data.next_dialog` | body | `string` | yes | Next dialog from the multi-button payload |
| `message.data.key` | body | `string` | yes | Button key from the prior prompt payload |
| `message.data.selected_button_index[0]` | body | `string` | yes | Selected multi-button index value |
