# WebWork Time Tracker Universal API Authentication

Every WebWork Time Tracker API request through MindCloud uses a MindCloud API key and the `connectionId` of a WebWork Time Tracker connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your WebWork Time Tracker connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [WebWork Time Tracker action](README.md#actions-36) with your API key and `connectionId`.
