# Wolfram Alpha Universal API Authentication

Every Wolfram Alpha API request through MindCloud uses a MindCloud API key and the `connectionId` of a Wolfram Alpha connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Wolfram Alpha connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Wolfram Alpha action](README.md#actions-46) with your API key and `connectionId`.
