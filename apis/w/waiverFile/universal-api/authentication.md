# WaiverFile Universal API Authentication

Every WaiverFile API request through MindCloud uses a MindCloud API key and the `connectionId` of a WaiverFile connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your WaiverFile connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [WaiverFile action](README.md#actions-45) with your API key and `connectionId`.
