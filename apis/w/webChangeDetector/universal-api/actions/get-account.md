# WebChange Detector: Get Account

Retrieves account details from WebChange Detector.

```
GET https://connect.mindcloud.co/v1/universal/webChangeDetector/latest/actions/get-account
```
