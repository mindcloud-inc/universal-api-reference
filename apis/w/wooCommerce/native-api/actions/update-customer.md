# Update Customer with WooCommerce
...
- **Official documentation:** [Update Customer](https://woocommerce.github.io/woocommerce-rest-api-docs/#update-a-customer)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `id` | path | `list<number>` | yes | Unique numeric ID of the customer to update. |
