# Webcrawler API: Cancel Crawl Job

Cancels an existing crawl job in Webcrawler API.

```
PUT https://connect.mindcloud.co/v1/universal/webcrawlerAPI/latest/actions/cancel-crawl-job
```
