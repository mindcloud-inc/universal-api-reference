# World News API Universal API Authentication

Every World News API API request through MindCloud uses a MindCloud API key and the `connectionId` of a World News API connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your World News API connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [World News API action](README.md#actions-10) with your API key and `connectionId`.
