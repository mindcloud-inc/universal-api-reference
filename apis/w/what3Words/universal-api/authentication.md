# What3Words Universal API Authentication

Every What3Words API request through MindCloud uses a MindCloud API key and the `connectionId` of a What3Words connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your What3Words connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [What3Words action](README.md#actions-5) with your API key and `connectionId`.
