# Week Plan Universal API Authentication

Every Week Plan API request through MindCloud uses a MindCloud API key and the `connectionId` of a Week Plan connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Week Plan connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Week Plan action](README.md#actions-56) with your API key and `connectionId`.
