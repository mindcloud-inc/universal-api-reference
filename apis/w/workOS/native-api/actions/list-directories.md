...
- **Official documentation:** [List Directories](https://workos.com/docs/reference)
...
| `organization_id` | query | `string` | no | Filter Directories by their associated organization. |
