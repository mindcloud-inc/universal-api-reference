...
- **Official documentation:** [List users](https://workos.com/docs/reference)
...
| `organization_id` | query | `string` | no | Filter users by the organization they are a member of. |
| `email` | query | `string` | no | Filter users by their email address. |
