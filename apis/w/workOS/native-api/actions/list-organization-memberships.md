# List organization memberships with WorkOS
...
- **Official documentation:** [List organization memberships](https://workos.com/docs/reference)
...
| `organization_id` | query | `string` | no | The ID of the [organization](/reference/organization) which the user belongs to. |
| `user_id` | query | `string` | no | The ID of the [user](/reference/authkit/user). |
