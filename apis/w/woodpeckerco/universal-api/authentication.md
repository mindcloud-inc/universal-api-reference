# Woodpecker.co Universal API Authentication

Every Woodpecker.co API request through MindCloud uses a MindCloud API key and the `connectionId` of a Woodpecker.co connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Woodpecker.co connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Woodpecker.co action](README.md#actions-30) with your API key and `connectionId`.
