# Weavo Liquid Loom Universal API Authentication

Every Weavo Liquid Loom API request through MindCloud uses a MindCloud API key and the `connectionId` of a Weavo Liquid Loom connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Weavo Liquid Loom connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Weavo Liquid Loom action](README.md#actions-9) with your API key and `connectionId`.
