# WeBeHome Universal API Authentication

Every WeBeHome API request through MindCloud uses a MindCloud API key and the `connectionId` of a WeBeHome connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your WeBeHome connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [WeBeHome action](README.md#actions-88) with your API key and `connectionId`.
