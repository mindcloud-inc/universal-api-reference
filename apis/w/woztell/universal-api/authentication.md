# Woztell Universal API Authentication

Every Woztell API request through MindCloud uses a MindCloud API key and the `connectionId` of a Woztell connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Woztell connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Woztell action](README.md#actions-30) with your API key and `connectionId`.
