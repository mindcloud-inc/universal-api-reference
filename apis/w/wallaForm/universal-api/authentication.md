# Walla Form Universal API Authentication

Every Walla Form API request through MindCloud uses a MindCloud API key and the `connectionId` of a Walla Form connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Walla Form connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Walla Form action](README.md#actions-13) with your API key and `connectionId`.
