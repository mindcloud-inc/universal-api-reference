# WebCategorize Universal API Authentication

Every WebCategorize API request through MindCloud uses a MindCloud API key and the `connectionId` of a WebCategorize connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your WebCategorize connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [WebCategorize action](README.md#actions-12) with your API key and `connectionId`.
