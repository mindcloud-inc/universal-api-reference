# WorkflowMax: Get Quote



```
GET https://connect.mindcloud.co/v1/universal/workflowMax/latest/actions/get-quote
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/workflowMax/latest/actions/get-quote?connectionId=$CONNECTION_ID&quoteId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/workflowMax/latest/actions/get-quote?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `quoteId` | string | yes | The WorkflowMax quote UUID. |
