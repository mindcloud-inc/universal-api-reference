# WorkflowMax: Update Job



```
PUT https://connect.mindcloud.co/v1/universal/workflowMax/latest/actions/update-job
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/workflowMax/latest/actions/update-job" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/workflowMax/latest/actions/update-job', {
  method: 'PUT',
  headers: {
