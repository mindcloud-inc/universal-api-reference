# Weberlo: List Websites

Retrieves a list of websites from Weberlo.

```
GET https://connect.mindcloud.co/v1/universal/weberlo/latest/actions/list-websites
```
...
Through the native Weberlo API, this operation is `GET /page/website/list` (base URL `https://connect.weberlo.com`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-websites.md) for the provider-specific parameters and requirements.
