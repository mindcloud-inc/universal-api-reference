# Worksection: Activate Project



```
PUT https://connect.mindcloud.co/v1/universal/worksection/latest/actions/activate-project
```
...
Through the native Worksection API, this operation is `POST /` (base URL `https://min7657.worksection.com/api/admin/v2`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/activate-project.md) for the provider-specific parameters and requirements.
