# Worksection Universal API Authentication

Every Worksection API request through MindCloud uses a MindCloud API key and the `connectionId` of a Worksection connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Worksection connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Worksection action](README.md#actions-55) with your API key and `connectionId`.
