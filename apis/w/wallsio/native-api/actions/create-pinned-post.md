# Create Pinned Post with Walls.io
...
- **Official documentation:** [Create Pinned Post](https://github.com/DieSocialisten/Walls.io-API-Docs/blob/master/endpoints/POST_posts.md)
