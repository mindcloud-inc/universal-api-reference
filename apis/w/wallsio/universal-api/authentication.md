# Walls.io Universal API Authentication

Every Walls.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a Walls.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Walls.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Walls.io action](README.md#actions-31) with your API key and `connectionId`.
