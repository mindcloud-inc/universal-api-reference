# Walls.io: List Posts By Language

Finds posts in Walls.io by language.

```
GET https://connect.mindcloud.co/v1/universal/wallsio/latest/actions/list-posts-by-language
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/wallsio/latest/actions/list-posts-by-language?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/wallsio/latest/actions/list-posts-by-language?${params}`, {
  headers: {
