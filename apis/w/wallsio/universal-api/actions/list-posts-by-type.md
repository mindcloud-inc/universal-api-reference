# Walls.io: List Posts By Type

Finds posts in Walls.io by post type.

```
GET https://connect.mindcloud.co/v1/universal/wallsio/latest/actions/list-posts-by-type
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/wallsio/latest/actions/list-posts-by-type?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/wallsio/latest/actions/list-posts-by-type?${params}`, {
  headers: {
