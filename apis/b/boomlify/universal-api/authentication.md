# Boomlify Universal API Authentication

Every Boomlify API request through MindCloud uses a MindCloud API key and the `connectionId` of a Boomlify connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Boomlify connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Boomlify action](README.md#actions-15) with your API key and `connectionId`.
