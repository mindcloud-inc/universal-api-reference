# BackgroundCut Universal API Authentication

Every BackgroundCut API request through MindCloud uses a MindCloud API key and the `connectionId` of a BackgroundCut connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BackgroundCut connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BackgroundCut action](README.md#actions-6) with your API key and `connectionId`.
