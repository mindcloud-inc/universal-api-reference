...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/blazeMeter/latest/actions/list-account-invoices?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/blazeMeter/latest/actions/list-account-invoices?${params}`, {
  headers: {
