# BlazeMeter Universal API Authentication

Every BlazeMeter API request through MindCloud uses a MindCloud API key and the `connectionId` of a BlazeMeter connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BlazeMeter connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BlazeMeter action](README.md#actions-34) with your API key and `connectionId`.
