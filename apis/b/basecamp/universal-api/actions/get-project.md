...
```
GET https://connect.mindcloud.co/v1/universal/basecamp/latest/actions/get-project
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/basecamp/latest/actions/get-project?connectionId=$CONNECTION_ID&accountId=6172410&projectId=46425319" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/basecamp/latest/actions/get-project?${params}`, {
  headers: {
