# Breaking Bad Quotes Universal API Authentication

Every Breaking Bad Quotes API request through MindCloud uses a MindCloud API key and the `connectionId` of a Breaking Bad Quotes connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Breaking Bad Quotes connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Breaking Bad Quotes action](README.md#actions-2) with your API key and `connectionId`.
