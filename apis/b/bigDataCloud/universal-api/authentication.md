# BigDataCloud Universal API Authentication

Every BigDataCloud API request through MindCloud uses a MindCloud API key and the `connectionId` of a BigDataCloud connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BigDataCloud connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BigDataCloud action](README.md#actions-26) with your API key and `connectionId`.
