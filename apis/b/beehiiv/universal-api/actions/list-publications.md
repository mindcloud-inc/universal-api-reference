# Beehiiv: List Publications

Retrieves publications from Beehiiv.

```
GET https://connect.mindcloud.co/v1/universal/beehiiv/latest/actions/list-publications
```
