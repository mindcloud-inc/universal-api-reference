...
```
POST https://connect.mindcloud.co/v1/universal/beehiiv/latest/actions/create-subscription
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/beehiiv/latest/actions/create-subscription" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/beehiiv/latest/actions/create-subscription', {
  method: 'POST',
  headers: {
...
| `email` | string | yes | Email address for the new subscription. |
