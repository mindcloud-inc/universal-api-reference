# Generate Response with Botsonic
...
- **Method:** `POST`
- **Path:** `/v1/botsonic/generate`
- **Base URL:** `https://api.botsonic.ai`
- **Official documentation:** [Generate Response](https://docs.botsonic.com/reference/botsonic_api_v1_botsonic_generate_post)
