# BASIC Universal API Authentication

Every BASIC API request through MindCloud uses a MindCloud API key and the `connectionId` of a BASIC connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BASIC connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BASIC action](README.md#actions-64) with your API key and `connectionId`.
