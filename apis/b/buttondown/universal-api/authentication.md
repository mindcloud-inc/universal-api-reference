# Buttondown Universal API Authentication

Every Buttondown API request through MindCloud uses a MindCloud API key and the `connectionId` of a Buttondown connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Buttondown connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Buttondown action](README.md#actions-19) with your API key and `connectionId`.
