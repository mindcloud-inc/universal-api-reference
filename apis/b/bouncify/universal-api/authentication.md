# Bouncify Universal API Authentication

Every Bouncify API request through MindCloud uses a MindCloud API key and the `connectionId` of a Bouncify connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Bouncify connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Bouncify action](README.md#actions-7) with your API key and `connectionId`.
