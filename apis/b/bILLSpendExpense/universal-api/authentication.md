# BILL Spend & Expense Universal API Authentication

Every BILL Spend & Expense API request through MindCloud uses a MindCloud API key and the `connectionId` of a BILL Spend & Expense connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BILL Spend & Expense connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BILL Spend & Expense action](README.md#actions-21) with your API key and `connectionId`.
