# Bannerbear: List Collections

Retrieves collections from Bannerbear.

```
GET https://connect.mindcloud.co/v1/universal/bannerbear/latest/actions/list-collections
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/bannerbear/latest/actions/list-collections?${params}`, {
  headers: {
