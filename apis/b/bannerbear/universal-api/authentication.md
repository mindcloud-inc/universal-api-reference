# Bannerbear Universal API Authentication

Every Bannerbear API request through MindCloud uses a MindCloud API key and the `connectionId` of a Bannerbear connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Bannerbear connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Bannerbear action](README.md#actions-29) with your API key and `connectionId`.
