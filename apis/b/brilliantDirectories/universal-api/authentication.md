# Brilliant Directories Universal API Authentication

Every Brilliant Directories API request through MindCloud uses a MindCloud API key and the `connectionId` of a Brilliant Directories connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Brilliant Directories connection.
