# Better Stack Uptime Universal API Authentication

Every Better Stack Uptime API request through MindCloud uses a MindCloud API key and the `connectionId` of a Better Stack Uptime connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Better Stack Uptime connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Better Stack Uptime action](README.md#actions-28) with your API key and `connectionId`.
