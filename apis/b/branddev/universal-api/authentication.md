# Brand.dev Universal API Authentication

Every Brand.dev API request through MindCloud uses a MindCloud API key and the `connectionId` of a Brand.dev connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Brand.dev connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Brand.dev action](README.md#actions-20) with your API key and `connectionId`.
