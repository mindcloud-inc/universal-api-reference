# Businesslogic.online Universal API Authentication

Every Businesslogic.online API request through MindCloud uses a MindCloud API key and the `connectionId` of a Businesslogic.online connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Businesslogic.online connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Businesslogic.online action](README.md#actions-2) with your API key and `connectionId`.
