# Billingo Universal API Authentication

Every Billingo API request through MindCloud uses a MindCloud API key and the `connectionId` of a Billingo connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Billingo connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Billingo action](README.md#actions-30) with your API key and `connectionId`.
