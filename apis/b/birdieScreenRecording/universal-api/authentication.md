# Birdie Screen Recording Universal API Authentication

Every Birdie Screen Recording API request through MindCloud uses a MindCloud API key and the `connectionId` of a Birdie Screen Recording connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Birdie Screen Recording connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Birdie Screen Recording action](README.md#actions-1) with your API key and `connectionId`.
