# Benchmark Email: Get Email

Retrieves an email from Benchmark Email.

```
GET https://connect.mindcloud.co/v1/universal/benchmarkEmail/latest/actions/get-email
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/benchmarkEmail/latest/actions/get-email?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/benchmarkEmail/latest/actions/get-email?${params}`, {
  headers: {
