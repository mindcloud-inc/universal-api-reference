# Benchmark Email: Create Contact

Creates a contact in a Benchmark Email contact list.

```
POST https://connect.mindcloud.co/v1/universal/benchmarkEmail/latest/actions/create-contact
```
