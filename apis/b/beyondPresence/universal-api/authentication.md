# Beyond Presence Universal API Authentication

Every Beyond Presence API request through MindCloud uses a MindCloud API key and the `connectionId` of a Beyond Presence connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Beyond Presence connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Beyond Presence action](README.md#actions-16) with your API key and `connectionId`.
