# Better Stack Telemetry Universal API Authentication

Every Better Stack Telemetry API request through MindCloud uses a MindCloud API key and the `connectionId` of a Better Stack Telemetry connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Better Stack Telemetry connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Better Stack Telemetry action](README.md#actions-27) with your API key and `connectionId`.
