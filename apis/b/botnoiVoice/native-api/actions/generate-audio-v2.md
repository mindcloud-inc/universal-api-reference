# Generate Audio V2 with Botnoi Voice
...
- **Method:** `POST`
- **Path:** `/openapi/v1/generate_audio_v2`
- **Base URL:** `https://api-voice.botnoi.ai`
- **Official documentation:** [Generate Audio V2](https://api-voice.botnoi.ai/openapi/v1/openapi.json)
