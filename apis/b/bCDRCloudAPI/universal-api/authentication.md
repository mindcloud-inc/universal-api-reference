# BCDR Cloud Universal API Authentication

Every BCDR Cloud API request through MindCloud uses a MindCloud API key and the `connectionId` of a BCDR Cloud connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BCDR Cloud connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BCDR Cloud action](README.md#actions-4) with your API key and `connectionId`.
