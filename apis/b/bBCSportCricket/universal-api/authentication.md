# BBC Sport - Cricket Universal API Authentication

Every BBC Sport - Cricket API request through MindCloud uses a MindCloud API key and the `connectionId` of a BBC Sport - Cricket connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BBC Sport - Cricket connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BBC Sport - Cricket action](README.md#actions-20) with your API key and `connectionId`.
