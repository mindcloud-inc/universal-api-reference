# Bannerbite Universal API Authentication

Every Bannerbite API request through MindCloud uses a MindCloud API key and the `connectionId` of a Bannerbite connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Bannerbite connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Bannerbite action](README.md#actions-7) with your API key and `connectionId`.
