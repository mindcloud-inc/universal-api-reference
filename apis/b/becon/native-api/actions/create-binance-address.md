# Create Binance Address with Becon
...
- **Official documentation:** [Create Binance Address](https://bcon.global/integrations/api/)
...
| `payment_currency` | body | `string` | yes | Token ticker to accept, for example BNB. |
