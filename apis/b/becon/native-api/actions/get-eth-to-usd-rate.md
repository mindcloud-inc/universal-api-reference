# Get ETH to USD Rate with Becon
...
- **Official documentation:** [Get ETH to USD Rate](https://bcon.global/integrations/api/)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `cryptoCurrencyName` | path | `string` | yes | The cryptocurrency code in the path, such as eth. |
