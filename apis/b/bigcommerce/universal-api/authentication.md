# BigCommerce Universal API Authentication

Every BigCommerce API request through MindCloud uses a MindCloud API key and the `connectionId` of a BigCommerce connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BigCommerce connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BigCommerce action](README.md#actions-65) with your API key and `connectionId`.
