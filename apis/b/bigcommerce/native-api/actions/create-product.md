# Create Product with BigCommerce
...
| `is_visible` | body | `boolean` | no | Flag to determine whether the product should be displayed to customers browsing the store. If true, the product will be displayed. If false, the product will be hidden from view Format: `text`. |
