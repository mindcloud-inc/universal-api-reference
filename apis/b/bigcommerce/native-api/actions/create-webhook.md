# Create Webhook with BigCommerce
...
| `is_active` | body | `boolean` | no | Boolean value that indicates whether the webhook is active or not. A webhook subscription becomes deactivated after 90 days of inactivity. Format: `toggle`. |
