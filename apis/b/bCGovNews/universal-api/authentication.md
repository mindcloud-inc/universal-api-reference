# BC Gov News Universal API Authentication

Every BC Gov News API request through MindCloud uses a MindCloud API key and the `connectionId` of a BC Gov News connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BC Gov News connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BC Gov News action](README.md#actions-30) with your API key and `connectionId`.
