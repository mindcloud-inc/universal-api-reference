# Billforward: List Accounts

Retrieves accounts from Billforward.

```
GET https://connect.mindcloud.co/v1/universal/billforward/latest/actions/list-accounts
```
...
Through the native Billforward API, this operation is `GET /accounts` (base URL `https://app-sandbox.billforward.net/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-accounts.md) for the provider-specific parameters and requirements.
