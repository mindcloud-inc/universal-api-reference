# Blockscout Universal API Authentication

Every Blockscout API request through MindCloud uses a MindCloud API key and the `connectionId` of a Blockscout connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Blockscout connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Blockscout action](README.md#actions-33) with your API key and `connectionId`.
