...
```
GET https://connect.mindcloud.co/v1/universal/bambooHrV2/latest/actions/list-employees
```
...
Through the native BambooHR API, this operation is `GET /v1/employees` (base URL `https://mindcloud.bamboohr.com/api`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-employees.md) for the provider-specific parameters and requirements.
