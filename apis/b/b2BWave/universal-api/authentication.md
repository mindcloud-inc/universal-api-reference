# B2B Wave Universal API Authentication

Every B2B Wave API request through MindCloud uses a MindCloud API key and the `connectionId` of a B2B Wave connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your B2B Wave connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [B2B Wave action](README.md#actions-20) with your API key and `connectionId`.
