# BBC Sport - Rugby Universal API Authentication

Every BBC Sport - Rugby API request through MindCloud uses a MindCloud API key and the `connectionId` of a BBC Sport - Rugby connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BBC Sport - Rugby connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BBC Sport - Rugby action](README.md#actions-20) with your API key and `connectionId`.
