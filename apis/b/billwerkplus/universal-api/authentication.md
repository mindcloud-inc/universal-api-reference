# Billwerkplus Universal API Authentication

Every Billwerkplus API request through MindCloud uses a MindCloud API key and the `connectionId` of a Billwerkplus connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Billwerkplus connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Billwerkplus action](README.md#actions-33) with your API key and `connectionId`.
