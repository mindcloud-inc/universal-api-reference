# BrowserStack Universal API Authentication

Every BrowserStack API request through MindCloud uses a MindCloud API key and the `connectionId` of a BrowserStack connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BrowserStack connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BrowserStack action](README.md#actions-19) with your API key and `connectionId`.
