...
- **Method:** `PUT`
- **Path:** `/organizations/:organization/pipelines/:pipeline/builds/:build/jobs/:job/unblock`
- **Base URL:** `https://api.buildkite.com/v2`
- **Official documentation:** [Unblock Job](https://buildkite.com/docs/apis/rest-api/jobs)
