...
- **Method:** `PUT`
- **Path:** `/organizations/:organization/pipelines/:pipeline/builds/:build/jobs/:job/retry`
- **Base URL:** `https://api.buildkite.com/v2`
- **Official documentation:** [Retry Job](https://buildkite.com/docs/apis/rest-api/jobs)
