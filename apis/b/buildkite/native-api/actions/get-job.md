...
- **Method:** `GET`
- **Path:** `/organizations/:organization/pipelines/:pipeline/builds/:build/jobs/:job`
- **Base URL:** `https://api.buildkite.com/v2`
- **Official documentation:** [Get Job](https://buildkite.com/docs/apis/rest-api/jobs)
