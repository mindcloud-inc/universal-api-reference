# Bridge Interactive Platform Universal API Authentication

Every Bridge Interactive Platform API request through MindCloud uses a MindCloud API key and the `connectionId` of a Bridge Interactive Platform connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Bridge Interactive Platform connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Bridge Interactive Platform action](README.md#actions-17) with your API key and `connectionId`.
