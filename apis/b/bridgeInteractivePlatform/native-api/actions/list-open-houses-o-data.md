# List open houses (OData) with Bridge Interactive Platform
...
- **Method:** `GET`
- **Path:** `/OData/:dataset/OpenHouse`
- **Base URL:** `https://api.bridgedataoutput.com/api/v2`
- **Official documentation:** [List open houses (OData)](https://bridgedataoutput.com/docs)
