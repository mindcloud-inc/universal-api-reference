# Bacon Ipsum Universal API Authentication

Every Bacon Ipsum API request through MindCloud uses a MindCloud API key and the `connectionId` of a Bacon Ipsum connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Bacon Ipsum connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Bacon Ipsum action](README.md#actions-1) with your API key and `connectionId`.
