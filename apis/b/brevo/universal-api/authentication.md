# Brevo Universal API Authentication

Every Brevo API request through MindCloud uses a MindCloud API key and the `connectionId` of a Brevo connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Brevo connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Brevo action](README.md#actions-285) with your API key and `connectionId`.
