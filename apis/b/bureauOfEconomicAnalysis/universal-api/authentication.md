# Bureau of Economic Analysis Universal API Authentication

Every Bureau of Economic Analysis API request through MindCloud uses a MindCloud API key and the `connectionId` of a Bureau of Economic Analysis connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Bureau of Economic Analysis connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Bureau of Economic Analysis action](README.md#actions-17) with your API key and `connectionId`.
