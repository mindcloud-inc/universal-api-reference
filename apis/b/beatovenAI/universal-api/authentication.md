# Beatoven AI Universal API Authentication

Every Beatoven AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Beatoven AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Beatoven AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Beatoven AI action](README.md#actions-3) with your API key and `connectionId`.
