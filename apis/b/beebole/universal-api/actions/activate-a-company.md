# Beebole: Activate a Company

Activates a company in Beebole.

```
PUT https://connect.mindcloud.co/v1/universal/beebole/latest/actions/activate-a-company
```
...
| --- | --- | --- | --- |
| `id` | number | yes | The Beebole company ID to activate. |
...
Through the native Beebole API, this operation is `POST` (base URL `https://beebole-apps.com/api/v2`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/activate-a-company.md) for the provider-specific parameters and requirements.
