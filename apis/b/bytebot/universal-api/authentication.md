# bytebot Universal API Authentication

Every bytebot API request through MindCloud uses a MindCloud API key and the `connectionId` of a bytebot connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your bytebot connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [bytebot action](README.md#actions-1) with your API key and `connectionId`.
