# BILL Payables & Receivables Universal API Authentication

Every BILL Payables & Receivables API request through MindCloud uses a MindCloud API key and the `connectionId` of a BILL Payables & Receivables connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BILL Payables & Receivables connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BILL Payables & Receivables action](README.md#actions-19) with your API key and `connectionId`.
