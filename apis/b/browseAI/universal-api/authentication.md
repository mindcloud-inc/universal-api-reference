# Browse AI Universal API Authentication

Every Browse AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Browse AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Browse AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Browse AI action](README.md#actions-19) with your API key and `connectionId`.
