# Bonusly Universal API Authentication

Every Bonusly API request through MindCloud uses a MindCloud API key and the `connectionId` of a Bonusly connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Bonusly connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Bonusly action](README.md#actions-46) with your API key and `connectionId`.
