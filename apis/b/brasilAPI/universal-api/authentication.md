# Brasil API Universal API Authentication

Every Brasil API API request through MindCloud uses a MindCloud API key and the `connectionId` of a Brasil API connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Brasil API connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Brasil API action](README.md#actions-34) with your API key and `connectionId`.
