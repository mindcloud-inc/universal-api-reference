# Bureau of Labor Statistics Universal API Authentication

Every Bureau of Labor Statistics API request through MindCloud uses a MindCloud API key and the `connectionId` of a Bureau of Labor Statistics connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Bureau of Labor Statistics connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Bureau of Labor Statistics action](README.md#actions-6) with your API key and `connectionId`.
