# Bika.ai Universal API Authentication

Every Bika.ai API request through MindCloud uses a MindCloud API key and the `connectionId` of a Bika.ai connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Bika.ai connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Bika.ai action](README.md#actions-14) with your API key and `connectionId`.
