# BrainyQuote Universal API Authentication

Every BrainyQuote API request through MindCloud uses a MindCloud API key and the `connectionId` of a BrainyQuote connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BrainyQuote connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BrainyQuote action](README.md#actions-5) with your API key and `connectionId`.
