# Baremetrics: List Plans

Retrieves plans from Baremetrics.

```
GET https://connect.mindcloud.co/v1/universal/baremetrics/latest/actions/list-plans
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/baremetrics/latest/actions/list-plans?connectionId=$CONNECTION_ID&limit=25&offset=0&sourceId=source_1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/baremetrics/latest/actions/list-plans?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `search` | string | no | Allows you to search based on the name or oid fields |
