# Baremetrics: Delete Customer

Deletes a customer from Baremetrics.

```
DELETE https://connect.mindcloud.co/v1/universal/baremetrics/latest/actions/delete-customer
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/baremetrics/latest/actions/delete-customer?connectionId=$CONNECTION_ID&oid=resource_1&sourceId=source_1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/baremetrics/latest/actions/delete-customer?${params}`, {
  headers: {
