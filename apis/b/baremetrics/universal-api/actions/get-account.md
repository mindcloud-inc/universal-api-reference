# Baremetrics: Get Account

Retrieves account details from Baremetrics.

```
GET https://connect.mindcloud.co/v1/universal/baremetrics/latest/actions/get-account
```
