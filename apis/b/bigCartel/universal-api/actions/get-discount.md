# Big Cartel: Get Discount

Retrieves a discount from Big Cartel.

```
GET https://connect.mindcloud.co/v1/universal/bigCartel/latest/actions/get-discount
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/bigCartel/latest/actions/get-discount?connectionId=$CONNECTION_ID&accountId=1&discountId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/bigCartel/latest/actions/get-discount?${params}`, {
  headers: {
