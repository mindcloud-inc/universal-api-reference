...
Retrieves a quote from Bexio.

```
GET https://connect.mindcloud.co/v1/universal/bexio/latest/actions/get-quote
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/bexio/latest/actions/get-quote?connectionId=$CONNECTION_ID&quoteId=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/bexio/latest/actions/get-quote?${params}`, {
  headers: {
