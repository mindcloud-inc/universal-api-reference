# Bexio: List Purchase Orders

Retrieves purchase orders from Bexio.

```
GET https://connect.mindcloud.co/v1/universal/bexio/latest/actions/list-purchase-orders
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/bexio/latest/actions/list-purchase-orders?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/bexio/latest/actions/list-purchase-orders?${params}`, {
  headers: {
