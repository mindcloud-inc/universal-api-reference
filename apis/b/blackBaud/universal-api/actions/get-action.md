# BlackBaud: Get Action



```
GET https://connect.mindcloud.co/v1/universal/blackBaud/latest/actions/get-action
```
...
| --- | --- | --- | --- |
| `actionId` | string | yes | The Blackbaud action identifier. Example: `Action ID`. |
