# List Order Ticket Details with BlackBaud

## Endpoint

- **Method:** `GET`
- **Path:** `alt-slsmg/sales/{sales_order_id}/orders`
- **Base URL:** `https://api.sky.blackbaud.com/`
- **Official documentation:** [List Order Ticket Details](https://developer.sky.blackbaud.com/api#api=alt-slsmg)
