# Base64.ai Universal API Authentication

Every Base64.ai API request through MindCloud uses a MindCloud API key and the `connectionId` of a Base64.ai connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Base64.ai connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Base64.ai action](README.md#actions-18) with your API key and `connectionId`.
