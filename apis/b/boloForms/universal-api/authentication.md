# BoloForms Universal API Authentication

Every BoloForms API request through MindCloud uses a MindCloud API key and the `connectionId` of a BoloForms connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BoloForms connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BoloForms action](README.md#actions-4) with your API key and `connectionId`.
