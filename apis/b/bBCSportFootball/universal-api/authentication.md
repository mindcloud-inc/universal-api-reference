# BBC Sport - Football Universal API Authentication

Every BBC Sport - Football API request through MindCloud uses a MindCloud API key and the `connectionId` of a BBC Sport - Football connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BBC Sport - Football connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BBC Sport - Football action](README.md#actions-20) with your API key and `connectionId`.
