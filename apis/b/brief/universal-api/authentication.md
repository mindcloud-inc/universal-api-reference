# Brief Universal API Authentication

Every Brief API request through MindCloud uses a MindCloud API key and the `connectionId` of a Brief connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Brief connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Brief action](README.md#actions-3) with your API key and `connectionId`.
