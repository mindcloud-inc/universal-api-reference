# Better Proposals: List Signed Proposals

Retrieves signed proposals from Better Proposals.

```
GET https://connect.mindcloud.co/v1/universal/betterProposals/latest/actions/list-signed-proposals
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/betterProposals/latest/actions/list-signed-proposals?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/betterProposals/latest/actions/list-signed-proposals?${params}`, {
  headers: {
  ...
  "data": [
    {
      ...
      "dateSigned": "2026-05-07T12:00:00.000Z",
      "description": {},
      ...
      "quoteID": "string",
      "signedEmail": "ava@example.com",
      "signedFirstName": "Ava",
      "signedSignature": "string",
      "signedSurname": "Ava Chen",
      "subjectLine": "string",
      "taxName": "Ava Chen",
...
Through the native Better Proposals API, this operation is `GET /proposal/signed` (base URL `https://api.betterproposals.io`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-signed-proposals.md) for the provider-specific parameters and requirements.
