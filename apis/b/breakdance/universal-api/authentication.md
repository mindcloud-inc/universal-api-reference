# Breakdance Universal API Authentication

Every Breakdance API request through MindCloud uses a MindCloud API key and the `connectionId` of a Breakdance connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Breakdance connection.
