# BippyBox Universal API Authentication

Every BippyBox API request through MindCloud uses a MindCloud API key and the `connectionId` of a BippyBox connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BippyBox connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BippyBox action](README.md#actions-2) with your API key and `connectionId`.
