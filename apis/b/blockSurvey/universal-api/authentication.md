# BlockSurvey Universal API Authentication

Every BlockSurvey API request through MindCloud uses a MindCloud API key and the `connectionId` of a BlockSurvey connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BlockSurvey connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [BlockSurvey action](README.md#actions-12) with your API key and `connectionId`.
