# BigCommerce (B2B): Get All Companies



```
GET https://connect.mindcloud.co/v1/universal/bigCommerceB2B/latest/actions/get-all-companies
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/bigCommerceB2B/latest/actions/get-all-companies?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/bigCommerceB2B/latest/actions/get-all-companies?${params}`, {
  headers: {
...
Through the native BigCommerce (B2B) API, this operation is `GET companies` (base URL `https://api-b2b.bigcommerce.com/api/v3/io/`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-all-companies.md) for the provider-specific parameters and requirements.
