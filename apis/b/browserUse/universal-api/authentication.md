# Browser Use Universal API Authentication

Every Browser Use API request through MindCloud uses a MindCloud API key and the `connectionId` of a Browser Use connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Browser Use connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Browser Use action](README.md#actions-25) with your API key and `connectionId`.
