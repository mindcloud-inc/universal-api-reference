# BlankBlocks Universal API Authentication

Every BlankBlocks API request through MindCloud uses a MindCloud API key and the `connectionId` of a BlankBlocks connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your BlankBlocks connection.
