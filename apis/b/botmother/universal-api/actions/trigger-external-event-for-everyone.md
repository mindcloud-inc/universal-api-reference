# Botmother: Trigger External Event For Everyone

Triggers an external event in Botmother for all users.

```
POST https://connect.mindcloud.co/v1/universal/botmother/latest/actions/trigger-external-event-for-everyone
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/botmother/latest/actions/trigger-external-event-for-everyone" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/botmother/latest/actions/trigger-external-event-for-everyone', {
  method: 'POST',
  headers: {
