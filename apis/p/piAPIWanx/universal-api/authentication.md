# PiAPI/Wanx Universal API Authentication

Every PiAPI/Wanx API request through MindCloud uses a MindCloud API key and the `connectionId` of a PiAPI/Wanx connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PiAPI/Wanx connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PiAPI/Wanx action](README.md#actions-11) with your API key and `connectionId`.
