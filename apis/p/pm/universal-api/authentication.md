# 5pm Universal API Authentication

Every 5pm API request through MindCloud uses a MindCloud API key and the `connectionId` of a 5pm connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your 5pm connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [5pm action](README.md#actions-31) with your API key and `connectionId`.
