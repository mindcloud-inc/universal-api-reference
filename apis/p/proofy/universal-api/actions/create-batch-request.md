# Proofy: Create Batch Request



```
POST https://connect.mindcloud.co/v1/universal/proofy/latest/actions/create-batch-request
```
...
Through the native Proofy API, this operation is `POST /verify/batch/create` (base URL `https://apis.proofy.io/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/create-batch-request.md) for the provider-specific parameters and requirements.
