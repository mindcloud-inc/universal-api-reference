...
```
GET https://connect.mindcloud.co/v1/universal/persona/latest/actions/list-inquiries
```
...
Through the native Persona API, this operation is `GET /inquiries` (base URL `https://api.withpersona.com/api/v1`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-inquiries.md) for the provider-specific parameters and requirements.
