# Printful Universal API Authentication

Every Printful API request through MindCloud uses a MindCloud API key and the `connectionId` of a Printful connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Printful connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Printful action](README.md#actions-55) with your API key and `connectionId`.
