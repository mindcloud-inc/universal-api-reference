# Portfolio Optimizer: Asset Correlation Matrix



```
GET https://connect.mindcloud.co/v1/universal/portfolioOptimizer/latest/actions/asset-correlation-matrix
```
...
Through the native Portfolio Optimizer API, this operation is `POST /v1/assets/correlation/matrix` (base URL `https://api.portfoliooptimizer.io`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/asset-correlation-matrix.md) for the provider-specific parameters and requirements.
