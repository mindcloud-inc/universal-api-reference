# Popup Maker Universal API Authentication

Every Popup Maker API request through MindCloud uses a MindCloud API key and the `connectionId` of a Popup Maker connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Popup Maker connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Popup Maker action](README.md#actions-1) with your API key and `connectionId`.
