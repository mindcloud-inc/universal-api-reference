# ParseHub Universal API Authentication

Every ParseHub API request through MindCloud uses a MindCloud API key and the `connectionId` of a ParseHub connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ParseHub connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ParseHub action](README.md#actions-10) with your API key and `connectionId`.
