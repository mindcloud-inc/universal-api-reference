# Password Pusher Universal API Authentication

Every Password Pusher API request through MindCloud uses a MindCloud API key and the `connectionId` of a Password Pusher connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Password Pusher connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Password Pusher action](README.md#actions-19) with your API key and `connectionId`.
