# Papersign: Cancel Papersign Document



```
PUT https://connect.mindcloud.co/v1/universal/papersign/latest/actions/cancel-papersign-document
```
...
Through the native Papersign API, this operation is `PUT /papersign/documents/:id/cancel` (base URL `https://api.paperform.co/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/cancel-papersign-document.md) for the provider-specific parameters and requirements.
