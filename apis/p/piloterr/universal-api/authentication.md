# Piloterr Universal API Authentication

Every Piloterr API request through MindCloud uses a MindCloud API key and the `connectionId` of a Piloterr connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Piloterr connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Piloterr action](README.md#actions-33) with your API key and `connectionId`.
