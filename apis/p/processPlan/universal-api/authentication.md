# Process Plan Universal API Authentication

Every Process Plan API request through MindCloud uses a MindCloud API key and the `connectionId` of a Process Plan connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Process Plan connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Process Plan action](README.md#actions-661) with your API key and `connectionId`.
