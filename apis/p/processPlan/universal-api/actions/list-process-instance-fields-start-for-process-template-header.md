# Process Plan: List Process Instance Fields Start for Process Template Header



```
GET https://connect.mindcloud.co/v1/universal/processPlan/latest/actions/list-process-instance-fields-start-for-process-template-header
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/processPlan/latest/actions/list-process-instance-fields-start-for-process-template-header?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/processPlan/latest/actions/list-process-instance-fields-start-for-process-template-header?${params}`, {
  headers: {
      ...
      "process_instance_field_list": [
        {
          ...
          "if_ui_required": true,
          "if_value": "string",
          "if_value_dth_id": "string",
          "if_value_ih_id": "string",
          "if_value_numeric": 1,
          "if_value_ug_id": "string",
          "if_value_usr_id": "string"
        }
      ],
...
| `process_instance_field_list[].if_background` | string |  |
...
| `process_instance_field_list[].if_value_dth_id` | string |  |
| `process_instance_field_list[].if_value_ih_id` | string |  |
| `process_instance_field_list[].if_value_numeric` | number |  |
| `process_instance_field_list[].if_value_ug_id` | string |  |
| `process_instance_field_list[].if_value_usr_id` | string |  |
...
Through the native Process Plan API, this operation is `GET /process_template_header/:processTemplateHeaderId/process_instance_field/list/start` (base URL `https://apius0.processplan.com/api/v4`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-process-instance-fields-start-for-process-template-header.md) for the provider-specific parameters and requirements.
