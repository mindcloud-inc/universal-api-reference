# Process Plan: Get Suggestion for Process Instance Task in Process Template Header Diagram Model



```
GET https://connect.mindcloud.co/v1/universal/processPlan/latest/actions/get-suggestion-for-process-instance-task-in-process-template-header-diagram-model
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/processPlan/latest/actions/get-suggestion-for-process-instance-task-in-process-template-header-diagram-model?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/processPlan/latest/actions/get-suggestion-for-process-instance-task-in-process-template-header-diagram-model?${params}`, {
  headers: {
...
Through the native Process Plan API, this operation is `GET /process_template_header/:processTemplateHeaderId/diagram_model/process_instance_task/:processInstanceTaskId/show_suggestion` (base URL `https://apius0.processplan.com/api/v4`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-suggestion-for-process-instance-task-in-process-template-header-diagram-model.md) for the provider-specific parameters and requirements.
