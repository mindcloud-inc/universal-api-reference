# Process Plan: Convert Process Instance Headers IDs to Objects for Process Template Header



```
GET https://connect.mindcloud.co/v1/universal/processPlan/latest/actions/convert-process-instance-headers-i-ds-to-objects-for-process-template-header
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/processPlan/latest/actions/convert-process-instance-headers-i-ds-to-objects-for-process-template-header?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/processPlan/latest/actions/convert-process-instance-headers-i-ds-to-objects-for-process-template-header?${params}`, {
  headers: {
...
Through the native Process Plan API, this operation is `POST /process_template_header/:processTemplateHeaderId/process_instance_header/id_list/to_object/list` (base URL `https://apius0.processplan.com/api/v4`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/convert-process-instance-headers-i-ds-to-objects-for-process-template-header.md) for the provider-specific parameters and requirements.
