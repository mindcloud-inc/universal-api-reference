# PostcardMania Universal API Authentication

Every PostcardMania API request through MindCloud uses a MindCloud API key and the `connectionId` of a PostcardMania connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PostcardMania connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PostcardMania action](README.md#actions-57) with your API key and `connectionId`.
