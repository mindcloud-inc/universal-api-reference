...
A consolidated summary of Paylocity's API configuration and 6 documented operations.
...
| [Get Company Shifts](actions/get-company-shifts.md) | `GET https://dc1demogwext.paylocity.com/apiHub/scheduling/v1/companies/:companyId/shifts` |  |
