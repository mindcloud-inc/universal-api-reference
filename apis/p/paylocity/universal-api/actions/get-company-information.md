# Paylocity: Get Company Information



```
GET https://connect.mindcloud.co/v1/universal/paylocity/latest/actions/get-company-information
```
...
Through the native Paylocity API, this operation is `GET apiHub/corehr/v1/companies/:companyId` (base URL `{{credentials.connection}}`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-company-information.md) for the provider-specific parameters and requirements.
