# Paradym Universal API Authentication

Every Paradym API request through MindCloud uses a MindCloud API key and the `connectionId` of a Paradym connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Paradym connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Paradym action](README.md#actions-29) with your API key and `connectionId`.
