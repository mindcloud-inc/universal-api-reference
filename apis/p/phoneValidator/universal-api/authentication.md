# Phone Validator Universal API Authentication

Every Phone Validator API request through MindCloud uses a MindCloud API key and the `connectionId` of a Phone Validator connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Phone Validator connection.
