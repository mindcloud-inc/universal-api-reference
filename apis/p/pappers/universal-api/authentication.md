# Pappers Universal API Authentication

Every Pappers API request through MindCloud uses a MindCloud API key and the `connectionId` of a Pappers connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Pappers connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Pappers action](README.md#actions-16) with your API key and `connectionId`.
