# PDFMonkey Universal API Authentication

Every PDFMonkey API request through MindCloud uses a MindCloud API key and the `connectionId` of a PDFMonkey connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PDFMonkey connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PDFMonkey action](README.md#actions-14) with your API key and `connectionId`.
