# Paycom Universal API Authentication

Every Paycom API request through MindCloud uses a MindCloud API key and the `connectionId` of a Paycom connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Paycom connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Paycom action](README.md#actions-16) with your API key and `connectionId`.
