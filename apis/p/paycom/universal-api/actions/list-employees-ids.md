# Paycom: List Employee ids



```
GET https://connect.mindcloud.co/v1/universal/paycom/latest/actions/list-employees-ids
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/paycom/latest/actions/list-employees-ids?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/paycom/latest/actions/list-employees-ids?${params}`, {
  headers: {
