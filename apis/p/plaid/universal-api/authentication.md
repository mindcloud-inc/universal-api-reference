# Plaid Universal API Authentication

Every Plaid API request through MindCloud uses a MindCloud API key and the `connectionId` of a Plaid connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Plaid connection.
