# PDF-API.io Universal API Authentication

Every PDF-API.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a PDF-API.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PDF-API.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PDF-API.io action](README.md#actions-4) with your API key and `connectionId`.
