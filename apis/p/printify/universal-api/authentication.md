# Printify Universal API Authentication

Every Printify API request through MindCloud uses a MindCloud API key and the `connectionId` of a Printify connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Printify connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Printify action](README.md#actions-35) with your API key and `connectionId`.
