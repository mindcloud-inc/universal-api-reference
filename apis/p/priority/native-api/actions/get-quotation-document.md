# Get Quotation Document with Priority
...
- **Method:** `GET`
- **Path:** `/DOCUMENTS_Q(DOCNO=':docNo',TYPE=':type')`
- **Base URL:** `https://t.eu.priority-connect.online/odata/Priority/tabbtd38.ini/usdemo`
- **Official documentation:** [Get Quotation Document](https://prioritysoftware.github.io/restapi/request/#Requesting_an_Individual_Entity_by_ID)
