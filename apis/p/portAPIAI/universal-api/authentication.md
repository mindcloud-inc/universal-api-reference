# Port API AI Universal API Authentication

Every Port API AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Port API AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Port API AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Port API AI action](README.md#actions-147) with your API key and `connectionId`.
