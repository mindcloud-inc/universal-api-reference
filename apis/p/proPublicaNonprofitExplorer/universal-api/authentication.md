# ProPublica Nonprofit Explorer Universal API Authentication

Every ProPublica Nonprofit Explorer API request through MindCloud uses a MindCloud API key and the `connectionId` of a ProPublica Nonprofit Explorer connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ProPublica Nonprofit Explorer connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ProPublica Nonprofit Explorer action](README.md#actions-2) with your API key and `connectionId`.
