# PlagiarismCheck.org Universal API Authentication

Every PlagiarismCheck.org API request through MindCloud uses a MindCloud API key and the `connectionId` of a PlagiarismCheck.org connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PlagiarismCheck.org connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PlagiarismCheck.org action](README.md#actions-15) with your API key and `connectionId`.
