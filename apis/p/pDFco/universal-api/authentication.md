# PDF.co Universal API Authentication

Every PDF.co API request through MindCloud uses a MindCloud API key and the `connectionId` of a PDF.co connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PDF.co connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PDF.co action](README.md#actions-34) with your API key and `connectionId`.
