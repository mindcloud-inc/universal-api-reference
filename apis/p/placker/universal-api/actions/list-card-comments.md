# Placker: List Card Comments



```
GET https://connect.mindcloud.co/v1/universal/placker/latest/actions/list-card-comments
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/placker/latest/actions/list-card-comments?connectionId=$CONNECTION_ID&card=12345" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/placker/latest/actions/list-card-comments?${params}`, {
  headers: {
