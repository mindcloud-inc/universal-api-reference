# PixieBrix: Health Check

Retrieves the PixieBrix API health status.

```
GET https://connect.mindcloud.co/v1/universal/pixieBrix/latest/actions/health-check
```
