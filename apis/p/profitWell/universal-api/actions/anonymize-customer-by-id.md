# ProfitWell: Anonymize Customer By ID

Anonymizes a customer in ProfitWell by customer ID.

```
POST https://connect.mindcloud.co/v1/universal/profitWell/latest/actions/anonymize-customer-by-id
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/profitWell/latest/actions/anonymize-customer-by-id" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/profitWell/latest/actions/anonymize-customer-by-id', {
  method: 'POST',
  headers: {
