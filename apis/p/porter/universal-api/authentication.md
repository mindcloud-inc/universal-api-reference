# Porter Universal API Authentication

Every Porter API request through MindCloud uses a MindCloud API key and the `connectionId` of a Porter connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Porter connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Porter action](README.md#actions-14) with your API key and `connectionId`.
