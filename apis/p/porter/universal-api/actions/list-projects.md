# Porter: List Projects

Retrieves projects from Porter.

```
GET https://connect.mindcloud.co/v1/universal/porter/latest/actions/list-projects
```
...
Through the native Porter API, this operation is `GET /api/v2/projects` (base URL `https://dashboard.porter.run`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-projects.md) for the provider-specific parameters and requirements.
