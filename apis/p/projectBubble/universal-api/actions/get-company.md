# Project Bubble: Get Company

Retrieves company details from Project Bubble.

```
GET https://connect.mindcloud.co/v1/universal/projectBubble/latest/actions/get-company
```
...
Through the native Project Bubble API, this operation is `GET /company` (base URL `https://api.projectbubble.com/v2`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-company.md) for the provider-specific parameters and requirements.
