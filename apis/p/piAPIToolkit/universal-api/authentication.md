# PiAPI/Toolkit Universal API Authentication

Every PiAPI/Toolkit API request through MindCloud uses a MindCloud API key and the `connectionId` of a PiAPI/Toolkit connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PiAPI/Toolkit connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PiAPI/Toolkit action](README.md#actions-14) with your API key and `connectionId`.
