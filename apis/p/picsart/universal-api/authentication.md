# Picsart Universal API Authentication

Every Picsart API request through MindCloud uses a MindCloud API key and the `connectionId` of a Picsart connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Picsart connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Picsart action](README.md#actions-11) with your API key and `connectionId`.
