# Pencil Spaces Universal API Authentication

Every Pencil Spaces API request through MindCloud uses a MindCloud API key and the `connectionId` of a Pencil Spaces connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Pencil Spaces connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Pencil Spaces action](README.md#actions-18) with your API key and `connectionId`.
