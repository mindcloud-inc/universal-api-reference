# Procore: List Timesheets

Retrieves timesheets from Procore.

```
GET https://connect.mindcloud.co/v1/universal/procore/latest/actions/list-timesheets
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/procore/latest/actions/list-timesheets?connectionId=$CONNECTION_ID&projectId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/procore/latest/actions/list-timesheets?${params}`, {
  headers: {
