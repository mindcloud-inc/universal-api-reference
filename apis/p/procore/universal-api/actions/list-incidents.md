# Procore: List Incidents

Retrieves incidents from Procore.

```
GET https://connect.mindcloud.co/v1/universal/procore/latest/actions/list-incidents
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/procore/latest/actions/list-incidents?connectionId=$CONNECTION_ID&projectId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/procore/latest/actions/list-incidents?${params}`, {
  headers: {
