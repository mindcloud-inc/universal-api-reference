...
```
GET https://connect.mindcloud.co/v1/universal/procore/latest/actions/get-form
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/procore/latest/actions/get-form?connectionId=$CONNECTION_ID&id=string&projectId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/procore/latest/actions/get-form?${params}`, {
  headers: {
