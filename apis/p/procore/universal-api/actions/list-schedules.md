# Procore: List Schedules

Retrieves schedules from Procore.

```
GET https://connect.mindcloud.co/v1/universal/procore/latest/actions/list-schedules
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/procore/latest/actions/list-schedules?connectionId=$CONNECTION_ID&companyId=string&projectId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/procore/latest/actions/list-schedules?${params}`, {
  headers: {
