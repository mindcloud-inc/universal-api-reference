# Procore Universal API Authentication

Every Procore API request through MindCloud uses a MindCloud API key and the `connectionId` of a Procore connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Procore connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Procore action](README.md#actions-26) with your API key and `connectionId`.
