# Pushinator Universal API Authentication

Every Pushinator API request through MindCloud uses a MindCloud API key and the `connectionId` of a Pushinator connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Pushinator connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Pushinator action](README.md#actions-3) with your API key and `connectionId`.
