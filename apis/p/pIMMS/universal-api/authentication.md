# PIMMS Universal API Authentication

Every PIMMS API request through MindCloud uses a MindCloud API key and the `connectionId` of a PIMMS connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PIMMS connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PIMMS action](README.md#actions-7) with your API key and `connectionId`.
