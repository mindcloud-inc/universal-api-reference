# Peplink Universal API Authentication

Every Peplink API request through MindCloud uses a MindCloud API key and the `connectionId` of a Peplink connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Peplink connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Peplink action](README.md#actions-7) with your API key and `connectionId`.
