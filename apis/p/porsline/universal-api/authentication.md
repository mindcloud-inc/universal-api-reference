# Porsline Universal API Authentication

Every Porsline API request through MindCloud uses a MindCloud API key and the `connectionId` of a Porsline connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Porsline connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Porsline action](README.md#actions-26) with your API key and `connectionId`.
