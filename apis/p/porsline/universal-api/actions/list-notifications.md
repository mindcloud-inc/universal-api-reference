# Porsline: List Notifications



```
GET https://connect.mindcloud.co/v1/universal/porsline/latest/actions/list-notifications
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/porsline/latest/actions/list-notifications?connectionId=$CONNECTION_ID&surveyId=213151" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/porsline/latest/actions/list-notifications?${params}`, {
  headers: {
