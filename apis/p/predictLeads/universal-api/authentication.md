# PredictLeads Universal API Authentication

Every PredictLeads API request through MindCloud uses a MindCloud API key and the `connectionId` of a PredictLeads connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PredictLeads connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PredictLeads action](README.md#actions-27) with your API key and `connectionId`.
