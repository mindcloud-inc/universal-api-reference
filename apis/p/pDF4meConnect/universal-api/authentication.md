# PDF4me Connect Universal API Authentication

Every PDF4me Connect API request through MindCloud uses a MindCloud API key and the `connectionId` of a PDF4me Connect connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PDF4me Connect connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PDF4me Connect action](README.md#actions-1) with your API key and `connectionId`.
