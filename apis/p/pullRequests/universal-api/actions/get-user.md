# 24 Pull Requests: Get User

Retrieves a user from 24 Pull Requests.

```
GET https://connect.mindcloud.co/v1/universal/pullRequests/latest/actions/get-user
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/pullRequests/latest/actions/get-user?connectionId=$CONNECTION_ID&nickname=andrew" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/pullRequests/latest/actions/get-user?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `nickname` | string | yes | 24 Pull Requests user nickname from the user URL. Example: `andrew`. |
