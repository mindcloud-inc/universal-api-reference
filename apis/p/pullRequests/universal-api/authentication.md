# 24 Pull Requests Universal API Authentication

Every 24 Pull Requests API request through MindCloud uses a MindCloud API key and the `connectionId` of a 24 Pull Requests connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your 24 Pull Requests connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [24 Pull Requests action](README.md#actions-7) with your API key and `connectionId`.
