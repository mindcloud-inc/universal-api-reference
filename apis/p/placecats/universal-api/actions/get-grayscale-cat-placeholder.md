# Placecats: Get Grayscale Cat Placeholder



```
GET https://connect.mindcloud.co/v1/universal/placecats/latest/actions/get-grayscale-cat-placeholder
```
...
Through the native Placecats API, this operation is `GET /g/:width/:height` (base URL `https://placecats.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-grayscale-cat-placeholder.md) for the provider-specific parameters and requirements.
