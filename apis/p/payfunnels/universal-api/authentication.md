# Payfunnels Universal API Authentication

Every Payfunnels API request through MindCloud uses a MindCloud API key and the `connectionId` of a Payfunnels connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Payfunnels connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Payfunnels action](README.md#actions-20) with your API key and `connectionId`.
