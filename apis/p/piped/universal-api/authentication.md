# Piped Universal API Authentication

Every Piped API request through MindCloud uses a MindCloud API key and the `connectionId` of a Piped connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Piped connection.
