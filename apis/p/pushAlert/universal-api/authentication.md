# PushAlert Universal API Authentication

Every PushAlert API request through MindCloud uses a MindCloud API key and the `connectionId` of a PushAlert connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PushAlert connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PushAlert action](README.md#actions-16) with your API key and `connectionId`.
