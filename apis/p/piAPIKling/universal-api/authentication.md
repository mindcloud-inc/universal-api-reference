# PiAPI/Kling Universal API Authentication

Every PiAPI/Kling API request through MindCloud uses a MindCloud API key and the `connectionId` of a PiAPI/Kling connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PiAPI/Kling connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PiAPI/Kling action](README.md#actions-17) with your API key and `connectionId`.
