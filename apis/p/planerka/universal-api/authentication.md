# Planerka Universal API Authentication

Every Planerka API request through MindCloud uses a MindCloud API key and the `connectionId` of a Planerka connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Planerka connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Planerka action](README.md#actions-3) with your API key and `connectionId`.
