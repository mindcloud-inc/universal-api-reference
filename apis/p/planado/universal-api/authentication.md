# Planado Universal API Authentication

Every Planado API request through MindCloud uses a MindCloud API key and the `connectionId` of a Planado connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Planado connection.
