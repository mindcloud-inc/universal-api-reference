# Create document from JSON with PrexView
...
- **Official documentation:** [Create document from JSON](https://prexview.com/docs/api/)
...
| --- | --- | --- | --- | --- |
| `json` | body | `string` | yes | JSON data to transform into the selected output format. |
