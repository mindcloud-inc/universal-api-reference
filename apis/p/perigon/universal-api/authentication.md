# Perigon Universal API Authentication

Every Perigon API request through MindCloud uses a MindCloud API key and the `connectionId` of a Perigon connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Perigon connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Perigon action](README.md#actions-14) with your API key and `connectionId`.
