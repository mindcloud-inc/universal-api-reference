# Pastebin Universal API Authentication

Every Pastebin API request through MindCloud uses a MindCloud API key and the `connectionId` of a Pastebin connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Pastebin connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Pastebin action](README.md#actions-13) with your API key and `connectionId`.
