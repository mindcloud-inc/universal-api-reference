# Planet Money Podcast Universal API Authentication

Every Planet Money Podcast API request through MindCloud uses a MindCloud API key and the `connectionId` of a Planet Money Podcast connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Planet Money Podcast connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Planet Money Podcast action](README.md#actions-7) with your API key and `connectionId`.
