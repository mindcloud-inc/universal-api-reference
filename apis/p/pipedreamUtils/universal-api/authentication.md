# Pipedream Utils Universal API Authentication

Every Pipedream Utils API request through MindCloud uses a MindCloud API key and the `connectionId` of a Pipedream Utils connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Pipedream Utils connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Pipedream Utils action](README.md#actions-30) with your API key and `connectionId`.
