# Pipedream Utils: Formatting - [Data] Convert JSON to String

Converts JSON data to a string in Pipedream Utils.

```
GET https://connect.mindcloud.co/v1/universal/pipedreamUtils/latest/actions/convert-json-to-string
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/pipedreamUtils/latest/actions/convert-json-to-string?connectionId=$CONNECTION_ID&input=%5Bobject%20Object%5D" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/pipedreamUtils/latest/actions/convert-json-to-string?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `input` | object | yes | An object to be serialized to a JSON format string. |
