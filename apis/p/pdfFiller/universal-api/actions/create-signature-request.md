# PdfFiller: Create Signature Request

Creates a signature request in PdfFiller.

```
POST https://connect.mindcloud.co/v1/universal/pdfFiller/latest/actions/create-signature-request
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/pdfFiller/latest/actions/create-signature-request" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/pdfFiller/latest/actions/create-signature-request', {
  method: 'POST',
  headers: {
