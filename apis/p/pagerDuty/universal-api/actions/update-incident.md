...
```
PUT https://connect.mindcloud.co/v1/universal/pagerDuty/latest/actions/update-incident
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/pagerDuty/latest/actions/update-incident" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/pagerDuty/latest/actions/update-incident', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `id` | string | yes | The PagerDuty incident ID to update. |
| `incident.title` | string | no | The new incident title. |
| `incident.status` | string | no | The new incident status. |
| `incident.urgency` | string | no | The new incident urgency. |
| `incident.resolution` | string | no | Resolution note used when resolving an incident. |
| `incident.service.id` | string | no | The service ID to assign to the incident. |
