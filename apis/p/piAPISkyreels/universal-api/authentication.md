# PiAPI/Skyreels Universal API Authentication

Every PiAPI/Skyreels API request through MindCloud uses a MindCloud API key and the `connectionId` of a PiAPI/Skyreels connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PiAPI/Skyreels connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PiAPI/Skyreels action](README.md#actions-3) with your API key and `connectionId`.
