# Update Person with Pipeline CRM
...
- **Official documentation:** [Update Person](https://app.pipelinecrm.com/openapi.yaml)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `deliver_reassignment_email` | query | `boolean` | no | Send an assignment email when the person owner changes. |
| `id` | path | `number` | yes | Person ID |
