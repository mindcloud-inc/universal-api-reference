...
- **Official documentation:** [Update Deal](https://app.pipelinecrm.com/openapi.yaml)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `deliver_reassignment_email` | query | `boolean` | no | Send an assignment email when the deal owner changes. |
