# PiAPI/Trellis Universal API Authentication

Every PiAPI/Trellis API request through MindCloud uses a MindCloud API key and the `connectionId` of a PiAPI/Trellis connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PiAPI/Trellis connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PiAPI/Trellis action](README.md#actions-7) with your API key and `connectionId`.
