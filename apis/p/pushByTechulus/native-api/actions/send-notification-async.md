# Send Notification Async with Push by Techulus

## Endpoint

- **Method:** `POST`
- **Path:** `/api/v1/notify-async`
- **Base URL:** `https://push.techulus.com`
- **Official documentation:** [Send Notification Async](https://docs.push.techulus.com/api-documentation)
