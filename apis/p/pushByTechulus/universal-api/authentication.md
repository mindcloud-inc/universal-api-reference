# Push by Techulus Universal API Authentication

Every Push by Techulus API request through MindCloud uses a MindCloud API key and the `connectionId` of a Push by Techulus connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Push by Techulus connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Push by Techulus action](README.md#actions-7) with your API key and `connectionId`.
