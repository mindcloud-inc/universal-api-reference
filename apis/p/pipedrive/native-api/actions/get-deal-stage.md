...
- **Official documentation:** [Get Deal Stage](https://developers.pipedrive.com/docs/api/v1/Deals#getDeal)
...
| `id` | path | `number` | yes | Unique ID of the stage. |
