# Prerender.io Universal API Authentication

Every Prerender.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a Prerender.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Prerender.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Prerender.io action](README.md#actions-90) with your API key and `connectionId`.
