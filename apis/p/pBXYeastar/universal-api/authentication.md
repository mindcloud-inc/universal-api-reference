# PBX Yeastar Universal API Authentication

Every PBX Yeastar API request through MindCloud uses a MindCloud API key and the `connectionId` of a PBX Yeastar connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PBX Yeastar connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PBX Yeastar action](README.md#actions-14) with your API key and `connectionId`.
