# Power Assist: Filter Array

Filters an array with Power Assist.

```
GET https://connect.mindcloud.co/v1/universal/powerAssist/latest/actions/filter-array
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/powerAssist/latest/actions/filter-array?connectionId=$CONNECTION_ID&array%5B%5D=%5Bobject%20Object%5D&propertyName=Ava%20Chen&comparison=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/powerAssist/latest/actions/filter-array?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `array[]` | array<object> | yes | Array of items to filter. |
