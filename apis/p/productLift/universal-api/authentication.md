# ProductLift Universal API Authentication

Every ProductLift API request through MindCloud uses a MindCloud API key and the `connectionId` of a ProductLift connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ProductLift connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ProductLift action](README.md#actions-75) with your API key and `connectionId`.
