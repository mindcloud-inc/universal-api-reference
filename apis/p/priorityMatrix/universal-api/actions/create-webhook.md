# Priority Matrix: Create Webhook

Creates a new webhook in Priority Matrix.

```
POST https://connect.mindcloud.co/v1/universal/priorityMatrix/latest/actions/create-webhook
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/priorityMatrix/latest/actions/create-webhook" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/priorityMatrix/latest/actions/create-webhook', {
  method: 'POST',
  headers: {
