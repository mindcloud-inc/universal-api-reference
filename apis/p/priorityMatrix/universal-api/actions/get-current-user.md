# Priority Matrix: Get Current User

Retrieves the current Priority Matrix user profile.

```
GET https://connect.mindcloud.co/v1/universal/priorityMatrix/latest/actions/get-current-user
```
