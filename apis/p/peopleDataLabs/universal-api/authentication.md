# People Data Labs Universal API Authentication

Every People Data Labs API request through MindCloud uses a MindCloud API key and the `connectionId` of a People Data Labs connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your People Data Labs connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [People Data Labs action](README.md#actions-11) with your API key and `connectionId`.
