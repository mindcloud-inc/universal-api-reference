# Polycom Universal API Authentication

Every Polycom API request through MindCloud uses a MindCloud API key and the `connectionId` of a Polycom connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Polycom connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Polycom action](README.md#actions-8) with your API key and `connectionId`.
