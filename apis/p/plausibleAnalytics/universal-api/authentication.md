# Plausible Analytics Universal API Authentication

Every Plausible Analytics API request through MindCloud uses a MindCloud API key and the `connectionId` of a Plausible Analytics connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Plausible Analytics connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Plausible Analytics action](README.md#actions-50) with your API key and `connectionId`.
