# Create Blob For Image with Paperless
...
- **Official documentation:** [Create Blob For Image](https://developers.paperless.io/docs/api/bb191806bdd25-create-a-document-from-a-pdf)
