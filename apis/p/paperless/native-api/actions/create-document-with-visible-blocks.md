# Create Document With Visible Blocks with Paperless
...
- **Official documentation:** [Create Document With Visible Blocks](https://developers.paperless.io/docs/api/2ba41f7dfe8a3-visibility-of-blocks)
