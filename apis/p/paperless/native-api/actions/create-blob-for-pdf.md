# Create Blob For PDF with Paperless
...
- **Official documentation:** [Create Blob For PDF](https://developers.paperless.io/docs/api/bb191806bdd25-create-a-document-from-a-pdf)
