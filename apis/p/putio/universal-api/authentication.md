# Put.io Universal API Authentication

Every Put.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a Put.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Put.io connection.
