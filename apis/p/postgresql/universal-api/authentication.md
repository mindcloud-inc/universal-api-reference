# PostgreSQL Universal API Authentication

Every PostgreSQL API request through MindCloud uses a MindCloud API key and the `connectionId` of a PostgreSQL connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PostgreSQL connection.
