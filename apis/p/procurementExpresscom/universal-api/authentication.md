# ProcurementExpress.com Universal API Authentication

Every ProcurementExpress.com API request through MindCloud uses a MindCloud API key and the `connectionId` of a ProcurementExpress.com connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ProcurementExpress.com connection.
