# Platerecognizer Universal API Authentication

Every Platerecognizer API request through MindCloud uses a MindCloud API key and the `connectionId` of a Platerecognizer connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Platerecognizer connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Platerecognizer action](README.md#actions-9) with your API key and `connectionId`.
