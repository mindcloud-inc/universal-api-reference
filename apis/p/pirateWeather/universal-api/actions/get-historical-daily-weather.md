# Pirate Weather: Get Historical Daily Weather

Retrieves historical daily weather from Pirate Weather.

```
GET https://connect.mindcloud.co/v1/universal/pirateWeather/latest/actions/get-historical-daily-weather
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/pirateWeather/latest/actions/get-historical-daily-weather?connectionId=$CONNECTION_ID&latitude=1&longitude=1&time=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/pirateWeather/latest/actions/get-historical-daily-weather?${params}`, {
  headers: {
