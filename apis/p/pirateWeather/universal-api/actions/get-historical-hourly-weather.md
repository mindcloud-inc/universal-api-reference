# Pirate Weather: Get Historical Hourly Weather

Retrieves historical hourly weather from Pirate Weather.

```
GET https://connect.mindcloud.co/v1/universal/pirateWeather/latest/actions/get-historical-hourly-weather
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/pirateWeather/latest/actions/get-historical-hourly-weather?connectionId=$CONNECTION_ID&latitude=1&longitude=1&time=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/pirateWeather/latest/actions/get-historical-hourly-weather?${params}`, {
  headers: {
