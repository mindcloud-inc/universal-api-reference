# Pirate Weather: Get Historical Weather

Retrieves historical weather from Pirate Weather.

```
GET https://connect.mindcloud.co/v1/universal/pirateWeather/latest/actions/get-historical-weather
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/pirateWeather/latest/actions/get-historical-weather?connectionId=$CONNECTION_ID&latitude=1&longitude=1&time=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/pirateWeather/latest/actions/get-historical-weather?${params}`, {
  headers: {
