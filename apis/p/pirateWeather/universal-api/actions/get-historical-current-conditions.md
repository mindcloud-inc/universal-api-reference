# Pirate Weather: Get Historical Current Conditions

Retrieves historical current conditions from Pirate Weather.

```
GET https://connect.mindcloud.co/v1/universal/pirateWeather/latest/actions/get-historical-current-conditions
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/pirateWeather/latest/actions/get-historical-current-conditions?connectionId=$CONNECTION_ID&latitude=1&longitude=1&time=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/pirateWeather/latest/actions/get-historical-current-conditions?${params}`, {
  headers: {
