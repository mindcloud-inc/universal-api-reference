# Get Historical Current Conditions with Pirate Weather
...
- **Official documentation:** [Get Historical Current Conditions](https://docs.pirateweather.net/en/latest/API/)
