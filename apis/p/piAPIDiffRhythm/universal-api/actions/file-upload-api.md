# PiAPI/DiffRhythm: File Upload API

Creates a temporary file upload in PiAPI/DiffRhythm.

```
POST https://connect.mindcloud.co/v1/universal/piAPIDiffRhythm/latest/actions/file-upload-api
```
...
| --- | --- | --- | --- |
| `fileName` | string | yes | File name including a supported extension such as `.mp3`, `.wav`, `.png`, or `.jpg`. |
| `fileData` | string | yes | Base64-encoded file content. PiAPI also accepts a matching data URI. |
