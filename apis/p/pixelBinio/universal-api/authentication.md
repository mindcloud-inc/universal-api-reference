# PixelBin.io Universal API Authentication

Every PixelBin.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a PixelBin.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PixelBin.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [PixelBin.io action](README.md#actions-30) with your API key and `connectionId`.
