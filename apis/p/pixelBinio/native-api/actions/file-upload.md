...
- **Official documentation:** [Upload File](https://www.pixelbin.io/docs/api/upload-api/)
...
| `file` | body | `file` | yes | Asset file stream or binary payload to upload. |
