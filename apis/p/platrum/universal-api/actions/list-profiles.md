# Platrum: List profiles

Retrieves profiles from Platrum.

```
GET https://connect.mindcloud.co/v1/universal/platrum/latest/actions/list-profiles
```
