# PDF Maker Universal API Authentication

Every PDF Maker API request through MindCloud uses a MindCloud API key and the `connectionId` of a PDF Maker connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your PDF Maker connection.
