# Planday: Update Department

Updates an existing department in Planday.

```
PUT https://connect.mindcloud.co/v1/universal/planday/latest/actions/update-department
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/planday/latest/actions/update-department" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/planday/latest/actions/update-department', {
  method: 'PUT',
  headers: {
