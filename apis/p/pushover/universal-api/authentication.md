# Pushover Universal API Authentication

Every Pushover API request through MindCloud uses a MindCloud API key and the `connectionId` of a Pushover connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Pushover connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Pushover action](README.md#actions-16) with your API key and `connectionId`.
