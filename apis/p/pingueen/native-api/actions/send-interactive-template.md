# Send Interactive Template with Pingueen
...
- **Official documentation:** [Send Interactive Template](https://etinet.gitbook.io/pingueen/api-reference/messages/templates/send-templates/send-interactive-template)
