# Postmaster+ Universal API Authentication

Every Postmaster+ API request through MindCloud uses a MindCloud API key and the `connectionId` of a Postmaster+ connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Postmaster+ connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Postmaster+ action](README.md#actions-14) with your API key and `connectionId`.
