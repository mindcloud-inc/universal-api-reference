# Parklio: List Devices

Retrieves devices from Parklio.

```
GET https://connect.mindcloud.co/v1/universal/parklio/latest/actions/list-devices
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/parklio/latest/actions/list-devices?${params}`, {
  headers: {
