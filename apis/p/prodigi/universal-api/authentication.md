# Prodigi Universal API Authentication

Every Prodigi API request through MindCloud uses a MindCloud API key and the `connectionId` of a Prodigi connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Prodigi connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Prodigi action](README.md#actions-11) with your API key and `connectionId`.
