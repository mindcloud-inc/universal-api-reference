# Paddle: Update Discount

Updates an existing discount in Paddle.

```
PUT https://connect.mindcloud.co/v1/universal/paddle/latest/actions/update-discount
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/paddle/latest/actions/update-discount" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/paddle/latest/actions/update-discount', {
  method: 'PUT',
  headers: {
