...
```
POST https://connect.mindcloud.co/v1/universal/paddle/latest/actions/create-customer
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/paddle/latest/actions/create-customer" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/paddle/latest/actions/create-customer', {
  method: 'POST',
  headers: {
