...
Updates an existing subscription in Paddle.

```
PUT https://connect.mindcloud.co/v1/universal/paddle/latest/actions/update-subscription
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/paddle/latest/actions/update-subscription" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/paddle/latest/actions/update-subscription', {
  method: 'PUT',
  headers: {
