# Paddle: Update Product

Updates an existing product in Paddle.

```
PUT https://connect.mindcloud.co/v1/universal/paddle/latest/actions/update-product
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/paddle/latest/actions/update-product" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/paddle/latest/actions/update-product', {
  method: 'PUT',
  headers: {
