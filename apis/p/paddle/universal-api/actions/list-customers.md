# Paddle: List Customers

Retrieves a list of customers from Paddle.

```
GET https://connect.mindcloud.co/v1/universal/paddle/latest/actions/list-customers
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/paddle/latest/actions/list-customers?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/paddle/latest/actions/list-customers?${params}`, {
  headers: {
