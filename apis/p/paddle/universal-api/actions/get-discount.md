...
Retrieves a discount from Paddle.

```
GET https://connect.mindcloud.co/v1/universal/paddle/latest/actions/get-discount
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/paddle/latest/actions/get-discount?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/paddle/latest/actions/get-discount?${params}`, {
  headers: {
