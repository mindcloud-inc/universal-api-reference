...
Creates a new transaction in Paddle.

```
POST https://connect.mindcloud.co/v1/universal/paddle/latest/actions/create-transaction
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/paddle/latest/actions/create-transaction" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/paddle/latest/actions/create-transaction', {
  method: 'POST',
  headers: {
