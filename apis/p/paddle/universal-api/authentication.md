# Paddle Universal API Authentication

Every Paddle API request through MindCloud uses a MindCloud API key and the `connectionId` of a Paddle connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Paddle connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Paddle action](README.md#actions-30) with your API key and `connectionId`.
