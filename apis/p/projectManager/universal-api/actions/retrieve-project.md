# ProjectManager: Retrieve Project

Retrieves a project from ProjectManager.

```
GET https://connect.mindcloud.co/v1/universal/projectManager/latest/actions/retrieve-project
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/projectManager/latest/actions/retrieve-project?connectionId=$CONNECTION_ID&projectId=11111111-1111-1111-1111-111111111111" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/projectManager/latest/actions/retrieve-project?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `projectId` | string | yes | The unique identifier of the Project to retrieve. Example: `11111111-1111-1111-1111-111111111111`. |
