# ProAbono Universal API Authentication

Every ProAbono API request through MindCloud uses a MindCloud API key and the `connectionId` of a ProAbono connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ProAbono connection.
