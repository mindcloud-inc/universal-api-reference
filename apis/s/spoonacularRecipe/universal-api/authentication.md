# Spoonacular Recipe Universal API Authentication

Every Spoonacular Recipe API request through MindCloud uses a MindCloud API key and the `connectionId` of a Spoonacular Recipe connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Spoonacular Recipe connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Spoonacular Recipe action](README.md#actions-24) with your API key and `connectionId`.
