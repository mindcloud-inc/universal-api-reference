# Spoonacular Recipe: Get Ingredient Substitutes by ID

Finds ingredient substitutes in Spoonacular by ID.

```
GET https://connect.mindcloud.co/v1/universal/spoonacularRecipe/latest/actions/get-ingredient-substitutes-by-id
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/spoonacularRecipe/latest/actions/get-ingredient-substitutes-by-id?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/spoonacularRecipe/latest/actions/get-ingredient-substitutes-by-id?${params}`, {
  headers: {
