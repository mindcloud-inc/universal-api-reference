# Scoreboard Buzz Universal API Authentication

Every Scoreboard Buzz API request through MindCloud uses a MindCloud API key and the `connectionId` of a Scoreboard Buzz connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Scoreboard Buzz connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Scoreboard Buzz action](README.md#actions-11) with your API key and `connectionId`.
