# Simplecast Universal API Authentication

Every Simplecast API request through MindCloud uses a MindCloud API key and the `connectionId` of a Simplecast connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Simplecast connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Simplecast action](README.md#actions-62) with your API key and `connectionId`.
