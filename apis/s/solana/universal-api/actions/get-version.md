...
Retrieves node version details from Solana.

```
GET https://connect.mindcloud.co/v1/universal/solana/latest/actions/get-version
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/solana/latest/actions/get-version?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/solana/latest/actions/get-version?${params}`, {
  headers: {
