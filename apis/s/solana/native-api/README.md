...
A consolidated summary of Solana's API configuration and 30 documented operations, with links to official documentation.
...
| [Get Block Production (Draft Variant)](actions/get-block-production-draft-variant.md) | `POST /` | [docs](https://solana.com/docs/rpc/http/getblockproduction) |
...
| [Get Recent Performance Samples (Draft Variant)](actions/get-recent-performance-samples-draft-variant.md) | `POST /` | [docs](https://solana.com/docs/rpc/http/getrecentperformancesamples) |
...
| [Get Recent Prioritization Fees (Draft Variant)](actions/get-recent-prioritization-fees-draft-variant.md) | `POST /` | [docs](https://solana.com/docs/rpc/http/getrecentprioritizationfees) |
