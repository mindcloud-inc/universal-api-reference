# SMS Connexion Universal API Authentication

Every SMS Connexion API request through MindCloud uses a MindCloud API key and the `connectionId` of a SMS Connexion connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SMS Connexion connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SMS Connexion action](README.md#actions-35) with your API key and `connectionId`.
