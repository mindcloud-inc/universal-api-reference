...
```
PUT https://connect.mindcloud.co/v1/universal/shopify/latest/actions/get-order-transactions-graph-ql
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/shopify/latest/actions/get-order-transactions-graph-ql" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/shopify/latest/actions/get-order-transactions-graph-ql', {
  method: 'PUT',
  headers: {
