# Sign.Plus Universal API Authentication

Every Sign.Plus API request through MindCloud uses a MindCloud API key and the `connectionId` of a Sign.Plus connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Sign.Plus connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Sign.Plus action](README.md#actions-24) with your API key and `connectionId`.
