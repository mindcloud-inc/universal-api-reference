...
```
POST https://connect.mindcloud.co/v1/universal/supabase/latest/actions/insert-row
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/supabase/latest/actions/insert-row" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/supabase/latest/actions/insert-row', {
  method: 'POST',
  headers: {
