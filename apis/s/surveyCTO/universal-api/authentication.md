# SurveyCTO Universal API Authentication

Every SurveyCTO API request through MindCloud uses a MindCloud API key and the `connectionId` of a SurveyCTO connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SurveyCTO connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SurveyCTO action](README.md#actions-1) with your API key and `connectionId`.
