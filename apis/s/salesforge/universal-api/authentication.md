# Salesforge Universal API Authentication

Every Salesforge API request through MindCloud uses a MindCloud API key and the `connectionId` of a Salesforge connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Salesforge connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Salesforge action](README.md#actions-36) with your API key and `connectionId`.
