# Send SMS Campaign with smsmode

## Endpoint

- **Method:** `POST`
- **Path:** `sms/v1/channels/:channelId/campaigns`
- **Base URL:** `https://rest.smsmode.com/`
- **Official documentation:** [Send SMS Campaign](https://dev.smsmode.com/sms/v1/#tag/Campaign/operation/send-campaign)
