# Update Scheduled SMS Campaign with smsmode

## Endpoint

- **Method:** `PATCH`
- **Path:** `sms/v1/channels/:channelId/campaigns/:campaignId`
- **Base URL:** `https://rest.smsmode.com/`
- **Official documentation:** [Update Scheduled SMS Campaign](https://dev.smsmode.com/sms/v1/#tag/Campaign/operation/edit-scheduled-campaign)
...
| `body` | body | `object` | no | Body request body field documented by the smsmode API. |
