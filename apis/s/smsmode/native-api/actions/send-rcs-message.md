...
- **Official documentation:** [Send RCS Message](https://dev.smsmode.com/rcs/v1/#tag/Message/operation/send-message)
...
| `validity` | body | `object` | no | Validity request body field documented by the smsmode API. |
