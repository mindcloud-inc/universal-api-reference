# smsmode: Update Scheduled RCS Message



```
PUT https://connect.mindcloud.co/v1/universal/smsmode/latest/actions/update-scheduled-rcs-message
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/smsmode/latest/actions/update-scheduled-rcs-message" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/smsmode/latest/actions/update-scheduled-rcs-message', {
  method: 'PUT',
  headers: {
