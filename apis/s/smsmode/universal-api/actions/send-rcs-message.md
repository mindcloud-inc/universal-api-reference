# smsmode: Send RCS Message



```
POST https://connect.mindcloud.co/v1/universal/smsmode/latest/actions/send-rcs-message
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/smsmode/latest/actions/send-rcs-message" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/smsmode/latest/actions/send-rcs-message', {
  method: 'POST',
  headers: {
...
| `validity` | object | no | Validity request body field documented by the smsmode API. |
