# smsmode: Delete Credential



```
DELETE https://connect.mindcloud.co/v1/universal/smsmode/latest/actions/delete-credential
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/smsmode/latest/actions/delete-credential?connectionId=$CONNECTION_ID&channelId=string&credentialId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/smsmode/latest/actions/delete-credential?${params}`, {
  headers: {
