# smsmode: Get Credential



```
GET https://connect.mindcloud.co/v1/universal/smsmode/latest/actions/get-credential
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/smsmode/latest/actions/get-credential?connectionId=$CONNECTION_ID&channelId=string&credentialId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/smsmode/latest/actions/get-credential?${params}`, {
  headers: {
