# smsmode Universal API Authentication

Every smsmode API request through MindCloud uses a MindCloud API key and the `connectionId` of a smsmode connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your smsmode connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [smsmode action](README.md#actions-39) with your API key and `connectionId`.
