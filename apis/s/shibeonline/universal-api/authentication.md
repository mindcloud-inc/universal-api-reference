# Shibe.online Universal API Authentication

Every Shibe.online API request through MindCloud uses a MindCloud API key and the `connectionId` of a Shibe.online connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Shibe.online connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Shibe.online action](README.md#actions-3) with your API key and `connectionId`.
