# Shippo - Legacy: Create Refund

Creates a refund for a Shippo shipping label.

```
POST https://connect.mindcloud.co/v1/universal/shippo/latest/actions/create-refund
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/shippo/latest/actions/create-refund" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/shippo/latest/actions/create-refund', {
  method: 'POST',
  headers: {
