# Simple Analytics Universal API Authentication

Every Simple Analytics API request through MindCloud uses a MindCloud API key and the `connectionId` of a Simple Analytics connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Simple Analytics connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Simple Analytics action](README.md#actions-23) with your API key and `connectionId`.
