# ScrapFly Universal API Authentication

Every ScrapFly API request through MindCloud uses a MindCloud API key and the `connectionId` of a ScrapFly connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ScrapFly connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ScrapFly action](README.md#actions-18) with your API key and `connectionId`.
