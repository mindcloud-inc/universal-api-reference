# SearchAPI - Google Search Universal API Authentication

Every SearchAPI - Google Search API request through MindCloud uses a MindCloud API key and the `connectionId` of a SearchAPI - Google Search connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SearchAPI - Google Search connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SearchAPI - Google Search action](README.md#actions-3) with your API key and `connectionId`.
