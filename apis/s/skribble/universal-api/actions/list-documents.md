# Skribble: List Documents

Retrieves accessible documents from Skribble.

```
GET https://connect.mindcloud.co/v1/universal/skribble/latest/actions/list-documents
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/skribble/latest/actions/list-documents?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/skribble/latest/actions/list-documents?${params}`, {
  headers: {
