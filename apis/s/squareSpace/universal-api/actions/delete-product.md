...
Deletes a product from Squarespace.

```
DELETE https://connect.mindcloud.co/v1/universal/squareSpace/latest/actions/delete-product
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/squareSpace/latest/actions/delete-product?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/squareSpace/latest/actions/delete-product?${params}`, {
  headers: {
