# SquareSpace Universal API Authentication

Every SquareSpace API request through MindCloud uses a MindCloud API key and the `connectionId` of a SquareSpace connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SquareSpace connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SquareSpace action](README.md#actions-27) with your API key and `connectionId`.
