...
Retrieves an invoice from Stax.

```
GET https://connect.mindcloud.co/v1/universal/stax/latest/actions/get-invoice
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/stax/latest/actions/get-invoice?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/stax/latest/actions/get-invoice?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `id` | string | no | Invoice identifier |
