# Stax: Update Customer

Updates a customer in Stax.

```
PUT https://connect.mindcloud.co/v1/universal/stax/latest/actions/update-customer
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/stax/latest/actions/update-customer" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/stax/latest/actions/update-customer', {
  method: 'PUT',
  headers: {
