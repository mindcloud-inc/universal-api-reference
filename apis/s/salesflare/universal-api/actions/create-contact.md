# Salesflare: Create Contact



```
POST https://connect.mindcloud.co/v1/universal/salesflare/latest/actions/create-contact
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/salesflare/latest/actions/create-contact" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/salesflare/latest/actions/create-contact', {
  method: 'POST',
  headers: {
