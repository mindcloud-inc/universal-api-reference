# SpreadsheetWeb Hub: List Tags

Retrieves tags from a SpreadsheetWeb Hub workspace.

```
GET https://connect.mindcloud.co/v1/universal/spreadsheetWebHub/latest/actions/list-tags
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/spreadsheetWebHub/latest/actions/list-tags?connectionId=$CONNECTION_ID&limit=25&offset=0&workspaceId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/spreadsheetWebHub/latest/actions/list-tags?${params}`, {
  headers: {
