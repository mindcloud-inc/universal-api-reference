# Switchur App Universal API Authentication

Every Switchur App API request through MindCloud uses a MindCloud API key and the `connectionId` of a Switchur App connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Switchur App connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Switchur App action](README.md#actions-5) with your API key and `connectionId`.
