# SurveyMethods Universal API Authentication

Every SurveyMethods API request through MindCloud uses a MindCloud API key and the `connectionId` of a SurveyMethods connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SurveyMethods connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SurveyMethods action](README.md#actions-18) with your API key and `connectionId`.
