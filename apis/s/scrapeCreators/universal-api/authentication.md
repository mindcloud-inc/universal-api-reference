# Scrape Creators Universal API Authentication

Every Scrape Creators API request through MindCloud uses a MindCloud API key and the `connectionId` of a Scrape Creators connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Scrape Creators connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Scrape Creators action](README.md#actions-19) with your API key and `connectionId`.
