# ShortPen: Get Authenticated User

Retrieves authenticated user details from ShortPen.

```
GET https://connect.mindcloud.co/v1/universal/shortPen/latest/actions/get-authenticated-user
```
