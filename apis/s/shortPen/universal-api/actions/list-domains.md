# ShortPen: List Domains

Retrieves available short-link domains from ShortPen.

```
GET https://connect.mindcloud.co/v1/universal/shortPen/latest/actions/list-domains
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/shortPen/latest/actions/list-domains?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/shortPen/latest/actions/list-domains?${params}`, {
  headers: {
