# SMS8.io Universal API Authentication

Every SMS8.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a SMS8.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SMS8.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SMS8.io action](README.md#actions-3) with your API key and `connectionId`.
