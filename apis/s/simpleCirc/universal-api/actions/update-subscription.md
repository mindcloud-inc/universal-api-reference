# SimpleCirc: Update Subscription

Updates an existing subscription in SimpleCirc.

```
PUT https://connect.mindcloud.co/v1/universal/simpleCirc/latest/actions/update-subscription
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/simpleCirc/latest/actions/update-subscription" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/simpleCirc/latest/actions/update-subscription', {
  method: 'PUT',
  headers: {
