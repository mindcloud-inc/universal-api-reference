# SimpleCirc Universal API Authentication

Every SimpleCirc API request through MindCloud uses a MindCloud API key and the `connectionId` of a SimpleCirc connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SimpleCirc connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SimpleCirc action](README.md#actions-7) with your API key and `connectionId`.
