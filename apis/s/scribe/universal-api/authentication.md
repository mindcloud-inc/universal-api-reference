# 3Scribe Universal API Authentication

Every 3Scribe API request through MindCloud uses a MindCloud API key and the `connectionId` of a 3Scribe connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your 3Scribe connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [3Scribe action](README.md#actions-5) with your API key and `connectionId`.
