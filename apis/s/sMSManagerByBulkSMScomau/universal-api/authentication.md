# SMS Manager by BulkSMS.com.au Universal API Authentication

Every SMS Manager by BulkSMS.com.au API request through MindCloud uses a MindCloud API key and the `connectionId` of a SMS Manager by BulkSMS.com.au connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SMS Manager by BulkSMS.com.au connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SMS Manager by BulkSMS.com.au action](README.md#actions-39) with your API key and `connectionId`.
