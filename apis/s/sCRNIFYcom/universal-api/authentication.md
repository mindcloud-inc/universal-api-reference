# SCRNIFY.com Universal API Authentication

Every SCRNIFY.com API request through MindCloud uses a MindCloud API key and the `connectionId` of a SCRNIFY.com connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SCRNIFY.com connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SCRNIFY.com action](README.md#actions-30) with your API key and `connectionId`.
