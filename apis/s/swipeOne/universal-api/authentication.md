# Swipe One Universal API Authentication

Every Swipe One API request through MindCloud uses a MindCloud API key and the `connectionId` of a Swipe One connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Swipe One connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Swipe One action](README.md#actions-36) with your API key and `connectionId`.
