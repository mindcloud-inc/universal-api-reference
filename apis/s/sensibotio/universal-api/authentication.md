# Sensibot.io Universal API Authentication

Every Sensibot.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a Sensibot.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Sensibot.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Sensibot.io action](README.md#actions-16) with your API key and `connectionId`.
