# SmartrMail: List Subscriber Lists

Retrieves subscriber lists from your SmartrMail account.

```
GET https://connect.mindcloud.co/v1/universal/smartrMail/latest/actions/list-subscriber-lists
```
...
Through the native SmartrMail API, this operation is `GET /lists` (base URL `https://go.smartrmail.com/api/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-subscriber-lists.md) for the provider-specific parameters and requirements.
