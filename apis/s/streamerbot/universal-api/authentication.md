# Streamer.bot Universal API Authentication

Every Streamer.bot API request through MindCloud uses a MindCloud API key and the `connectionId` of a Streamer.bot connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Streamer.bot connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Streamer.bot action](README.md#actions-6) with your API key and `connectionId`.
