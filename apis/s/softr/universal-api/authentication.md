# Softr Universal API Authentication

Every Softr API request through MindCloud uses a MindCloud API key and the `connectionId` of a Softr connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Softr connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Softr action](README.md#actions-26) with your API key and `connectionId`.
