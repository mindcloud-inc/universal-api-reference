# SimpleLocalize Universal API Authentication

Every SimpleLocalize API request through MindCloud uses a MindCloud API key and the `connectionId` of a SimpleLocalize connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SimpleLocalize connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SimpleLocalize action](README.md#actions-39) with your API key and `connectionId`.
