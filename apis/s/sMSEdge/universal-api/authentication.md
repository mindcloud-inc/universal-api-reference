# SMSEdge Universal API Authentication

Every SMSEdge API request through MindCloud uses a MindCloud API key and the `connectionId` of a SMSEdge connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SMSEdge connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SMSEdge action](README.md#actions-20) with your API key and `connectionId`.
