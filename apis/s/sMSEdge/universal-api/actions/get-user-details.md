# SMSEdge: Get User Details

Retrieves API user details from SMSEdge.

```
GET https://connect.mindcloud.co/v1/universal/sMSEdge/latest/actions/get-user-details
```
...
Through the native SMSEdge API, this operation is `POST /user/details/` (base URL `https://api.smsedge.com/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-user-details.md) for the provider-specific parameters and requirements.
