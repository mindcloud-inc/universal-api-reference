# Scraptio Universal API Authentication

Every Scraptio API request through MindCloud uses a MindCloud API key and the `connectionId` of a Scraptio connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Scraptio connection.
