# Salesrobot: Update Schedule



```
PUT https://connect.mindcloud.co/v1/universal/salesrobot/latest/actions/update-schedule
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/salesrobot/latest/actions/update-schedule" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/salesrobot/latest/actions/update-schedule', {
  method: 'PUT',
  headers: {
