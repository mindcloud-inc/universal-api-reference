# Salesrobot: List Campaigns



```
GET https://connect.mindcloud.co/v1/universal/salesrobot/latest/actions/list-campaigns
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/salesrobot/latest/actions/list-campaigns?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/salesrobot/latest/actions/list-campaigns?${params}`, {
  headers: {
