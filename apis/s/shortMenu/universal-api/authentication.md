# Short Menu Universal API Authentication

Every Short Menu API request through MindCloud uses a MindCloud API key and the `connectionId` of a Short Menu connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Short Menu connection.
