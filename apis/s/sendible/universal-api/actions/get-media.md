...
```
GET https://connect.mindcloud.co/v1/universal/sendible/latest/actions/get-media
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/sendible/latest/actions/get-media?connectionId=$CONNECTION_ID&ids=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/sendible/latest/actions/get-media?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `ids` | string | yes | Comma-separated media IDs to fetch. |
