# Smart Sender Universal API Authentication

Every Smart Sender API request through MindCloud uses a MindCloud API key and the `connectionId` of a Smart Sender connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Smart Sender connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Smart Sender action](README.md#actions-35) with your API key and `connectionId`.
