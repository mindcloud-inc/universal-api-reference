# Superthread Universal API Authentication

Every Superthread API request through MindCloud uses a MindCloud API key and the `connectionId` of a Superthread connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Superthread connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Superthread action](README.md#actions-41) with your API key and `connectionId`.
