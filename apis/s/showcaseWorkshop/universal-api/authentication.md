# Showcase Workshop Universal API Authentication

Every Showcase Workshop API request through MindCloud uses a MindCloud API key and the `connectionId` of a Showcase Workshop connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Showcase Workshop connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Showcase Workshop action](README.md#actions-4) with your API key and `connectionId`.
