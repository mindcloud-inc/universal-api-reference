# Sozuri (Kenya) SMS: Send WhatsApp Interactive List Message

Sends a WhatsApp interactive list through Sozuri.

```
POST https://connect.mindcloud.co/v1/universal/sozuriKenyaSMS/latest/actions/send-whats-app-interactive-list-message
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/sozuriKenyaSMS/latest/actions/send-whats-app-interactive-list-message" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/sozuriKenyaSMS/latest/actions/send-whats-app-interactive-list-message', {
  method: 'POST',
  headers: {
...
| `interactive` | object | yes | The WhatsApp interactive payload object for a list message. |
