# Sozuri (Kenya) SMS: Send WhatsApp Interactive Reply Buttons Message

Sends WhatsApp reply buttons through Sozuri.

```
POST https://connect.mindcloud.co/v1/universal/sozuriKenyaSMS/latest/actions/send-whats-app-interactive-reply-buttons-message
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/sozuriKenyaSMS/latest/actions/send-whats-app-interactive-reply-buttons-message" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/sozuriKenyaSMS/latest/actions/send-whats-app-interactive-reply-buttons-message', {
  method: 'POST',
  headers: {
...
| `interactive` | object | yes | The WhatsApp interactive payload object for reply buttons. |
