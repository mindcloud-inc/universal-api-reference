# Shields.io Universal API Authentication

Every Shields.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a Shields.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Shields.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Shields.io action](README.md#actions-7) with your API key and `connectionId`.
