# Update Action Status with SafetyCulture
...
- **Method:** `PUT`
- **Path:** `/tasks/v1/actions/{task_id}/status`
- **Base URL:** `https://api.safetyculture.io`
- **Official documentation:** [Update Action Status](https://developer.safetyculture.com/reference/actionsservice_updatestatus)
