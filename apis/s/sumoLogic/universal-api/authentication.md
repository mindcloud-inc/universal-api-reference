# Sumo Logic Universal API Authentication

Every Sumo Logic API request through MindCloud uses a MindCloud API key and the `connectionId` of a Sumo Logic connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Sumo Logic connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Sumo Logic action](README.md#actions-24) with your API key and `connectionId`.
