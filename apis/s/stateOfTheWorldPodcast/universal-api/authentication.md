# State of the World Podcast Universal API Authentication

Every State of the World Podcast API request through MindCloud uses a MindCloud API key and the `connectionId` of a State of the World Podcast connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your State of the World Podcast connection.
