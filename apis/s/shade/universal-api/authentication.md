# Shade Universal API Authentication

Every Shade API request through MindCloud uses a MindCloud API key and the `connectionId` of a Shade connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Shade connection.
