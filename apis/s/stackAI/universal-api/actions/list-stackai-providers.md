# Stack AI: List StackAI Providers



```
GET https://connect.mindcloud.co/v1/universal/stackAI/latest/actions/list-stackai-providers
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/stackAI/latest/actions/list-stackai-providers?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/stackAI/latest/actions/list-stackai-providers?${params}`, {
  headers: {
