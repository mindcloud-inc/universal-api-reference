# Stack AI: Update Knowledge Base



```
PUT https://connect.mindcloud.co/v1/universal/stackAI/latest/actions/update-knowledge-base
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/stackAI/latest/actions/update-knowledge-base" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/stackAI/latest/actions/update-knowledge-base', {
  method: 'PUT',
  headers: {
