# Sponsy: Create Customer

Creates a customer in Sponsy.

```
POST https://connect.mindcloud.co/v1/universal/sponsy/latest/actions/create-customer
```
