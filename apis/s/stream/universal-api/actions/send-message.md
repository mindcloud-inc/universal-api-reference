...
```
POST https://connect.mindcloud.co/v1/universal/stream/latest/actions/send-message
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/stream/latest/actions/send-message" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/stream/latest/actions/send-message', {
  method: 'POST',
  headers: {
