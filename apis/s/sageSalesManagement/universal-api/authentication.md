# Sage Sales Management Universal API Authentication

Every Sage Sales Management API request through MindCloud uses a MindCloud API key and the `connectionId` of a Sage Sales Management connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Sage Sales Management connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Sage Sales Management action](README.md#actions-129) with your API key and `connectionId`.
