...
- **Official documentation:** [Create Task](https://developer.servicem8.com/reference/createtasks)
...
| `uuid` | body | `string` | no | Optional UUID for record creation. |
