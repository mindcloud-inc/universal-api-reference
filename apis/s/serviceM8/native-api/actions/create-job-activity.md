# Create Job Activity with ServiceM8

## Endpoint

- **Method:** `POST`
- **Path:** `/api_1.0/jobactivity.json`
- **Base URL:** `https://api.servicem8.com`
- **Official documentation:** [Create Job Activity](https://developer.servicem8.com/reference/createjobactivities)
