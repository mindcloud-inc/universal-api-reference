# Streak Universal API Authentication

Every Streak API request through MindCloud uses a MindCloud API key and the `connectionId` of a Streak connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Streak connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Streak action](README.md#actions-25) with your API key and `connectionId`.
