...
```
POST https://connect.mindcloud.co/v1/universal/streak/latest/actions/create-box
```
...
| --- | --- | --- | --- |
| `pipelineKey` | list<string> | yes | The key of the pipeline the box should belong to. |
| `name` | string | yes | The name of this box. |
| `stageKey` | string | no | The stage of this box. |

### Advanced

| Key | Type | Required | Description |
| --- | --- | --- | --- |
| `notes` | string | no | The notes on the box. |
| `assignedToSharingEntries` | string | no | The member(s) of your team this box will be assigned to. This must be an array of objects with `email` properties encoded as a JSON string. |
