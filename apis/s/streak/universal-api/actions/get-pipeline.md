...
```
GET https://connect.mindcloud.co/v1/universal/streak/latest/actions/get-pipeline
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/streak/latest/actions/get-pipeline?connectionId=$CONNECTION_ID&pipelineKey=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/streak/latest/actions/get-pipeline?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `pipelineKey` | list<string> | yes | The key of the pipeline to retrieve. |
