...
```
PUT https://connect.mindcloud.co/v1/universal/streak/latest/actions/update-task
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/streak/latest/actions/update-task" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/streak/latest/actions/update-task', {
  method: 'PUT',
  headers: {
