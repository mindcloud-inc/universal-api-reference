# Screenly Universal API Authentication

Every Screenly API request through MindCloud uses a MindCloud API key and the `connectionId` of a Screenly connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Screenly connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Screenly action](README.md#actions-16) with your API key and `connectionId`.
