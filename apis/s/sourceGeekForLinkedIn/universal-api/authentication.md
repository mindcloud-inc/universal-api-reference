# SourceGeek for LinkedIn Universal API Authentication

Every SourceGeek for LinkedIn API request through MindCloud uses a MindCloud API key and the `connectionId` of a SourceGeek for LinkedIn connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SourceGeek for LinkedIn connection.
