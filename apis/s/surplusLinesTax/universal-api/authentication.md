# Surplus Lines Tax Universal API Authentication

Every Surplus Lines Tax API request through MindCloud uses a MindCloud API key and the `connectionId` of a Surplus Lines Tax connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Surplus Lines Tax connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Surplus Lines Tax action](README.md#actions-2) with your API key and `connectionId`.
