# ShipWise: Create Order V2

Creates an order in ShipWise.

```
POST https://connect.mindcloud.co/v1/universal/shipWise/latest/actions/create-order-v2
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/shipWise/latest/actions/create-order-v2" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/shipWise/latest/actions/create-order-v2', {
  method: 'POST',
  headers: {
