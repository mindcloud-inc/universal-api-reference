# ShipWise Universal API Authentication

Every ShipWise API request through MindCloud uses a MindCloud API key and the `connectionId` of a ShipWise connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ShipWise connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ShipWise action](README.md#actions-139) with your API key and `connectionId`.
