# SimpleKPI Universal API Authentication

Every SimpleKPI API request through MindCloud uses a MindCloud API key and the `connectionId` of a SimpleKPI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SimpleKPI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SimpleKPI action](README.md#actions-42) with your API key and `connectionId`.
