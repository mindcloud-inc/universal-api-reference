# SeaTable Universal API Authentication

Every SeaTable API request through MindCloud uses a MindCloud API key and the `connectionId` of a SeaTable connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SeaTable connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SeaTable action](README.md#actions-63) with your API key and `connectionId`.
