# Studio Ghibli Universal API Authentication

Every Studio Ghibli API request through MindCloud uses a MindCloud API key and the `connectionId` of a Studio Ghibli connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Studio Ghibli connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Studio Ghibli action](README.md#actions-10) with your API key and `connectionId`.
