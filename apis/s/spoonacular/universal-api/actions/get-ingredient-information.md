# Spoonacular: Get Ingredient Information

Retrieves ingredient details from Spoonacular.

```
GET https://connect.mindcloud.co/v1/universal/spoonacular/latest/actions/get-ingredient-information
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/spoonacular/latest/actions/get-ingredient-information?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/spoonacular/latest/actions/get-ingredient-information?${params}`, {
  headers: {
