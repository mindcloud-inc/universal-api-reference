# Spoonacular: Add Meal Plan Template

Creates a meal plan template in Spoonacular.

```
POST https://connect.mindcloud.co/v1/universal/spoonacular/latest/actions/add-meal-plan-template
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/spoonacular/latest/actions/add-meal-plan-template" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/spoonacular/latest/actions/add-meal-plan-template', {
  method: 'POST',
  headers: {
