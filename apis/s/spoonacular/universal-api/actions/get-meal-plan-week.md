# Spoonacular: Get Meal Plan Week

Retrieves a weekly meal plan from Spoonacular.

```
GET https://connect.mindcloud.co/v1/universal/spoonacular/latest/actions/get-meal-plan-week
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/spoonacular/latest/actions/get-meal-plan-week?connectionId=$CONNECTION_ID&hash=string&startDate=string&username=Ava%20Chen" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/spoonacular/latest/actions/get-meal-plan-week?${params}`, {
  headers: {
