# Spoonacular Universal API Authentication

Every Spoonacular API request through MindCloud uses a MindCloud API key and the `connectionId` of a Spoonacular connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Spoonacular connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Spoonacular action](README.md#actions-104) with your API key and `connectionId`.
