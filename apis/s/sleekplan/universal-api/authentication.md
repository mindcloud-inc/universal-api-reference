# Sleekplan Universal API Authentication

Every Sleekplan API request through MindCloud uses a MindCloud API key and the `connectionId` of a Sleekplan connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Sleekplan connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Sleekplan action](README.md#actions-34) with your API key and `connectionId`.
