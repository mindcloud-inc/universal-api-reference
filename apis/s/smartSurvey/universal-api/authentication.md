# SmartSurvey Universal API Authentication

Every SmartSurvey API request through MindCloud uses a MindCloud API key and the `connectionId` of a SmartSurvey connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SmartSurvey connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SmartSurvey action](README.md#actions-40) with your API key and `connectionId`.
