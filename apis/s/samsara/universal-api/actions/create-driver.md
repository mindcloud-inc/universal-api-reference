# Samsara: Create Driver



```
POST https://connect.mindcloud.co/v1/universal/samsara/latest/actions/create-driver
```
...
Through the native Samsara API, this operation is `POST fleet/drivers` (base URL `https://api.samsara.com/`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/create-driver.md) for the provider-specific parameters and requirements.
