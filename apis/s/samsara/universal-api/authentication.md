# Samsara Universal API Authentication

Every Samsara API request through MindCloud uses a MindCloud API key and the `connectionId` of a Samsara connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Samsara connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Samsara action](README.md#actions-26) with your API key and `connectionId`.
