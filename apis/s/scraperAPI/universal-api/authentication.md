# ScraperAPI Universal API Authentication

Every ScraperAPI API request through MindCloud uses a MindCloud API key and the `connectionId` of a ScraperAPI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ScraperAPI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ScraperAPI action](README.md#actions-31) with your API key and `connectionId`.
