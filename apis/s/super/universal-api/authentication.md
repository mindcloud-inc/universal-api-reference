# Super Universal API Authentication

Every Super API request through MindCloud uses a MindCloud API key and the `connectionId` of a Super connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Super connection.
