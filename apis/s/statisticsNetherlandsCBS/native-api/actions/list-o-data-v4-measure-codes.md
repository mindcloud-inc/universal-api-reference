# List OData V4 Measure Codes with Statistics Netherlands CBS
...
- **Method:** `GET`
- **Path:** `https://datasets.cbs.nl/odata/v1/CBS/{{tableIdentifier}}/MeasureCodes`
- **Base URL:** `https://opendata.cbs.nl`
- **Official documentation:** [List OData V4 Measure Codes](https://www.cbs.nl/en-gb/onze-diensten/open-data/statline-as-open-data)
