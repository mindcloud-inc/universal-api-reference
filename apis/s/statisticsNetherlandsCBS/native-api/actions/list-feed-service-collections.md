# List Feed Service Collections with Statistics Netherlands CBS
...
- **Method:** `GET`
- **Path:** `/ODataFeed/odata/{{tableIdentifier}}`
- **Base URL:** `https://opendata.cbs.nl`
- **Official documentation:** [List Feed Service Collections](https://www.cbs.nl/en-gb/onze-diensten/open-data/statline-as-open-data)
