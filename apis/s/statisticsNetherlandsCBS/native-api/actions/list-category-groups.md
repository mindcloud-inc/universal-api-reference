# List Category Groups with Statistics Netherlands CBS
...
- **Method:** `GET`
- **Path:** `/ODataApi/odata/{{tableIdentifier}}/CategoryGroups`
- **Base URL:** `https://opendata.cbs.nl`
- **Official documentation:** [List Category Groups](https://www.cbs.nl/en-gb/onze-diensten/open-data/statline-as-open-data)
