# Statistics Netherlands CBS Universal API Authentication

Every Statistics Netherlands CBS API request through MindCloud uses a MindCloud API key and the `connectionId` of a Statistics Netherlands CBS connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Statistics Netherlands CBS connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Statistics Netherlands CBS action](README.md#actions-61) with your API key and `connectionId`.
