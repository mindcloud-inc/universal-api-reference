# Smartsheet Universal API Authentication

Every Smartsheet API request through MindCloud uses a MindCloud API key and the `connectionId` of a Smartsheet connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Smartsheet connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Smartsheet action](README.md#actions-29) with your API key and `connectionId`.
