# Square Universal API Authentication

Every Square API request through MindCloud uses a MindCloud API key and the `connectionId` of a Square connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Square connection.
