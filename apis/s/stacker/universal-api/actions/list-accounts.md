# Stacker: List Accounts

Retrieves accounts from Stacker.

```
GET https://connect.mindcloud.co/v1/universal/stacker/latest/actions/list-accounts
```
