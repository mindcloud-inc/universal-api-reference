# Salespanel Universal API Authentication

Every Salespanel API request through MindCloud uses a MindCloud API key and the `connectionId` of a Salespanel connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Salespanel connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Salespanel action](README.md#actions-8) with your API key and `connectionId`.
