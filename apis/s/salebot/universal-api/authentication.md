# Salebot Universal API Authentication

Every Salebot API request through MindCloud uses a MindCloud API key and the `connectionId` of a Salebot connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Salebot connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Salebot action](README.md#actions-26) with your API key and `connectionId`.
