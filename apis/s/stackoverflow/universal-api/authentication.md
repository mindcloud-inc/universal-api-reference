# Stackoverflow Universal API Authentication

Every Stackoverflow API request through MindCloud uses a MindCloud API key and the `connectionId` of a Stackoverflow connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Stackoverflow connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Stackoverflow action](README.md#actions-143) with your API key and `connectionId`.
