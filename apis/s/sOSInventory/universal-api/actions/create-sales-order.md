# SOS Inventory: Create Sales Order

Creates a sales order in SOS Inventory.

```
POST https://connect.mindcloud.co/v1/universal/sOSInventory/latest/actions/create-sales-order
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/sOSInventory/latest/actions/create-sales-order" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/sOSInventory/latest/actions/create-sales-order', {
  method: 'POST',
  headers: {
...
| --- | --- | --- | --- |
| `number` | string | yes | Order number for this sales order. Use auto for automatic numbering. |
