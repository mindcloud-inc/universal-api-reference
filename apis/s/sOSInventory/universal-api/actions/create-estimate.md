# SOS Inventory: Create Estimate

Creates an estimate in SOS Inventory.

```
POST https://connect.mindcloud.co/v1/universal/sOSInventory/latest/actions/create-estimate
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/sOSInventory/latest/actions/create-estimate" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/sOSInventory/latest/actions/create-estimate', {
  method: 'POST',
  headers: {
...
| --- | --- | --- | --- |
| `number` | string | yes | Order number for this estimate. Use auto for automatic numbering. |
