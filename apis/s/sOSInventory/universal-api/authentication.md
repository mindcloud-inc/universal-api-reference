# SOS Inventory Universal API Authentication

Every SOS Inventory API request through MindCloud uses a MindCloud API key and the `connectionId` of a SOS Inventory connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SOS Inventory connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SOS Inventory action](README.md#actions-38) with your API key and `connectionId`.
