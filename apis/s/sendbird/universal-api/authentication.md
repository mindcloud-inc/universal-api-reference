# Sendbird Universal API Authentication

Every Sendbird API request through MindCloud uses a MindCloud API key and the `connectionId` of a Sendbird connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Sendbird connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Sendbird action](README.md#actions-48) with your API key and `connectionId`.
