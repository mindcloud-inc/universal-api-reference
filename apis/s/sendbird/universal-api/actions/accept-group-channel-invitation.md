# Sendbird: Accept Group Channel Invitation



```
PUT https://connect.mindcloud.co/v1/universal/sendbird/latest/actions/accept-group-channel-invitation
```
...
Through the native Sendbird API, this operation is `PUT /group_channels/:channelUrl/accept` (base URL `https://api-{{credentials.applicationId}}.sendbird.com/v3`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/accept-group-channel-invitation.md) for the provider-specific parameters and requirements.
