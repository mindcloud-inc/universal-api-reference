# Shuffler Universal API Authentication

Every Shuffler API request through MindCloud uses a MindCloud API key and the `connectionId` of a Shuffler connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Shuffler connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Shuffler action](README.md#actions-56) with your API key and `connectionId`.
