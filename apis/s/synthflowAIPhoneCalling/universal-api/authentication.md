# Synthflow AI Phone Calling Universal API Authentication

Every Synthflow AI Phone Calling API request through MindCloud uses a MindCloud API key and the `connectionId` of a Synthflow AI Phone Calling connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Synthflow AI Phone Calling connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Synthflow AI Phone Calling action](README.md#actions-34) with your API key and `connectionId`.
