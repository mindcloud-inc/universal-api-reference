# Socialbu Universal API Authentication

Every Socialbu API request through MindCloud uses a MindCloud API key and the `connectionId` of a Socialbu connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Socialbu connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Socialbu action](README.md#actions-49) with your API key and `connectionId`.
