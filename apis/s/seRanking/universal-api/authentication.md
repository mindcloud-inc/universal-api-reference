# SE Ranking Data Universal API Authentication

Every SE Ranking Data API request through MindCloud uses a MindCloud API key and the `connectionId` of a SE Ranking Data connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SE Ranking Data connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SE Ranking Data action](README.md#actions-60) with your API key and `connectionId`.
