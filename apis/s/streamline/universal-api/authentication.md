# Streamline Universal API Authentication

Every Streamline API request through MindCloud uses a MindCloud API key and the `connectionId` of a Streamline connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Streamline connection.
