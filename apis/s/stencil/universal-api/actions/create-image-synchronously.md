# Stencil: Create Image Synchronously



```
POST https://connect.mindcloud.co/v1/universal/stencil/latest/actions/create-image-synchronously
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/stencil/latest/actions/create-image-synchronously" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/stencil/latest/actions/create-image-synchronously', {
  method: 'POST',
  headers: {
...
Through the native Stencil API, this operation is `POST /v1/images/sync` (base URL `https://api.usestencil.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/create-image-synchronously.md) for the provider-specific parameters and requirements.
