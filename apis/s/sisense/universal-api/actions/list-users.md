...
```
GET https://connect.mindcloud.co/v1/universal/sisense/latest/actions/list-users
```
...
| --- | --- | --- | --- |
| `fields` | string | no | Comma-delimited list of user fields to include or exclude. |
| `expand` | string | no | Expand related fields such as groups into full entities. |
