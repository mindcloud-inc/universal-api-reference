# Sisense: Delete Table

Deletes an existing table from Sisense.

```
DELETE https://connect.mindcloud.co/v1/universal/sisense/latest/actions/delete-table
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/sisense/latest/actions/delete-table?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/sisense/latest/actions/delete-table?${params}`, {
  headers: {
