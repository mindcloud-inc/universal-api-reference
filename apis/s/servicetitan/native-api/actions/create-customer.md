# Create Customer with ServiceTitan
...
| `locations[]` | body | `array<object>` | yes | Locations for the customer |
| `locations[].address.state` | body | `string` | yes | — |
| `locations[].externalData` | body | `object` | no | — |
| `address` | body | `object<object>` | yes | Bill-To address of the customer record |
