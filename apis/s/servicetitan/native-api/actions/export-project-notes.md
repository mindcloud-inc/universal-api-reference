# Export Project Notes with ServiceTitan

## Endpoint

- **Method:** `GET`
- **Path:** `jpm/v2/tenant/{tenant}/export/project-notes`
- **Base URL:** `https://{baseUrl}/`
- **Official documentation:** [Export Project Notes](https://developer.servicetitan.io/api-details/#api=tenant-jpm-v2&operation=Export_JobNotes)
