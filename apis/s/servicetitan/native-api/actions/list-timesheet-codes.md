# List Timesheet Codes with ServiceTitan
...
- **Method:** `GET`
- **Path:** `payroll/v2/tenant/{tenant}/timesheet-codes`
- **Base URL:** `https://{baseUrl}/`
- **Official documentation:** [List Timesheet Codes](https://developer.servicetitan.io/api-details/#api=tenant-payroll-v2&operation=Payrolls_GetList)
