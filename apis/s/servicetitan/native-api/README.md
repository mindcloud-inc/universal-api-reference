...
A consolidated summary of ServiceTitan's API configuration and 112 documented operations, with links to official documentation.
...
| [Get Returns](actions/get-returns.md) | `GET inventory/v2/tenant/{{credentials.tenant}}/returns` | [docs](https://developer.servicetitan.io/docs/apis/tenant-inventory-v2/endpoints/Returns_GetList) |
...
| [Get Vendor AP Credits](actions/get-vendor-ap-credits.md) | `GET accounting/v2/tenant/{{credentials.tenant}}/ap-credits` | [docs](https://developer.servicetitan.io/docs/apis/tenant-accounting-v2/endpoints/ApCredits_GetList) |
