...
Through the native ServiceTitan API, this operation is `PATCH crm/v2/tenant/{{credentials.tenant}}/locations/:id` (base URL `https://{{credentials.baseUrl}}/`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/update-location-tags.md) for the provider-specific parameters and requirements.
