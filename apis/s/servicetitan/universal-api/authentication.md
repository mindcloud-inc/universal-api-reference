# ServiceTitan Universal API Authentication

Every ServiceTitan API request through MindCloud uses a MindCloud API key and the `connectionId` of a ServiceTitan connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ServiceTitan connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ServiceTitan action](README.md#actions-100) with your API key and `connectionId`.
