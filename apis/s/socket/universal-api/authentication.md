# Socket Universal API Authentication

Every Socket API request through MindCloud uses a MindCloud API key and the `connectionId` of a Socket connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Socket connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Socket action](README.md#actions-91) with your API key and `connectionId`.
