# Stability AI Universal API Authentication

Every Stability AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Stability AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Stability AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Stability AI action](README.md#actions-23) with your API key and `connectionId`.
