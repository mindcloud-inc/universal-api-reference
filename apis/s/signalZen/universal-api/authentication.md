# SignalZen Universal API Authentication

Every SignalZen API request through MindCloud uses a MindCloud API key and the `connectionId` of a SignalZen connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SignalZen connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SignalZen action](README.md#actions-4) with your API key and `connectionId`.
