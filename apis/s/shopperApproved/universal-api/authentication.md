# Shopper Approved Universal API Authentication

Every Shopper Approved API request through MindCloud uses a MindCloud API key and the `connectionId` of a Shopper Approved connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Shopper Approved connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Shopper Approved action](README.md#actions-9) with your API key and `connectionId`.
