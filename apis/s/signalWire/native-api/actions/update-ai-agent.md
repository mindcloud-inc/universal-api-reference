# Update AI Agent with SignalWire
...
- **Method:** `PATCH`
- **Path:** `/fabric/resources/ai_agents/{id}`
- **Base URL:** `https://mindcloud.signalwire.com/api`
- **Official documentation:** [Update AI Agent](https://signalwire.com/docs/apis/rest/ai-agents/ai-agents-custom/update-ai-agent)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `id` | path | `string` | yes | Unique ID of an AI Agent. |
| `agent_id` | body | `string` | no | Unique ID of an AI Agent. |
| `name` | body | `string` | no | Name of the AI Agent. |
