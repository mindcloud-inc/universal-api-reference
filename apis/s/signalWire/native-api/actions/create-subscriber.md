# Create Subscriber with SignalWire
...
- **Method:** `POST`
- **Path:** `/fabric/resources/subscribers`
- **Base URL:** `https://mindcloud.signalwire.com/api`
- **Official documentation:** [Create Subscriber](https://signalwire.com/docs/apis/rest/subscribers/create-subscriber)
