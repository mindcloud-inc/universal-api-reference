...
```
GET https://connect.mindcloud.co/v1/universal/strava/latest/actions/get-authenticated-athlete
```
...
Through the native Strava API, this operation is `GET /athlete` (base URL `https://www.strava.com/api/v3`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-authenticated-athlete.md) for the provider-specific parameters and requirements.
