# Send Single Message with SyncMate
...
- **Official documentation:** [Send Single Message](https://assistro.co/user-guide/developer-guide/connect-your-custom-app-with-syncmate/)
