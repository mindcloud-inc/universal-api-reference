# SyncMate Universal API Authentication

Every SyncMate API request through MindCloud uses a MindCloud API key and the `connectionId` of a SyncMate connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SyncMate connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SyncMate action](README.md#actions-10) with your API key and `connectionId`.
