# Ship24 Universal API Authentication

Every Ship24 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Ship24 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Ship24 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Ship24 action](README.md#actions-13) with your API key and `connectionId`.
