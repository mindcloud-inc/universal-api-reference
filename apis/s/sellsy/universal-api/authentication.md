# Sellsy Universal API Authentication

Every Sellsy API request through MindCloud uses a MindCloud API key and the `connectionId` of a Sellsy connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Sellsy connection.
