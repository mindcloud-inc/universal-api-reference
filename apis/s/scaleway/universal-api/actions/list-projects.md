# Scaleway: List Projects

Retrieves projects from Scaleway for an organization.

```
GET https://connect.mindcloud.co/v1/universal/scaleway/latest/actions/list-projects
```
...
| --- | --- | --- | --- |
| `organizationId` | string | yes | Organization ID to list projects for. |
