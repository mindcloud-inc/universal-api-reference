# Scaleway Universal API Authentication

Every Scaleway API request through MindCloud uses a MindCloud API key and the `connectionId` of a Scaleway connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Scaleway connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Scaleway action](README.md#actions-20) with your API key and `connectionId`.
