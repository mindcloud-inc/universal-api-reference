# Shotstack Universal API Authentication

Every Shotstack API request through MindCloud uses a MindCloud API key and the `connectionId` of a Shotstack connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Shotstack connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Shotstack action](README.md#actions-18) with your API key and `connectionId`.
