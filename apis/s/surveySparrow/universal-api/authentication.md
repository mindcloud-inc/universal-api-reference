# SurveySparrow Universal API Authentication

Every SurveySparrow API request through MindCloud uses a MindCloud API key and the `connectionId` of a SurveySparrow connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SurveySparrow connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SurveySparrow action](README.md#actions-46) with your API key and `connectionId`.
