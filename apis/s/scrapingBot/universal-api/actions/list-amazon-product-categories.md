# ScrapingBot: List Amazon Product Categories



```
GET https://connect.mindcloud.co/v1/universal/scrapingBot/latest/actions/list-amazon-product-categories
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/scrapingBot/latest/actions/list-amazon-product-categories?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/scrapingBot/latest/actions/list-amazon-product-categories?${params}`, {
  headers: {
