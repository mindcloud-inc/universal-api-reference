# SCOTUSblog: List Abbe R. Gluck Posts



```
GET https://connect.mindcloud.co/v1/universal/sCOTUSblog/latest/actions/list-abbe-r-gluck-posts
```
...
Through the native SCOTUSblog API, this operation is `GET /author/abbe-gluck/feed/` (base URL `https://www.scotusblog.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-abbe-r-gluck-posts.md) for the provider-specific parameters and requirements.
