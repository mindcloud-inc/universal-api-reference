# Socie Universal API Authentication

Every Socie API request through MindCloud uses a MindCloud API key and the `connectionId` of a Socie connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Socie connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Socie action](README.md#actions-26) with your API key and `connectionId`.
