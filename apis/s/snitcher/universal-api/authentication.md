# Snitcher Universal API Authentication

Every Snitcher API request through MindCloud uses a MindCloud API key and the `connectionId` of a Snitcher connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Snitcher connection.
