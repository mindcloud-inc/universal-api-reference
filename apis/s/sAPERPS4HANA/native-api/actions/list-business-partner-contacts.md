# List Business Partner Contacts with SAP ERP (S/4HANA)
...
- **Method:** `GET`
- **Path:** `/A_BusinessPartner('{{businessPartner}}')/to_BusinessPartnerContact`
- **Base URL:** `https://sandbox.api.sap.com/s4hanacloud/sap/opu/odata/sap/API_BUSINESS_PARTNER`
- **Official documentation:** [List Business Partner Contacts](https://api.sap.com/api/API_BUSINESS_PARTNER)
