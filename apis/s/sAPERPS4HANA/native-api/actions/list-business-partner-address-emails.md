# List Business Partner Address Emails with SAP ERP (S/4HANA)
...
- **Method:** `GET`
- **Path:** `/A_BusinessPartnerAddress(BusinessPartner='{{businessPartner}}',AddressID='{{addressId}}')/to_EmailAddress`
- **Base URL:** `https://sandbox.api.sap.com/s4hanacloud/sap/opu/odata/sap/API_BUSINESS_PARTNER`
- **Official documentation:** [List Business Partner Address Emails](https://api.sap.com/api/API_BUSINESS_PARTNER)
