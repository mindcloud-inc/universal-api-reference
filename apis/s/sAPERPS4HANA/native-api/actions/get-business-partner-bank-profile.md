# Get Business Partner Bank Profile with SAP ERP (S/4HANA)
...
- **Method:** `GET`
- **Path:** `/A_BusinessPartner('{{businessPartner}}')/to_BusinessPartnerIsBank`
- **Base URL:** `https://sandbox.api.sap.com/s4hanacloud/sap/opu/odata/sap/API_BUSINESS_PARTNER`
- **Official documentation:** [Get Business Partner Bank Profile](https://api.sap.com/api/API_BUSINESS_PARTNER)
