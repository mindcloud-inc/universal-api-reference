# Get Customer for Business Partner with SAP ERP (S/4HANA)
...
- **Method:** `GET`
- **Path:** `/A_BusinessPartner('{{businessPartner}}')/to_Customer`
- **Base URL:** `https://sandbox.api.sap.com/s4hanacloud/sap/opu/odata/sap/API_BUSINESS_PARTNER`
- **Official documentation:** [Get Customer for Business Partner](https://api.sap.com/api/API_BUSINESS_PARTNER)
