# 88stacks Image Generator Universal API Authentication

Every 88stacks Image Generator API request through MindCloud uses a MindCloud API key and the `connectionId` of a 88stacks Image Generator connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your 88stacks Image Generator connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [88stacks Image Generator action](README.md#actions-6) with your API key and `connectionId`.
