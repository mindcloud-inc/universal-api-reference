# Update Activity with Salesmate

## Endpoint

- **Method:** `PUT`
- **Path:** `/activity/v4/:activityId`
- **Base URL:** `https://apis.salesmate.io`
- **Official documentation:** [Update Activity](https://apidocs.salesmate.io/)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `activityId` | path | `number` | yes | Salesmate activity ID. |
