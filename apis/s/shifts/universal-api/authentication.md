# 7shifts Universal API Authentication

Every 7shifts API request through MindCloud uses a MindCloud API key and the `connectionId` of a 7shifts connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your 7shifts connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [7shifts action](README.md#actions-40) with your API key and `connectionId`.
