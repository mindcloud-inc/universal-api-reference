...
```
POST https://connect.mindcloud.co/v1/universal/smartCloud/latest/actions/create-favorite-widget-groups
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/smartCloud/latest/actions/create-favorite-widget-groups" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/smartCloud/latest/actions/create-favorite-widget-groups', {
  method: 'POST',
  headers: {
