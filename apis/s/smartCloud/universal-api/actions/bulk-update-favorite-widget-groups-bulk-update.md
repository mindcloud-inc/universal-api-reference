# 2Smart Cloud: Bulk update favorite widgets groups positions



```
PUT https://connect.mindcloud.co/v1/universal/smartCloud/latest/actions/bulk-update-favorite-widget-groups-bulk-update
```
...
Through the native 2Smart Cloud API, this operation is `POST /favorite-widget-groups/bulk-update` (base URL `https://cloud.2smart.com/robot/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/bulk-update-favorite-widget-groups-bulk-update.md) for the provider-specific parameters and requirements.
