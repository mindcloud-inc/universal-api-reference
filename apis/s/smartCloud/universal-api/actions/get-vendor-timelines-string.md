...
```
GET https://connect.mindcloud.co/v1/universal/smartCloud/latest/actions/get-vendor-timelines-string
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/smartCloud/latest/actions/get-vendor-timelines-string?connectionId=$CONNECTION_ID&topic=string&period=string&interval=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/smartCloud/latest/actions/get-vendor-timelines-string?${params}`, {
  headers: {
