# 2Smart Cloud Universal API Authentication

Every 2Smart Cloud API request through MindCloud uses a MindCloud API key and the `connectionId` of a 2Smart Cloud connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your 2Smart Cloud connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [2Smart Cloud action](README.md#actions-236) with your API key and `connectionId`.
