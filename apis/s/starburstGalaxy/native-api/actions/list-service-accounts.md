# List service accounts with Starburst Galaxy

## Endpoint

- **Method:** `GET`
- **Path:** `/public/api/v1/serviceAccount`
- **Base URL:** `https://mindcloud.galaxy.starburst.io`
- **Official documentation:** [List service accounts](https://galaxy.starburst.io/public-api)
