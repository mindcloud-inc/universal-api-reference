# Get GCS catalog with Starburst Galaxy

## Endpoint

- **Method:** `GET`
- **Path:** `/public/api/v1/catalogType/gcs/catalog/{catalogId}`
- **Base URL:** `https://mindcloud.galaxy.starburst.io`
- **Official documentation:** [Get GCS catalog](https://galaxy.starburst.io/public-api)
