# List BigQuery catalogs with Starburst Galaxy

## Endpoint

- **Method:** `GET`
- **Path:** `/public/api/v1/catalogType/bigquery/catalog`
- **Base URL:** `https://mindcloud.galaxy.starburst.io`
- **Official documentation:** [List BigQuery catalogs](https://galaxy.starburst.io/public-api)
