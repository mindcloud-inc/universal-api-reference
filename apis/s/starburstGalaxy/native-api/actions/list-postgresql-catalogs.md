# List PostgreSQL catalogs with Starburst Galaxy

## Endpoint

- **Method:** `GET`
- **Path:** `/public/api/v1/catalogType/postgresql/catalog`
- **Base URL:** `https://mindcloud.galaxy.starburst.io`
- **Official documentation:** [List PostgreSQL catalogs](https://galaxy.starburst.io/public-api)
