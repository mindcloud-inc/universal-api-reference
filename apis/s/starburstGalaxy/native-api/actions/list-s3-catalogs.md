# List S3 catalogs with Starburst Galaxy

## Endpoint

- **Method:** `GET`
- **Path:** `/public/api/v1/catalogType/s3/catalog`
- **Base URL:** `https://mindcloud.galaxy.starburst.io`
- **Official documentation:** [List S3 catalogs](https://galaxy.starburst.io/public-api)
