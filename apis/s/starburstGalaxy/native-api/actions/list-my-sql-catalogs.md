# List MySQL catalogs with Starburst Galaxy

## Endpoint

- **Method:** `GET`
- **Path:** `/public/api/v1/catalogType/mysql/catalog`
- **Base URL:** `https://mindcloud.galaxy.starburst.io`
- **Official documentation:** [List MySQL catalogs](https://galaxy.starburst.io/public-api)
