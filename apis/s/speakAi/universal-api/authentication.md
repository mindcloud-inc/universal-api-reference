# Speak Ai Universal API Authentication

Every Speak Ai API request through MindCloud uses a MindCloud API key and the `connectionId` of a Speak Ai connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Speak Ai connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Speak Ai action](README.md#actions-24) with your API key and `connectionId`.
