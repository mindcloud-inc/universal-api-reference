# SureContact: List Lists

Retrieves available contact lists from SureContact.

```
GET https://connect.mindcloud.co/v1/universal/sureContact/latest/actions/list-lists
```
...
| --- | --- | --- | --- |
| `archived` | string | no | Filter by archive status: false, true, or all. |
