# Skyvern: Get Workflow

Retrieves a workflow by permanent ID from Skyvern.

```
GET https://connect.mindcloud.co/v1/universal/skyvern/latest/actions/get-workflow
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/skyvern/latest/actions/get-workflow?connectionId=$CONNECTION_ID&workflowPermanentId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/skyvern/latest/actions/get-workflow?${params}`, {
  headers: {
