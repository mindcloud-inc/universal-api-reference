# Simla.com: List Couriers

Retrieves courier reference records from Simla.com.

```
GET https://connect.mindcloud.co/v1/universal/simlacom/latest/actions/list-couriers
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/simlacom/latest/actions/list-couriers?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/simlacom/latest/actions/list-couriers?${params}`, {
  headers: {
