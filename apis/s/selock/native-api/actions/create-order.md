# Create Order with Selock

## Endpoint

- **Method:** `POST`
- **Path:** `/zaiper/create_order/`
- **Base URL:** `https://selock.co/api/v1`
- **Official documentation:** [Create Order](https://selock.co/en/docs/)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `guest_name` | body | `string` | yes | Guest first name. |
| `guest_surname` | body | `string` | no | Guest last name. |
| `guest_phone` | body | `string` | yes | Guest phone number. |
| `guest_email` | body | `string` | no | Guest email address. |
| `start_date` | body | `string` | yes | Check-in date in DD-MM-YYYY format. |
| `hour_in` | body | `number` | no | Check-in hour as an integer. |
| `end_date` | body | `string` | yes | Check-out date in DD-MM-YYYY format. |
