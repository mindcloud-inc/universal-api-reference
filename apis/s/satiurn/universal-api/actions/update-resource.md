# Satiurn: Update Resource

Updates an existing resource in Satiurn.

```
PUT https://connect.mindcloud.co/v1/universal/satiurn/latest/actions/update-resource
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/satiurn/latest/actions/update-resource" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/satiurn/latest/actions/update-resource', {
  method: 'PUT',
  headers: {
