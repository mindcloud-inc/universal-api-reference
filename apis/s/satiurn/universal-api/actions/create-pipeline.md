# Satiurn: Create Pipeline

Creates a new pipeline in Satiurn.

```
POST https://connect.mindcloud.co/v1/universal/satiurn/latest/actions/create-pipeline
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/satiurn/latest/actions/create-pipeline" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/satiurn/latest/actions/create-pipeline', {
  method: 'POST',
  headers: {
