# Satiurn: Update Issue

Updates an existing issue in Satiurn.

```
PUT https://connect.mindcloud.co/v1/universal/satiurn/latest/actions/update-issue
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/satiurn/latest/actions/update-issue" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/satiurn/latest/actions/update-issue', {
  method: 'PUT',
  headers: {
