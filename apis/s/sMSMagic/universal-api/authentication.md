# SMSMagic Universal API Authentication

Every SMSMagic API request through MindCloud uses a MindCloud API key and the `connectionId` of a SMSMagic connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SMSMagic connection.
