# Snappy: Delete API Key

Deletes an existing API key from Snappy.

```
DELETE https://connect.mindcloud.co/v1/universal/snappy/latest/actions/delete-api-key
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/snappy/latest/actions/delete-api-key?connectionId=$CONNECTION_ID&apiKeyId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/snappy/latest/actions/delete-api-key?${params}`, {
  headers: {
