# Survalyzer Universal API Authentication

Every Survalyzer API request through MindCloud uses a MindCloud API key and the `connectionId` of a Survalyzer connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Survalyzer connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Survalyzer action](README.md#actions-43) with your API key and `connectionId`.
