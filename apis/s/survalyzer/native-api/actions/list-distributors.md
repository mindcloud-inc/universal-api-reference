# List Distributors with Survalyzer

## Endpoint

- **Method:** `POST`
- **Path:** `/publicapi/Distribute/v3/ReadDistributorList`
- **Base URL:** `https://api.survalyzer-eu.app`
- **Official documentation:** [List Distributors](https://developer.survalyzer.com/knowledge-base/public-api-eu/)
