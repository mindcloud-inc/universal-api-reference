# List Surveys with Survalyzer

## Endpoint

- **Method:** `POST`
- **Path:** `/publicapi/Survey/v3/ReadSurveyList`
- **Base URL:** `https://api.survalyzer-eu.app`
- **Official documentation:** [List Surveys](https://developer.survalyzer.com/knowledge-base/public-api-eu/)
...
| `workspaceId` | body | `string` | no | The Survalyzer workspace identifier. |
