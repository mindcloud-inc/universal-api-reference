# Sumtracker: Create Purchase Order or Stock Transfer

Creates a purchase order or stock transfer in Sumtracker.

```
POST https://connect.mindcloud.co/v1/universal/sumtracker/latest/actions/create-order
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/sumtracker/latest/actions/create-order" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/sumtracker/latest/actions/create-order', {
  method: 'POST',
  headers: {
