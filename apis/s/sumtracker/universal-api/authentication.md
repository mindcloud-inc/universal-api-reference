# Sumtracker Universal API Authentication

Every Sumtracker API request through MindCloud uses a MindCloud API key and the `connectionId` of a Sumtracker connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Sumtracker connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Sumtracker action](README.md#actions-38) with your API key and `connectionId`.
