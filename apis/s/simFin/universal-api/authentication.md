# SimFin Universal API Authentication

Every SimFin API request through MindCloud uses a MindCloud API key and the `connectionId` of a SimFin connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SimFin connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SimFin action](README.md#actions-616) with your API key and `connectionId`.
