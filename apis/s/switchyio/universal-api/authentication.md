# Switchy.io Universal API Authentication

Every Switchy.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a Switchy.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Switchy.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Switchy.io action](README.md#actions-22) with your API key and `connectionId`.
