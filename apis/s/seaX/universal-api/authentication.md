# SeaX Universal API Authentication

Every SeaX API request through MindCloud uses a MindCloud API key and the `connectionId` of a SeaX connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SeaX connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SeaX action](README.md#actions-85) with your API key and `connectionId`.
