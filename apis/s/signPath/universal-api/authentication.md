# SignPath Universal API Authentication

Every SignPath API request through MindCloud uses a MindCloud API key and the `connectionId` of a SignPath connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SignPath connection.
