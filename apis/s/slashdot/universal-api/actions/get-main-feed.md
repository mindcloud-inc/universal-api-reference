# Slashdot: Get Main Feed

Retrieves the main feed from Slashdot.

```
GET https://connect.mindcloud.co/v1/universal/slashdot/latest/actions/get-main-feed
```
...
Through the native Slashdot API, this operation is `GET slashdotMain` (base URL `https://rss.slashdot.org/Slashdot/`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-main-feed.md) for the provider-specific parameters and requirements.
