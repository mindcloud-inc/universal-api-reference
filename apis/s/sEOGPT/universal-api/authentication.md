# SEO GPT Universal API Authentication

Every SEO GPT API request through MindCloud uses a MindCloud API key and the `connectionId` of a SEO GPT connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SEO GPT connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SEO GPT action](README.md#actions-20) with your API key and `connectionId`.
