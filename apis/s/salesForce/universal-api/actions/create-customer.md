# Salesforce: Create Customer



```
POST https://connect.mindcloud.co/v1/universal/salesForce/latest/actions/create-customer
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/salesForce/latest/actions/create-customer" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/salesForce/latest/actions/create-customer', {
  method: 'POST',
  headers: {
