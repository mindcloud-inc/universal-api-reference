# SEA-LION AI Playground Universal API Authentication

Every SEA-LION AI Playground API request through MindCloud uses a MindCloud API key and the `connectionId` of a SEA-LION AI Playground connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SEA-LION AI Playground connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SEA-LION AI Playground action](README.md#actions-6) with your API key and `connectionId`.
