# SEA-LION AI Playground: List Models



```
GET https://connect.mindcloud.co/v1/universal/sEALIONAIPlaygroundAPI/latest/actions/list-models
```
...
Through the native SEA-LION AI Playground API, this operation is `GET /models` (base URL `https://api.sea-lion.ai/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-models.md) for the provider-specific parameters and requirements.
