# Simpleen Translation: List Languages

Retrieves languages from Simpleen Translation.

```
GET https://connect.mindcloud.co/v1/universal/simpleenTranslation/latest/actions/list-languages
```
...
Through the native Simpleen Translation API, this operation is `GET /languages` (base URL `https://api.simpleen.io`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-languages.md) for the provider-specific parameters and requirements.
