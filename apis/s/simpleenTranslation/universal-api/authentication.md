# Simpleen Translation Universal API Authentication

Every Simpleen Translation API request through MindCloud uses a MindCloud API key and the `connectionId` of a Simpleen Translation connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Simpleen Translation connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Simpleen Translation action](README.md#actions-17) with your API key and `connectionId`.
