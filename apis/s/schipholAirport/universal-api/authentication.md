# Schiphol Airport Universal API Authentication

Every Schiphol Airport API request through MindCloud uses a MindCloud API key and the `connectionId` of a Schiphol Airport connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Schiphol Airport connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Schiphol Airport action](README.md#actions-8) with your API key and `connectionId`.
