# STEL Order Universal API Authentication

Every STEL Order API request through MindCloud uses a MindCloud API key and the `connectionId` of a STEL Order connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your STEL Order connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [STEL Order action](README.md#actions-30) with your API key and `connectionId`.
