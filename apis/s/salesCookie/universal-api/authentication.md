# Sales Cookie Universal API Authentication

Every Sales Cookie API request through MindCloud uses a MindCloud API key and the `connectionId` of a Sales Cookie connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Sales Cookie connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Sales Cookie action](README.md#actions-33) with your API key and `connectionId`.
