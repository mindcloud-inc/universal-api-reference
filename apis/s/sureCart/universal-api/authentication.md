# SureCart Universal API Authentication

Every SureCart API request through MindCloud uses a MindCloud API key and the `connectionId` of a SureCart connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SureCart connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SureCart action](README.md#actions-40) with your API key and `connectionId`.
