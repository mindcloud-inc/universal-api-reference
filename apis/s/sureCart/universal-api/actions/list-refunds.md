...
```
GET https://connect.mindcloud.co/v1/universal/sureCart/latest/actions/list-refunds
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/sureCart/latest/actions/list-refunds?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/sureCart/latest/actions/list-refunds?${params}`, {
  headers: {
