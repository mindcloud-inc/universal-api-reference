...
```
PUT https://connect.mindcloud.co/v1/universal/sureCart/latest/actions/update-product
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/sureCart/latest/actions/update-product" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/sureCart/latest/actions/update-product', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `id` | string | yes | The product ID to update. Example: `8434ff3e-c078-4902-8c86-1eb81cc59775`. |
| `product.name` | string | no | The updated product name. Example: `Updated Product`. |
