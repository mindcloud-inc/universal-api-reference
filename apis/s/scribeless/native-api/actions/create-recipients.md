# Create Recipients with Scribeless
...
- **Official documentation:** [Create Recipients](https://docs.scribeless.co/)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `campaignId` | body | `string` | yes | The Scribeless campaign ID that will receive the recipients. |
| `data[]` | body | `array<object>` | yes | Array of recipient payload objects for multiple Scribeless recipients. |
