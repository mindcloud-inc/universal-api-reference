# SIGNL4 Universal API Authentication

Every SIGNL4 API request through MindCloud uses a MindCloud API key and the `connectionId` of a SIGNL4 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SIGNL4 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SIGNL4 action](README.md#actions-47) with your API key and `connectionId`.
