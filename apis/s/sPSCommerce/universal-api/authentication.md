# SPS Commerce Universal API Authentication

Every SPS Commerce API request through MindCloud uses a MindCloud API key and the `connectionId` of a SPS Commerce connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SPS Commerce connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SPS Commerce action](README.md#actions-10) with your API key and `connectionId`.
