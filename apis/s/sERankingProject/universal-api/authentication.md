# SE Ranking Project Universal API Authentication

Every SE Ranking Project API request through MindCloud uses a MindCloud API key and the `connectionId` of a SE Ranking Project connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SE Ranking Project connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SE Ranking Project action](README.md#actions-30) with your API key and `connectionId`.
