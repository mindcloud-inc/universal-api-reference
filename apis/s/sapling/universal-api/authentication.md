# Sapling Universal API Authentication

Every Sapling API request through MindCloud uses a MindCloud API key and the `connectionId` of a Sapling connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Sapling connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Sapling action](README.md#actions-20) with your API key and `connectionId`.
