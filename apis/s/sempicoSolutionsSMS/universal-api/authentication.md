# Sempico Solutions SMS Universal API Authentication

Every Sempico Solutions SMS API request through MindCloud uses a MindCloud API key and the `connectionId` of a Sempico Solutions SMS connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Sempico Solutions SMS connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Sempico Solutions SMS action](README.md#actions-12) with your API key and `connectionId`.
