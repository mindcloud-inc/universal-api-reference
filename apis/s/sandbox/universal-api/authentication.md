# Sandbox Universal API Authentication

Every Sandbox API request through MindCloud uses a MindCloud API key and the `connectionId` of a Sandbox connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Sandbox connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Sandbox action](README.md#actions-2) with your API key and `connectionId`.
