...
Retrieves a list of users from Specific.

```
GET https://connect.mindcloud.co/v1/universal/specific/latest/actions/list-users
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/specific/latest/actions/list-users?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/specific/latest/actions/list-users?${params}`, {
  headers: {
