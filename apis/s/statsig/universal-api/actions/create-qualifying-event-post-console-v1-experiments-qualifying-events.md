# Statsig: Create Qualifying Event

Creates a qualifying event in Statsig.

```
POST https://connect.mindcloud.co/v1/universal/statsig/latest/actions/create-qualifying-event-post-console-v1-experiments-qualifying-events
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/statsig/latest/actions/create-qualifying-event-post-console-v1-experiments-qualifying-events" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/statsig/latest/actions/create-qualifying-event-post-console-v1-experiments-qualifying-events', {
  method: 'POST',
  headers: {
...
Through the native Statsig API, this operation is `POST /console/v1/experiments/qualifying_events` (base URL `https://statsigapi.net`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/create-qualifying-event-post-console-v1-experiments-qualifying-events.md) for the provider-specific parameters and requirements.
