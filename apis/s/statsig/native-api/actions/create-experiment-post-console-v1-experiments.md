# Create Experiment with Statsig
...
- **API:** rest
- **Official documentation:** [Create Experiment](https://docs.statsig.com/api-reference/experiments/create-experiment)
...
| `layerID` | body | `string` | no | Request body field. |
