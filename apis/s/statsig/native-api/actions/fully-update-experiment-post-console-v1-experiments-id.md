# Fully Update Experiment with Statsig
...
- **API:** rest
- **Official documentation:** [Fully Update Experiment](https://docs.statsig.com/api-reference/experiments/fully-update-experiment)
...
| `bonferroniCorrection` | body | `boolean` | yes | Request body field. |
...
| `defaultConfidenceInterval` | body | `string` | yes | Request body field. |
...
| `status` | body | `string` | yes | Request body field. |
