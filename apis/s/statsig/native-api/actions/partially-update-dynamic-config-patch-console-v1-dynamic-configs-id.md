# Partially Update Dynamic Config with Statsig
...
- **API:** rest
- **Official documentation:** [Partially Update Dynamic Config](https://docs.statsig.com/api-reference/dynamic-configs/partially-update-dynamic-config)
