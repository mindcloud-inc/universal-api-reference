# Update Qualifying Event with Statsig
...
- **Method:** `POST`
- **Path:** `/console/v1/experiments/qualifying_events/{name}`
- **Base URL:** `https://statsigapi.net`
- **API:** rest
- **Official documentation:** [Update Qualifying Event](https://docs.statsig.com/api-reference/experiments-warehouse-native/update-qualifying-event)
