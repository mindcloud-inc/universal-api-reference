# SMASHSEND Email Marketing: List Webhooks

Retrieves webhooks from your SMASHSEND workspace.

```
GET https://connect.mindcloud.co/v1/universal/sMASHSENDEmailMarketing/latest/actions/list-webhooks
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/sMASHSENDEmailMarketing/latest/actions/list-webhooks?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/sMASHSENDEmailMarketing/latest/actions/list-webhooks?${params}`, {
  headers: {
