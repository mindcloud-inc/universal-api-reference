# SMASHSEND Email Marketing Universal API Authentication

Every SMASHSEND Email Marketing API request through MindCloud uses a MindCloud API key and the `connectionId` of a SMASHSEND Email Marketing connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SMASHSEND Email Marketing connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [SMASHSEND Email Marketing action](README.md#actions-18) with your API key and `connectionId`.
