# SunriseSunset.org Universal API Authentication

Every SunriseSunset.org API request through MindCloud uses a MindCloud API key and the `connectionId` of a SunriseSunset.org connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your SunriseSunset.org connection.
