...
```
GET https://connect.mindcloud.co/v1/universal/scalr/latest/actions/list-accounts
```
...
Through the native Scalr API, this operation is `GET /accounts` (base URL `https://mindcloud.scalr.io/api/iacp/v3`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-accounts.md) for the provider-specific parameters and requirements.
