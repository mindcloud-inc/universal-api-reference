# Simplicate Universal API Authentication

Every Simplicate API request through MindCloud uses a MindCloud API key and the `connectionId` of a Simplicate connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Simplicate connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Simplicate action](README.md#actions-36) with your API key and `connectionId`.
