# Stitch Universal API Authentication

Every Stitch API request through MindCloud uses a MindCloud API key and the `connectionId` of a Stitch connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Stitch connection.
