# Xano Universal API Authentication

Every Xano API request through MindCloud uses a MindCloud API key and the `connectionId` of a Xano connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Xano connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Xano action](README.md#actions-34) with your API key and `connectionId`.
