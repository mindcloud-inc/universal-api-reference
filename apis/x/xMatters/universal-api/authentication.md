# xMatters Universal API Authentication

Every xMatters API request through MindCloud uses a MindCloud API key and the `connectionId` of a xMatters connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your xMatters connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [xMatters action](README.md#actions-164) with your API key and `connectionId`.
