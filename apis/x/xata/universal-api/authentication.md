# Xata Universal API Authentication

Every Xata API request through MindCloud uses a MindCloud API key and the `connectionId` of a Xata connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Xata connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Xata action](README.md#actions-45) with your API key and `connectionId`.
