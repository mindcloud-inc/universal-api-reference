# GAN.AI Universal API Authentication

Every GAN.AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a GAN.AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your GAN.AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [GAN.AI action](README.md#actions-28) with your API key and `connectionId`.
