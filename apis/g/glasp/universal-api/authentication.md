# Glasp Universal API Authentication

Every Glasp API request through MindCloud uses a MindCloud API key and the `connectionId` of a Glasp connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Glasp connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Glasp action](README.md#actions-4) with your API key and `connectionId`.
