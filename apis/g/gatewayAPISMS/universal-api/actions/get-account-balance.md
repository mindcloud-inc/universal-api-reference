# GatewayAPI SMS: Get Account Balance

Retrieves your GatewayAPI SMS account balance and currency.

```
GET https://connect.mindcloud.co/v1/universal/gatewayAPISMS/latest/actions/get-account-balance
```
