# GSA Per Diem Universal API Authentication

Every GSA Per Diem API request through MindCloud uses a MindCloud API key and the `connectionId` of a GSA Per Diem connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your GSA Per Diem connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [GSA Per Diem action](README.md#actions-6) with your API key and `connectionId`.
