...
```
POST https://connect.mindcloud.co/v1/universal/groq/latest/actions/create-speech
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/groq/latest/actions/create-speech" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/groq/latest/actions/create-speech', {
  method: 'POST',
  headers: {
