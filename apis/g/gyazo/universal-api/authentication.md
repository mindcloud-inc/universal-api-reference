# Gyazo Universal API Authentication

Every Gyazo API request through MindCloud uses a MindCloud API key and the `connectionId` of a Gyazo connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Gyazo connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Gyazo action](README.md#actions-7) with your API key and `connectionId`.
