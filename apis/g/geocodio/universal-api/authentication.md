# Geocodio Universal API Authentication

Every Geocodio API request through MindCloud uses a MindCloud API key and the `connectionId` of a Geocodio connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Geocodio connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Geocodio action](README.md#actions-16) with your API key and `connectionId`.
