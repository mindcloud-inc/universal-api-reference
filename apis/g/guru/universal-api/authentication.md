# Guru Universal API Authentication

Every Guru API request through MindCloud uses a MindCloud API key and the `connectionId` of a Guru connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Guru connection.
