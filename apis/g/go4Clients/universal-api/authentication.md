# Go4Clients Universal API Authentication

Every Go4Clients API request through MindCloud uses a MindCloud API key and the `connectionId` of a Go4Clients connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Go4Clients connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Go4Clients action](README.md#actions-29) with your API key and `connectionId`.
