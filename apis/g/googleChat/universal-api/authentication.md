# Google Chat Universal API Authentication

Every Google Chat API request through MindCloud uses a MindCloud API key and the `connectionId` of a Google Chat connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Google Chat connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Google Chat action](README.md#actions-6) with your API key and `connectionId`.
