# Google Forms Universal API Authentication

Every Google Forms API request through MindCloud uses a MindCloud API key and the `connectionId` of a Google Forms connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Google Forms connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Google Forms action](README.md#actions-31) with your API key and `connectionId`.
