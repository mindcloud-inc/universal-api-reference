# Gutendex Universal API Authentication

Every Gutendex API request through MindCloud uses a MindCloud API key and the `connectionId` of a Gutendex connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Gutendex connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Gutendex action](README.md#actions-15) with your API key and `connectionId`.
