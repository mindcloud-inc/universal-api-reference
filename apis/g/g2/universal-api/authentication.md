# G2 Universal API Authentication

Every G2 API request through MindCloud uses a MindCloud API key and the `connectionId` of a G2 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your G2 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [G2 action](README.md#actions-10) with your API key and `connectionId`.
