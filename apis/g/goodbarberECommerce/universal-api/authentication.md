# Goodbarber eCommerce Universal API Authentication

Every Goodbarber eCommerce API request through MindCloud uses a MindCloud API key and the `connectionId` of a Goodbarber eCommerce connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Goodbarber eCommerce connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Goodbarber eCommerce action](README.md#actions-31) with your API key and `connectionId`.
