# List Page Views with Goodbarber eCommerce

## Endpoint

- **Method:** `GET`
- **Path:** `/publicapi/v2/general/stats/:webzine_id/page_views/`
- **Base URL:** `https://commerce.goodbarber.dev`
- **Official documentation:** [List Page Views](https://commerce.goodbarber.dev/publicapi/v2/documentation/)
