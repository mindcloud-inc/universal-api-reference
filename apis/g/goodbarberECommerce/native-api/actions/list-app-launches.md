# List App Launches with Goodbarber eCommerce

## Endpoint

- **Method:** `GET`
- **Path:** `/publicapi/v2/general/stats/:webzine_id/launches/`
- **Base URL:** `https://commerce.goodbarber.dev`
- **Official documentation:** [List App Launches](https://commerce.goodbarber.dev/publicapi/v2/documentation/)
