# GoT Quotes Universal API Authentication

Every GoT Quotes API request through MindCloud uses a MindCloud API key and the `connectionId` of a GoT Quotes connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your GoT Quotes connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [GoT Quotes action](README.md#actions-8) with your API key and `connectionId`.
