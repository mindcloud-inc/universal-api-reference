...
```
PUT https://connect.mindcloud.co/v1/universal/goCardless/latest/actions/cancel-payment
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/goCardless/latest/actions/cancel-payment" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/goCardless/latest/actions/cancel-payment', {
  method: 'PUT',
  headers: {
