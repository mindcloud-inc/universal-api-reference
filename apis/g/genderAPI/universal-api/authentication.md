# Gender API Universal API Authentication

Every Gender API API request through MindCloud uses a MindCloud API key and the `connectionId` of a Gender API connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Gender API connection.
