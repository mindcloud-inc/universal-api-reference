...
```
POST https://connect.mindcloud.co/v1/universal/github/latest/actions/create-issue-comment
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/github/latest/actions/create-issue-comment" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/github/latest/actions/create-issue-comment', {
  method: 'POST',
  headers: {
...
| `issue_number` | number | yes | Issue or pull request number. |
