...
```
GET https://connect.mindcloud.co/v1/universal/github/latest/actions/get-repository
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/github/latest/actions/get-repository?connectionId=$CONNECTION_ID&owner=string&repo=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/github/latest/actions/get-repository?${params}`, {
  headers: {
