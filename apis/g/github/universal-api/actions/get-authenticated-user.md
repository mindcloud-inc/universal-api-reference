...
```
GET https://connect.mindcloud.co/v1/universal/github/latest/actions/get-authenticated-user
```
...
Through the native GitHub API, this operation is `GET /user` (base URL `https://api.github.com`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/get-authenticated-user.md) for the provider-specific parameters and requirements.
