# Google Maps Universal API Authentication

Every Google Maps API request through MindCloud uses a MindCloud API key and the `connectionId` of a Google Maps connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Google Maps connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Google Maps action](README.md#actions-3) with your API key and `connectionId`.
