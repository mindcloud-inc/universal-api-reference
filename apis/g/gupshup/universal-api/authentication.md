# Gupshup Universal API Authentication

Every Gupshup API request through MindCloud uses a MindCloud API key and the `connectionId` of a Gupshup connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Gupshup connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Gupshup action](README.md#actions-40) with your API key and `connectionId`.
