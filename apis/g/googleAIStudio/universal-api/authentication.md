# Google AI Studio Universal API Authentication

Every Google AI Studio API request through MindCloud uses a MindCloud API key and the `connectionId` of a Google AI Studio connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Google AI Studio connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Google AI Studio action](README.md#actions-18) with your API key and `connectionId`.
