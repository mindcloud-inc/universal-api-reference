# Google AI Studio: Stream Generate Content

Generates streamed content with a Gemini model in Google AI Studio.

```
POST https://connect.mindcloud.co/v1/universal/googleAIStudio/latest/actions/stream-generate-content
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/googleAIStudio/latest/actions/stream-generate-content" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/googleAIStudio/latest/actions/stream-generate-content', {
  method: 'POST',
  headers: {
