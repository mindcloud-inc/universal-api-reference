# Google AI Studio: List Files

Retrieves file metadata for your Google AI Studio project.

```
GET https://connect.mindcloud.co/v1/universal/googleAIStudio/latest/actions/list-files
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/googleAIStudio/latest/actions/list-files?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/googleAIStudio/latest/actions/list-files?${params}`, {
  headers: {
