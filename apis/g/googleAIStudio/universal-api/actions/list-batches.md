# Google AI Studio: List Batches

Retrieves batch operations from Google AI Studio.

```
GET https://connect.mindcloud.co/v1/universal/googleAIStudio/latest/actions/list-batches
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/googleAIStudio/latest/actions/list-batches?${params}`, {
  headers: {
