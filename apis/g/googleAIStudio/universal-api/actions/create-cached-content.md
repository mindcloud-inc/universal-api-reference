# Google AI Studio: Create Cached Content

Creates a cached content entry in Google AI Studio.

```
POST https://connect.mindcloud.co/v1/universal/googleAIStudio/latest/actions/create-cached-content
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/googleAIStudio/latest/actions/create-cached-content" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/googleAIStudio/latest/actions/create-cached-content', {
  method: 'POST',
  headers: {
