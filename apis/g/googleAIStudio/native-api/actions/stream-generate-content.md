# Stream Generate Content with Google AI Studio
...
- **Official documentation:** [Stream Generate Content](https://ai.google.dev/api/generate-content)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `model` | path | `string` | yes | Required. Model endpoint token including suffix, for example `gemini-2.5-flash:streamGenerateContent`. |
