# GoDaddy CRM Universal API Authentication

Every GoDaddy CRM API request through MindCloud uses a MindCloud API key and the `connectionId` of a GoDaddy CRM connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your GoDaddy CRM connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [GoDaddy CRM action](README.md#actions-39) with your API key and `connectionId`.
