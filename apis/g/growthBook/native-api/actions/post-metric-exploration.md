# Create a Metric based visualization with GrowthBook
...
- **Method:** `POST`
- **Path:** `/product-analytics/metric-exploration`
- **Base URL:** `https://api.growthbook.io/api/v1`
- **Official documentation:** [Create a Metric based visualization](https://docs.growthbook.io/api)
