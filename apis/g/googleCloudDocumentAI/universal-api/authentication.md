# Google Cloud Document AI Universal API Authentication

Every Google Cloud Document AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Google Cloud Document AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Google Cloud Document AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Google Cloud Document AI action](README.md#actions-40) with your API key and `connectionId`.
