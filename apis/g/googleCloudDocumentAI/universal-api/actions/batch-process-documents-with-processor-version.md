# Google Cloud Document AI: Batch Process Documents With Processor Version

Batch processes documents with a Google Cloud Document AI processor version.

```
GET https://connect.mindcloud.co/v1/universal/googleCloudDocumentAI/latest/actions/batch-process-documents-with-processor-version
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/googleCloudDocumentAI/latest/actions/batch-process-documents-with-processor-version?connectionId=$CONNECTION_ID&processorsId=string&processorVersionsId=string&inputDocuments=%5Bobject%20Object%5D&documentOutputConfig=%5Bobject%20Object%5D" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/googleCloudDocumentAI/latest/actions/batch-process-documents-with-processor-version?${params}`, {
  headers: {
