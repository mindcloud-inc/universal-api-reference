# GetSales.io Universal API Authentication

Every GetSales.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a GetSales.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your GetSales.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [GetSales.io action](README.md#actions-25) with your API key and `connectionId`.
