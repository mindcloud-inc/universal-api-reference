# Goldbelly Universal API Authentication

Every Goldbelly API request through MindCloud uses a MindCloud API key and the `connectionId` of a Goldbelly connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Goldbelly connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Goldbelly action](README.md#actions-10) with your API key and `connectionId`.
