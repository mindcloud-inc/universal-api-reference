# Google Dialogflow: Get Page

Retrieves a page from Google Dialogflow.

```
GET https://connect.mindcloud.co/v1/universal/googleDialogflow/latest/actions/get-page
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/googleDialogflow/latest/actions/get-page?connectionId=$CONNECTION_ID&name=projects%2Fmy-project%2Flocations%2Fglobal%2Fagents%2Fagent-id%2Fflows%2Fflow-id%2Fpages%2Fpage-id" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/googleDialogflow/latest/actions/get-page?${params}`, {
  headers: {
