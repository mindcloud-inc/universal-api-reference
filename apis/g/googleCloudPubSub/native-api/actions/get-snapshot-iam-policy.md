# Get Snapshot IAM Policy with Google Cloud Pub/Sub
...
- **Official documentation:** [Get Snapshot IAM Policy](https://docs.cloud.google.com/pubsub/docs/reference/rest/v1/projects.snapshots/getIamPolicy)
