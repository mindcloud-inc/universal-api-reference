# Get Schema IAM Policy with Google Cloud Pub/Sub
...
- **Official documentation:** [Get Schema IAM Policy](https://docs.cloud.google.com/pubsub/docs/reference/rest/v1/projects.schemas/getIamPolicy)
