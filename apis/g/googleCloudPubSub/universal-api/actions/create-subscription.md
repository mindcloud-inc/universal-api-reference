...
```
POST https://connect.mindcloud.co/v1/universal/googleCloudPubSub/latest/actions/create-subscription
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/googleCloudPubSub/latest/actions/create-subscription" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/googleCloudPubSub/latest/actions/create-subscription', {
  method: 'POST',
  headers: {
