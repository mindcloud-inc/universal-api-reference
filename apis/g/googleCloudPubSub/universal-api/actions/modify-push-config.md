# Google Cloud Pub/Sub: Modify Push Config

Modifies a subscription push config in Google Cloud Pub/Sub.

```
PUT https://connect.mindcloud.co/v1/universal/googleCloudPubSub/latest/actions/modify-push-config
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/googleCloudPubSub/latest/actions/modify-push-config" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/googleCloudPubSub/latest/actions/modify-push-config', {
  method: 'PUT',
  headers: {
