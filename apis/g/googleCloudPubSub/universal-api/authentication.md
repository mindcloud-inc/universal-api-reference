# Google Cloud Pub/Sub Universal API Authentication

Every Google Cloud Pub/Sub API request through MindCloud uses a MindCloud API key and the `connectionId` of a Google Cloud Pub/Sub connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Google Cloud Pub/Sub connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Google Cloud Pub/Sub action](README.md#actions-46) with your API key and `connectionId`.
