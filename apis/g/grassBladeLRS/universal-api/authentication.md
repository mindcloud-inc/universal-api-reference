# GrassBlade LRS Universal API Authentication

Every GrassBlade LRS API request through MindCloud uses a MindCloud API key and the `connectionId` of a GrassBlade LRS connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your GrassBlade LRS connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [GrassBlade LRS action](README.md#actions-33) with your API key and `connectionId`.
