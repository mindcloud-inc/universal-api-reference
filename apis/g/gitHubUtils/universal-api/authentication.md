# GitHub Utils Universal API Authentication

Every GitHub Utils API request through MindCloud uses a MindCloud API key and the `connectionId` of a GitHub Utils connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your GitHub Utils connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [GitHub Utils action](README.md#actions-24) with your API key and `connectionId`.
