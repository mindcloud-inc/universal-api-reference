# GitHub Utils: Native API Reference

A consolidated summary of GitHub Utils's API configuration and 24 documented operations, with links to official documentation.
...
Connect with GitHub OAuth to access repository and workflow utility actions.
...
Requested scopes: `repo read:user user:email workflow`.
...
Use `per_page` in the query string to set the page size (maximum 100). Use `page` in the query string to choose the page; numbering starts at 1. Follow the complete next-page URL returned by the API.
