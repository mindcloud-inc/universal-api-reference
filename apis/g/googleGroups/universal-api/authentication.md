# Google Groups Universal API Authentication

Every Google Groups API request through MindCloud uses a MindCloud API key and the `connectionId` of a Google Groups connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Google Groups connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Google Groups action](README.md#actions-19) with your API key and `connectionId`.
