# Google Groups: Patch Group

Updates an existing group in Google Groups.

```
PUT https://connect.mindcloud.co/v1/universal/googleGroups/latest/actions/patch-group
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/googleGroups/latest/actions/patch-group" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/googleGroups/latest/actions/patch-group', {
  method: 'PUT',
  headers: {
