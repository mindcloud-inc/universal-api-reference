# Google Groups: Patch Group Settings

Updates group settings in Google Groups.

```
PUT https://connect.mindcloud.co/v1/universal/googleGroups/latest/actions/patch-group-settings
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/googleGroups/latest/actions/patch-group-settings" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/googleGroups/latest/actions/patch-group-settings', {
  method: 'PUT',
  headers: {
