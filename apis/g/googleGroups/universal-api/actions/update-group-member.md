# Google Groups: Update Group Member

Replaces an existing group member in Google Groups.

```
PUT https://connect.mindcloud.co/v1/universal/googleGroups/latest/actions/update-group-member
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/googleGroups/latest/actions/update-group-member" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/googleGroups/latest/actions/update-group-member', {
  method: 'PUT',
  headers: {
