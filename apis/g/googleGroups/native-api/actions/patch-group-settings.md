# Patch Group Settings with Google Groups
...
- **Official documentation:** [Patch Group Settings](https://developers.google.com/workspace/admin/groups-settings/v1/reference/groups/patch)
