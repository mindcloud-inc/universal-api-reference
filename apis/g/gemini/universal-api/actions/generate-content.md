...
Generates content with a Gemini model.

```
POST https://connect.mindcloud.co/v1/universal/gemini/latest/actions/generate-content
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/gemini/latest/actions/generate-content" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/gemini/latest/actions/generate-content', {
  method: 'POST',
  headers: {
