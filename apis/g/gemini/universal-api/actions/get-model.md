...
```
GET https://connect.mindcloud.co/v1/universal/gemini/latest/actions/get-model
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/gemini/latest/actions/get-model?connectionId=$CONNECTION_ID&model=gemini-2.5-flash" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/gemini/latest/actions/get-model?${params}`, {
  headers: {
