# Gemini: List Cached Contents

Retrieves a list of cached content resources from Gemini.

```
GET https://connect.mindcloud.co/v1/universal/gemini/latest/actions/list-cached-contents
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/gemini/latest/actions/list-cached-contents?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/gemini/latest/actions/list-cached-contents?${params}`, {
  headers: {
