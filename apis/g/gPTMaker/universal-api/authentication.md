# GPT Maker Universal API Authentication

Every GPT Maker API request through MindCloud uses a MindCloud API key and the `connectionId` of a GPT Maker connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your GPT Maker connection.
