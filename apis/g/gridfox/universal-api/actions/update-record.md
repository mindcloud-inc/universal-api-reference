# Gridfox: Update Record

Updates an existing record in a Gridfox table.

```
PUT https://connect.mindcloud.co/v1/universal/gridfox/latest/actions/update-record
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/gridfox/latest/actions/update-record" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/gridfox/latest/actions/update-record', {
  method: 'PUT',
  headers: {
