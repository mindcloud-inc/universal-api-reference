...
```
GET https://connect.mindcloud.co/v1/universal/gridfox/latest/actions/get-record
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/gridfox/latest/actions/get-record?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/gridfox/latest/actions/get-record?${params}`, {
  headers: {
