# Google Drive Universal API Authentication

Every Google Drive API request through MindCloud uses a MindCloud API key and the `connectionId` of a Google Drive connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Google Drive connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Google Drive action](README.md#actions-13) with your API key and `connectionId`.
