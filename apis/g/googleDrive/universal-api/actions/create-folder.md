...
```
POST https://connect.mindcloud.co/v1/universal/googleDrive/latest/actions/create-folder
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/googleDrive/latest/actions/create-folder" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/googleDrive/latest/actions/create-folder', {
  method: 'POST',
  headers: {
...
| --- | --- | --- | --- |
| `name` | string | yes | Give the new Folder a name. |
