# Google Drive: List Documents

Finds documents in Google Drive by query.

```
GET https://connect.mindcloud.co/v1/universal/googleDrive/latest/actions/list-documents
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/googleDrive/latest/actions/list-documents?${params}`, {
  headers: {
...
| `shared` | boolean | Whether the document is shared. |
| `webViewLink` | string | Link to open the document in Google Drive. |
