# GSA Public Comment Universal API Authentication

Every GSA Public Comment API request through MindCloud uses a MindCloud API key and the `connectionId` of a GSA Public Comment connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your GSA Public Comment connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [GSA Public Comment action](README.md#actions-7) with your API key and `connectionId`.
