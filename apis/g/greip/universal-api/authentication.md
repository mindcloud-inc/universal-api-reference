# Greip - Fraud Prevention Universal API Authentication

Every Greip - Fraud Prevention API request through MindCloud uses a MindCloud API key and the `connectionId` of a Greip - Fraud Prevention connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Greip - Fraud Prevention connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Greip - Fraud Prevention action](README.md#actions-15) with your API key and `connectionId`.
