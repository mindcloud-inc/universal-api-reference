# Grand Avenue Software Universal API Authentication

Every Grand Avenue Software API request through MindCloud uses a MindCloud API key and the `connectionId` of a Grand Avenue Software connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Grand Avenue Software connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Grand Avenue Software action](README.md#actions-78) with your API key and `connectionId`.
