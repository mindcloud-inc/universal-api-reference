# GoSquared: List Sites

Retrieves sites from the connected GoSquared account.

```
GET https://connect.mindcloud.co/v1/universal/goSquared/latest/actions/list-sites
```
...
| --- | --- | --- | --- |
| `presenter` | string | no | Modifies the response data structure. Default: `flat`. |
