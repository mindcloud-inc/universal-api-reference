# GoSquared: List Devices

Retrieves visitor devices tracked in GoSquared.

```
GET https://connect.mindcloud.co/v1/universal/goSquared/latest/actions/list-devices
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/goSquared/latest/actions/list-devices?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/goSquared/latest/actions/list-devices?${params}`, {
  headers: {
