# GoSquared: List Event Types

Retrieves person event types from GoSquared.

```
GET https://connect.mindcloud.co/v1/universal/goSquared/latest/actions/list-event-types
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/goSquared/latest/actions/list-event-types?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/goSquared/latest/actions/list-event-types?${params}`, {
  headers: {
