# Get Website Report Universal API Authentication

Every Get Website Report API request through MindCloud uses a MindCloud API key and the `connectionId` of a Get Website Report connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Get Website Report connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Get Website Report action](README.md#actions-14) with your API key and `connectionId`.
