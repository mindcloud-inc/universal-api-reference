# Google Search Console Universal API Authentication

Every Google Search Console API request through MindCloud uses a MindCloud API key and the `connectionId` of a Google Search Console connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Google Search Console connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Google Search Console action](README.md#actions-10) with your API key and `connectionId`.
