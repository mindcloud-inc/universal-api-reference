# Global Patron Universal API Authentication

Every Global Patron API request through MindCloud uses a MindCloud API key and the `connectionId` of a Global Patron connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Global Patron connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Global Patron action](README.md#actions-36) with your API key and `connectionId`.
