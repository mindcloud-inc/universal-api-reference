# Google Ads Universal API Authentication

Every Google Ads API request through MindCloud uses a MindCloud API key and the `connectionId` of a Google Ads connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Google Ads connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Google Ads action](README.md#actions-93) with your API key and `connectionId`.
