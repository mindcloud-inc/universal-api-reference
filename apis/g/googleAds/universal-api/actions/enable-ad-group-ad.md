# Google Ads: Enable Ad Group Ad

Updates an ad group ad to enabled status in Google Ads.

```
PUT https://connect.mindcloud.co/v1/universal/googleAds/latest/actions/enable-ad-group-ad
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/googleAds/latest/actions/enable-ad-group-ad" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/googleAds/latest/actions/enable-ad-group-ad', {
  method: 'PUT',
  headers: {
