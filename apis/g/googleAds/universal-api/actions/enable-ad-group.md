# Google Ads: Enable Ad Group

Updates an ad group to enabled status in Google Ads.

```
PUT https://connect.mindcloud.co/v1/universal/googleAds/latest/actions/enable-ad-group
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/googleAds/latest/actions/enable-ad-group" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/googleAds/latest/actions/enable-ad-group', {
  method: 'PUT',
  headers: {
