# Google Ads: Enable Keyword Criterion

Updates a keyword criterion to enabled status in Google Ads.

```
PUT https://connect.mindcloud.co/v1/universal/googleAds/latest/actions/enable-keyword-criterion
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/googleAds/latest/actions/enable-keyword-criterion" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/googleAds/latest/actions/enable-keyword-criterion', {
  method: 'PUT',
  headers: {
