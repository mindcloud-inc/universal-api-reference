...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/googleAds/latest/actions/remove-ad-group-ad?connectionId=$CONNECTION_ID&customerId=1234567890&operations%5B%5D.remove=string" \
