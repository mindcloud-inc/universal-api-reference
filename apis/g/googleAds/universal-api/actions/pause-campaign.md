...
```
PUT https://connect.mindcloud.co/v1/universal/googleAds/latest/actions/pause-campaign
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/googleAds/latest/actions/pause-campaign" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/googleAds/latest/actions/pause-campaign', {
  method: 'PUT',
  headers: {
