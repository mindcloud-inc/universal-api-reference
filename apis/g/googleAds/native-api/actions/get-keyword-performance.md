# Get Keyword Performance with Google Ads
...
- **API:** REST
- **Official documentation:** [Get Keyword Performance](https://developers.google.com/google-ads/api/reference/rpc/v22/GoogleAdsService/Search)
