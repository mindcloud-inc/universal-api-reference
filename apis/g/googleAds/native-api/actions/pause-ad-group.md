# Pause Ad Group with Google Ads
...
- **API:** REST
- **Official documentation:** [Pause Ad Group](https://developers.google.com/google-ads/api/reference/rpc/v22/AdGroupService/MutateAdGroups)
