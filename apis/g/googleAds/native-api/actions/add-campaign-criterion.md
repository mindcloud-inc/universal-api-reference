# Add Campaign Criterion with Google Ads
...
- **API:** REST
- **Official documentation:** [Add Campaign Criterion](https://developers.google.com/google-ads/api/reference/rpc/v22/CampaignCriterionService/MutateCampaignCriteria)
