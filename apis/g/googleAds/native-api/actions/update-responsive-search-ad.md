# Update Responsive Search Ad with Google Ads
...
- **API:** REST
- **Official documentation:** [Update Responsive Search Ad](https://developers.google.com/google-ads/api/reference/rpc/v22/AdGroupAdService/MutateAdGroupAds)
