# List Recommendations with Google Ads
...
- **API:** REST
- **Official documentation:** [List Recommendations](https://developers.google.com/google-ads/api/reference/rpc/v22/GoogleAdsService/Search)
