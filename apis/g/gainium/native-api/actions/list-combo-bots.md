# List Combo Bots with Gainium

## Endpoint

- **Method:** `GET`
- **Path:** `/api/v2/bots/combo`
- **Base URL:** `https://api.gainium.io`
- **Official documentation:** [List Combo Bots](https://api.gainium.io/api/docs/v2#/Bots%20-%20Combo/getComboBots)
