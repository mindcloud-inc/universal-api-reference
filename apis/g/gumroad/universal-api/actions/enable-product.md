...
Enables a product in Gumroad.

```
PUT https://connect.mindcloud.co/v1/universal/gumroad/latest/actions/enable-product
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/gumroad/latest/actions/enable-product" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/gumroad/latest/actions/enable-product', {
  method: 'PUT',
  headers: {
...
Through the native Gumroad API, this operation is `PUT /products/:id/enable` (base URL `https://api.gumroad.com/v2`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/enable-product.md) for the provider-specific parameters and requirements.
