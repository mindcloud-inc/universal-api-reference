# Jooto: List Organizations



```
GET https://connect.mindcloud.co/v1/universal/jooto/latest/actions/list-organizations
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/jooto/latest/actions/list-organizations?${params}`, {
  headers: {
