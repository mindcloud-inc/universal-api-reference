# Jottacloud Universal API Authentication

Every Jottacloud API request through MindCloud uses a MindCloud API key and the `connectionId` of a Jottacloud connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Jottacloud connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Jottacloud action](README.md#actions-18) with your API key and `connectionId`.
