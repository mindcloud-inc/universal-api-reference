# JVZoo: Get Latest Transactions

Retrieves latest transactions across your JVZoo products.

```
GET https://connect.mindcloud.co/v1/universal/jVZoo/latest/actions/get-latest-transactions
```
...
Through the native JVZoo API, this operation is `GET /latest-transactions/[:paykey]` (base URL `https://api.jvzoo.com/v2.0`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-latest-transactions.md) for the provider-specific parameters and requirements.
