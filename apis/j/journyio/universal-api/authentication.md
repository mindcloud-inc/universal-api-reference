# Journy.io Universal API Authentication

Every Journy.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a Journy.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Journy.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Journy.io action](README.md#actions-15) with your API key and `connectionId`.
