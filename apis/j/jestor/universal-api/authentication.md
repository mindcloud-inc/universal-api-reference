# Jestor Universal API Authentication

Every Jestor API request through MindCloud uses a MindCloud API key and the `connectionId` of a Jestor connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Jestor connection.
