# Jotform Universal API Authentication

Every Jotform API request through MindCloud uses a MindCloud API key and the `connectionId` of a Jotform connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Jotform connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Jotform action](README.md#actions-33) with your API key and `connectionId`.
