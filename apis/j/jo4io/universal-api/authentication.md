# jo4.io Universal API Authentication

Every jo4.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a jo4.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your jo4.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [jo4.io action](README.md#actions-30) with your API key and `connectionId`.
