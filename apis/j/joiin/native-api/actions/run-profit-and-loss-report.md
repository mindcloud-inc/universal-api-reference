# Run Profit and Loss Report with Joiin
...
- **Method:** `POST`
- **Path:** `/v1/report/profit-loss`
- **Base URL:** `https://app-api.joiin.co`
- **Official documentation:** [Run Profit and Loss Report](https://app.joiin.co/reference/run_profit_and_loss_report)
...
| `categoryName` | body | `string` | no | The category name to filter the report by. |
| `categoryOptionNames[]` | body | `array<string>` | no | Category option names to include in the report. |
