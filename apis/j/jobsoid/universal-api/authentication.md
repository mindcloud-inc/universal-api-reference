# Jobsoid Universal API Authentication

Every Jobsoid API request through MindCloud uses a MindCloud API key and the `connectionId` of a Jobsoid connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Jobsoid connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Jobsoid action](README.md#actions-6) with your API key and `connectionId`.
