# Jira Software Cloud Universal API Authentication

Every Jira Software Cloud API request through MindCloud uses a MindCloud API key and the `connectionId` of a Jira Software Cloud connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Jira Software Cloud connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Jira Software Cloud action](README.md#actions-24) with your API key and `connectionId`.
