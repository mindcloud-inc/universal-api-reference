# Jira Software Cloud: Add Comment

Creates a new comment in Jira Software Cloud.

```
POST https://connect.mindcloud.co/v1/universal/jiraSoftwareCloud/latest/actions/add-comment
```
...
| --- | --- | --- | --- |
| `body` | object | yes | Atlassian Document Format comment body payload. |
