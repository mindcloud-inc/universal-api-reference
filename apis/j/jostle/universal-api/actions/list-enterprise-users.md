# Jostle: List Enterprise Users



```
GET https://connect.mindcloud.co/v1/universal/jostle/latest/actions/list-enterprise-users
```
...
Through the native Jostle API, this operation is `GET /v2/people` (base URL `https://api-prod.jostle.us`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-enterprise-users.md) for the provider-specific parameters and requirements.
