# Qase Universal API Authentication

Every Qase API request through MindCloud uses a MindCloud API key and the `connectionId` of a Qase connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Qase connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Qase action](README.md#actions-83) with your API key and `connectionId`.
