# Quantum Digital Universal API Authentication

Every Quantum Digital API request through MindCloud uses a MindCloud API key and the `connectionId` of a Quantum Digital connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Quantum Digital connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Quantum Digital action](README.md#actions-15) with your API key and `connectionId`.
