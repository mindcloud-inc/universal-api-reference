# Quiz Maker Universal API Authentication

Every Quiz Maker API request through MindCloud uses a MindCloud API key and the `connectionId` of a Quiz Maker connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Quiz Maker connection.
