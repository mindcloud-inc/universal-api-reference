...
```
GET https://connect.mindcloud.co/v1/universal/qWIC/latest/actions/fetch-bot-flow
```
...
Through the native QWIC API, this operation is `GET /v1/bots/:bot_id/flow` (base URL `https://app.qwic.ai`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/fetch-bot-flow.md) for the provider-specific parameters and requirements.
