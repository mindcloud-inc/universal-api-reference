# Quickbase Universal API Authentication

Every Quickbase API request through MindCloud uses a MindCloud API key and the `connectionId` of a Quickbase connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Quickbase connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Quickbase action](README.md#actions-20) with your API key and `connectionId`.
