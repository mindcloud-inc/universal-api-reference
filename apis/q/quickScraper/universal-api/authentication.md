# Quick Scraper Universal API Authentication

Every Quick Scraper API request through MindCloud uses a MindCloud API key and the `connectionId` of a Quick Scraper connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Quick Scraper connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Quick Scraper action](README.md#actions-2) with your API key and `connectionId`.
