# Qryptal Universal API Authentication

Every Qryptal API request through MindCloud uses a MindCloud API key and the `connectionId` of a Qryptal connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Qryptal connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Qryptal action](README.md#actions-4) with your API key and `connectionId`.
