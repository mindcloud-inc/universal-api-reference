# Get Async Attributed Actions Report Download URL with Quantcast
...
- **Official documentation:** [Get Async Attributed Actions Report Download URL](https://developers.quantcast.com/docs/graphql-api/reference/queries/)
