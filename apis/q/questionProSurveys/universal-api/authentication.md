# QuestionPro Surveys Universal API Authentication

Every QuestionPro Surveys API request through MindCloud uses a MindCloud API key and the `connectionId` of a QuestionPro Surveys connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your QuestionPro Surveys connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [QuestionPro Surveys action](README.md#actions-25) with your API key and `connectionId`.
