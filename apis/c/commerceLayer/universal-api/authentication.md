# Commerce Layer Universal API Authentication

Every Commerce Layer API request through MindCloud uses a MindCloud API key and the `connectionId` of a Commerce Layer connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Commerce Layer connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Commerce Layer action](README.md#actions-59) with your API key and `connectionId`.
