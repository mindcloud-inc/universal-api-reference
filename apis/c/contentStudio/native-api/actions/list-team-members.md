# List Team Members with ContentStudio
...
- **Method:** `GET`
- **Path:** `/workspaces/:workspace_id/team-members`
- **Base URL:** `https://api.contentstudio.io/api/v1`
- **Official documentation:** [List Team Members](https://api-prod.contentstudio.io/scalar)
