# CallPage: Delete User

Deletes an existing user from CallPage.

```
DELETE https://connect.mindcloud.co/v1/universal/callPage/latest/actions/delete-user
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/callPage/latest/actions/delete-user?connectionId=$CONNECTION_ID&id=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/callPage/latest/actions/delete-user?${params}`, {
  headers: {
