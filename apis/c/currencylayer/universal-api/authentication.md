# Currencylayer Universal API Authentication

Every Currencylayer API request through MindCloud uses a MindCloud API key and the `connectionId` of a Currencylayer connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Currencylayer connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Currencylayer action](README.md#actions-16) with your API key and `connectionId`.
