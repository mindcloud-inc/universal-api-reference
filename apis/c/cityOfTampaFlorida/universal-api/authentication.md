# City of Tampa, Florida Universal API Authentication

Every City of Tampa, Florida API request through MindCloud uses a MindCloud API key and the `connectionId` of a City of Tampa, Florida connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your City of Tampa, Florida connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [City of Tampa, Florida action](README.md#actions-20) with your API key and `connectionId`.
