# Cin7 Core Universal API Authentication

Every Cin7 Core API request through MindCloud uses a MindCloud API key and the `connectionId` of a Cin7 Core connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Cin7 Core connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Cin7 Core action](README.md#actions-15) with your API key and `connectionId`.
