# CleverReach: List Groups

Retrieves receiver groups from your CleverReach account.

```
GET https://connect.mindcloud.co/v1/universal/cleverReach/latest/actions/list-groups
```
...
| --- | --- | --- | --- |
| `order` | string | no | order by statement (created ASC or DESC, changed ASC or DESC). |
