# CleverReach: Get Report

Retrieves a report from CleverReach by report ID.

```
GET https://connect.mindcloud.co/v1/universal/cleverReach/latest/actions/get-report
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/cleverReach/latest/actions/get-report?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/cleverReach/latest/actions/get-report?${params}`, {
  headers: {
