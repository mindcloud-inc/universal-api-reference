# Normalize Street Address with Cloudmersive
...
- **Method:** `POST`
- **Path:** `/validate/address/street-address/normalize`
- **Base URL:** `https://api.cloudmersive.com`
- **Official documentation:** [Normalize Street Address](https://api.cloudmersive.com/docs/validate.asp#operation--validate-address-street-address-normalize-post)
...
| `StreetAddress` | body | `string` | no | Street address to normalize. |
