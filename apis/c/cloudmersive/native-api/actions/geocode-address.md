# Geocode Address with Cloudmersive
...
- **Method:** `POST`
- **Path:** `/validate/address/geocode`
- **Base URL:** `https://api.cloudmersive.com`
- **Official documentation:** [Geocode Address](https://api.cloudmersive.com/docs/validate.asp#operation--validate-address-geocode-post)
...
| `StreetAddress` | body | `string` | no | Street address to geocode. |
