# Cloudmersive Security Universal API Authentication

Every Cloudmersive Security API request through MindCloud uses a MindCloud API key and the `connectionId` of a Cloudmersive Security connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Cloudmersive Security connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Cloudmersive Security action](README.md#actions-9) with your API key and `connectionId`.
