# Callingly: Create Agent

Creates an agent in Callingly.

```
POST https://connect.mindcloud.co/v1/universal/callingly/latest/actions/create-agent
```
