# Columns AI Universal API Authentication

Every Columns AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Columns AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Columns AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Columns AI action](README.md#actions-3) with your API key and `connectionId`.
