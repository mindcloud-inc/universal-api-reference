# List Bill Cosponsors with Congress.gov
...
- **Official documentation:** [List Bill Cosponsors](https://github.com/LibraryOfCongress/api.congress.gov/blob/main/Documentation/BillEndpoint.md)
