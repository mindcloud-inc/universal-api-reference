# List Bill Summaries with Congress.gov
...
- **Official documentation:** [List Bill Summaries](https://github.com/LibraryOfCongress/api.congress.gov/blob/main/Documentation/BillEndpoint.md)
