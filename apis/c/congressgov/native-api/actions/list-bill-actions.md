# List Bill Actions with Congress.gov
...
- **Official documentation:** [List Bill Actions](https://github.com/LibraryOfCongress/api.congress.gov/blob/main/Documentation/BillEndpoint.md)
