# List Bill Text Versions with Congress.gov
...
- **Official documentation:** [List Bill Text Versions](https://github.com/LibraryOfCongress/api.congress.gov/blob/main/Documentation/BillEndpoint.md)
