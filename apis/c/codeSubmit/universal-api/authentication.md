# CodeSubmit Universal API Authentication

Every CodeSubmit API request through MindCloud uses a MindCloud API key and the `connectionId` of a CodeSubmit connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CodeSubmit connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [CodeSubmit action](README.md#actions-40) with your API key and `connectionId`.
