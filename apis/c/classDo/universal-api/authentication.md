# ClassDo Universal API Authentication

Every ClassDo API request through MindCloud uses a MindCloud API key and the `connectionId` of a ClassDo connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ClassDo connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ClassDo action](README.md#actions-15) with your API key and `connectionId`.
