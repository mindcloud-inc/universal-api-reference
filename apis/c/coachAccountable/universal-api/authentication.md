# CoachAccountable Universal API Authentication

Every CoachAccountable API request through MindCloud uses a MindCloud API key and the `connectionId` of a CoachAccountable connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CoachAccountable connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [CoachAccountable action](README.md#actions-99) with your API key and `connectionId`.
