# Chat Aid Universal API Authentication

Every Chat Aid API request through MindCloud uses a MindCloud API key and the `connectionId` of a Chat Aid connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Chat Aid connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Chat Aid action](README.md#actions-7) with your API key and `connectionId`.
