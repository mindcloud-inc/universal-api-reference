# Common Ninja Universal API Authentication

Every Common Ninja API request through MindCloud uses a MindCloud API key and the `connectionId` of a Common Ninja connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Common Ninja connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Common Ninja action](README.md#actions-18) with your API key and `connectionId`.
