# Centerpoint Universal API Authentication

Every Centerpoint API request through MindCloud uses a MindCloud API key and the `connectionId` of a Centerpoint connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Centerpoint connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Centerpoint action](README.md#actions-66) with your API key and `connectionId`.
