# Castor EDC Universal API Authentication

Every Castor EDC API request through MindCloud uses a MindCloud API key and the `connectionId` of a Castor EDC connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Castor EDC connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Castor EDC action](README.md#actions-36) with your API key and `connectionId`.
