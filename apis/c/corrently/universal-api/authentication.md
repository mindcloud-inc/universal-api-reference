# Corrently Universal API Authentication

Every Corrently API request through MindCloud uses a MindCloud API key and the `connectionId` of a Corrently connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Corrently connection.
