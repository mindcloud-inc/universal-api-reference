...
```
POST https://connect.mindcloud.co/v1/universal/confluenceCloud/latest/actions/create-page
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/confluenceCloud/latest/actions/create-page" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/confluenceCloud/latest/actions/create-page', {
  method: 'POST',
  headers: {
