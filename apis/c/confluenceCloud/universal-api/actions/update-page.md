...
```
PUT https://connect.mindcloud.co/v1/universal/confluenceCloud/latest/actions/update-page
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/confluenceCloud/latest/actions/update-page" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/confluenceCloud/latest/actions/update-page', {
  method: 'PUT',
  headers: {
...
| `pageBodyId` | string | yes | Page ID required in the request body for Confluence page updates. |
