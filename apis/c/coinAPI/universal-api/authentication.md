# CoinAPI Universal API Authentication

Every CoinAPI API request through MindCloud uses a MindCloud API key and the `connectionId` of a CoinAPI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CoinAPI connection.
