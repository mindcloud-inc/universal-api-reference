# Caltrain Universal API Authentication

Every Caltrain API request through MindCloud uses a MindCloud API key and the `connectionId` of a Caltrain connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Caltrain connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Caltrain action](README.md#actions-12) with your API key and `connectionId`.
