# Courier Universal API Authentication

Every Courier API request through MindCloud uses a MindCloud API key and the `connectionId` of a Courier connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Courier connection.
