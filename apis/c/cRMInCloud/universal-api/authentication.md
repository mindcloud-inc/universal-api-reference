# CRM in Cloud Universal API Authentication

Every CRM in Cloud API request through MindCloud uses a MindCloud API key and the `connectionId` of a CRM in Cloud connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CRM in Cloud connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [CRM in Cloud action](README.md#actions-24) with your API key and `connectionId`.
