# ContactDrive: List Contacts



```
GET https://connect.mindcloud.co/v1/universal/contactDrive/latest/actions/list-contacts
```
...
Through the native ContactDrive API, this operation is `GET /contacts` (base URL `https://api.contactdrive.app/api/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-contacts.md) for the provider-specific parameters and requirements.
