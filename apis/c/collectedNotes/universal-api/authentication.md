# Collected Notes Universal API Authentication

Every Collected Notes API request through MindCloud uses a MindCloud API key and the `connectionId` of a Collected Notes connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Collected Notes connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Collected Notes action](README.md#actions-21) with your API key and `connectionId`.
