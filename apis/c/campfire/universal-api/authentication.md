# Campfire Universal API Authentication

Every Campfire API request through MindCloud uses a MindCloud API key and the `connectionId` of a Campfire connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Campfire connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Campfire action](README.md#actions-26) with your API key and `connectionId`.
