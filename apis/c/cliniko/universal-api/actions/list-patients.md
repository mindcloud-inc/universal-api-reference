...
```
GET https://connect.mindcloud.co/v1/universal/cliniko/latest/actions/list-patients
```
...
Through the native Cliniko API, this operation is `GET /patients` (base URL `https://api.au5.cliniko.com/v1`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-patients.md) for the provider-specific parameters and requirements.
