# Cryotos: List Templates



```
GET https://connect.mindcloud.co/v1/universal/cryotos/latest/actions/list-templates
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/cryotos/latest/actions/list-templates?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/cryotos/latest/actions/list-templates?${params}`, {
  headers: {
