...
- **Official documentation:** [Get All Cards](https://coastpay.com/integrations/)
...
| `personId` | query | `string` | no | Only return cards assigned to this Coast person ID. |
| `vehicleId` | query | `string` | no | Only return cards assigned to this Coast vehicle ID. |
