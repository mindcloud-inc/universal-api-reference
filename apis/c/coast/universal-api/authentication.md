# Coast Universal API Authentication

Every Coast API request through MindCloud uses a MindCloud API key and the `connectionId` of a Coast connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Coast connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Coast action](README.md#actions-42) with your API key and `connectionId`.
