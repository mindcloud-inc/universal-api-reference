# Climbo 2.0 Universal API Authentication

Every Climbo 2.0 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Climbo 2.0 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Climbo 2.0 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Climbo 2.0 action](README.md#actions-10) with your API key and `connectionId`.
