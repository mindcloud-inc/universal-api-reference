# Company URL Finder Universal API Authentication

Every Company URL Finder API request through MindCloud uses a MindCloud API key and the `connectionId` of a Company URL Finder connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Company URL Finder connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Company URL Finder action](README.md#actions-3) with your API key and `connectionId`.
