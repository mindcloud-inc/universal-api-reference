# Chatvolt AI Universal API Authentication

Every Chatvolt AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Chatvolt AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Chatvolt AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Chatvolt AI action](README.md#actions-107) with your API key and `connectionId`.
