# Comm100 Universal API Authentication

Every Comm100 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Comm100 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Comm100 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Comm100 action](README.md#actions-20) with your API key and `connectionId`.
