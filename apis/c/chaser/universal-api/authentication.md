# Chaser Universal API Authentication

Every Chaser API request through MindCloud uses a MindCloud API key and the `connectionId` of a Chaser connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Chaser connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Chaser action](README.md#actions-2) with your API key and `connectionId`.
