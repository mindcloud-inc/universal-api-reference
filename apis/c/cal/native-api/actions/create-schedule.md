...
- **Official documentation:** [Create Schedule](https://cal.com/docs/api-reference/v2/schedules/create-a-schedule)
...
| `timeZone` | body | `string` | yes | IANA time zone for the schedule. |
| `isDefault` | body | `boolean` | yes | Set true to make this the default schedule. |
