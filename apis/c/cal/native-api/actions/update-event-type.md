# Update Event Type with Cal.com
...
- **Official documentation:** [Update Event Type](https://cal.com/docs/api-reference/v2/event-types/update-an-event-type)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `afterEventBuffer` | body | `number` | no | Updated buffer after each booking, in minutes. |
...
| `beforeEventBuffer` | body | `number` | no | Updated buffer before each booking, in minutes. |
...
| `customName` | body | `string` | no | Updated custom label for this event type. |
| `description` | body | `string` | no | Updated event type description. |
...
| `eventTypeId` | path | `list` | yes | Event type identifier from Cal.com path parameter. |
...
| `lengthInMinutes` | body | `number` | no | Updated event duration in minutes. |
| `lengthInMinutesOptions[]` | body | `array<number>` | no | Updated allowed duration options in minutes. |
...
| `minimumBookingNotice` | body | `number` | no | Updated minimum notice before booking, in minutes. |
| `offsetStart` | body | `number` | no | Updated start offset in minutes. |
...
| `scheduleId` | body | `list` | no | Updated schedule ID assigned to the event type. |
...
| `slotInterval` | body | `number` | no | Updated slot interval in minutes. |
| `slug` | body | `string` | no | Updated event type slug. |
...
| `title` | body | `string` | no | Updated event type title. |
