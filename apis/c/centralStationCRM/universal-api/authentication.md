# CentralStationCRM Universal API Authentication

Every CentralStationCRM API request through MindCloud uses a MindCloud API key and the `connectionId` of a CentralStationCRM connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CentralStationCRM connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [CentralStationCRM action](README.md#actions-40) with your API key and `connectionId`.
