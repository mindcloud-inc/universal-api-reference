# Creatomate: Create Video From Template

Creates a video render from a template in Creatomate.

```
POST https://connect.mindcloud.co/v1/universal/creatomate/latest/actions/create-video-from-template
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/creatomate/latest/actions/create-video-from-template" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/creatomate/latest/actions/create-video-from-template', {
  method: 'POST',
  headers: {
...
| --- | --- | --- | --- |
| `templateId` | string | yes | The ID of the video template to render. Example: `0bb2ceb3-50b5-48f0-9fe2-84e6bcba43c0`. |
