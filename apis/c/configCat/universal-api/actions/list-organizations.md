...
Retrieves a list of organizations from ConfigCat.

```
GET https://connect.mindcloud.co/v1/universal/configCat/latest/actions/list-organizations
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/configCat/latest/actions/list-organizations?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/configCat/latest/actions/list-organizations?${params}`, {
  headers: {
