# ConfigCat: Get Product

Retrieves an existing product from ConfigCat.

```
GET https://connect.mindcloud.co/v1/universal/configCat/latest/actions/get-product
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/configCat/latest/actions/get-product?connectionId=$CONNECTION_ID&productId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/configCat/latest/actions/get-product?${params}`, {
  headers: {
