# Client Commander Universal API Authentication

Every Client Commander API request through MindCloud uses a MindCloud API key and the `connectionId` of a Client Commander connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Client Commander connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Client Commander action](README.md#actions-1) with your API key and `connectionId`.
