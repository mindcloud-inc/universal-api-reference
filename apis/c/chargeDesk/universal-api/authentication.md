# ChargeDesk Universal API Authentication

Every ChargeDesk API request through MindCloud uses a MindCloud API key and the `connectionId` of a ChargeDesk connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ChargeDesk connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ChargeDesk action](README.md#actions-24) with your API key and `connectionId`.
