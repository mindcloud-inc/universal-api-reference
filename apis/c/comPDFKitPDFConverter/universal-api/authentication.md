# ComPDFKit PDF Converter Universal API Authentication

Every ComPDFKit PDF Converter API request through MindCloud uses a MindCloud API key and the `connectionId` of a ComPDFKit PDF Converter connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ComPDFKit PDF Converter connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ComPDFKit PDF Converter action](README.md#actions-30) with your API key and `connectionId`.
