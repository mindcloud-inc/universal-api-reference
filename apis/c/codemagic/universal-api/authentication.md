# Codemagic Universal API Authentication

Every Codemagic API request through MindCloud uses a MindCloud API key and the `connectionId` of a Codemagic connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Codemagic connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Codemagic action](README.md#actions-40) with your API key and `connectionId`.
