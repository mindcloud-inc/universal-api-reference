# 2Chat Universal API Authentication

Every 2Chat API request through MindCloud uses a MindCloud API key and the `connectionId` of a 2Chat connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your 2Chat connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [2Chat action](README.md#actions-25) with your API key and `connectionId`.
