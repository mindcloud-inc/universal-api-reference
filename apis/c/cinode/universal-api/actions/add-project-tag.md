# Cinode: Add Project Tag

Adds a tag to a project in Cinode.

```
POST https://connect.mindcloud.co/v1/universal/cinode/latest/actions/add-project-tag
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/cinode/latest/actions/add-project-tag" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/cinode/latest/actions/add-project-tag', {
  method: 'POST',
  headers: {
