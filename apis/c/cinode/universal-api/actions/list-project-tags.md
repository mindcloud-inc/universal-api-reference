# Cinode: List Project Tags

Retrieves tags for a project in Cinode.

```
GET https://connect.mindcloud.co/v1/universal/cinode/latest/actions/list-project-tags
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/cinode/latest/actions/list-project-tags?connectionId=$CONNECTION_ID&companyId=1&projectId=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/cinode/latest/actions/list-project-tags?${params}`, {
  headers: {
