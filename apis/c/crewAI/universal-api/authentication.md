# CrewAI Universal API Authentication

Every CrewAI API request through MindCloud uses a MindCloud API key and the `connectionId` of a CrewAI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CrewAI connection.
