# CallTrackingMetrics Universal API Authentication

Every CallTrackingMetrics API request through MindCloud uses a MindCloud API key and the `connectionId` of a CallTrackingMetrics connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CallTrackingMetrics connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [CallTrackingMetrics action](README.md#actions-23) with your API key and `connectionId`.
