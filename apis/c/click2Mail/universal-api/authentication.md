# Click2Mail Universal API Authentication

Every Click2Mail API request through MindCloud uses a MindCloud API key and the `connectionId` of a Click2Mail connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Click2Mail connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Click2Mail action](README.md#actions-40) with your API key and `connectionId`.
