...
```
GET https://connect.mindcloud.co/v1/universal/column/latest/actions/get-entity
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/column/latest/actions/get-entity?connectionId=$CONNECTION_ID&entityId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/column/latest/actions/get-entity?${params}`, {
  headers: {
