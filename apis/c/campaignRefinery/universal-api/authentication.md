# Campaign Refinery Universal API Authentication

Every Campaign Refinery API request through MindCloud uses a MindCloud API key and the `connectionId` of a Campaign Refinery connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Campaign Refinery connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Campaign Refinery action](README.md#actions-35) with your API key and `connectionId`.
