# CloudContactAI: List Incoming Messages



```
GET https://connect.mindcloud.co/v1/universal/cloudContactAI/latest/actions/list-incoming-messages
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/cloudContactAI/latest/actions/list-incoming-messages?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/cloudContactAI/latest/actions/list-incoming-messages?${params}`, {
  headers: {
