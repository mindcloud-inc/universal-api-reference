# CloudContactAI: Get Message by ID



```
GET https://connect.mindcloud.co/v1/universal/cloudContactAI/latest/actions/get-message-by-id
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/cloudContactAI/latest/actions/get-message-by-id?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/cloudContactAI/latest/actions/get-message-by-id?${params}`, {
  headers: {
