# CloudContactAI: Create Client



```
POST https://connect.mindcloud.co/v1/universal/cloudContactAI/latest/actions/create-client
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/cloudContactAI/latest/actions/create-client" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/cloudContactAI/latest/actions/create-client', {
  method: 'POST',
  headers: {
