# Corporate Buzzword Generator Universal API Authentication

Every Corporate Buzzword Generator API request through MindCloud uses a MindCloud API key and the `connectionId` of a Corporate Buzzword Generator connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Corporate Buzzword Generator connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Corporate Buzzword Generator action](README.md#actions-1) with your API key and `connectionId`.
