# Cursor Universal API Authentication

Every Cursor API request through MindCloud uses a MindCloud API key and the `connectionId` of a Cursor connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Cursor connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Cursor action](README.md#actions-12) with your API key and `connectionId`.
