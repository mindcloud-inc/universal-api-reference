# Classe365 Universal API Authentication

Every Classe365 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Classe365 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Classe365 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Classe365 action](README.md#actions-41) with your API key and `connectionId`.
