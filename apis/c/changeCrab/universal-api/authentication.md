# ChangeCrab Universal API Authentication

Every ChangeCrab API request through MindCloud uses a MindCloud API key and the `connectionId` of a ChangeCrab connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ChangeCrab connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ChangeCrab action](README.md#actions-10) with your API key and `connectionId`.
