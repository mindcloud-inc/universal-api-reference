# Cisco Umbrella Universal API Authentication

Every Cisco Umbrella API request through MindCloud uses a MindCloud API key and the `connectionId` of a Cisco Umbrella connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Cisco Umbrella connection.
