# Chargeflow Universal API Authentication

Every Chargeflow API request through MindCloud uses a MindCloud API key and the `connectionId` of a Chargeflow connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Chargeflow connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Chargeflow action](README.md#actions-34) with your API key and `connectionId`.
