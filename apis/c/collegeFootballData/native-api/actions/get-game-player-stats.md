# List Game Player Stats with College Football Data
...
- **Official documentation:** [List Game Player Stats](https://api.collegefootballdata.com/)
...
| `category` | query | `string` | no | Optional player statistical category filter |
