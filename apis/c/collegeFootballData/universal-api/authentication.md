# College Football Data Universal API Authentication

Every College Football Data API request through MindCloud uses a MindCloud API key and the `connectionId` of a College Football Data connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your College Football Data connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [College Football Data action](README.md#actions-60) with your API key and `connectionId`.
