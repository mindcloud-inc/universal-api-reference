# Content Snare: Delete Webhook

Deletes a webhook from Content Snare.

```
DELETE https://connect.mindcloud.co/v1/universal/contentSnare/latest/actions/delete-webhook
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/contentSnare/latest/actions/delete-webhook?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/contentSnare/latest/actions/delete-webhook?${params}`, {
  headers: {
