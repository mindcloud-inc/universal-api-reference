# Content Snare: Delete Team Member

Deletes a team member from Content Snare.

```
DELETE https://connect.mindcloud.co/v1/universal/contentSnare/latest/actions/delete-team-member
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/contentSnare/latest/actions/delete-team-member?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/contentSnare/latest/actions/delete-team-member?${params}`, {
  headers: {
