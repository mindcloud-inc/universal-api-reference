# Content Snare: Approve All Submitted Fields

Approves all submitted fields for a request in Content Snare.

```
PUT https://connect.mindcloud.co/v1/universal/contentSnare/latest/actions/approve-all-submitted-fields
```
...
Through the native Content Snare API, this operation is `PUT /partner_api/v1/requests/{id}/approve_all_submitted_fields` (base URL `https://api.contentsnare.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/approve-all-submitted-fields.md) for the provider-specific parameters and requirements.
