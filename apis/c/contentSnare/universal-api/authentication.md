# Content Snare Universal API Authentication

Every Content Snare API request through MindCloud uses a MindCloud API key and the `connectionId` of a Content Snare connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Content Snare connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Content Snare action](README.md#actions-38) with your API key and `connectionId`.
