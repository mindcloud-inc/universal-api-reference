# ChatDaddy Universal API Authentication

Every ChatDaddy API request through MindCloud uses a MindCloud API key and the `connectionId` of a ChatDaddy connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ChatDaddy connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ChatDaddy action](README.md#actions-30) with your API key and `connectionId`.
