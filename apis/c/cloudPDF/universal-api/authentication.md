# CloudPDF Universal API Authentication

Every CloudPDF API request through MindCloud uses a MindCloud API key and the `connectionId` of a CloudPDF connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CloudPDF connection.
