# companydata.dk Universal API Authentication

Every companydata.dk API request through MindCloud uses a MindCloud API key and the `connectionId` of a companydata.dk connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your companydata.dk connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [companydata.dk action](README.md#actions-1) with your API key and `connectionId`.
