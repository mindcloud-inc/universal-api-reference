# Cisco Webex Meetings Universal API Authentication

Every Cisco Webex Meetings API request through MindCloud uses a MindCloud API key and the `connectionId` of a Cisco Webex Meetings connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Cisco Webex Meetings connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Cisco Webex Meetings action](README.md#actions-11) with your API key and `connectionId`.
