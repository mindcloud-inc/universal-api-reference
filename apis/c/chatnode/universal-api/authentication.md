# Chatnode Universal API Authentication

Every Chatnode API request through MindCloud uses a MindCloud API key and the `connectionId` of a Chatnode connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Chatnode connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Chatnode action](README.md#actions-4) with your API key and `connectionId`.
