# Cloudsmith Universal API Authentication

Every Cloudsmith API request through MindCloud uses a MindCloud API key and the `connectionId` of a Cloudsmith connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Cloudsmith connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Cloudsmith action](README.md#actions-20) with your API key and `connectionId`.
