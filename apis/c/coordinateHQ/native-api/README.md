...
A consolidated summary of CoordinateHQ's API configuration and 11 documented operations.
...
| [Attach Task File](actions/new-action1.md) | `POST /projects/:project_id/task/:task_id/files/attach` | [docs](https://app.coordinatehq.com/static/API_Documentation.html#project-pages) |
