# Cloudinary Universal API Authentication

Every Cloudinary API request through MindCloud uses a MindCloud API key and the `connectionId` of a Cloudinary connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Cloudinary connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Cloudinary action](README.md#actions-26) with your API key and `connectionId`.
