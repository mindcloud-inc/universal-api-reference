# Update Question with ClassMarker
...
- **Official documentation:** [Update Question](https://www.classmarker.com/online-testing/docs/api/#put-question)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `question_id` | path | `number` | yes | Numeric ClassMarker question ID. |
...
| `verify_only` | query | `boolean` | no | Validate the request without updating the question. |
