...
```
GET https://connect.mindcloud.co/v1/universal/calculoid/latest/actions/get-table
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/calculoid/latest/actions/get-table?connectionId=$CONNECTION_ID&calculatorId=109359&tableId=42" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/calculoid/latest/actions/get-table?${params}`, {
  headers: {
