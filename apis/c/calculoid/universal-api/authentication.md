# Calculoid Universal API Authentication

Every Calculoid API request through MindCloud uses a MindCloud API key and the `connectionId` of a Calculoid connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Calculoid connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Calculoid action](README.md#actions-26) with your API key and `connectionId`.
