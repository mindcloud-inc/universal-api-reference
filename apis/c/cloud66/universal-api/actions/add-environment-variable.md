# Cloud 66: Add Environment Variable

Creates an environment variable in your Cloud 66 account.

```
POST https://connect.mindcloud.co/v1/universal/cloud66/latest/actions/add-environment-variable
```
...
| `key` | string | yes | The environment variable key or name |
...
Through the native Cloud 66 API, this operation is `POST /stacks/:stack_id/environments` (base URL `https://app.cloud66.com/api/3`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/add-environment-variable.md) for the provider-specific parameters and requirements.
