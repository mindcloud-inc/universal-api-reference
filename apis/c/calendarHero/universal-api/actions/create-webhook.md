# CalendarHero: Create Webhook

Creates a webhook in CalendarHero.

```
POST https://connect.mindcloud.co/v1/universal/calendarHero/latest/actions/create-webhook
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/calendarHero/latest/actions/create-webhook" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/calendarHero/latest/actions/create-webhook', {
  method: 'POST',
  headers: {
