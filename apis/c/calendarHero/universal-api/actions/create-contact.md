...
```
POST https://connect.mindcloud.co/v1/universal/calendarHero/latest/actions/create-contact
```
...
| --- | --- | --- | --- |
| `body` | string | no | Contact payload to create. |
