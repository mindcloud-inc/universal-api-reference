# CalendarHero: Get User

Retrieves a user from CalendarHero.

```
GET https://connect.mindcloud.co/v1/universal/calendarHero/latest/actions/get-user
```
