# CalendarHero Universal API Authentication

Every CalendarHero API request through MindCloud uses a MindCloud API key and the `connectionId` of a CalendarHero connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CalendarHero connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [CalendarHero action](README.md#actions-40) with your API key and `connectionId`.
