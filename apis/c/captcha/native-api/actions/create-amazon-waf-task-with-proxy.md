# Create Amazon WAF Task With Proxy with 2Captcha
...
- **Official documentation:** [Create Amazon WAF Task With Proxy](https://2captcha.com/api-docs/amazon-aws-waf-captcha)
...
| `task.jsapiScript` | body | `string` | yes | — |
