# Create reCAPTCHA V2 Enterprise Task With Proxy with 2Captcha
...
- **Official documentation:** [Create reCAPTCHA V2 Enterprise Task With Proxy](https://2captcha.com/api-docs/recaptcha-v2-enterprise)
