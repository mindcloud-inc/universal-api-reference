# Create Cloudflare Turnstile Task With Proxy with 2Captcha
...
- **Official documentation:** [Create Cloudflare Turnstile Task With Proxy](https://2captcha.com/api-docs/cloudflare-turnstile)
