# Clio Manage Universal API Authentication

Every Clio Manage API request through MindCloud uses a MindCloud API key and the `connectionId` of a Clio Manage connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Clio Manage connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Clio Manage action](README.md#actions-35) with your API key and `connectionId`.
