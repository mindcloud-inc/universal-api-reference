# CurrencyAPI Universal API Authentication

Every CurrencyAPI API request through MindCloud uses a MindCloud API key and the `connectionId` of a CurrencyAPI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CurrencyAPI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [CurrencyAPI action](README.md#actions-4) with your API key and `connectionId`.
