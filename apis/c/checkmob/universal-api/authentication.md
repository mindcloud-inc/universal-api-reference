# Checkmob Universal API Authentication

Every Checkmob API request through MindCloud uses a MindCloud API key and the `connectionId` of a Checkmob connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Checkmob connection.
