# Cerbo: Get Patient Estimate

Retrieves patient estimate details from Cerbo.

```
GET https://connect.mindcloud.co/v1/universal/cerbo/latest/actions/get-patient-estimate
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/cerbo/latest/actions/get-patient-estimate?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/cerbo/latest/actions/get-patient-estimate?${params}`, {
  headers: {
