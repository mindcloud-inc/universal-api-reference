# ConvertAPI: Convert File to PDF

Converts a file to PDF with ConvertAPI.

```
POST https://connect.mindcloud.co/v1/universal/convertAPI/latest/actions/convert-file-to-pdf
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/convertAPI/latest/actions/convert-file-to-pdf" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/convertAPI/latest/actions/convert-file-to-pdf', {
  method: 'POST',
  headers: {
