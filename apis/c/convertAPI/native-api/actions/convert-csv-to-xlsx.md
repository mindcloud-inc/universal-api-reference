# Convert CSV to XLSX with ConvertAPI
...
- **Official documentation:** [Convert CSV to XLSX](https://www.convertapi.com/csv-to-xlsx)
...
| `Delimiter` | body | `string` | yes | Set fields separator. |
...
| `CellType` | body | `list<string>` | no | Set Excel cell type, if set as text the date and number format will be the same as in CSV file. Accepted values: `general`, `text`. |
