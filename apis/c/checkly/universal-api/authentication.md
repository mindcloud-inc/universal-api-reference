# Checkly Universal API Authentication

Every Checkly API request through MindCloud uses a MindCloud API key and the `connectionId` of a Checkly connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Checkly connection.
