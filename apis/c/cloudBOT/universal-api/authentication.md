# Cloud BOT Universal API Authentication

Every Cloud BOT API request through MindCloud uses a MindCloud API key and the `connectionId` of a Cloud BOT connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Cloud BOT connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Cloud BOT action](README.md#actions-12) with your API key and `connectionId`.
