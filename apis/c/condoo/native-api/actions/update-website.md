...
- **Official documentation:** [Update Website](https://trk.condoo.systems/en/api-documentation/websites)
...
| `host` | body | `string` | no | Optional website host. |
| `is_enabled` | body | `boolean` | no | Optional enabled toggle. |
| `name` | body | `string` | no | Optional website name. |
...
| `scheme` | body | `string` | no | Optional URL scheme. Allowed values: http, https. |
