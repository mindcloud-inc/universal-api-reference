...
- **Official documentation:** [Create Pageview](https://trk.condoo.systems/en/api-documentation/pageviews-lightweight)
...
| `device_type` | body | `string` | no | Device type. Allowed values: desktop, mobile, tablet. |
| `os_name` | body | `string` | no | Optional operating system name. |
| `path` | body | `string` | no | Optional page path when type is pageview. |
...
| `theme` | body | `string` | no | Theme. Allowed values: light, dark. |
| `type` | body | `string` | no | Optional type. Allowed values: pageview, custom. Defaults to pageview. |
