# Catalog Machine Universal API Authentication

Every Catalog Machine API request through MindCloud uses a MindCloud API key and the `connectionId` of a Catalog Machine connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Catalog Machine connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Catalog Machine action](README.md#actions-13) with your API key and `connectionId`.
