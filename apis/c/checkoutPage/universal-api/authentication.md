# Checkout Page Universal API Authentication

Every Checkout Page API request through MindCloud uses a MindCloud API key and the `connectionId` of a Checkout Page connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Checkout Page connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Checkout Page action](README.md#actions-40) with your API key and `connectionId`.
