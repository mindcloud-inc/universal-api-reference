# Checkout Page: List Ticket Types

Retrieves ticket types from Checkout Page.

```
GET https://connect.mindcloud.co/v1/universal/checkoutPage/latest/actions/list-ticket-types
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/checkoutPage/latest/actions/list-ticket-types?connectionId=$CONNECTION_ID&pageId=string&ticketGroupId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/checkoutPage/latest/actions/list-ticket-types?${params}`, {
  headers: {
