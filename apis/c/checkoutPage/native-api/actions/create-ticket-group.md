# Create Ticket Group with Checkout Page
...
- **Official documentation:** [Create Ticket Group](https://checkoutpage.com/docs/api/v1/events/ticket-groups/create)
...
| `name` | body | `string` | yes | Name of the ticket group. |
