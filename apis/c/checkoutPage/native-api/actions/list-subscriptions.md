# List Subscriptions with Checkout Page
...
- **Official documentation:** [List Subscriptions](https://checkoutpage.com/docs/api/v1/subscriptions/list)
...
| `search` | query | `string` | no | List all subscriptions |
| `pageId` | query | `string` | no | Unique identifier. Must be in BSON ObjectId format. |
| `status` | query | `string` | no | List all subscriptions |
