# List Bookings with Checkout Page
...
- **Official documentation:** [List Bookings](https://checkoutpage.com/docs/api/v1/bookings/list)
...
| `status` | query | `string` | no | List all bookings |
