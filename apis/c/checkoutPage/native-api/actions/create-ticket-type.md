# Create Ticket Type with Checkout Page
...
- **Official documentation:** [Create Ticket Type](https://checkoutpage.com/docs/api/v1/events/ticket-groups/ticket-types/create)
