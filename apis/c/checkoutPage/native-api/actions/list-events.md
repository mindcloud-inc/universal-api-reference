# List Events with Checkout Page
...
- **Official documentation:** [List Events](https://checkoutpage.com/docs/api/v1/events/list)
...
| `status` | query | `string` | no | Filter events by publication status. |
