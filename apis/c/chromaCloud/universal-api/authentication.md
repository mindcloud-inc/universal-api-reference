# Chroma Cloud Universal API Authentication

Every Chroma Cloud API request through MindCloud uses a MindCloud API key and the `connectionId` of a Chroma Cloud connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Chroma Cloud connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Chroma Cloud action](README.md#actions-40) with your API key and `connectionId`.
