# Chroma Cloud: Update tenant

Updates a tenant in Chroma Cloud.

```
PUT https://connect.mindcloud.co/v1/universal/chromaCloud/latest/actions/update-tenant
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/chromaCloud/latest/actions/update-tenant" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/chromaCloud/latest/actions/update-tenant', {
  method: 'PUT',
  headers: {
