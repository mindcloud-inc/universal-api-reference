# Chroma Cloud: Create database

Creates a database in Chroma Cloud.

```
POST https://connect.mindcloud.co/v1/universal/chromaCloud/latest/actions/create-database
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/chromaCloud/latest/actions/create-database" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/chromaCloud/latest/actions/create-database', {
  method: 'POST',
  headers: {
