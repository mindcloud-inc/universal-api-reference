# Cocoonmail Universal API Authentication

Every Cocoonmail API request through MindCloud uses a MindCloud API key and the `connectionId` of a Cocoonmail connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Cocoonmail connection.
