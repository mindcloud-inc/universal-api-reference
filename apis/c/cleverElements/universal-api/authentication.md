# Clever Elements Universal API Authentication

Every Clever Elements API request through MindCloud uses a MindCloud API key and the `connectionId` of a Clever Elements connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Clever Elements connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Clever Elements action](README.md#actions-20) with your API key and `connectionId`.
