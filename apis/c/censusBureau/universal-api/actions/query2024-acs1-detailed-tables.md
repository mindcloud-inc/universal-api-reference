# Census Bureau: Query 2024 ACS 1-Year Detailed Tables

Queries Census Bureau 2024 ACS 1-Year detailed tables.

```
GET https://connect.mindcloud.co/v1/universal/censusBureau/latest/actions/query2024-acs1-detailed-tables
```
...
Through the native Census Bureau API, this operation is `GET /2024/acs/acs1` (base URL `https://api.census.gov/data`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/query2024-acs1-detailed-tables.md) for the provider-specific parameters and requirements.
