# Get Batch Verification Results Raw with ClearBounce
...
- **Official documentation:** [Get Batch Verification Results Raw](https://docs.clearbounce.net/api-reference/batch-verification)
