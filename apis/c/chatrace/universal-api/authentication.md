# Chatrace Universal API Authentication

Every Chatrace API request through MindCloud uses a MindCloud API key and the `connectionId` of a Chatrace connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Chatrace connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Chatrace action](README.md#actions-55) with your API key and `connectionId`.
