# CastingWords Universal API Authentication

Every CastingWords API request through MindCloud uses a MindCloud API key and the `connectionId` of a CastingWords connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CastingWords connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [CastingWords action](README.md#actions-31) with your API key and `connectionId`.
