# CompanyCam Universal API Authentication

Every CompanyCam API request through MindCloud uses a MindCloud API key and the `connectionId` of a CompanyCam connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CompanyCam connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [CompanyCam action](README.md#actions-48) with your API key and `connectionId`.
