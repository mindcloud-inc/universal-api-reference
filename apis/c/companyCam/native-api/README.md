...
A consolidated summary of CompanyCam's API configuration and 52 documented operations, with links to official documentation.
...
| --- | --- | --- |
| [Add Comment to Photo](actions/add-comment-to-photo.md) | `POST photos/:id/comments` | [docs](https://docs.companycam.com/reference/createphotocomment) |
...
| [Delete Project](actions/delete-project.md) | `DELETE https://api.companycam.com/v2/projects/:id` | [docs](https://docs.companycam.com/reference/deleteproject) |
...
| [List All Checklist Templates](actions/list-all-checklist-templates.md) | `GET templates/checklists` | [docs](https://docs.companycam.com/reference/listchecklisttemplates) |
...
| [List Groups](actions/list-groups.md) | `GET groups` | [docs](https://docs.companycam.com/reference/listgroups) |
...
| [List Project Labels](actions/list-project-labels.md) | `GET projects/:id/labels` | [docs](https://docs.companycam.com/reference/listprojectlabels) |
