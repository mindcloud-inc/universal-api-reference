# CallRail Universal API Authentication

Every CallRail API request through MindCloud uses a MindCloud API key and the `connectionId` of a CallRail connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CallRail connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [CallRail action](README.md#actions-22) with your API key and `connectionId`.
