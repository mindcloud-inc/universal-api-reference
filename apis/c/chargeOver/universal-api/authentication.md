# ChargeOver Universal API Authentication

Every ChargeOver API request through MindCloud uses a MindCloud API key and the `connectionId` of a ChargeOver connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ChargeOver connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ChargeOver action](README.md#actions-24) with your API key and `connectionId`.
