# CommercioNetwork Universal API Authentication

Every CommercioNetwork API request through MindCloud uses a MindCloud API key and the `connectionId` of a CommercioNetwork connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CommercioNetwork connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [CommercioNetwork action](README.md#actions-20) with your API key and `connectionId`.
