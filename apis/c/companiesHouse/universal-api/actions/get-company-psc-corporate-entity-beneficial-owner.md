# Companies House: Get Company PSC Corporate Entity Beneficial Owner

Retrieves a corporate entity beneficial owner notification from Companies House.

```
GET https://connect.mindcloud.co/v1/universal/companiesHouse/latest/actions/get-company-psc-corporate-entity-beneficial-owner
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/companiesHouse/latest/actions/get-company-psc-corporate-entity-beneficial-owner?connectionId=$CONNECTION_ID&companyNumber=string&pscId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/companiesHouse/latest/actions/get-company-psc-corporate-entity-beneficial-owner?${params}`, {
  headers: {
