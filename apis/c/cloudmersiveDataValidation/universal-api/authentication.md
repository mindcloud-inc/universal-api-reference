# Cloudmersive Data Validation Universal API Authentication

Every Cloudmersive Data Validation API request through MindCloud uses a MindCloud API key and the `connectionId` of a Cloudmersive Data Validation connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Cloudmersive Data Validation connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Cloudmersive Data Validation action](README.md#actions-23) with your API key and `connectionId`.
