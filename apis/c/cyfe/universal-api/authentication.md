# Cyfe Universal API Authentication

Every Cyfe API request through MindCloud uses a MindCloud API key and the `connectionId` of a Cyfe connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Cyfe connection.
