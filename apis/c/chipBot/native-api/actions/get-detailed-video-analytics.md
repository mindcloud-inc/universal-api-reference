# Get Detailed Video Analytics with ChipBot

## Endpoint

- **Method:** `GET`
- **Path:** `/api/v2/connect/accounts/:accountId/domains/:domainId/video-exp/:videoExpId/reporting/detailed`
- **Base URL:** `https://getchipbot.com`
- **Official documentation:** [Get Detailed Video Analytics](https://getchipbot.com/api-docs/video-exp/video-analytics-detailed)
