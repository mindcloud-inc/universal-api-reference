# Coffee API Universal API Authentication

Every Coffee API API request through MindCloud uses a MindCloud API key and the `connectionId` of a Coffee API connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Coffee API connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Coffee API action](README.md#actions-2) with your API key and `connectionId`.
