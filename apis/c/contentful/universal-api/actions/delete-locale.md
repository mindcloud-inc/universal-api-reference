# Contentful: Delete locale



```
DELETE https://connect.mindcloud.co/v1/universal/contentful/latest/actions/delete-locale
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/contentful/latest/actions/delete-locale?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/contentful/latest/actions/delete-locale?${params}`, {
  headers: {
