...
```
DELETE https://connect.mindcloud.co/v1/universal/contentful/latest/actions/delete-entry
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/contentful/latest/actions/delete-entry?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/contentful/latest/actions/delete-entry?${params}`, {
  headers: {
