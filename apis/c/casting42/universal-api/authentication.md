# Casting42 Universal API Authentication

Every Casting42 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Casting42 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Casting42 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Casting42 action](README.md#actions-13) with your API key and `connectionId`.
