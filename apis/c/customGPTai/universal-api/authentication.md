# CustomGPT.ai Universal API Authentication

Every CustomGPT.ai API request through MindCloud uses a MindCloud API key and the `connectionId` of a CustomGPT.ai connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your CustomGPT.ai connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [CustomGPT.ai action](README.md#actions-18) with your API key and `connectionId`.
