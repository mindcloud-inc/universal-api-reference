...
Retrieves app chart records from Clappia.

```
GET https://connect.mindcloud.co/v1/universal/clappia/latest/actions/list-charts
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/clappia/latest/actions/list-charts?connectionId=$CONNECTION_ID&appId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/clappia/latest/actions/list-charts?${params}`, {
  headers: {
