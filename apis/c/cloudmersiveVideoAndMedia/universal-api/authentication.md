# Cloudmersive Video and Media Universal API Authentication

Every Cloudmersive Video and Media API request through MindCloud uses a MindCloud API key and the `connectionId` of a Cloudmersive Video and Media connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Cloudmersive Video and Media connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Cloudmersive Video and Media action](README.md#actions-2) with your API key and `connectionId`.
