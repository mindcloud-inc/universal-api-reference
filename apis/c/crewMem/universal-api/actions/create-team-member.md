# CrewMem: Create Team Member



```
POST https://connect.mindcloud.co/v1/universal/crewMem/latest/actions/create-team-member
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/crewMem/latest/actions/create-team-member" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/crewMem/latest/actions/create-team-member', {
  method: 'POST',
  headers: {
