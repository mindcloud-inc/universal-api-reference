# CrewMem: Create Member



```
POST https://connect.mindcloud.co/v1/universal/crewMem/latest/actions/create-member
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/crewMem/latest/actions/create-member" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/crewMem/latest/actions/create-member', {
  method: 'POST',
  headers: {
