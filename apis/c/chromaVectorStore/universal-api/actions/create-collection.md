# Chroma Vector Store: Create Collection

Creates a new collection in Chroma.

```
POST https://connect.mindcloud.co/v1/universal/chromaVectorStore/latest/actions/create-collection
```
