# Chroma Vector Store: Create Database

Creates a new database in Chroma.

```
POST https://connect.mindcloud.co/v1/universal/chromaVectorStore/latest/actions/create-database
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/chromaVectorStore/latest/actions/create-database" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/chromaVectorStore/latest/actions/create-database', {
  method: 'POST',
  headers: {
