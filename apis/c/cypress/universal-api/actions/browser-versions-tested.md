# Cypress: Browser Versions Tested

Retrieves tested browser versions from Cypress Cloud.

```
GET https://connect.mindcloud.co/v1/universal/cypress/latest/actions/browser-versions-tested
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/cypress/latest/actions/browser-versions-tested?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/cypress/latest/actions/browser-versions-tested?${params}`, {
  headers: {
