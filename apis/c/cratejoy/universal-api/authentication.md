# Cratejoy Universal API Authentication

Every Cratejoy API request through MindCloud uses a MindCloud API key and the `connectionId` of a Cratejoy connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Cratejoy connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Cratejoy action](README.md#actions-24) with your API key and `connectionId`.
