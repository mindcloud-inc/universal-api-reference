...
```
DELETE https://connect.mindcloud.co/v1/universal/calendly/latest/actions/delete-webhook-subscription
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/calendly/latest/actions/delete-webhook-subscription?connectionId=$CONNECTION_ID&webhook_uuid=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/calendly/latest/actions/delete-webhook-subscription?${params}`, {
  headers: {
