# Crawlbase Universal API Authentication

Every Crawlbase API request through MindCloud uses a MindCloud API key and the `connectionId` of a Crawlbase connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Crawlbase connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Crawlbase action](README.md#actions-40) with your API key and `connectionId`.
