# Customerly Universal API Authentication

Every Customerly API request through MindCloud uses a MindCloud API key and the `connectionId` of a Customerly connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Customerly connection.
