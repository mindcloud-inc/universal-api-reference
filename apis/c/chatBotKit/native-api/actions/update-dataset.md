# Update Dataset with ChatBotKit

## Endpoint

- **Method:** `POST`
- **Path:** `/dataset/{datasetId}/update`
- **Base URL:** `https://api.chatbotkit.com/v1`
- **Official documentation:** [Update Dataset](https://chatbotkit.com/manuals/datasets)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `datasetId` | path | `string` | yes | The ID of the dataset to update |
