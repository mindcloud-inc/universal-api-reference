# Ensure Contact Existence with ChatBotKit
...
- **Official documentation:** [Ensure Contact Existence](https://chatbotkit.com/manuals/contacts)
...
| `fingerprint` | body | `string` | yes | Fingerprint for the contact |
