# CodeREADr: Delete Database

Deletes an existing validation database from CodeREADr.

```
DELETE https://connect.mindcloud.co/v1/universal/codeREADr/latest/actions/delete-database
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/codeREADr/latest/actions/delete-database?connectionId=$CONNECTION_ID&databaseId=1347442" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/codeREADr/latest/actions/delete-database?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `databaseId` | string | yes | Database to delete. Example: `1347442`. |
