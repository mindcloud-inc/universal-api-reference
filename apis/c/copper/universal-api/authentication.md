# Copper Universal API Authentication

Every Copper API request through MindCloud uses a MindCloud API key and the `connectionId` of a Copper connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Copper connection.
