# COVID-19 JHU CSSE Universal API Authentication

Every COVID-19 JHU CSSE API request through MindCloud uses a MindCloud API key and the `connectionId` of a COVID-19 JHU CSSE connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your COVID-19 JHU CSSE connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [COVID-19 JHU CSSE action](README.md#actions-11) with your API key and `connectionId`.
