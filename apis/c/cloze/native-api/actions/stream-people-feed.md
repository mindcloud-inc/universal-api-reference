...
- **Official documentation:** [Stream People Feed](https://api.cloze.com/api-docs/#/paths/v1-people-feed/get)
...
| `includeauditedchanges` | query | `boolean` | no | Return change audit details in results for each delivered person. |
