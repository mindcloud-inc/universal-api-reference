# Cloze: Delete Company

Deletes a company from Cloze.

```
DELETE https://connect.mindcloud.co/v1/universal/cloze/latest/actions/delete-company
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/cloze/latest/actions/delete-company?connectionId=$CONNECTION_ID&uniqueid=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/cloze/latest/actions/delete-company?${params}`, {
  headers: {
