# Callexa Feedback Universal API Authentication

Every Callexa Feedback API request through MindCloud uses a MindCloud API key and the `connectionId` of a Callexa Feedback connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Callexa Feedback connection.
