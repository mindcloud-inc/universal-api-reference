# Couchbase Capella: List Organizations

Retrieves organizations from Couchbase Capella.

```
GET https://connect.mindcloud.co/v1/universal/couchbaseCapella/latest/actions/list-organizations
```
