# Couchbase Capella Universal API Authentication

Every Couchbase Capella API request through MindCloud uses a MindCloud API key and the `connectionId` of a Couchbase Capella connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Couchbase Capella connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Couchbase Capella action](README.md#actions-259) with your API key and `connectionId`.
