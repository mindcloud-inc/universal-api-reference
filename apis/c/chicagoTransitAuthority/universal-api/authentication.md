# Chicago Transit Authority Universal API Authentication

Every Chicago Transit Authority API request through MindCloud uses a MindCloud API key and the `connectionId` of a Chicago Transit Authority connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Chicago Transit Authority connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Chicago Transit Authority action](README.md#actions-30) with your API key and `connectionId`.
