# Clockify Universal API Authentication

Every Clockify API request through MindCloud uses a MindCloud API key and the `connectionId` of a Clockify connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Clockify connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Clockify action](README.md#actions-154) with your API key and `connectionId`.
