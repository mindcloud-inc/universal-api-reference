# Generate Summary Report with Clockify
...
- **Method:** `POST`
- **Path:** `https://reports.api.clockify.me/v1/workspaces/:workspaceId/reports/summary`
- **Base URL:** `https://api.clockify.me/api/v1`
- **Official documentation:** [Generate Summary Report](https://docs.developer.clockify.me/#tag/Time-Entry-Report/operation/generateSummaryReport)
