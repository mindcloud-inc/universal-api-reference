# Hyperstack Certificates Universal API Authentication

Every Hyperstack Certificates API request through MindCloud uses a MindCloud API key and the `connectionId` of a Hyperstack Certificates connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Hyperstack Certificates connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Hyperstack Certificates action](README.md#actions-16) with your API key and `connectionId`.
