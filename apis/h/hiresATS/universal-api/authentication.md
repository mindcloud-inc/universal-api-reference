# 100Hires ATS Universal API Authentication

Every 100Hires ATS API request through MindCloud uses a MindCloud API key and the `connectionId` of a 100Hires ATS connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your 100Hires ATS connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [100Hires ATS action](README.md#actions-33) with your API key and `connectionId`.
