# HTML/CSS to Image app Universal API Authentication

Every HTML/CSS to Image app API request through MindCloud uses a MindCloud API key and the `connectionId` of a HTML/CSS to Image app connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your HTML/CSS to Image app connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [HTML/CSS to Image app action](README.md#actions-11) with your API key and `connectionId`.
