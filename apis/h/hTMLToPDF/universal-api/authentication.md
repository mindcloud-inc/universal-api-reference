# HTML to PDF Universal API Authentication

Every HTML to PDF API request through MindCloud uses a MindCloud API key and the `connectionId` of a HTML to PDF connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your HTML to PDF connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [HTML to PDF action](README.md#actions-3) with your API key and `connectionId`.
