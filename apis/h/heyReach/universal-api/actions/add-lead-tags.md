# Hey Reach: Add Lead Tags

Adds tags to a lead in Hey Reach.

```
PUT https://connect.mindcloud.co/v1/universal/heyReach/latest/actions/add-lead-tags
```
...
Through the native Hey Reach API, this operation is `POST /api/public/lead/AddTags` (base URL `https://api.heyreach.io`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/add-lead-tags.md) for the provider-specific parameters and requirements.
