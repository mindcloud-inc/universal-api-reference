# Hacker News Universal API Authentication

Every Hacker News API request through MindCloud uses a MindCloud API key and the `connectionId` of a Hacker News connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Hacker News connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Hacker News action](README.md#actions-50) with your API key and `connectionId`.
