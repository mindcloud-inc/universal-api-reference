# Housecall Pro Universal API Authentication

Every Housecall Pro API request through MindCloud uses a MindCloud API key and the `connectionId` of a Housecall Pro connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Housecall Pro connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Housecall Pro action](README.md#actions-23) with your API key and `connectionId`.
