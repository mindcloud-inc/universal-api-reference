# List Organizations with Harbour
...
- **Method:** `GET`
- **Path:** `https://api.harbourshare.com/v1/organizations`
- **Base URL:** `https://api.myharbourshare.com/v2`
- **Official documentation:** [List Organizations](https://developers.harbourshare.com/#list-organizations)
