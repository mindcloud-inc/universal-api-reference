# HrFlow.ai Universal API Authentication

Every HrFlow.ai API request through MindCloud uses a MindCloud API key and the `connectionId` of a HrFlow.ai connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your HrFlow.ai connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [HrFlow.ai action](README.md#actions-4) with your API key and `connectionId`.
