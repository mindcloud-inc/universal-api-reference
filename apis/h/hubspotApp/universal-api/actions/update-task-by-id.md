# HubSpot: Update Task by ID



```
PUT https://connect.mindcloud.co/v1/universal/hubspotApp/latest/actions/update-task-by-id
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/hubspotApp/latest/actions/update-task-by-id" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/hubspotApp/latest/actions/update-task-by-id', {
  method: 'PUT',
  headers: {
