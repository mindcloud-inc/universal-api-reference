...
Requested scopes: `crm.schemas.companies.write crm.schemas.quotes.read crm.objects.line_items.read crm.schemas.deals.read crm.objects.line_items.write crm.schemas.projects.read crm.schemas.deals.write crm.schemas.line_items.read crm.schemas.orders.read oauth crm.objects.owners.read crm.objects.orders.read crm.objects.invoices.read crm.schemas.invoices.read crm.objects.products.read tickets crm.objects.contacts.write crm.objects.products.write crm.schemas.custom.read crm.objects.custom.read crm.objects.projects.read crm.objects.companies.write crm.objects.projects.write crm.lists.write crm.objects.companies.read crm.schemas.listings.read crm.lists.read settings.users.read crm.objects.deals.read crm.schemas.contacts.read crm.objects.deals.write crm.objects.contacts.read crm.schemas.companies.read crm.objects.quotes.read`.
...
| [Create Listings (v2026-03)](actions/create-listings-v202603.md) | REST - Query Pagination | `POST crm/objects/2026-03/listings` | [docs](https://developers.hubspot.com/docs/api-reference/crm-companies-v3/basic/patch-crm-v3-objects-companies-companyId) |
