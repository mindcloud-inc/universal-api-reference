...
- **Official documentation:** [Search Tickets](https://developers.hubspot.com/docs/api-reference/crm-tickets-v3/search/post-crm-v3-objects-tickets-search)
...
| --- | --- | --- | --- | --- |
| `query` | body | `string` | no | The text query to match across searchable ticket properties. |
| `filterGroups` | body | `object` | no | Provide the full HubSpot filterGroups array, for example [{"filters":[{"propertyName":"hs_object_id","operator":"EQ","value":"123"}]}]. |
...
| `properties[]` | body | `array<string>` | no | Ticket property names to return in the response. |
