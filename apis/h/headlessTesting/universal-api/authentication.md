# Headless Testing Universal API Authentication

Every Headless Testing API request through MindCloud uses a MindCloud API key and the `connectionId` of a Headless Testing connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Headless Testing connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Headless Testing action](README.md#actions-59) with your API key and `connectionId`.
