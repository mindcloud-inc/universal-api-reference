# Harvest: Retrieve Project

Retrieves a project from Harvest.

```
GET https://connect.mindcloud.co/v1/universal/harvest/latest/actions/retrieve-project
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/harvest/latest/actions/retrieve-project?connectionId=$CONNECTION_ID&id=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/harvest/latest/actions/retrieve-project?${params}`, {
  headers: {
