...
Retrieves clients from Harvest.

```
GET https://connect.mindcloud.co/v1/universal/harvest/latest/actions/list-clients
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/harvest/latest/actions/list-clients?${params}`, {
  headers: {
