# Harvest: Retrieve Invoice

Retrieves an invoice from Harvest.

```
GET https://connect.mindcloud.co/v1/universal/harvest/latest/actions/retrieve-invoice
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/harvest/latest/actions/retrieve-invoice?connectionId=$CONNECTION_ID&id=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/harvest/latest/actions/retrieve-invoice?${params}`, {
  headers: {
