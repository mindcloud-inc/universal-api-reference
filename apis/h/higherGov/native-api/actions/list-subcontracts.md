# List Subcontracts with HigherGov
...
- **Method:** `GET`
- **Path:** `/api-external/subcontract/`
- **Base URL:** `https://www.highergov.com`
- **Official documentation:** [List Subcontracts](https://www.highergov.com/api-external/docs/#/api-external/api_external_subcontract_list)
