# HTML 2 PDF Universal API Authentication

Every HTML 2 PDF API request through MindCloud uses a MindCloud API key and the `connectionId` of a HTML 2 PDF connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your HTML 2 PDF connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [HTML 2 PDF action](README.md#actions-1) with your API key and `connectionId`.
