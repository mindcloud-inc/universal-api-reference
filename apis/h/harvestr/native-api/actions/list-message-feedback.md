# List Message Feedback with Harvestr.io

## Endpoint

- **Method:** `GET`
- **Path:** `/message/{id}/feedback`
- **Base URL:** `https://rest.harvestr.io/v1`
- **Official documentation:** [List Message Feedback](https://developers.harvestr.io/api/list-messages-feedback/)
