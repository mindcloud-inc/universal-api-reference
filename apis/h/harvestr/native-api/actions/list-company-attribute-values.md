# List Company Attribute Values with Harvestr.io

## Endpoint

- **Method:** `GET`
- **Path:** `/company/{id}/attribute-value`
- **Base URL:** `https://rest.harvestr.io/v1`
- **Official documentation:** [List Company Attribute Values](https://developers.harvestr.io/api/list-companys-attribute-values/)
