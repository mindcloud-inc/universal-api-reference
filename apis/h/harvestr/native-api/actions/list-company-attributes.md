# List Company Attributes with Harvestr.io

## Endpoint

- **Method:** `GET`
- **Path:** `/attribute/company`
- **Base URL:** `https://rest.harvestr.io/v1`
- **Official documentation:** [List Company Attributes](https://developers.harvestr.io/api/list-companies-attributes/)
