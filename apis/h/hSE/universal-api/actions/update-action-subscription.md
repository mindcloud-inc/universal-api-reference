# 4HSE: Update Action Subscription

Updates an existing action subscription in 4HSE.

```
PUT https://connect.mindcloud.co/v1/universal/hSE/latest/actions/update-action-subscription
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/hSE/latest/actions/update-action-subscription" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/hSE/latest/actions/update-action-subscription', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `id` | string | yes | The action subscription to update. |
