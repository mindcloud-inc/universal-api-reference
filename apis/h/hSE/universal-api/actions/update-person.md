...
```
PUT https://connect.mindcloud.co/v1/universal/hSE/latest/actions/update-person
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/hSE/latest/actions/update-person" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/hSE/latest/actions/update-person', {
  method: 'PUT',
  headers: {
...
| `projectIdBody` | string | yes | Project (company) ID. |
| `codeBody` | string | no | Employee code. |
