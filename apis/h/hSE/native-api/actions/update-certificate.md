...
- **Method:** `PUT`
- **Path:** `/v2/certificate/update/:id`
- **Base URL:** `https://service.4hse.com`
- **Official documentation:** [Update Certificate](https://docs.4hse.com/en/api/certificate/#operation-updateCertificate-put)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `id` | path | `string` | yes | The certificate to update. |
