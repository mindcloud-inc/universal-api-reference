# Habitica Universal API Authentication

Every Habitica API request through MindCloud uses a MindCloud API key and the `connectionId` of a Habitica connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Habitica connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Habitica action](README.md#actions-32) with your API key and `connectionId`.
