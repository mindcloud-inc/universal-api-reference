# HTTP Dogs: Get HTTP Status Dog AVIF



```
GET https://connect.mindcloud.co/v1/universal/hTTPDogs/latest/actions/get-http-status-dog-avif
```
...
Through the native HTTP Dogs API, this operation is `GET /:statusCode.avif` (base URL `https://http.dog`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-http-status-dog-avif.md) for the provider-specific parameters and requirements.
