# HeyGen Universal API Authentication

Every HeyGen API request through MindCloud uses a MindCloud API key and the `connectionId` of a HeyGen connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your HeyGen connection.
