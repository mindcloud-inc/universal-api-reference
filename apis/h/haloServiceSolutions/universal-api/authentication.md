# Halo Service Solutions Universal API Authentication

Every Halo Service Solutions API request through MindCloud uses a MindCloud API key and the `connectionId` of a Halo Service Solutions connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Halo Service Solutions connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Halo Service Solutions action](README.md#actions-41) with your API key and `connectionId`.
