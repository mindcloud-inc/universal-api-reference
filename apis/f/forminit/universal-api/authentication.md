# Forminit Universal API Authentication

Every Forminit API request through MindCloud uses a MindCloud API key and the `connectionId` of a Forminit connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Forminit connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Forminit action](README.md#actions-2) with your API key and `connectionId`.
