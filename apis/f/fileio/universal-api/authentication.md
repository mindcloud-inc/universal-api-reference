# File.io Universal API Authentication

Every File.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a File.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your File.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [File.io action](README.md#actions-6) with your API key and `connectionId`.
