# fal.ai Universal API Authentication

Every fal.ai API request through MindCloud uses a MindCloud API key and the `connectionId` of a fal.ai connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your fal.ai connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [fal.ai action](README.md#actions-33) with your API key and `connectionId`.
