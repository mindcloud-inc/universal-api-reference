# FuseDesk: Get Department

Retrieves a department record from FuseDesk.

```
GET https://connect.mindcloud.co/v1/universal/fuseDesk/latest/actions/get-department
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/fuseDesk/latest/actions/get-department?connectionId=$CONNECTION_ID&departmentId=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/fuseDesk/latest/actions/get-department?${params}`, {
  headers: {
