# FuseDesk: Update Contact

Updates an existing contact in FuseDesk.

```
PUT https://connect.mindcloud.co/v1/universal/fuseDesk/latest/actions/update-contact
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/fuseDesk/latest/actions/update-contact" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/fuseDesk/latest/actions/update-contact', {
  method: 'PUT',
  headers: {
...
| `contactId` | string | yes | The FuseDesk contact ID or UUID. |
