# Framework360 Universal API Authentication

Every Framework360 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Framework360 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Framework360 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Framework360 action](README.md#actions-86) with your API key and `connectionId`.
