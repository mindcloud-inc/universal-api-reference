# Fun Translations Universal API Authentication

Every Fun Translations API request through MindCloud uses a MindCloud API key and the `connectionId` of a Fun Translations connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Fun Translations connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Fun Translations action](README.md#actions-6) with your API key and `connectionId`.
