# Fluxguard: Delete Webhook

Deletes a webhook from Fluxguard.

```
DELETE https://connect.mindcloud.co/v1/universal/fluxguard/latest/actions/delete-webhook
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/fluxguard/latest/actions/delete-webhook?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/fluxguard/latest/actions/delete-webhook?${params}`, {
  headers: {
