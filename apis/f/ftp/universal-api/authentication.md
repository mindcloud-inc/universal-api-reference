# FTP Universal API Authentication

Every FTP API request through MindCloud uses a MindCloud API key and the `connectionId` of a FTP connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your FTP connection.
