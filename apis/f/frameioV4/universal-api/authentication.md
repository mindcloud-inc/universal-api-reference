# Frame.io v4 Universal API Authentication

Every Frame.io v4 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Frame.io v4 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Frame.io v4 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Frame.io v4 action](README.md#actions-40) with your API key and `connectionId`.
