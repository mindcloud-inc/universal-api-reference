# Frame.io v4: List Version Stack Children

Retrieves child items for a version stack in Frame.io v4.

```
GET https://connect.mindcloud.co/v1/universal/frameioV4/latest/actions/list-version-stack-children
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/frameioV4/latest/actions/list-version-stack-children?connectionId=$CONNECTION_ID&limit=25&offset=0&accountId=string&versionStackId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/frameioV4/latest/actions/list-version-stack-children?${params}`, {
  headers: {
...
Through the native Frame.io v4 API, this operation is `GET /accounts/:accountId/version_stacks/:versionStackId/children` (base URL `https://api.frame.io/v4`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-version-stack-children.md) for the provider-specific parameters and requirements.
