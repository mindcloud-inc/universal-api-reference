...
- **Official documentation:** [Update Contact](https://developer.fleetio.com/docs/api/contacts-update)
...
| `first_name` | body | `string` | no | This Contact's first name. |
