...
- **Official documentation:** [Create Vendor](https://developer.fleetio.com/docs/api/vendors-create)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `name` | body | `string` | yes | The name of the Vendor. Must be unique. |
