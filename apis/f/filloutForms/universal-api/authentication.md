# Fillout Forms Universal API Authentication

Every Fillout Forms API request through MindCloud uses a MindCloud API key and the `connectionId` of a Fillout Forms connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Fillout Forms connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Fillout Forms action](README.md#actions-26) with your API key and `connectionId`.
