# Fillout Universal API Authentication

Every Fillout API request through MindCloud uses a MindCloud API key and the `connectionId` of a Fillout connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Fillout connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Fillout action](README.md#actions-26) with your API key and `connectionId`.
