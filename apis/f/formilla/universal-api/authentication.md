# Formilla Universal API Authentication

Every Formilla API request through MindCloud uses a MindCloud API key and the `connectionId` of a Formilla connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Formilla connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Formilla action](README.md#actions-2) with your API key and `connectionId`.
