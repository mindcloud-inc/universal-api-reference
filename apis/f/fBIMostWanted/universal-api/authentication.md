# FBI Most Wanted Universal API Authentication

Every FBI Most Wanted API request through MindCloud uses a MindCloud API key and the `connectionId` of a FBI Most Wanted connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your FBI Most Wanted connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [FBI Most Wanted action](README.md#actions-1) with your API key and `connectionId`.
