# Freshworks CRM: Update Custom Module

Updates a custom module in Freshworks CRM.

```
PUT https://connect.mindcloud.co/v1/universal/freshworksCRM/latest/actions/update-custom-module
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/freshworksCRM/latest/actions/update-custom-module" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/freshworksCRM/latest/actions/update-custom-module', {
  method: 'PUT',
  headers: {
...
| `moduleCustomization.entity_name` | string | no |  |
| `moduleCustomization.plural_name` | string | no |  |
| `moduleCustomization.show_in_navigation_menu` | boolean | no |  |
| `moduleCustomization.singular_name` | string | no |  |
