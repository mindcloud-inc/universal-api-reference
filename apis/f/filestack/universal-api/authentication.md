# Filestack Universal API Authentication

Every Filestack API request through MindCloud uses a MindCloud API key and the `connectionId` of a Filestack connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Filestack connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Filestack action](README.md#actions-5) with your API key and `connectionId`.
