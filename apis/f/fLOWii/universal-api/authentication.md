# FLOWii Universal API Authentication

Every FLOWii API request through MindCloud uses a MindCloud API key and the `connectionId` of a FLOWii connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your FLOWii connection.
