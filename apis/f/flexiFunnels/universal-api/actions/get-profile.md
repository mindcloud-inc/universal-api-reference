# FlexiFunnels: Get Profile

Retrieves the authenticated member profile from FlexiFunnels.

```
GET https://connect.mindcloud.co/v1/universal/flexiFunnels/latest/actions/get-profile
```
