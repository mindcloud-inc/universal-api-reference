# Fiscal Data Service Universal API Authentication

Every Fiscal Data Service API request through MindCloud uses a MindCloud API key and the `connectionId` of a Fiscal Data Service connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Fiscal Data Service connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Fiscal Data Service action](README.md#actions-24) with your API key and `connectionId`.
