# Fiserv: Get Transaction

Retrieves detailed transaction information from Fiserv.

```
GET https://connect.mindcloud.co/v1/universal/fiserv/latest/actions/get-transaction
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/fiserv/latest/actions/get-transaction?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/fiserv/latest/actions/get-transaction?${params}`, {
  headers: {
