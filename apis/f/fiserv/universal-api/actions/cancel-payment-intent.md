# Fiserv: Cancel Payment Intent

Cancels a payment intent in Fiserv.

```
PUT https://connect.mindcloud.co/v1/universal/fiserv/latest/actions/cancel-payment-intent
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/fiserv/latest/actions/cancel-payment-intent" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/fiserv/latest/actions/cancel-payment-intent', {
  method: 'PUT',
  headers: {
