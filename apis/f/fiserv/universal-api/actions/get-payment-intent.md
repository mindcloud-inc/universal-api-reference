# Fiserv: Get Payment Intent

Retrieves a payment intent from Fiserv.

```
GET https://connect.mindcloud.co/v1/universal/fiserv/latest/actions/get-payment-intent
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/fiserv/latest/actions/get-payment-intent?connectionId=$CONNECTION_ID&xAccountId=string&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/fiserv/latest/actions/get-payment-intent?${params}`, {
  headers: {
