# Filestage: List Projects

Retrieves projects from Filestage.

```
GET https://connect.mindcloud.co/v1/universal/filestage/latest/actions/list-projects
```
...
Through the native Filestage API, this operation is `GET /projects` (base URL `https://api.filestage.io/ext/v2`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-projects.md) for the provider-specific parameters and requirements.
