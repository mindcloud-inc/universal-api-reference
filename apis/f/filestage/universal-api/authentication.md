# Filestage Universal API Authentication

Every Filestage API request through MindCloud uses a MindCloud API key and the `connectionId` of a Filestage connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Filestage connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Filestage action](README.md#actions-81) with your API key and `connectionId`.
