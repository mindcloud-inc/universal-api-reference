# Fliqr AI Universal API Authentication

Every Fliqr AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Fliqr AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Fliqr AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Fliqr AI action](README.md#actions-23) with your API key and `connectionId`.
