...
```
POST https://connect.mindcloud.co/v1/universal/fx/latest/actions/resize-image
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/fx/latest/actions/resize-image" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/fx/latest/actions/resize-image', {
  method: 'POST',
  headers: {
