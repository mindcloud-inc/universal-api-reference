# 1001fx Universal API Authentication

Every 1001fx API request through MindCloud uses a MindCloud API key and the `connectionId` of a 1001fx connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your 1001fx connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [1001fx action](README.md#actions-24) with your API key and `connectionId`.
