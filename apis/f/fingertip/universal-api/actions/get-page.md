...
```
GET https://connect.mindcloud.co/v1/universal/fingertip/latest/actions/get-page
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/fingertip/latest/actions/get-page?connectionId=$CONNECTION_ID&pageId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/fingertip/latest/actions/get-page?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `pageId` | string | yes | ID of the page to retrieve |
