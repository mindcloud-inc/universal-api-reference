# Fingertip: List Blog Posts



```
GET https://connect.mindcloud.co/v1/universal/fingertip/latest/actions/list-blog-posts
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/fingertip/latest/actions/list-blog-posts?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `siteId` | string | yes | ID of the site to list blog posts for. |
