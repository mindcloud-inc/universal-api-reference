# Fingertip: Get Form Template



```
GET https://connect.mindcloud.co/v1/universal/fingertip/latest/actions/get-form-template
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/fingertip/latest/actions/get-form-template?connectionId=$CONNECTION_ID&formTemplateId=string&siteId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/fingertip/latest/actions/get-form-template?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `formTemplateId` | string | yes | ID of the form template to retrieve. |
