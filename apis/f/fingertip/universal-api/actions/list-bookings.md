# Fingertip: List Bookings



```
GET https://connect.mindcloud.co/v1/universal/fingertip/latest/actions/list-bookings
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/fingertip/latest/actions/list-bookings?connectionId=$CONNECTION_ID&limit=25&offset=0&siteId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/fingertip/latest/actions/list-bookings?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `siteId` | string | yes | ID of the site to list bookings for. |
