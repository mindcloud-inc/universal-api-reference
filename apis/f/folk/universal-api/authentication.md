# folk Universal API Authentication

Every folk API request through MindCloud uses a MindCloud API key and the `connectionId` of a folk connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your folk connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [folk action](README.md#actions-36) with your API key and `connectionId`.
