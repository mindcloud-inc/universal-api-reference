# Flotiq Universal API Authentication

Every Flotiq API request through MindCloud uses a MindCloud API key and the `connectionId` of a Flotiq connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Flotiq connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Flotiq action](README.md#actions-38) with your API key and `connectionId`.
