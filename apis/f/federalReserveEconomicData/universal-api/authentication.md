# Federal Reserve Economic Data Universal API Authentication

Every Federal Reserve Economic Data API request through MindCloud uses a MindCloud API key and the `connectionId` of a Federal Reserve Economic Data connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Federal Reserve Economic Data connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Federal Reserve Economic Data action](README.md#actions-20) with your API key and `connectionId`.
