...
- **Official documentation:** [Create Contact](https://developers.freshdesk.com/api/#create_contact)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `name` | body | `string` | yes | Name of the contact |
