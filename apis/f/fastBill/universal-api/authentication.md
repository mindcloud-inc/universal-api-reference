# FastBill Universal API Authentication

Every FastBill API request through MindCloud uses a MindCloud API key and the `connectionId` of a FastBill connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your FastBill connection.
