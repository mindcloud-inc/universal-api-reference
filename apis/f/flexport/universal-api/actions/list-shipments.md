# Flexport: List Shipments

Retrieves shipments from your Flexport account.

```
GET https://connect.mindcloud.co/v1/universal/flexport/latest/actions/list-shipments
```
