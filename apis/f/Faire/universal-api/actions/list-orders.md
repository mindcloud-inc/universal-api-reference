...
```
GET https://connect.mindcloud.co/v1/universal/Faire/latest/actions/list-orders
```
...
Through the native Faire API, this operation is `GET orders` (base URL `https://www.faire.com/external-api/v2/`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-orders.md) for the provider-specific parameters and requirements.
