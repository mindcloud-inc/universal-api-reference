# Five9 Universal API Authentication

Every Five9 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Five9 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Five9 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Five9 action](README.md#actions-6) with your API key and `connectionId`.
