...
A consolidated summary of Five9's API configuration and 6 documented operations, with links to official documentation.
...
| [List Contacts](actions/list-contacts.md) | `GET https://app-scl.five9.com/appsvcs/rs/svc/orgs/:domainID/getContactRecords` | [docs](https://documentation.five9.com/bundle/admin-console/page/admin-console/contact-fields/_ch-contact-fields.htm) |
