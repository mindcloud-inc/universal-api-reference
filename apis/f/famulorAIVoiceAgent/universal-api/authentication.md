# Famulor AI - Voice Agent Universal API Authentication

Every Famulor AI - Voice Agent API request through MindCloud uses a MindCloud API key and the `connectionId` of a Famulor AI - Voice Agent connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Famulor AI - Voice Agent connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Famulor AI - Voice Agent action](README.md#actions-40) with your API key and `connectionId`.
