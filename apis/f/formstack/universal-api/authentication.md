# Formstack Universal API Authentication

Every Formstack API request through MindCloud uses a MindCloud API key and the `connectionId` of a Formstack connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Formstack connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Formstack action](README.md#actions-24) with your API key and `connectionId`.
