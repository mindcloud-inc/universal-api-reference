# Create Form Field with Formstack
...
- **Official documentation:** [Create Form Field](https://developers.formstack.com/reference/createfieldinform-1)
...
| `type` | body | `list<string>` | no | Type of the field. Accepted values: `address`, `checkbox`, `creditcard`, `datetime`, `email`, `embed`, `file`, `matrix`, `name`, `number`, `phone`, `product`, `radio`, `rating`, `richtext`, `section`, `select`, `signature`, `table`, `text`, `textarea`. |
