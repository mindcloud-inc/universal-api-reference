...
```
GET https://connect.mindcloud.co/v1/universal/flespi/latest/actions/list-devices
```
...
Through the native Flespi API, this operation is `GET /gw/devices/all` (base URL `https://flespi.io`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-devices.md) for the provider-specific parameters and requirements.
