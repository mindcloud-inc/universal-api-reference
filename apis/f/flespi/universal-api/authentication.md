# Flespi Universal API Authentication

Every Flespi API request through MindCloud uses a MindCloud API key and the `connectionId` of a Flespi connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Flespi connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Flespi action](README.md#actions-365) with your API key and `connectionId`.
