# Fourthwall: Get Product

Retrieves a product from Fourthwall by ID.

```
GET https://connect.mindcloud.co/v1/universal/fourthwall/latest/actions/get-product
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/fourthwall/latest/actions/get-product?connectionId=$CONNECTION_ID&productId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/fourthwall/latest/actions/get-product?${params}`, {
  headers: {
