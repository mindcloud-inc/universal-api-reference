# Fourthwall: Update Webhook

Updates an existing webhook in Fourthwall.

```
PUT https://connect.mindcloud.co/v1/universal/fourthwall/latest/actions/update-webhook
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/fourthwall/latest/actions/update-webhook" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/fourthwall/latest/actions/update-webhook', {
  method: 'PUT',
  headers: {
