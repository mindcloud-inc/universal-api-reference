# Fourthwall Universal API Authentication

Every Fourthwall API request through MindCloud uses a MindCloud API key and the `connectionId` of a Fourthwall connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Fourthwall connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Fourthwall action](README.md#actions-21) with your API key and `connectionId`.
