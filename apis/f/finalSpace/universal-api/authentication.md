# Final Space Universal API Authentication

Every Final Space API request through MindCloud uses a MindCloud API key and the `connectionId` of a Final Space connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Final Space connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Final Space action](README.md#actions-7) with your API key and `connectionId`.
