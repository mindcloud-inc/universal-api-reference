...
```
GET https://connect.mindcloud.co/v1/universal/figma/latest/actions/get-component
```
...
Through the native Figma API, this operation is `GET /components/:key` (base URL `https://api.figma.com/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-component.md) for the provider-specific parameters and requirements.
