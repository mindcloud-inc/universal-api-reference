# Files.com Universal API Authentication

Every Files.com API request through MindCloud uses a MindCloud API key and the `connectionId` of a Files.com connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Files.com connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Files.com action](README.md#actions-38) with your API key and `connectionId`.
