# Festivo Universal API Authentication

Every Festivo API request through MindCloud uses a MindCloud API key and the `connectionId` of a Festivo connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Festivo connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Festivo action](README.md#actions-2) with your API key and `connectionId`.
