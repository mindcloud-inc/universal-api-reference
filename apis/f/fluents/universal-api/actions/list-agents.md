...
```
GET https://connect.mindcloud.co/v1/universal/fluents/latest/actions/list-agents
```
...
Through the native Fluents API, this operation is `GET /agents/list` (base URL `https://api.fluents.ai/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-agents.md) for the provider-specific parameters and requirements.
