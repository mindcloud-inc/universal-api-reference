# FEMA Universal API Authentication

Every FEMA API request through MindCloud uses a MindCloud API key and the `connectionId` of a FEMA connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your FEMA connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [FEMA action](README.md#actions-40) with your API key and `connectionId`.
