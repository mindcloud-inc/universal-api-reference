# Formstack Documents Universal API Authentication

Every Formstack Documents API request through MindCloud uses a MindCloud API key and the `connectionId` of a Formstack Documents connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Formstack Documents connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Formstack Documents action](README.md#actions-26) with your API key and `connectionId`.
