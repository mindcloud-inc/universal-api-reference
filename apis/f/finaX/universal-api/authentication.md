# finaX Universal API Authentication

Every finaX API request through MindCloud uses a MindCloud API key and the `connectionId` of a finaX connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your finaX connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [finaX action](README.md#actions-12) with your API key and `connectionId`.
