# Frontegg: Add Roles To Group

Adds roles to a user group in Frontegg.

```
PUT https://connect.mindcloud.co/v1/universal/frontegg/latest/actions/add-roles-to-group
```
...
| `roleIds[]` | array<string> | yes | Role IDs to add to the group. |
...
Through the native Frontegg API, this operation is `POST /identity/resources/groups/v1/:groupId/roles` (base URL `https://api.frontegg.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/add-roles-to-group.md) for the provider-specific parameters and requirements.
