# Frontegg: Delete User

Deletes a user from Frontegg.

```
DELETE https://connect.mindcloud.co/v1/universal/frontegg/latest/actions/delete-user
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/frontegg/latest/actions/delete-user?connectionId=$CONNECTION_ID&userId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/frontegg/latest/actions/delete-user?${params}`, {
  headers: {
