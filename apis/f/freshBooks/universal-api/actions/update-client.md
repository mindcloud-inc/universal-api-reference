...
```
PUT https://connect.mindcloud.co/v1/universal/freshBooks/latest/actions/update-client
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/freshBooks/latest/actions/update-client" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/freshBooks/latest/actions/update-client', {
  method: 'PUT',
  headers: {
