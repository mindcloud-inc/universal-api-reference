# Firebolt Universal API Authentication

Every Firebolt API request through MindCloud uses a MindCloud API key and the `connectionId` of a Firebolt connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Firebolt connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Firebolt action](README.md#actions-39) with your API key and `connectionId`.
