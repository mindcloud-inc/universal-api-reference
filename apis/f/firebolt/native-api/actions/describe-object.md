...
- **Official documentation:** [Describe Object](https://docs.firebolt.io/reference-sql/commands/metadata/describe)
...
| `tableName` | body | `string` | yes | Table name to describe. Firebolt's DESCRIBE reference is table-scoped. |
