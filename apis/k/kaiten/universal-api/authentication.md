# Kaiten Universal API Authentication

Every Kaiten API request through MindCloud uses a MindCloud API key and the `connectionId` of a Kaiten connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Kaiten connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Kaiten action](README.md#actions-24) with your API key and `connectionId`.
