# King County Metro Universal API Authentication

Every King County Metro API request through MindCloud uses a MindCloud API key and the `connectionId` of a King County Metro connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your King County Metro connection.
