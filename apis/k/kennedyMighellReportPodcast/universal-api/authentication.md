# Kennedy-Mighell Report Podcast Universal API Authentication

Every Kennedy-Mighell Report Podcast API request through MindCloud uses a MindCloud API key and the `connectionId` of a Kennedy-Mighell Report Podcast connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Kennedy-Mighell Report Podcast connection.
