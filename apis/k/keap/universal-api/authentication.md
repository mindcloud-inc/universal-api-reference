# Keap Universal API Authentication

Every Keap API request through MindCloud uses a MindCloud API key and the `connectionId` of a Keap connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Keap connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Keap action](README.md#actions-30) with your API key and `connectionId`.
