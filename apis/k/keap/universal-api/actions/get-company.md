...
```
GET https://connect.mindcloud.co/v1/universal/keap/latest/actions/get-company
```
...
Through the native Keap API, this operation is `GET /companies/:company_id` (base URL `https://api.infusionsoft.com/crm/rest/v2`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-company.md) for the provider-specific parameters and requirements.
