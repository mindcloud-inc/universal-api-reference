# Karma CRM: Update Contact

Updates an existing contact in Karma CRM.

```
PUT https://connect.mindcloud.co/v1/universal/karmaCRM/latest/actions/update-contact
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/karmaCRM/latest/actions/update-contact" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/karmaCRM/latest/actions/update-contact', {
  method: 'PUT',
  headers: {
...
| `contact` | object | yes | Contact payload object with the fields to update. |
