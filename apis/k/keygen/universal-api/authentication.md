# Keygen Universal API Authentication

Every Keygen API request through MindCloud uses a MindCloud API key and the `connectionId` of a Keygen connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Keygen connection.
