# Klippa DocHorizon Universal API Authentication

Every Klippa DocHorizon API request through MindCloud uses a MindCloud API key and the `connectionId` of a Klippa DocHorizon connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Klippa DocHorizon connection.
