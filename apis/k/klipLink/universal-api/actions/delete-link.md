# KlipLink: Delete Link



```
DELETE https://connect.mindcloud.co/v1/universal/klipLink/latest/actions/delete-link
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/klipLink/latest/actions/delete-link?connectionId=$CONNECTION_ID&shortUrl=https%3A%2F%2Fexample.com" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/klipLink/latest/actions/delete-link?${params}`, {
  headers: {
