# Kite Suite Universal API Authentication

Every Kite Suite API request through MindCloud uses a MindCloud API key and the `connectionId` of a Kite Suite connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Kite Suite connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Kite Suite action](README.md#actions-274) with your API key and `connectionId`.
