# Klaviyo Universal API Authentication

Every Klaviyo API request through MindCloud uses a MindCloud API key and the `connectionId` of a Klaviyo connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Klaviyo connection.
