# KleverKey Universal API Authentication

Every KleverKey API request through MindCloud uses a MindCloud API key and the `connectionId` of a KleverKey connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your KleverKey connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [KleverKey action](README.md#actions-24) with your API key and `connectionId`.
