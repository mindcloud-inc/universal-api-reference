# Kontent.ai Universal API Authentication

Every Kontent.ai API request through MindCloud uses a MindCloud API key and the `connectionId` of a Kontent.ai connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Kontent.ai connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Kontent.ai action](README.md#actions-40) with your API key and `connectionId`.
