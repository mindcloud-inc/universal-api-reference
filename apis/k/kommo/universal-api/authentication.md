# Kommo Universal API Authentication

Every Kommo API request through MindCloud uses a MindCloud API key and the `connectionId` of a Kommo connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Kommo connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Kommo action](README.md#actions-137) with your API key and `connectionId`.
