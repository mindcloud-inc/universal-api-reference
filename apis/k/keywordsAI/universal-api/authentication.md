# Keywords AI Universal API Authentication

Every Keywords AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Keywords AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Keywords AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Keywords AI action](README.md#actions-17) with your API key and `connectionId`.
