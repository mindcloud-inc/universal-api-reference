# KLIPY: List GIF Categories

Retrieves available GIF categories from KLIPY.

```
GET https://connect.mindcloud.co/v1/universal/kLIPY/latest/actions/list-gif-categories
```
...
| --- | --- | --- | --- |
| `locale` | string | no | Optional country code used to localize GIF categories. |
