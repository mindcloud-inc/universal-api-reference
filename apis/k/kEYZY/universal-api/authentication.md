# KEYZY Universal API Authentication

Every KEYZY API request through MindCloud uses a MindCloud API key and the `connectionId` of a KEYZY connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your KEYZY connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [KEYZY action](README.md#actions-14) with your API key and `connectionId`.
