# Kiwili Universal API Authentication

Every Kiwili API request through MindCloud uses a MindCloud API key and the `connectionId` of a Kiwili connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Kiwili connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Kiwili action](README.md#actions-54) with your API key and `connectionId`.
