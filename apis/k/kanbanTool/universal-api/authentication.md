# Kanban Tool Universal API Authentication

Every Kanban Tool API request through MindCloud uses a MindCloud API key and the `connectionId` of a Kanban Tool connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Kanban Tool connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Kanban Tool action](README.md#actions-26) with your API key and `connectionId`.
