# KIS Universal API Authentication

Every KIS API request through MindCloud uses a MindCloud API key and the `connectionId` of a KIS connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your KIS connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [KIS action](README.md#actions-7) with your API key and `connectionId`.
