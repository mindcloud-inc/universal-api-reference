# Kapso Universal API Authentication

Every Kapso API request through MindCloud uses a MindCloud API key and the `connectionId` of a Kapso connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Kapso connection.
