# Zyte: Get Forum Thread Extraction Usage

Retrieves forum thread extraction usage metrics from Zyte.

```
GET https://connect.mindcloud.co/v1/universal/zyte/latest/actions/get-forum-thread-extraction-usage
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/zyte/latest/actions/get-forum-thread-extraction-usage?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/zyte/latest/actions/get-forum-thread-extraction-usage?${params}`, {
  headers: {
