# Zyte: Get File Download Feature Usage

Retrieves file download feature usage metrics from Zyte.

```
GET https://connect.mindcloud.co/v1/universal/zyte/latest/actions/get-file-download-feature-usage
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/zyte/latest/actions/get-file-download-feature-usage?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/zyte/latest/actions/get-file-download-feature-usage?${params}`, {
  headers: {
