# ZenRows Universal API Authentication

Every ZenRows API request through MindCloud uses a MindCloud API key and the `connectionId` of a ZenRows connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ZenRows connection.
