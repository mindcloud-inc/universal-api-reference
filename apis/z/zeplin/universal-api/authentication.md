# Zeplin Universal API Authentication

Every Zeplin API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zeplin connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zeplin connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zeplin action](README.md#actions-121) with your API key and `connectionId`.
