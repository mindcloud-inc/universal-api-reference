# Zeo Route Planner Universal API Authentication

Every Zeo Route Planner API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zeo Route Planner connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zeo Route Planner connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zeo Route Planner action](README.md#actions-13) with your API key and `connectionId`.
