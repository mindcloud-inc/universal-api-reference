# Zoho Webinar Universal API Authentication

Every Zoho Webinar API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zoho Webinar connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zoho Webinar connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zoho Webinar action](README.md#actions-22) with your API key and `connectionId`.
