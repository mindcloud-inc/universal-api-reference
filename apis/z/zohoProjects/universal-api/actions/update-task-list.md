# Zoho Projects: Update Task List

Updates an existing task list in Zoho Projects.

```
PUT https://connect.mindcloud.co/v1/universal/zohoProjects/latest/actions/update-task-list
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/zohoProjects/latest/actions/update-task-list" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/zohoProjects/latest/actions/update-task-list', {
  method: 'PUT',
  headers: {
...
Through the native Zoho Projects API, this operation is `PATCH /portal/[:PORTALID]/projects/[:PROJECTID]/tasklists/[:TASKLISTID]` (base URL `https://projectsapi.zoho.com/api/v3`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/update-task-list.md) for the provider-specific parameters and requirements.
