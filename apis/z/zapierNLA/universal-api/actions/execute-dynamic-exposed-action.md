# Zapier NLA: Execute Dynamic Exposed Action



```
POST https://connect.mindcloud.co/v1/universal/zapierNLA/latest/actions/execute-dynamic-exposed-action
```
...
Through the native Zapier NLA API, this operation is `POST /api/v1/dynamic/exposed/:exposed_app_action_id/execute/` (base URL `https://actions.zapier.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/execute-dynamic-exposed-action.md) for the provider-specific parameters and requirements.
