...
- **Official documentation:** [Find](https://www.zoho.com/sheet/help/api/v2/#CONTENT-Find)
...
| `search` | body | `string` | yes | The string that needs to be searched |
| `scope` | body | `string` | yes | workbook \| worksheet \| row \| column |
| `worksheet_name` | body | `string` | no | Name of the worksheet if scope is either worksheet, or row, or column |
...
| `is_exact_match` | body | `boolean` | no | If set to true the search will match with the full content of the cell. |
