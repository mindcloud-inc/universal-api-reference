# Delete Records from Table with Zoho Sheet
...
- **Official documentation:** [Delete Records from Table](https://www.zoho.com/sheet/help/api/v2/#TABULAR-Delete-records-from-table)
...
| `table_name` | body | `string` | yes | Name of the table whose records needs to be deleted |
