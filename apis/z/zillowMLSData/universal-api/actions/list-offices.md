# Zillow MLS Data: List offices

Retrieves offices from a Zillow MLS Data dataset.

```
GET https://connect.mindcloud.co/v1/universal/zillowMLSData/latest/actions/list-offices
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/zillowMLSData/latest/actions/list-offices?connectionId=$CONNECTION_ID&dataset=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/zillowMLSData/latest/actions/list-offices?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `dataset` | string | yes | Bridge dataset code to read offices from. |
