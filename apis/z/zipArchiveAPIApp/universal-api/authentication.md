# Zip Archive API app Universal API Authentication

Every Zip Archive API app API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zip Archive API app connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zip Archive API app connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zip Archive API app action](README.md#actions-2) with your API key and `connectionId`.
