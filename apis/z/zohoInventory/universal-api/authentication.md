# Zoho Inventory Universal API Authentication

Every Zoho Inventory API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zoho Inventory connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zoho Inventory connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zoho Inventory action](README.md#actions-24) with your API key and `connectionId`.
