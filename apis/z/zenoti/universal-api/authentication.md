# Zenoti Universal API Authentication

Every Zenoti API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zenoti connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zenoti connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zenoti action](README.md#actions-18) with your API key and `connectionId`.
