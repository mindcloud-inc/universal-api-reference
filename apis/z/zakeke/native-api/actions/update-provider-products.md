# Update Provider Products with Zakeke

## Endpoint

- **Method:** `POST`
- **Path:** `/v2/providerproducts/update`
- **Base URL:** `https://api.zakeke.com`
- **Official documentation:** [Update Provider Products](https://api-reference.zakeke.com/docs)
...
| `products[]` | body | `array<object>` | no | Provider product list to update. |
