# Zyllio Universal API Authentication

Every Zyllio API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zyllio connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zyllio connection.
