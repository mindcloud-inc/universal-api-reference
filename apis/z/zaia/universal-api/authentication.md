# Zaia Universal API Authentication

Every Zaia API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zaia connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zaia connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zaia action](README.md#actions-20) with your API key and `connectionId`.
