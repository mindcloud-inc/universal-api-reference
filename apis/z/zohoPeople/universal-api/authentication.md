# Zoho People Universal API Authentication

Every Zoho People API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zoho People connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zoho People connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zoho People action](README.md#actions-23) with your API key and `connectionId`.
