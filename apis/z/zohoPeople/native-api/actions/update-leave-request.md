# Update Leave Request with Zoho People
...
- **Method:** `PUT`
- **Path:** `/api/v3/leave-tracker/leaves/:leaveRecordId`
- **Base URL:** `https://people.zoho.com`
- **Official documentation:** [Update Leave Request](https://www.zoho.com/people/api/v3/leave-tracker/edit-leave.html)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `leaveRecordId` | path | `string` | yes | Leave request record ID to update. |
