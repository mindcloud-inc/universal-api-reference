# Zippopotamus Universal API Authentication

Every Zippopotamus API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zippopotamus connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zippopotamus connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zippopotamus action](README.md#actions-3) with your API key and `connectionId`.
