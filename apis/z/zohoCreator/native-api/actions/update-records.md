# Update Records with Zoho Creator
...
- **Official documentation:** [Update Records](https://www.zoho.com/creator/help/api/v2.1/update-records.html)
...
| `criteria` | body | `string` | yes | Criteria used to select records for update. |
| `data` | body | `object` | yes | Field values to update. |
