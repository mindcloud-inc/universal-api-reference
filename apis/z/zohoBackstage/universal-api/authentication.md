# Zoho Backstage Universal API Authentication

Every Zoho Backstage API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zoho Backstage connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zoho Backstage connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zoho Backstage action](README.md#actions-19) with your API key and `connectionId`.
