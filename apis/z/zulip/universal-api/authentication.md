# Zulip Universal API Authentication

Every Zulip API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zulip connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zulip connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zulip action](README.md#actions-25) with your API key and `connectionId`.
