# Zoho Cliq Universal API Authentication

Every Zoho Cliq API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zoho Cliq connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zoho Cliq connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zoho Cliq action](README.md#actions-24) with your API key and `connectionId`.
