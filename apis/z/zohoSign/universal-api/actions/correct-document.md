# Zoho Sign: Correct Document

Marks a document for correction in Zoho Sign.

```
PUT https://connect.mindcloud.co/v1/universal/zohoSign/latest/actions/correct-document
```
...
Through the native Zoho Sign API, this operation is `POST /requests/:requestId/markforcorrection` (base URL `https://sign.zoho.com/api/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/correct-document.md) for the provider-specific parameters and requirements.
