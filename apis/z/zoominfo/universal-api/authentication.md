# Zoominfo Universal API Authentication

Every Zoominfo API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zoominfo connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zoominfo connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zoominfo action](README.md#actions-84) with your API key and `connectionId`.
