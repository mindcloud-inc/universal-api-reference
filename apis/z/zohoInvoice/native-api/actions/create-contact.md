# Create Contact with Zoho Invoice
...
- **Official documentation:** [Create Contact](https://www.zoho.com/invoice/api/v3/contacts/#create-a-contact)
...
| `custom_fields[]` | body | `array<object>` | no | Custom fields or additional fields for the contact. |
