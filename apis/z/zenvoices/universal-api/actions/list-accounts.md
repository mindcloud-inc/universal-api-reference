# Zenvoices: List Accounts

Retrieves accounts from your Zenvoices workspace.

```
GET https://connect.mindcloud.co/v1/universal/zenvoices/latest/actions/list-accounts
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/zenvoices/latest/actions/list-accounts?${params}`, {
  headers: {
