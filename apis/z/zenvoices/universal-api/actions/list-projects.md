# Zenvoices: List Projects

Retrieves projects from your Zenvoices workspace.

```
GET https://connect.mindcloud.co/v1/universal/zenvoices/latest/actions/list-projects
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/zenvoices/latest/actions/list-projects?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/zenvoices/latest/actions/list-projects?${params}`, {
  headers: {
