...
- **Official documentation:** [Create 4K Export](https://platform.zapcap.ai/docs/api#tag/videos/post/videos/%7BvideoId%7D/task)
...
| `exportSettings.quality` | body | `string` | yes | ZapCap export quality level. |
