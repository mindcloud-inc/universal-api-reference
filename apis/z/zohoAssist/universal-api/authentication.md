# Zoho Assist Universal API Authentication

Every Zoho Assist API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zoho Assist connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zoho Assist connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zoho Assist action](README.md#actions-13) with your API key and `connectionId`.
