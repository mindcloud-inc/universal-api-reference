# Zoom Team Chat Universal API Authentication

Every Zoom Team Chat API request through MindCloud uses a MindCloud API key and the `connectionId` of a Zoom Team Chat connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Zoom Team Chat connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Zoom Team Chat action](README.md#actions-40) with your API key and `connectionId`.
