# National Weather Service Universal API Authentication

Every National Weather Service API request through MindCloud uses a MindCloud API key and the `connectionId` of a National Weather Service connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your National Weather Service connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [National Weather Service action](README.md#actions-40) with your API key and `connectionId`.
