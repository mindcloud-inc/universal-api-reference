# Get Ticket Volume Time Series with NeetoDesk

## Endpoint

- **Method:** `GET`
- **Path:** `/reports/ticket-time-series`
- **Base URL:** `https://{workspaceSubdomain}.neetodesk.com/api/external/v2`
- **Official documentation:** [Get Ticket Volume Time Series](https://apidocs.neetodesk.com/api-reference/reports/get-ticket-time-series)
