...
Retrieves a deal from Nimble by ID.

```
GET https://connect.mindcloud.co/v1/universal/nimble/latest/actions/get-deal
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/nimble/latest/actions/get-deal?connectionId=$CONNECTION_ID&dealId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/nimble/latest/actions/get-deal?${params}`, {
  headers: {
