# Nimble: Update Contact

Updates an existing contact in Nimble.

```
PUT https://connect.mindcloud.co/v1/universal/nimble/latest/actions/update-contact
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/nimble/latest/actions/update-contact" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/nimble/latest/actions/update-contact', {
  method: 'PUT',
  headers: {
