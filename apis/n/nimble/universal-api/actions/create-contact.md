...
```
POST https://connect.mindcloud.co/v1/universal/nimble/latest/actions/create-contact
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/nimble/latest/actions/create-contact" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/nimble/latest/actions/create-contact', {
  method: 'POST',
  headers: {
