...
```
PUT https://connect.mindcloud.co/v1/universal/nimble/latest/actions/update-deal
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/nimble/latest/actions/update-deal" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/nimble/latest/actions/update-deal', {
  method: 'PUT',
  headers: {
