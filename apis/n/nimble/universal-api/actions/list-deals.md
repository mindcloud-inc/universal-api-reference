...
Retrieves a list of deals from Nimble.

```
GET https://connect.mindcloud.co/v1/universal/nimble/latest/actions/list-deals
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/nimble/latest/actions/list-deals?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/nimble/latest/actions/list-deals?${params}`, {
  headers: {
...
| `fieldsValues.69bc532677d905125927a64d[]` | array<object> |  |
| `fieldsValues.69bc532677d905125927a64d[].isPrimary` | boolean |  |
| `fieldsValues.69bc532677d905125927a64d[].value` | string |  |
...
| `fieldsValuesWithNames.actualCloseDate[]` | array<object> |  |
| `fieldsValuesWithNames.actualCloseDate[].isPrimary` | boolean |  |
| `fieldsValuesWithNames.actualCloseDate[].value` | string |  |
...
| `relatedContacts[].contact.email[]` | string |  |
| `relatedContacts[].contact.employment` | object |  |
| `relatedContacts[].contact.employment.companyName` | string |  |
...
| `relatedContacts[].contact.phones[]` | string |  |
| `relatedContacts[].contact.phones[].label` | string |  |
| `relatedContacts[].contact.phones[].value` | string |  |
| `relatedContacts[].contact.subtitle` | string |  |
| `relatedContacts[].contact.title` | string |  |
| `relatedContacts[].employments[]` | string |  |
| `relatedContacts[].employments[].employer` | object |  |
| `relatedContacts[].employments[].employer.avatarUrl` | string |  |
| `relatedContacts[].employments[].employer.contactType` | string |  |
| `relatedContacts[].employments[].employer.email[]` | array<string> |  |
| `relatedContacts[].employments[].employer.employment` | object |  |
| `relatedContacts[].employments[].employer.id` | string |  |
| `relatedContacts[].employments[].employer.isViewable` | boolean |  |
| `relatedContacts[].employments[].employer.name` | string |  |
| `relatedContacts[].employments[].employer.phones[]` | array<string> |  |
| `relatedContacts[].employments[].employer.subtitle` | object |  |
| `relatedContacts[].employments[].employer.title` | object |  |
| `relatedContacts[].employments[].endDate` | object |  |
| `relatedContacts[].employments[].startDate` | string |  |
| `relatedContacts[].employments[].title` | string |  |
| `relatedContacts[].note` | object |  |
| `relatedExternalContacts[]` | string |  |
| `relatedExternalContacts[].contactInfo` | string |  |
| `relatedExternalContacts[].note` | string |  |
| `stage` | object |  |
...
| `stageTransitions.beforeFinalStage.archivedAt` | object |  |
| `stageTransitions.beforeFinalStage.created` | string |  |
| `stageTransitions.beforeFinalStage.creator` | object |  |
| `stageTransitions.beforeFinalStage.creator.avatarUrl` | object |  |
| `stageTransitions.beforeFinalStage.creator.email` | string |  |
| `stageTransitions.beforeFinalStage.creator.isActive` | boolean |  |
| `stageTransitions.beforeFinalStage.creator.name` | string |  |
| `stageTransitions.beforeFinalStage.creator.userId` | string |  |
| `stageTransitions.beforeFinalStage.defaultProbability` | number |  |
| `stageTransitions.beforeFinalStage.description` | string |  |
| `stageTransitions.beforeFinalStage.expectedDays` | number |  |
| `stageTransitions.beforeFinalStage.name` | string |  |
| `stageTransitions.beforeFinalStage.pipelineId` | string |  |
| `stageTransitions.beforeFinalStage.role` | object |  |
| `stageTransitions.beforeFinalStage.role.isFinal` | boolean |  |
| `stageTransitions.beforeFinalStage.role.name` | string |  |
| `stageTransitions.beforeFinalStage.stageId` | string |  |
| `stageTransitions.beforeFinalStage.updated` | string |  |
...
| `updated` | string |  |
| `updatedBy` | object |  |
| `updatedBy.avatarUrl` | object |  |
| `updatedBy.email` | string |  |
| `updatedBy.isActive` | boolean |  |
| `updatedBy.name` | string |  |
| `updatedBy.userId` | string |  |

## Native endpoint

Through the native Nimble API, this operation is `GET /api/v2/deals` (base URL `https://app.nimble.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-deals.md) for the provider-specific parameters and requirements.
