# Nimble Universal API Authentication

Every Nimble API request through MindCloud uses a MindCloud API key and the `connectionId` of a Nimble connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Nimble connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Nimble action](README.md#actions-24) with your API key and `connectionId`.
