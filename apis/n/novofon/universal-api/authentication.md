# Novofon Universal API Authentication

Every Novofon API request through MindCloud uses a MindCloud API key and the `connectionId` of a Novofon connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Novofon connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Novofon action](README.md#actions-18) with your API key and `connectionId`.
