# NCEI Climate Data Universal API Authentication

Every NCEI Climate Data API request through MindCloud uses a MindCloud API key and the `connectionId` of a NCEI Climate Data connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your NCEI Climate Data connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [NCEI Climate Data action](README.md#actions-13) with your API key and `connectionId`.
