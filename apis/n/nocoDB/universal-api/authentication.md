# NocoDB Universal API Authentication

Every NocoDB API request through MindCloud uses a MindCloud API key and the `connectionId` of a NocoDB connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your NocoDB connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [NocoDB action](README.md#actions-26) with your API key and `connectionId`.
