...
- **Method:** `GET`
- **Path:** `teams/:teamId/databases/:dbId/tables/:tableId/records/:recordId/files/:file/metadata`
- **Base URL:** `https://api.ninox.com/v1`
- **Official documentation:** [Get File Metadata](https://forum.ninox.com/t/35yzp89/api-endpoints-for-public-cloud)
