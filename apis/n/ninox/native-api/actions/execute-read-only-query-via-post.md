# Execute Read-Only Query Via POST with Ninox
...
- **Official documentation:** [Execute Read-Only Query Via POST](https://forum.ninox.com/t/35yzp89/api-endpoints-for-public-cloud)
...
| `query` | body | `string` | yes | The read-only Ninox query to execute. |
