...
- **Method:** `GET`
- **Path:** `teams/:teamId/databases/:dbId/tables/:tableId/records/:recordId/files/:file`
- **Base URL:** `https://api.ninox.com/v1`
- **Official documentation:** [Download File](https://forum.ninox.com/t/35yzp89/api-endpoints-for-public-cloud)
