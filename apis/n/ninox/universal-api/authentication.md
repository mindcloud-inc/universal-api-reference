# Ninox Universal API Authentication

Every Ninox API request through MindCloud uses a MindCloud API key and the `connectionId` of a Ninox connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Ninox connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Ninox action](README.md#actions-25) with your API key and `connectionId`.
