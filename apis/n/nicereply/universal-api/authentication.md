# Nicereply Universal API Authentication

Every Nicereply API request through MindCloud uses a MindCloud API key and the `connectionId` of a Nicereply connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Nicereply connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Nicereply action](README.md#actions-30) with your API key and `connectionId`.
