# Nicereply: Create Response

Creates a new response in Nicereply.

```
POST https://connect.mindcloud.co/v1/universal/nicereply/latest/actions/create-response
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/nicereply/latest/actions/create-response" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/nicereply/latest/actions/create-response', {
  method: 'POST',
  headers: {
