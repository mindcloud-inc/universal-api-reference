# Nicereply: List Customers

Retrieves a list of customers from Nicereply.

```
GET https://connect.mindcloud.co/v1/universal/nicereply/latest/actions/list-customers
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/nicereply/latest/actions/list-customers?${params}`, {
  headers: {
