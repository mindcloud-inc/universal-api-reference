# Nozbe Personal Universal API Authentication

Every Nozbe Personal API request through MindCloud uses a MindCloud API key and the `connectionId` of a Nozbe Personal connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Nozbe Personal connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Nozbe Personal action](README.md#actions-35) with your API key and `connectionId`.
