# NextBrain: List Models

Retrieves available model IDs from NextBrain.

```
GET https://connect.mindcloud.co/v1/universal/nextBrain/latest/actions/list-models
```
...
Through the native NextBrain API, this operation is `POST /model/model_ids_token` (base URL `https://api.nextbrain.ai`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-models.md) for the provider-specific parameters and requirements.
