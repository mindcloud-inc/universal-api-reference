# noCRM.io: Retrieve Lead

Retrieves lead details from noCRM.io.

```
GET https://connect.mindcloud.co/v1/universal/noCRMio/latest/actions/retrieve-lead
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/noCRMio/latest/actions/retrieve-lead?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/noCRMio/latest/actions/retrieve-lead?${params}`, {
  headers: {
...
Through the native noCRM.io API, this operation is `GET /leads/:id` (base URL `{{credentials.baseUrl}}/api/v2`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/retrieve-lead.md) for the provider-specific parameters and requirements.
