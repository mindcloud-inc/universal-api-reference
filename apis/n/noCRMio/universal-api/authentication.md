# noCRM.io Universal API Authentication

Every noCRM.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a noCRM.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your noCRM.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [noCRM.io action](README.md#actions-26) with your API key and `connectionId`.
