...
```
GET https://connect.mindcloud.co/v1/universal/nutshell/latest/actions/list-leads
```
...
| --- | --- | --- | --- |
| `q` | string | no | Search across lead details and related information. |
...
Through the native Nutshell API, this operation is `GET /leads` (base URL `https://app.nutshell.com/rest`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-leads.md) for the provider-specific parameters and requirements.
