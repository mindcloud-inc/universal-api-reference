...
- **Method:** `GET`
- **Path:** `/organizations/:organizationId/projects/:projectId/groups`
- **Base URL:** `https://client-api.nucleus.one/api/v1`
- **Official documentation:** [List Groups](https://client-api.nucleus.one/api/v1/docs)
