# NYC Squirrel Census Universal API Authentication

Every NYC Squirrel Census API request through MindCloud uses a MindCloud API key and the `connectionId` of a NYC Squirrel Census connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your NYC Squirrel Census connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [NYC Squirrel Census action](README.md#actions-1) with your API key and `connectionId`.
