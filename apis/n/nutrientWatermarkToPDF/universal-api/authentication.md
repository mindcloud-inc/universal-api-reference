# Nutrient - Watermark to PDF Universal API Authentication

Every Nutrient - Watermark to PDF API request through MindCloud uses a MindCloud API key and the `connectionId` of a Nutrient - Watermark to PDF connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Nutrient - Watermark to PDF connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Nutrient - Watermark to PDF action](README.md#actions-5) with your API key and `connectionId`.
