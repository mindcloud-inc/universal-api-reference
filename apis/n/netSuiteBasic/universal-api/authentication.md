# NetSuite - Basic Universal API Authentication

Every NetSuite - Basic API request through MindCloud uses a MindCloud API key and the `connectionId` of a NetSuite - Basic connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your NetSuite - Basic connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [NetSuite - Basic action](README.md#actions-99) with your API key and `connectionId`.
