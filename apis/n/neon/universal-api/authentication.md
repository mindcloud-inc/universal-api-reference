# Neon Universal API Authentication

Every Neon API request through MindCloud uses a MindCloud API key and the `connectionId` of a Neon connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Neon connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Neon action](README.md#actions-140) with your API key and `connectionId`.
