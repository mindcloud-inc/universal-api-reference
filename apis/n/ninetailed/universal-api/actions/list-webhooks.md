# Ninetailed: List Webhooks



```
GET https://connect.mindcloud.co/v1/universal/ninetailed/latest/actions/list-webhooks
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/ninetailed/latest/actions/list-webhooks?connectionId=$CONNECTION_ID&limit=25&offset=0&spaceId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/ninetailed/latest/actions/list-webhooks?${params}`, {
  headers: {
