# Ninetailed: Publish Asset



```
PUT https://connect.mindcloud.co/v1/universal/ninetailed/latest/actions/publish-asset
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/ninetailed/latest/actions/publish-asset" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/ninetailed/latest/actions/publish-asset', {
  method: 'PUT',
  headers: {
...
| `assetId` | string | yes | Asset ID to publish. |
