# Ninetailed: Publish Entry



```
PUT https://connect.mindcloud.co/v1/universal/ninetailed/latest/actions/publish-entry
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/ninetailed/latest/actions/publish-entry" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/ninetailed/latest/actions/publish-entry', {
  method: 'PUT',
  headers: {
...
| `entryId` | string | yes | Entry ID to publish. |
