# Ninetailed: Archive Entry



```
PUT https://connect.mindcloud.co/v1/universal/ninetailed/latest/actions/archive-entry
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/ninetailed/latest/actions/archive-entry" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/ninetailed/latest/actions/archive-entry', {
  method: 'PUT',
  headers: {
...
| `entryId` | string | yes | Entry ID to archive. |
