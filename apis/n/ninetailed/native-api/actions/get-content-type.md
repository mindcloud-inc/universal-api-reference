# Get Content Type with Ninetailed
...
- **Official documentation:** [Get Content Type](https://www.contentful.com/developers/docs/references/content-management-api/#/reference/content-types/content-type)
