# NetHunt CRM Universal API Authentication

Every NetHunt CRM API request through MindCloud uses a MindCloud API key and the `connectionId` of a NetHunt CRM connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your NetHunt CRM connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [NetHunt CRM action](README.md#actions-15) with your API key and `connectionId`.
