# National Park Service Universal API Authentication

Every National Park Service API request through MindCloud uses a MindCloud API key and the `connectionId` of a National Park Service connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your National Park Service connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [National Park Service action](README.md#actions-24) with your API key and `connectionId`.
