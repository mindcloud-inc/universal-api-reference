# Next Cloud OCS: Translate Text

Translates a text in Next Cloud OCS.

```
POST https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/translate-text
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/translate-text" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/translate-text', {
  method: 'POST',
  headers: {
