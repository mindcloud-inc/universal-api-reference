# Next Cloud OCS: Update Notification Settings

Updates a notification settings in Next Cloud OCS.

```
PUT https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/update-notification-settings
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/update-notification-settings" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/update-notification-settings', {
  method: 'PUT',
  headers: {
