# Next Cloud OCS: Update Webhook

Updates a webhook in Next Cloud OCS.

```
PUT https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/update-webhook
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/update-webhook" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/update-webhook', {
  method: 'PUT',
  headers: {
