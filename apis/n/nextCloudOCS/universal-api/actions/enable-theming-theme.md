# Next Cloud OCS: Enable Theming Theme

Enables a theming theme in Next Cloud OCS.

```
PUT https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/enable-theming-theme
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/enable-theming-theme" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/enable-theming-theme', {
  method: 'PUT',
  headers: {
