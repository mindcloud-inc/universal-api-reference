# Next Cloud OCS: Disable User

Disables a user in Next Cloud OCS.

```
PUT https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/disable-user
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/disable-user" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/disable-user', {
  method: 'PUT',
  headers: {
