# Next Cloud OCS: Create Webhook

Creates a new webhook in Next Cloud OCS.

```
POST https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/create-webhook
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/create-webhook" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/create-webhook', {
  method: 'POST',
  headers: {
