# Next Cloud OCS: Enable Talk Bot

Enables a talk bot in Next Cloud OCS.

```
PUT https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/enable-talk-bot
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/enable-talk-bot" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/enable-talk-bot', {
  method: 'PUT',
  headers: {
