# Next Cloud OCS: Delete Webhook

Deletes a webhook from Next Cloud OCS.

```
DELETE https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/delete-webhook
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/delete-webhook?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/nextCloudOCS/latest/actions/delete-webhook?${params}`, {
  headers: {
