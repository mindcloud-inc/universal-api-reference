# National Science Foundation Universal API Authentication

Every National Science Foundation API request through MindCloud uses a MindCloud API key and the `connectionId` of a National Science Foundation connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your National Science Foundation connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [National Science Foundation action](README.md#actions-3) with your API key and `connectionId`.
