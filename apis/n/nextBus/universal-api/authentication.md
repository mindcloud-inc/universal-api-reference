# NextBus Universal API Authentication

Every NextBus API request through MindCloud uses a MindCloud API key and the `connectionId` of a NextBus connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your NextBus connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [NextBus action](README.md#actions-14) with your API key and `connectionId`.
