# No Stupid Questions Podcast Universal API Authentication

Every No Stupid Questions Podcast API request through MindCloud uses a MindCloud API key and the `connectionId` of a No Stupid Questions Podcast connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your No Stupid Questions Podcast connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [No Stupid Questions Podcast action](README.md#actions-1) with your API key and `connectionId`.
