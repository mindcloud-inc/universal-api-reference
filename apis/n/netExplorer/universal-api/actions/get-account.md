# NetExplorer: Get Account



```
GET https://connect.mindcloud.co/v1/universal/netExplorer/latest/actions/get-account
```
...
Through the native NetExplorer API, this operation is `GET /account` (base URL `{{credentials.platformBaseUrl}}/api`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-account.md) for the provider-specific parameters and requirements.
