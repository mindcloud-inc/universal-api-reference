# NetExplorer Universal API Authentication

Every NetExplorer API request through MindCloud uses a MindCloud API key and the `connectionId` of a NetExplorer connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your NetExplorer connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [NetExplorer action](README.md#actions-240) with your API key and `connectionId`.
