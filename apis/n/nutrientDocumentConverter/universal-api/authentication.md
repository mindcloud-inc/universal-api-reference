# Nutrient Document Converter Universal API Authentication

Every Nutrient Document Converter API request through MindCloud uses a MindCloud API key and the `connectionId` of a Nutrient Document Converter connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Nutrient Document Converter connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Nutrient Document Converter action](README.md#actions-12) with your API key and `connectionId`.
