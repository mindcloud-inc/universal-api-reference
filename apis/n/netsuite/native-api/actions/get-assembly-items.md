# List Items with NetSuite - Advanced
...
- **API:** REST
- **Official documentation:** [List Items](https://system.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2024_2/script/record/account.html)
