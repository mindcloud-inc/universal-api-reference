# List Employees with NetSuite - Advanced
...
- **API:** REST
- **Official documentation:** [List Employees](https://system.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2024_2/script/record/employee.html)
