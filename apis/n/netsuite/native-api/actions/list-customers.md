# List Customers with NetSuite - Advanced
...
- **API:** REST
- **Official documentation:** [List Customers](https://system.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2024_2/script/record/customer.html)
