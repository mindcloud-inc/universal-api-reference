# List Tasks with NetSuite - Advanced
...
- **API:** REST
- **Official documentation:** [List Tasks](https://system.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2024_2/script/record/task.html)
