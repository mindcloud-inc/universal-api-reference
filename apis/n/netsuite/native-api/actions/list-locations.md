# List Locations with NetSuite - Advanced
...
- **API:** REST
- **Official documentation:** [List Locations](https://system.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2024_2/script/record/location.html)
