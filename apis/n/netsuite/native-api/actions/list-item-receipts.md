# List Item Receipts with NetSuite - Advanced
...
- **API:** REST
- **Official documentation:** [List Item Receipts](https://system.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2024_2/script/record/itemreceipt.html)
