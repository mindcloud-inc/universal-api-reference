# List Classifications with NetSuite - Advanced
...
- **API:** REST
- **Official documentation:** [List Classifications](https://system.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2024_2/script/record/classification.html)
