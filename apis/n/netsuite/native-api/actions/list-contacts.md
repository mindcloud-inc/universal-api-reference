# List Contacts with NetSuite - Advanced
...
- **API:** REST
- **Official documentation:** [List Contacts](https://system.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2024_2/script/record/contact.html)
