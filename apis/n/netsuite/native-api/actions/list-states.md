# List States with NetSuite - Advanced
...
- **API:** REST
- **Official documentation:** [List States](https://system.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2024_2/schema/record/state.html)
