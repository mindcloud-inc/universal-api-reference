# NetSuite - Advanced: List Items



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/get-assembly-items
```
...
Through the native NetSuite - Advanced API, this operation is `POST https://{{credentials.accountId}}.restlets.api.netsuite.com/app/site/hosting/restlet.nl` (base URL `https://{{credentials.accountId}}.suitetalk.api.netsuite.com`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/get-assembly-items.md) for the provider-specific parameters and requirements.
