# NetSuite - Advanced: Update Customer



```
PUT https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-customer
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-customer" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-customer', {
  method: 'PUT',
  headers: {
