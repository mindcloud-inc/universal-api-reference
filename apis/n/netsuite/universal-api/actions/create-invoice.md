# NetSuite - Advanced: Create Invoice



```
POST https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-invoice
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-invoice" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-invoice', {
  method: 'POST',
  headers: {
