# NetSuite - Advanced: List Classifications



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-classifications
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-classifications?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-classifications?${params}`, {
  headers: {
