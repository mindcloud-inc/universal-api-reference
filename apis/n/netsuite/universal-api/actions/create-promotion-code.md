# NetSuite - Advanced: Create Promotion Code



```
POST https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-promotion-code
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-promotion-code" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-promotion-code', {
  method: 'POST',
  headers: {
