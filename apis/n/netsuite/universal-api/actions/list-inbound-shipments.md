# NetSuite - Advanced: List Inbound Shipments



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-inbound-shipments
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-inbound-shipments?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-inbound-shipments?${params}`, {
  headers: {
