# NetSuite - Advanced: List Payment Methods



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-payment-methods
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-payment-methods?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-payment-methods?${params}`, {
  headers: {
