# NetSuite - Advanced: List Accounts



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-accounts
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-accounts?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-accounts?${params}`, {
  headers: {
