# NetSuite - Advanced: Update Custom Record



```
PUT https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-custom-record
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-custom-record" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-custom-record', {
  method: 'PUT',
  headers: {
