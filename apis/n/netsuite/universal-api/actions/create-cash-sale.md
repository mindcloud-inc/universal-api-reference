# NetSuite - Advanced: Create Cash Sale



```
POST https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-cash-sale
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-cash-sale" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-cash-sale', {
  method: 'POST',
  headers: {
