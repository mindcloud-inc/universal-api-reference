# NetSuite - Advanced: Update Purchase Order



```
PUT https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-purchase-order
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-purchase-order" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-purchase-order', {
  method: 'PUT',
  headers: {
