# NetSuite - Advanced: Update Vendor



```
PUT https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-vendor
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-vendor" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-vendor', {
  method: 'PUT',
  headers: {
