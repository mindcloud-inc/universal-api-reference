# NetSuite - Advanced: Update Location



```
PUT https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-location
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-location" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-location', {
  method: 'PUT',
  headers: {
