# NetSuite - Advanced: List Customers



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-customers
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-customers?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-customers?${params}`, {
  headers: {
