# NetSuite - Advanced: Delete Contact



```
DELETE https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-contact
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-contact?connectionId=$CONNECTION_ID&recordId=123456" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-contact?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `recordId` | list<string> | yes | Example: `123456`. |
