# NetSuite - Advanced: List Lot Numbered Assembly Items



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-lot-numbered-assembly-items
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-lot-numbered-assembly-items?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-lot-numbered-assembly-items?${params}`, {
  headers: {
