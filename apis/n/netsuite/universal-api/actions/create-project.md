# NetSuite - Advanced: Create Project



```
POST https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-project
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-project" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-project', {
  method: 'POST',
  headers: {
