# NetSuite - Advanced: Update Project



```
PUT https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-project
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-project" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-project', {
  method: 'PUT',
  headers: {
