# NetSuite - Advanced: List Sales Orders



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-sales-orders
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-sales-orders?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-sales-orders?${params}`, {
  headers: {
