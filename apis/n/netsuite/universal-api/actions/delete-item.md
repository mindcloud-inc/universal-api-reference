# NetSuite - Advanced: Delete Item



```
DELETE https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-item
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-item?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-item?${params}`, {
  headers: {
