# NetSuite - Advanced: Create Vendor



```
POST https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-vendor
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-vendor" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-vendor', {
  method: 'POST',
  headers: {
