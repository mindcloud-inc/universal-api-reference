# NetSuite - Advanced: List Employees



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-employees
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-employees?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-employees?${params}`, {
  headers: {
