# NetSuite - Advanced: List Opportunities



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-opportunities
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-opportunities?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-opportunities?${params}`, {
  headers: {
