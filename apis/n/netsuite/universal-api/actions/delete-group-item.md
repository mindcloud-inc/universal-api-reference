# NetSuite - Advanced: Delete Group Item



```
DELETE https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-group-item
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-group-item?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-group-item?${params}`, {
  headers: {
