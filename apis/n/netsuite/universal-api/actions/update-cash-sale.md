# NetSuite - Advanced: Update Cash Sale



```
PUT https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-cash-sale
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-cash-sale" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-cash-sale', {
  method: 'PUT',
  headers: {
