# NetSuite - Advanced: List Departments



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-departments
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-departments?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-departments?${params}`, {
  headers: {
