# NetSuite - Advanced: List Files



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-files
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-files?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-files?${params}`, {
  headers: {
