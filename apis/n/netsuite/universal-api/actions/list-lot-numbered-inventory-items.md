# NetSuite - Advanced: List Lot Numbered Inventory Items



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-lot-numbered-inventory-items
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-lot-numbered-inventory-items?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-lot-numbered-inventory-items?${params}`, {
  headers: {
