# NetSuite - Advanced: Create Customer



```
POST https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-customer
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-customer" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-customer', {
  method: 'POST',
  headers: {
