# NetSuite - Advanced: Create Location



```
POST https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-location
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-location" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-location', {
  method: 'POST',
  headers: {
