# NetSuite - Advanced: List Tasks



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-tasks
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-tasks?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-tasks?${params}`, {
  headers: {
