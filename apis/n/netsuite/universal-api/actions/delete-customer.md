# NetSuite - Advanced: Delete Customer



```
DELETE https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-customer
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-customer?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-customer?${params}`, {
  headers: {
