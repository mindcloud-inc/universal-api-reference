# NetSuite - Advanced: Create Sales Order



```
POST https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-sales-order
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-sales-order" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-sales-order', {
  method: 'POST',
  headers: {
