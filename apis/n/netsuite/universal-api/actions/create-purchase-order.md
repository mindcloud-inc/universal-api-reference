# NetSuite - Advanced: Create Purchase Order



```
POST https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-purchase-order
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-purchase-order" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/create-purchase-order', {
  method: 'POST',
  headers: {
