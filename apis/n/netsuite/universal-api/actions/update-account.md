# NetSuite - Advanced: Update Account



```
PUT https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-account
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-account" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-account', {
  method: 'PUT',
  headers: {
