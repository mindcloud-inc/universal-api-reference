# NetSuite - Advanced: Update Sales Order



```
PUT https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-sales-order
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-sales-order" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/update-sales-order', {
  method: 'PUT',
  headers: {
