# NetSuite - Advanced: Delete Purchase Order



```
DELETE https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-purchase-order
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-purchase-order?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/delete-purchase-order?${params}`, {
  headers: {
