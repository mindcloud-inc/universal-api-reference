# NetSuite - Advanced: List Vendors



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-vendors
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-vendors?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-vendors?${params}`, {
  headers: {
