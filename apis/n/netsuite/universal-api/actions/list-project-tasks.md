# NetSuite - Advanced: List Project Tasks



```
GET https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-project-tasks
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-project-tasks?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/netsuite/latest/actions/list-project-tasks?${params}`, {
  headers: {
