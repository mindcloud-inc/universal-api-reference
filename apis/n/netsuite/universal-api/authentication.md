# NetSuite - Advanced Universal API Authentication

Every NetSuite - Advanced API request through MindCloud uses a MindCloud API key and the `connectionId` of a NetSuite - Advanced connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your NetSuite - Advanced connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [NetSuite - Advanced action](README.md#actions-181) with your API key and `connectionId`.
