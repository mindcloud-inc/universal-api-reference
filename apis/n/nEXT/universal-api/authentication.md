# NEXT Universal API Authentication

Every NEXT API request through MindCloud uses a MindCloud API key and the `connectionId` of a NEXT connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your NEXT connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [NEXT action](README.md#actions-30) with your API key and `connectionId`.
