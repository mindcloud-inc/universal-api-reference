# NetLicensing Universal API Authentication

Every NetLicensing API request through MindCloud uses a MindCloud API key and the `connectionId` of a NetLicensing connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your NetLicensing connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [NetLicensing action](README.md#actions-42) with your API key and `connectionId`.
