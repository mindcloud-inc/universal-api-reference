# NASA Image and Video Library Universal API Authentication

Every NASA Image and Video Library API request through MindCloud uses a MindCloud API key and the `connectionId` of a NASA Image and Video Library connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your NASA Image and Video Library connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [NASA Image and Video Library action](README.md#actions-5) with your API key and `connectionId`.
