# New Relic Universal API Authentication

Every New Relic API request through MindCloud uses a MindCloud API key and the `connectionId` of a New Relic connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your New Relic connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [New Relic action](README.md#actions-37) with your API key and `connectionId`.
