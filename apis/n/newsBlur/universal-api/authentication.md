# NewsBlur Universal API Authentication

Every NewsBlur API request through MindCloud uses a MindCloud API key and the `connectionId` of a NewsBlur connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your NewsBlur connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [NewsBlur action](README.md#actions-25) with your API key and `connectionId`.
