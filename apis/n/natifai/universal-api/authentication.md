# Natif.ai Universal API Authentication

Every Natif.ai API request through MindCloud uses a MindCloud API key and the `connectionId` of a Natif.ai connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Natif.ai connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Natif.ai action](README.md#actions-24) with your API key and `connectionId`.
