# Notificações Inteligentes: List Integrations

Retrieves integrations from Notificações Inteligentes.

```
GET https://connect.mindcloud.co/v1/universal/notificaesInteligentes/latest/actions/list-integrations
```
