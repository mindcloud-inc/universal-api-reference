# Get Analytics Protocols with NextDNS
...
- **Method:** `GET`
- **Path:** `/profiles/:profile/analytics/protocols`
- **Base URL:** `https://api.nextdns.io`
- **Official documentation:** [Get Analytics Protocols](https://nextdns.io/api#profilesprofileanalyticsprotocols)
