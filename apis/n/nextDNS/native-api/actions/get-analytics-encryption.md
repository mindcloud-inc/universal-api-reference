# Get Analytics Encryption with NextDNS
...
- **Method:** `GET`
- **Path:** `/profiles/:profile/analytics/encryption`
- **Base URL:** `https://api.nextdns.io`
- **Official documentation:** [Get Analytics Encryption](https://nextdns.io/api#profilesprofileanalyticsencryption)
