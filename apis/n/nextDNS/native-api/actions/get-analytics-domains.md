# Get Analytics Domains with NextDNS
...
- **Method:** `GET`
- **Path:** `/profiles/:profile/analytics/domains`
- **Base URL:** `https://api.nextdns.io`
- **Official documentation:** [Get Analytics Domains](https://nextdns.io/api#profilesprofileanalyticsdomains)
...
| `status` | query | `string` | no | Filter by response status. |
| `root` | query | `boolean` | no | When true, aggregate results by root domain. |
