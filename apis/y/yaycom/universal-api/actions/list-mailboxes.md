# Yay.com: List Mailboxes

Retrieves mailboxes from Yay.com.

```
GET https://connect.mindcloud.co/v1/universal/yaycom/latest/actions/list-mailboxes
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/yaycom/latest/actions/list-mailboxes?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/yaycom/latest/actions/list-mailboxes?${params}`, {
  headers: {
