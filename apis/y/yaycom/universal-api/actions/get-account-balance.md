# Yay.com: Get Account Balance

Retrieves the account balance from Yay.com.

```
GET https://connect.mindcloud.co/v1/universal/yaycom/latest/actions/get-account-balance
```
