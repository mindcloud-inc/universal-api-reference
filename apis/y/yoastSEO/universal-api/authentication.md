# Yoast SEO Universal API Authentication

Every Yoast SEO API request through MindCloud uses a MindCloud API key and the `connectionId` of a Yoast SEO connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Yoast SEO connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Yoast SEO action](README.md#actions-16) with your API key and `connectionId`.
