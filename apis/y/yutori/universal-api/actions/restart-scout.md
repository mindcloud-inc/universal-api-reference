# Yutori: Restart Scout

Restarts an existing scout in Yutori.

```
PUT https://connect.mindcloud.co/v1/universal/yutori/latest/actions/restart-scout
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/yutori/latest/actions/restart-scout" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/yutori/latest/actions/restart-scout', {
  method: 'PUT',
  headers: {
