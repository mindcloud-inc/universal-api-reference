...
```
GET https://connect.mindcloud.co/v1/universal/yutori/latest/actions/get-health
```
...
Through the native Yutori API, this operation is `GET /v1/health` (base URL `https://api.yutori.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-health.md) for the provider-specific parameters and requirements.
