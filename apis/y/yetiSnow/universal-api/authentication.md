# Yeti Snow Universal API Authentication

Every Yeti Snow API request through MindCloud uses a MindCloud API key and the `connectionId` of a Yeti Snow connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Yeti Snow connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Yeti Snow action](README.md#actions-30) with your API key and `connectionId`.
