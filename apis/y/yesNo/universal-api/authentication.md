# Yes/No Universal API Authentication

Every Yes/No API request through MindCloud uses a MindCloud API key and the `connectionId` of a Yes/No connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Yes/No connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Yes/No action](README.md#actions-1) with your API key and `connectionId`.
