# Yotpo Loyalty & Referrals Universal API Authentication

Every Yotpo Loyalty & Referrals API request through MindCloud uses a MindCloud API key and the `connectionId` of a Yotpo Loyalty & Referrals connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Yotpo Loyalty & Referrals connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Yotpo Loyalty & Referrals action](README.md#actions-22) with your API key and `connectionId`.
