# Youform Universal API Authentication

Every Youform API request through MindCloud uses a MindCloud API key and the `connectionId` of a Youform connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Youform connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Youform action](README.md#actions-7) with your API key and `connectionId`.
