# Yr app Universal API Authentication

Every Yr app API request through MindCloud uses a MindCloud API key and the `connectionId` of a Yr app connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Yr app connection.
