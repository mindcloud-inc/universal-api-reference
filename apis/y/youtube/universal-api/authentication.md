# YouTube Universal API Authentication

Every YouTube API request through MindCloud uses a MindCloud API key and the `connectionId` of a YouTube connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your YouTube connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [YouTube action](README.md#actions-20) with your API key and `connectionId`.
