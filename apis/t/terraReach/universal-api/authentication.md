# TerraReach Universal API Authentication

Every TerraReach API request through MindCloud uses a MindCloud API key and the `connectionId` of a TerraReach connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TerraReach connection.
