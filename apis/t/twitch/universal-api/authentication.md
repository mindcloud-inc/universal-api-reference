# Twitch Universal API Authentication

Every Twitch API request through MindCloud uses a MindCloud API key and the `connectionId` of a Twitch connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Twitch connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Twitch action](README.md#actions-33) with your API key and `connectionId`.
