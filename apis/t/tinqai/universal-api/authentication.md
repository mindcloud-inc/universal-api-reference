# Tinq.ai Universal API Authentication

Every Tinq.ai API request through MindCloud uses a MindCloud API key and the `connectionId` of a Tinq.ai connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Tinq.ai connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Tinq.ai action](README.md#actions-15) with your API key and `connectionId`.
