...
- **Official documentation:** [Create Post](https://typeflo.io/knowledge-base/headless-cms-admin-api-documentation)
...
| --- | --- | --- | --- | --- |
| `postData.title` | body | `string` | yes | The title of the post. |
| `postData.content` | body | `string` | yes | The main post content in HTML. |
