# TikTok Conversions Universal API Authentication

Every TikTok Conversions API request through MindCloud uses a MindCloud API key and the `connectionId` of a TikTok Conversions connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TikTok Conversions connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TikTok Conversions action](README.md#actions-14) with your API key and `connectionId`.
