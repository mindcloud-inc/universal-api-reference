# Telldus Live! Universal API Authentication

Every Telldus Live! API request through MindCloud uses a MindCloud API key and the `connectionId` of a Telldus Live! connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Telldus Live! connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Telldus Live! action](README.md#actions-6) with your API key and `connectionId`.
