# TAYL Universal API Authentication

Every TAYL API request through MindCloud uses a MindCloud API key and the `connectionId` of a TAYL connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TAYL connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TAYL action](README.md#actions-3) with your API key and `connectionId`.
