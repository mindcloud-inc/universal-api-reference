# Streaming Text To Speech with TypeCast
...
- **Official documentation:** [Streaming Text To Speech](https://typecast.ai/docs/api-reference/text-to-speech/streaming-text-to-speech)
