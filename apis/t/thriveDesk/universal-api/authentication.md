# ThriveDesk Universal API Authentication

Every ThriveDesk API request through MindCloud uses a MindCloud API key and the `connectionId` of a ThriveDesk connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ThriveDesk connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ThriveDesk action](README.md#actions-143) with your API key and `connectionId`.
