# ThriveDesk: Get Inbox



```
GET https://connect.mindcloud.co/v1/universal/thriveDesk/latest/actions/get-inbox
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/thriveDesk/latest/actions/get-inbox?connectionId=$CONNECTION_ID&inboxId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/thriveDesk/latest/actions/get-inbox?${params}`, {
  headers: {
