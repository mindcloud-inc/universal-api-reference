# Talk Python To Me Universal API Authentication

Every Talk Python To Me API request through MindCloud uses a MindCloud API key and the `connectionId` of a Talk Python To Me connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Talk Python To Me connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Talk Python To Me action](README.md#actions-1) with your API key and `connectionId`.
