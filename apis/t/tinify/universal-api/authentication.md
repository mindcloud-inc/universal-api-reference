# Tinify Universal API Authentication

Every Tinify API request through MindCloud uses a MindCloud API key and the `connectionId` of a Tinify connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Tinify connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Tinify action](README.md#actions-9) with your API key and `connectionId`.
