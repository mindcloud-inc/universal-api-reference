# Tax ID Pro Universal API Authentication

Every Tax ID Pro API request through MindCloud uses a MindCloud API key and the `connectionId` of a Tax ID Pro connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Tax ID Pro connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Tax ID Pro action](README.md#actions-2) with your API key and `connectionId`.
