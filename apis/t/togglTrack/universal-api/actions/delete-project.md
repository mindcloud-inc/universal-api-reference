# Toggl Track: Delete Project

Deletes an existing project from Toggl Track.

```
DELETE https://connect.mindcloud.co/v1/universal/togglTrack/latest/actions/delete-project
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/togglTrack/latest/actions/delete-project?connectionId=$CONNECTION_ID&workspaceId=1&projectId=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/togglTrack/latest/actions/delete-project?${params}`, {
  headers: {
