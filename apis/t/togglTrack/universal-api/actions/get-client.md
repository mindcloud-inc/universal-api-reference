# Toggl Track: Get Client

Retrieves a client from Toggl Track.

```
GET https://connect.mindcloud.co/v1/universal/togglTrack/latest/actions/get-client
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/togglTrack/latest/actions/get-client?connectionId=$CONNECTION_ID&workspaceId=1&clientId=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/togglTrack/latest/actions/get-client?${params}`, {
  headers: {
