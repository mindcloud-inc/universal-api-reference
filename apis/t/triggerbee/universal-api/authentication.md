# Triggerbee Universal API Authentication

Every Triggerbee API request through MindCloud uses a MindCloud API key and the `connectionId` of a Triggerbee connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Triggerbee connection.
