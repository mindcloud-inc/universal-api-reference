# Tenderplan Universal API Authentication

Every Tenderplan API request through MindCloud uses a MindCloud API key and the `connectionId` of a Tenderplan connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Tenderplan connection.
