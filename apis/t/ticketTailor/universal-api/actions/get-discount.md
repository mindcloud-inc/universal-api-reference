# Ticket Tailor: Get Discount

Retrieves a discount from Ticket Tailor.

```
GET https://connect.mindcloud.co/v1/universal/ticketTailor/latest/actions/get-discount
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/ticketTailor/latest/actions/get-discount?connectionId=$CONNECTION_ID&discountId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/ticketTailor/latest/actions/get-discount?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `discountId` | string | yes | Ticket Tailor discount ID. |
