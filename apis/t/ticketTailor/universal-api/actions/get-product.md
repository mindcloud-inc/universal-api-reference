# Ticket Tailor: Get Product

Retrieves a product from Ticket Tailor.

```
GET https://connect.mindcloud.co/v1/universal/ticketTailor/latest/actions/get-product
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/ticketTailor/latest/actions/get-product?connectionId=$CONNECTION_ID&productId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/ticketTailor/latest/actions/get-product?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `productId` | string | yes | Ticket Tailor product ID. |
