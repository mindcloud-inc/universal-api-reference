# Tableau Cloud Universal API Authentication

Every Tableau Cloud API request through MindCloud uses a MindCloud API key and the `connectionId` of a Tableau Cloud connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Tableau Cloud connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Tableau Cloud action](README.md#actions-41) with your API key and `connectionId`.
