...
- **Official documentation:** [Create Daily Plan](https://api.tidely.com/tidely-open-api-docs)
...
| `period` | body | `string` | no | Plan period: DAILY. |
