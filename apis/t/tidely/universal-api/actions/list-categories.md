# Tidely: List Categories



```
GET https://connect.mindcloud.co/v1/universal/tidely/latest/actions/list-categories
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/tidely/latest/actions/list-categories?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/tidely/latest/actions/list-categories?${params}`, {
  headers: {
