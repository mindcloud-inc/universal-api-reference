...
```
POST https://connect.mindcloud.co/v1/universal/tidely/latest/actions/create-plan
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/tidely/latest/actions/create-plan" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/tidely/latest/actions/create-plan', {
  method: 'POST',
  headers: {
...
| `period` | string | no | Plan period: DAILY, WEEKLY, or MONTHLY. |
