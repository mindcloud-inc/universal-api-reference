# Tidely: List Categories For Planned Transactions



```
GET https://connect.mindcloud.co/v1/universal/tidely/latest/actions/list-categories-for-planned-transactions
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/tidely/latest/actions/list-categories-for-planned-transactions?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/tidely/latest/actions/list-categories-for-planned-transactions?${params}`, {
  headers: {
