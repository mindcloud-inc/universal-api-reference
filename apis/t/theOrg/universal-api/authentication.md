# The Org Universal API Authentication

Every The Org API request through MindCloud uses a MindCloud API key and the `connectionId` of a The Org connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your The Org connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [The Org action](README.md#actions-5) with your API key and `connectionId`.
