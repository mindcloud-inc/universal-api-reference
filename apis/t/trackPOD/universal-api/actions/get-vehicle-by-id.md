# Track-POD: Get Vehicle By Id

Retrieves a vehicle from Track-POD by ID.

```
GET https://connect.mindcloud.co/v1/universal/trackPOD/latest/actions/get-vehicle-by-id
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/trackPOD/latest/actions/get-vehicle-by-id?connectionId=$CONNECTION_ID&id=123" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/trackPOD/latest/actions/get-vehicle-by-id?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `id` | number | yes | Track-POD unique identifier for the vehicle. Example: `123`. |
