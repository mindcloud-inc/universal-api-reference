# Track-POD: Get Route By Code

Retrieves a route from Track-POD by code.

```
GET https://connect.mindcloud.co/v1/universal/trackPOD/latest/actions/get-route-by-code
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/trackPOD/latest/actions/get-route-by-code?connectionId=$CONNECTION_ID&code=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/trackPOD/latest/actions/get-route-by-code?${params}`, {
  headers: {
