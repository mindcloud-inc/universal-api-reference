...
- **Official documentation:** [Update Order](https://api.track-pod.com/index.html#/Order/UpdateOrder)
...
| `Priority` | body | `string` | no | Order priority. Accepted values: `0`, `1`, `2`. |
