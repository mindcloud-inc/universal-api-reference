# TranslatePlus Universal API Authentication

Every TranslatePlus API request through MindCloud uses a MindCloud API key and the `connectionId` of a TranslatePlus connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TranslatePlus connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TranslatePlus action](README.md#actions-14) with your API key and `connectionId`.
