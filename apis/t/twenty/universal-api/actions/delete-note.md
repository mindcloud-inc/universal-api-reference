...
```
DELETE https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-note
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-note?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-note?${params}`, {
  headers: {
