...
```
GET https://connect.mindcloud.co/v1/universal/twenty/latest/actions/get-company
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/twenty/latest/actions/get-company?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/twenty/latest/actions/get-company?${params}`, {
  headers: {
