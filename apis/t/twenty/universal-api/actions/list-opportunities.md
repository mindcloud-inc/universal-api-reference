...
```
GET https://connect.mindcloud.co/v1/universal/twenty/latest/actions/list-opportunities
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/twenty/latest/actions/list-opportunities?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/twenty/latest/actions/list-opportunities?${params}`, {
  headers: {
