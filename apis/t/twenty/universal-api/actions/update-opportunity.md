# Twenty: Update Opportunity



```
PUT https://connect.mindcloud.co/v1/universal/twenty/latest/actions/update-opportunity
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/twenty/latest/actions/update-opportunity" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/twenty/latest/actions/update-opportunity', {
  method: 'PUT',
  headers: {
