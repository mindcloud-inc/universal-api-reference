...
```
DELETE https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-task
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-task?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-task?${params}`, {
  headers: {
