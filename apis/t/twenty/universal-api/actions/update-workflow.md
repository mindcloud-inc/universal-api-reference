# Twenty: Update Workflow



```
PUT https://connect.mindcloud.co/v1/universal/twenty/latest/actions/update-workflow
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/twenty/latest/actions/update-workflow" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/twenty/latest/actions/update-workflow', {
  method: 'PUT',
  headers: {
