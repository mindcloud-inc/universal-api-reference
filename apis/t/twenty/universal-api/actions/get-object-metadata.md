# Twenty: Get Object Metadata



```
GET https://connect.mindcloud.co/v1/universal/twenty/latest/actions/get-object-metadata
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/twenty/latest/actions/get-object-metadata?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/twenty/latest/actions/get-object-metadata?${params}`, {
  headers: {
