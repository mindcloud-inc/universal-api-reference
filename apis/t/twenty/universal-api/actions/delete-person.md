# Twenty: Delete Person



```
DELETE https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-person
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-person?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-person?${params}`, {
  headers: {
