# Twenty: Update Company



```
PUT https://connect.mindcloud.co/v1/universal/twenty/latest/actions/update-company
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/twenty/latest/actions/update-company" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/twenty/latest/actions/update-company', {
  method: 'PUT',
  headers: {
...
| `employees` | number | no |  |
| `idealCustomerProfile` | boolean | no |  |
