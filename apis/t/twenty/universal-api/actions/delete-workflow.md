# Twenty: Delete Workflow



```
DELETE https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-workflow
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-workflow?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-workflow?${params}`, {
  headers: {
