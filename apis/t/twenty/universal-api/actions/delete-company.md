# Twenty: Delete Company



```
DELETE https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-company
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-company?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/twenty/latest/actions/delete-company?${params}`, {
  headers: {
