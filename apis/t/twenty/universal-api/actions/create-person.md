...
```
POST https://connect.mindcloud.co/v1/universal/twenty/latest/actions/create-person
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/twenty/latest/actions/create-person" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/twenty/latest/actions/create-person', {
  method: 'POST',
  headers: {
