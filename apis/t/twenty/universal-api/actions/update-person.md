...
```
PUT https://connect.mindcloud.co/v1/universal/twenty/latest/actions/update-person
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/twenty/latest/actions/update-person" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/twenty/latest/actions/update-person', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `id` | string | yes |  |
| `phones.primaryPhoneNumber` | string | no |  |
| `phones.primaryPhoneCountryCode` | string | no |  |
| `phones.primaryPhoneCallingCode` | string | no |  |
| `phones.additionalPhones[]` | array<string> | no |  |
| `name.firstName` | string | no |  |
| `name.lastName` | string | no |  |
| `emails.primaryEmail` | string | no |  |
| `emails.additionalEmails[]` | array<string> | no |  |
| `city` | string | no |  |
