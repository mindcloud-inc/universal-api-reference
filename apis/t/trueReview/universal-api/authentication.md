# TrueReview Universal API Authentication

Every TrueReview API request through MindCloud uses a MindCloud API key and the `connectionId` of a TrueReview connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TrueReview connection.
