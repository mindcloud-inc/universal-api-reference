# Transifex: List Projects



```
GET https://connect.mindcloud.co/v1/universal/transifex/latest/actions/list-projects
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/transifex/latest/actions/list-projects?connectionId=$CONNECTION_ID&filterOrganization=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/transifex/latest/actions/list-projects?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `filterOrganization` | string | yes | Return projects for this organization id, for example o:mindcloud. |
