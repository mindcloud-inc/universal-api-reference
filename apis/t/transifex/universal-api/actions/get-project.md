# Transifex: Get Project



```
GET https://connect.mindcloud.co/v1/universal/transifex/latest/actions/get-project
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/transifex/latest/actions/get-project?connectionId=$CONNECTION_ID&projectId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/transifex/latest/actions/get-project?${params}`, {
  headers: {
