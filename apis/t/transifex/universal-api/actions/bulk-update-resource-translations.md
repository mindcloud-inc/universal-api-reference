# Transifex: Bulk Update Resource Translations



```
PUT https://connect.mindcloud.co/v1/universal/transifex/latest/actions/bulk-update-resource-translations
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/transifex/latest/actions/bulk-update-resource-translations" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/transifex/latest/actions/bulk-update-resource-translations', {
  method: 'PUT',
  headers: {
...
Through the native Transifex API, this operation is `PATCH /resource_translations` (base URL `https://rest.api.transifex.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/bulk-update-resource-translations.md) for the provider-specific parameters and requirements.
