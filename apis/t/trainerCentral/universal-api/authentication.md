# TrainerCentral Universal API Authentication

Every TrainerCentral API request through MindCloud uses a MindCloud API key and the `connectionId` of a TrainerCentral connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TrainerCentral connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TrainerCentral action](README.md#actions-12) with your API key and `connectionId`.
