...
Retrieves a process from Tallyfy.

```
GET https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/get-process
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/get-process?connectionId=$CONNECTION_ID&run_id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/get-process?${params}`, {
  headers: {
