...
Retrieves a task from Tallyfy.

```
GET https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/get-task
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/get-task?connectionId=$CONNECTION_ID&task_id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/get-task?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `task_id` | string | yes | Task ID from Tallyfy. |
