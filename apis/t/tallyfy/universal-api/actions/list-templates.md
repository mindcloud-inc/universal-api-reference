# Tallyfy: List Templates

Retrieves process templates from your Tallyfy organization.

```
GET https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/list-templates
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/list-templates?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/list-templates?${params}`, {
  headers: {
