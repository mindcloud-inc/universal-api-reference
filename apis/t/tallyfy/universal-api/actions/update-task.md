...
Updates an existing task in Tallyfy.

```
PUT https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/update-task
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/update-task" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/update-task', {
  method: 'PUT',
  headers: {
