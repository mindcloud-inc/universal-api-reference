# Tallyfy: Get Template

Retrieves a template from Tallyfy.

```
GET https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/get-template
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/get-template?connectionId=$CONNECTION_ID&checklist_id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/tallyfy/latest/actions/get-template?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `checklist_id` | string | yes | Template ID from Tallyfy. |
