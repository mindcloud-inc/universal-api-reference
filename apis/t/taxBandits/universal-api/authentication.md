# TaxBandits Universal API Authentication

Every TaxBandits API request through MindCloud uses a MindCloud API key and the `connectionId` of a TaxBandits connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TaxBandits connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TaxBandits action](README.md#actions-30) with your API key and `connectionId`.
