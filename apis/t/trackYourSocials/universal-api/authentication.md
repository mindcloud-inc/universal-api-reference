# TrackYourSocials Universal API Authentication

Every TrackYourSocials API request through MindCloud uses a MindCloud API key and the `connectionId` of a TrackYourSocials connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TrackYourSocials connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TrackYourSocials action](README.md#actions-3) with your API key and `connectionId`.
