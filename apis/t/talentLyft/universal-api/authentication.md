# TalentLyft Universal API Authentication

Every TalentLyft API request through MindCloud uses a MindCloud API key and the `connectionId` of a TalentLyft connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TalentLyft connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TalentLyft action](README.md#actions-20) with your API key and `connectionId`.
