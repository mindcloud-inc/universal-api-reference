# TalentLyft: List Members

Retrieves all company members from TalentLyft.

```
GET https://connect.mindcloud.co/v1/universal/talentLyft/latest/actions/list-members
```
