# TalentLyft: Get Department

Retrieves a department from TalentLyft.

```
GET https://connect.mindcloud.co/v1/universal/talentLyft/latest/actions/get-department
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/talentLyft/latest/actions/get-department?connectionId=$CONNECTION_ID&id=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/talentLyft/latest/actions/get-department?${params}`, {
  headers: {
