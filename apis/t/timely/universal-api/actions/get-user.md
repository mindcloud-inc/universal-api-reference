...
Retrieves a user from Timely.

```
GET https://connect.mindcloud.co/v1/universal/timely/latest/actions/get-user
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/timely/latest/actions/get-user?connectionId=$CONNECTION_ID&accountId=1&id=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/timely/latest/actions/get-user?${params}`, {
  headers: {
