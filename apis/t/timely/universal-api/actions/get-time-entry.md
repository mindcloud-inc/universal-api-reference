# Timely: Get Time Entry

Retrieves a time entry from Timely.

```
GET https://connect.mindcloud.co/v1/universal/timely/latest/actions/get-time-entry
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/timely/latest/actions/get-time-entry?connectionId=$CONNECTION_ID&accountId=1&id=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/timely/latest/actions/get-time-entry?${params}`, {
  headers: {
