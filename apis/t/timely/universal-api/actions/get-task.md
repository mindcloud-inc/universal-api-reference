...
Retrieves a task from Timely.

```
GET https://connect.mindcloud.co/v1/universal/timely/latest/actions/get-task
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/timely/latest/actions/get-task?connectionId=$CONNECTION_ID&accountId=1&id=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/timely/latest/actions/get-task?${params}`, {
  headers: {
