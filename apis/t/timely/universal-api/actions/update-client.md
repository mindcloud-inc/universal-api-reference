...
```
PUT https://connect.mindcloud.co/v1/universal/timely/latest/actions/update-client
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/timely/latest/actions/update-client" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/timely/latest/actions/update-client', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `accountId` | number | yes | Account ID for the client you want to update |
| `id` | number | yes | Client ID to update |
| `client` | object | yes |  |
