...
```
POST https://connect.mindcloud.co/v1/universal/timely/latest/actions/invite-user
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/timely/latest/actions/invite-user" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/timely/latest/actions/invite-user', {
  method: 'POST',
  headers: {
