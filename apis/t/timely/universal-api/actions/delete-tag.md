...
Deletes an existing tag from Timely.

```
DELETE https://connect.mindcloud.co/v1/universal/timely/latest/actions/delete-tag
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/timely/latest/actions/delete-tag?connectionId=$CONNECTION_ID&accountId=1&id=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/timely/latest/actions/delete-tag?${params}`, {
  headers: {
