...
```
DELETE https://connect.mindcloud.co/v1/universal/timely/latest/actions/delete-task
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/timely/latest/actions/delete-task?connectionId=$CONNECTION_ID&accountId=1&id=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/timely/latest/actions/delete-task?${params}`, {
  headers: {
