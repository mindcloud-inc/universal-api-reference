...
Retrieves the current user from Timely.

```
GET https://connect.mindcloud.co/v1/universal/timely/latest/actions/get-current-user
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/timely/latest/actions/get-current-user?connectionId=$CONNECTION_ID&accountId=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/timely/latest/actions/get-current-user?${params}`, {
  headers: {
