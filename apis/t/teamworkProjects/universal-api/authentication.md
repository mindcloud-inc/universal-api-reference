# Teamwork Projects Universal API Authentication

Every Teamwork Projects API request through MindCloud uses a MindCloud API key and the `connectionId` of a Teamwork Projects connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Teamwork Projects connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Teamwork Projects action](README.md#actions-24) with your API key and `connectionId`.
