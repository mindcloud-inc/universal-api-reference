...
- **Official documentation:** [Send Bulk SMS](https://topmessage.com/documentation-api/send-message)
...
| `data.text` | body | `string` | yes | The SMS content to send to all recipients. |
