# TopMessage: Send Bulk SMS

Creates a bulk SMS message in TopMessage.

```
POST https://connect.mindcloud.co/v1/universal/topMessage/latest/actions/send-bulk-sms
```
...
| `text` | string | yes | The SMS content to send to all recipients. |
...
| --- | --- | --- |
| `data` | object | The bulk message submission returned by TopMessage. |
