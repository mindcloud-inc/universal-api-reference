# Tremendous Universal API Authentication

Every Tremendous API request through MindCloud uses a MindCloud API key and the `connectionId` of a Tremendous connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Tremendous connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Tremendous action](README.md#actions-20) with your API key and `connectionId`.
