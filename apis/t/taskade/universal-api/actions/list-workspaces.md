# Taskade: List Workspaces

Retrieves workspaces from your Taskade account.

```
GET https://connect.mindcloud.co/v1/universal/taskade/latest/actions/list-workspaces
```
...
Through the native Taskade API, this operation is `GET /workspaces` (base URL `https://www.taskade.com/api/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-workspaces.md) for the provider-specific parameters and requirements.
