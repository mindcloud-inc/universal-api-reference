# Timeular Universal API Authentication

Every Timeular API request through MindCloud uses a MindCloud API key and the `connectionId` of a Timeular connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Timeular connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Timeular action](README.md#actions-113) with your API key and `connectionId`.
