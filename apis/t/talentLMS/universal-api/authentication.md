# TalentLMS Universal API Authentication

Every TalentLMS API request through MindCloud uses a MindCloud API key and the `connectionId` of a TalentLMS connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TalentLMS connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TalentLMS action](README.md#actions-25) with your API key and `connectionId`.
