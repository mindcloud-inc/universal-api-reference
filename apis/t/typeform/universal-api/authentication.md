# Typeform Universal API Authentication

Every Typeform API request through MindCloud uses a MindCloud API key and the `connectionId` of a Typeform connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Typeform connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Typeform action](README.md#actions-48) with your API key and `connectionId`.
