# Update Theme (Partial Update) with Typeform
...
- **Official documentation:** [Update Theme (Partial Update)](https://www.typeform.com/developers/create/reference/update-theme-partial-update/)
