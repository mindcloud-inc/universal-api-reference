# Trackabi: Delete Client

Deletes an existing client from Trackabi.

```
DELETE https://connect.mindcloud.co/v1/universal/trackabi/latest/actions/delete-client
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/trackabi/latest/actions/delete-client?connectionId=$CONNECTION_ID&clientId=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/trackabi/latest/actions/delete-client?${params}`, {
  headers: {
