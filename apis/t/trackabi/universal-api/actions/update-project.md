# Trackabi: Update Project

Updates an existing project in Trackabi.

```
PUT https://connect.mindcloud.co/v1/universal/trackabi/latest/actions/update-project
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/trackabi/latest/actions/update-project" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/trackabi/latest/actions/update-project', {
  method: 'PUT',
  headers: {
...
| `currency` | string | no | Project currency. |
