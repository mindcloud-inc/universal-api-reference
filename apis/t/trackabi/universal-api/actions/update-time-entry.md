# Trackabi: Update Time Entry

Updates an existing time entry in Trackabi.

```
PUT https://connect.mindcloud.co/v1/universal/trackabi/latest/actions/update-time-entry
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/trackabi/latest/actions/update-time-entry" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/trackabi/latest/actions/update-time-entry', {
  method: 'PUT',
  headers: {
