# Tavus Universal API Authentication

Every Tavus API request through MindCloud uses a MindCloud API key and the `connectionId` of a Tavus connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Tavus connection.
