# Tidio Universal API Authentication

Every Tidio API request through MindCloud uses a MindCloud API key and the `connectionId` of a Tidio connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Tidio connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Tidio action](README.md#actions-25) with your API key and `connectionId`.
