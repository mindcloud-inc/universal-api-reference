# TPS API Universal API Authentication

Every TPS API API request through MindCloud uses a MindCloud API key and the `connectionId` of a TPS API connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TPS API connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TPS API action](README.md#actions-1) with your API key and `connectionId`.
