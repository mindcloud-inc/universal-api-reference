# Taste of Home Universal API Authentication

Every Taste of Home API request through MindCloud uses a MindCloud API key and the `connectionId` of a Taste of Home connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Taste of Home connection.
