# Toolhouse Universal API Authentication

Every Toolhouse API request through MindCloud uses a MindCloud API key and the `connectionId` of a Toolhouse connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Toolhouse connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Toolhouse action](README.md#actions-10) with your API key and `connectionId`.
