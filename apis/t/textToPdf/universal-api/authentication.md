# Text to pdf Universal API Authentication

Every Text to pdf API request through MindCloud uses a MindCloud API key and the `connectionId` of a Text to pdf connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Text to pdf connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Text to pdf action](README.md#actions-6) with your API key and `connectionId`.
