# Turbot Pipes Universal API Authentication

Every Turbot Pipes API request through MindCloud uses a MindCloud API key and the `connectionId` of a Turbot Pipes connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Turbot Pipes connection.
