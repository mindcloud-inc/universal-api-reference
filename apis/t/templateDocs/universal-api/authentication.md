# TemplateDocs Universal API Authentication

Every TemplateDocs API request through MindCloud uses a MindCloud API key and the `connectionId` of a TemplateDocs connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TemplateDocs connection.
