# Tiger Form Universal API Authentication

Every Tiger Form API request through MindCloud uses a MindCloud API key and the `connectionId` of a Tiger Form connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Tiger Form connection.
