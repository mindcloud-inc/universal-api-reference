# Typesense: Import Documents With Upsert

Imports documents into Typesense using upsert mode.

```
PUT https://connect.mindcloud.co/v1/universal/typesense/latest/actions/import-documents-with-upsert
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/typesense/latest/actions/import-documents-with-upsert" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/typesense/latest/actions/import-documents-with-upsert', {
  method: 'PUT',
  headers: {
