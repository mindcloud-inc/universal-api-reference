# Typesense Universal API Authentication

Every Typesense API request through MindCloud uses a MindCloud API key and the `connectionId` of a Typesense connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Typesense connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Typesense action](README.md#actions-89) with your API key and `connectionId`.
