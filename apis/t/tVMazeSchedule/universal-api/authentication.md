# TVMaze Schedule Universal API Authentication

Every TVMaze Schedule API request through MindCloud uses a MindCloud API key and the `connectionId` of a TVMaze Schedule connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TVMaze Schedule connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TVMaze Schedule action](README.md#actions-56) with your API key and `connectionId`.
