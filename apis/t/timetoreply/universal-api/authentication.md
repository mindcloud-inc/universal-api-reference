# Timetoreply Universal API Authentication

Every Timetoreply API request through MindCloud uses a MindCloud API key and the `connectionId` of a Timetoreply connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Timetoreply connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Timetoreply action](README.md#actions-20) with your API key and `connectionId`.
