# TouchBasePro: Update Email Template

Updates an existing email template in TouchBasePro.

```
PUT https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/update-email-template
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/update-email-template" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/update-email-template', {
  method: 'PUT',
  headers: {
