# TouchBasePro: Unsubscribe Subscriber

Unsubscribes a subscriber in TouchBasePro.

```
PUT https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/unsubscribe-subscriber
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/unsubscribe-subscriber" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/unsubscribe-subscriber', {
  method: 'PUT',
  headers: {
