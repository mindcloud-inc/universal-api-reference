# TouchBasePro: Delete Segment

Deletes an existing segment from TouchBasePro.

```
DELETE https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/delete-segment
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/delete-segment?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/delete-segment?${params}`, {
  headers: {
