# TouchBasePro: Delete Subscriber

Deletes an existing subscriber from TouchBasePro.

```
DELETE https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/delete-subscriber
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/delete-subscriber?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/delete-subscriber?${params}`, {
  headers: {
