# TouchBasePro: List Webhooks

Retrieves configured webhooks from TouchBasePro.

```
GET https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/list-webhooks
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/list-webhooks?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/touchBasePro/latest/actions/list-webhooks?${params}`, {
  headers: {
