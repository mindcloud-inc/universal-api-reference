# TouchBasePro Universal API Authentication

Every TouchBasePro API request through MindCloud uses a MindCloud API key and the `connectionId` of a TouchBasePro connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TouchBasePro connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TouchBasePro action](README.md#actions-124) with your API key and `connectionId`.
