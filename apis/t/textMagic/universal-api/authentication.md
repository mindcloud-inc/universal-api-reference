# TextMagic Universal API Authentication

Every TextMagic API request through MindCloud uses a MindCloud API key and the `connectionId` of a TextMagic connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TextMagic connection.
