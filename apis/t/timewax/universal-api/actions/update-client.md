# Timewax: Update Client

Updates an existing client in Timewax.

```
PUT https://connect.mindcloud.co/v1/universal/timewax/latest/actions/update-client
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/timewax/latest/actions/update-client" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/timewax/latest/actions/update-client', {
  method: 'PUT',
  headers: {
