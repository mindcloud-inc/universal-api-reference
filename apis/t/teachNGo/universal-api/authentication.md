# Teach 'n Go Universal API Authentication

Every Teach 'n Go API request through MindCloud uses a MindCloud API key and the `connectionId` of a Teach 'n Go connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Teach 'n Go connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Teach 'n Go action](README.md#actions-13) with your API key and `connectionId`.
