# Get Tokenized Positions with Torque

## Endpoint

- **Method:** `GET`
- **Path:** `/enso/positions/tokenized`
- **Base URL:** `https://app.torque.fi/api`
- **Official documentation:** [Get Tokenized Positions](https://docs.torque.fi/business/api-reference)
