# TLY Link Shortener Universal API Authentication

Every TLY Link Shortener API request through MindCloud uses a MindCloud API key and the `connectionId` of a TLY Link Shortener connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TLY Link Shortener connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TLY Link Shortener action](README.md#actions-29) with your API key and `connectionId`.
