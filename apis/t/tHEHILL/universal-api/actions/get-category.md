# THE HILL: Get Category

Retrieves a specific category from The Hill.

```
GET https://connect.mindcloud.co/v1/universal/tHEHILL/latest/actions/get-category
```
...
| --- | --- | --- | --- |
| `id` | number | yes | WordPress category ID. |
...
Through the native THE HILL API, this operation is `GET /wp/v2/categories/{id}` (base URL `https://thehill.com/wp-json/`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-category.md) for the provider-specific parameters and requirements.
