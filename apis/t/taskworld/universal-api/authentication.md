# Taskworld Universal API Authentication

Every Taskworld API request through MindCloud uses a MindCloud API key and the `connectionId` of a Taskworld connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Taskworld connection.
