# Temp Stick Universal API Authentication

Every Temp Stick API request through MindCloud uses a MindCloud API key and the `connectionId` of a Temp Stick connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Temp Stick connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Temp Stick action](README.md#actions-12) with your API key and `connectionId`.
