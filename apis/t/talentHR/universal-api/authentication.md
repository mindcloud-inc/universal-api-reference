# TalentHR Universal API Authentication

Every TalentHR API request through MindCloud uses a MindCloud API key and the `connectionId` of a TalentHR connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TalentHR connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TalentHR action](README.md#actions-52) with your API key and `connectionId`.
