# Talend Universal API Authentication

Every Talend API request through MindCloud uses a MindCloud API key and the `connectionId` of a Talend connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Talend connection.
