# Tiledesk Universal API Authentication

Every Tiledesk API request through MindCloud uses a MindCloud API key and the `connectionId` of a Tiledesk connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Tiledesk connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Tiledesk action](README.md#actions-66) with your API key and `connectionId`.
