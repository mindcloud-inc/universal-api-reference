# TestRail Universal API Authentication

Every TestRail API request through MindCloud uses a MindCloud API key and the `connectionId` of a TestRail connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TestRail connection.
