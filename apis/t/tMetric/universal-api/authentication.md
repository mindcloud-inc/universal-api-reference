# TMetric Universal API Authentication

Every TMetric API request through MindCloud uses a MindCloud API key and the `connectionId` of a TMetric connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TMetric connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TMetric action](README.md#actions-29) with your API key and `connectionId`.
