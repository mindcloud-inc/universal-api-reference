# TextingHouse Universal API Authentication

Every TextingHouse API request through MindCloud uses a MindCloud API key and the `connectionId` of a TextingHouse connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your TextingHouse connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [TextingHouse action](README.md#actions-6) with your API key and `connectionId`.
