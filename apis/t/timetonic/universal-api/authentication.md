# Timetonic Universal API Authentication

Every Timetonic API request through MindCloud uses a MindCloud API key and the `connectionId` of a Timetonic connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Timetonic connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Timetonic action](README.md#actions-21) with your API key and `connectionId`.
