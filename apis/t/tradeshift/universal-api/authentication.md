# Tradeshift Universal API Authentication

Every Tradeshift API request through MindCloud uses a MindCloud API key and the `connectionId` of a Tradeshift connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Tradeshift connection.
