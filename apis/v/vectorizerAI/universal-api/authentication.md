# Vectorizer AI Universal API Authentication

Every Vectorizer AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Vectorizer AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Vectorizer AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Vectorizer AI action](README.md#actions-4) with your API key and `connectionId`.
