# Veterans Affairs Forms Universal API Authentication

Every Veterans Affairs Forms API request through MindCloud uses a MindCloud API key and the `connectionId` of a Veterans Affairs Forms connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Veterans Affairs Forms connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Veterans Affairs Forms action](README.md#actions-2) with your API key and `connectionId`.
