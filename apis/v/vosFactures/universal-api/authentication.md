# VosFactures Universal API Authentication

Every VosFactures API request through MindCloud uses a MindCloud API key and the `connectionId` of a VosFactures connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your VosFactures connection.
