# Viqeo Universal API Authentication

Every Viqeo API request through MindCloud uses a MindCloud API key and the `connectionId` of a Viqeo connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Viqeo connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Viqeo action](README.md#actions-15) with your API key and `connectionId`.
