...
```
GET https://connect.mindcloud.co/v1/universal/viqeo/latest/actions/list-projects
```
...
Through the native Viqeo API, this operation is `GET /media-platform/v1/project` (base URL `https://api.viqeo.tv`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-projects.md) for the provider-specific parameters and requirements.
