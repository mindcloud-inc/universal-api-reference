# Virtual Summits Software Universal API Authentication

Every Virtual Summits Software API request through MindCloud uses a MindCloud API key and the `connectionId` of a Virtual Summits Software connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Virtual Summits Software connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Virtual Summits Software action](README.md#actions-12) with your API key and `connectionId`.
