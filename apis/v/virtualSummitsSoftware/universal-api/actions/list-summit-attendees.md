# Virtual Summits Software: List Summit Attendees



```
GET https://connect.mindcloud.co/v1/universal/virtualSummitsSoftware/latest/actions/list-summit-attendees
```
...
Through the native Virtual Summits Software API, this operation is `GET /summits/:summitId/attendees` (base URL `https://api.virtualsummits.com/api/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-summit-attendees.md) for the provider-specific parameters and requirements.
