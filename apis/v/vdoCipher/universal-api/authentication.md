# VdoCipher Universal API Authentication

Every VdoCipher API request through MindCloud uses a MindCloud API key and the `connectionId` of a VdoCipher connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your VdoCipher connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [VdoCipher action](README.md#actions-26) with your API key and `connectionId`.
