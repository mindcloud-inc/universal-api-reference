# Vortex Universal API Authentication

Every Vortex API request through MindCloud uses a MindCloud API key and the `connectionId` of a Vortex connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Vortex connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Vortex action](README.md#actions-16) with your API key and `connectionId`.
