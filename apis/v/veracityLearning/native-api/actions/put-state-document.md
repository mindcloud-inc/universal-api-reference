# Put State Document with Veracity Learning
...
- **Official documentation:** [Put State Document](https://xapi.ieee-saopen.org/standard/)
...
| `document` | body | `object` | yes | JSON state document to store. |
