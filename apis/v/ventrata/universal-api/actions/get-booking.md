# Ventrata: Get Booking

Retrieves a booking from Ventrata.

```
GET https://connect.mindcloud.co/v1/universal/ventrata/latest/actions/get-booking
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/ventrata/latest/actions/get-booking?connectionId=$CONNECTION_ID&uuid=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/ventrata/latest/actions/get-booking?${params}`, {
  headers: {
