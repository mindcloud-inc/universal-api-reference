# Ventrata: Cancel Booking

Cancels an existing booking in Ventrata.

```
DELETE https://connect.mindcloud.co/v1/universal/ventrata/latest/actions/cancel-booking
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/ventrata/latest/actions/cancel-booking?connectionId=$CONNECTION_ID&uuid=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/ventrata/latest/actions/cancel-booking?${params}`, {
  headers: {
