# Ventrata: Create and Confirm Booking

Creates and confirms a booking in Ventrata.

```
POST https://connect.mindcloud.co/v1/universal/ventrata/latest/actions/create-and-confirm-booking
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/ventrata/latest/actions/create-and-confirm-booking" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/ventrata/latest/actions/create-and-confirm-booking', {
  method: 'POST',
  headers: {
...
Through the native Ventrata API, this operation is `POST octo/bookings/confirm` (base URL `https://api.ventrata.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/create-and-confirm-booking.md) for the provider-specific parameters and requirements.
