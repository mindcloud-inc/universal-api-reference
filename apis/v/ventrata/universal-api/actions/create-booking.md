# Ventrata: Create Booking

Creates a new booking in Ventrata.

```
POST https://connect.mindcloud.co/v1/universal/ventrata/latest/actions/create-booking
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/ventrata/latest/actions/create-booking" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/ventrata/latest/actions/create-booking', {
  method: 'POST',
  headers: {
