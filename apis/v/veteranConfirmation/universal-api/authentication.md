# Veteran Confirmation Universal API Authentication

Every Veteran Confirmation API request through MindCloud uses a MindCloud API key and the `connectionId` of a Veteran Confirmation connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Veteran Confirmation connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Veteran Confirmation action](README.md#actions-1) with your API key and `connectionId`.
