...
```
GET https://connect.mindcloud.co/v1/universal/vimeo/latest/actions/list-projects
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/vimeo/latest/actions/list-projects?connectionId=$CONNECTION_ID&limit=25&offset=0&userId=152184" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/vimeo/latest/actions/list-projects?${params}`, {
  headers: {
...
| Key | Type | Required | Description |
| --- | --- | --- | --- |
| `sort` | list<string> | no | The way to sort the results. One of: `date`, `default`, `modified_time`, `name`, `pinned_on`. Example: `date`. |
