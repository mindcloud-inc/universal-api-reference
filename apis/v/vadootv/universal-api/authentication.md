# Vadootv Universal API Authentication

Every Vadootv API request through MindCloud uses a MindCloud API key and the `connectionId` of a Vadootv connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Vadootv connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Vadootv action](README.md#actions-15) with your API key and `connectionId`.
