# Process a Business Card with Veryfi
...
- **Method:** `POST`
- **Path:** `/api/v8/partner/business-cards`
- **Base URL:** `https://api.veryfi.com`
- **Official documentation:** [Process a Business Card](https://docs.veryfi.com/api/business-cards/process-a-business-card/)
...
| `auto_delete` | body | `boolean` | no | Default value: false Delete this business_card from Veryfi after data has been extracted |
