# Process a Bank Statement with Veryfi
...
- **Method:** `POST`
- **Path:** `/api/v8/partner/bank-statements`
- **Base URL:** `https://api.veryfi.com`
- **Official documentation:** [Process a Bank Statement](https://docs.veryfi.com/api/bank-statements/process-a-bank-statement/)
