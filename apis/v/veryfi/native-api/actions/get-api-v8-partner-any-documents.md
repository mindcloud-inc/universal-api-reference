...
- **Official documentation:** [Get âDocs](https://docs.veryfi.com/api/anydocs/get-A-docs/)
...
| `blueprint_name` | query | `string` | no | The name of the extraction blueprints. |
| `template_name` | query | `string` | no | Deprecated.The name of the extraction blueprints. |
