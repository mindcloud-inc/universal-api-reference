# Veryfi Universal API Authentication

Every Veryfi API request through MindCloud uses a MindCloud API key and the `connectionId` of a Veryfi connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Veryfi connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Veryfi action](README.md#actions-99) with your API key and `connectionId`.
