# Veryfi OCR Universal API Authentication

Every Veryfi OCR API request through MindCloud uses a MindCloud API key and the `connectionId` of a Veryfi OCR connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Veryfi OCR connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Veryfi OCR action](README.md#actions-76) with your API key and `connectionId`.
