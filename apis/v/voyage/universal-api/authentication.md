# Voyage Universal API Authentication

Every Voyage API request through MindCloud uses a MindCloud API key and the `connectionId` of a Voyage connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Voyage connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Voyage action](README.md#actions-12) with your API key and `connectionId`.
