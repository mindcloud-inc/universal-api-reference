# v0 Universal API Authentication

Every v0 API request through MindCloud uses a MindCloud API key and the `connectionId` of a v0 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your v0 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [v0 action](README.md#actions-24) with your API key and `connectionId`.
