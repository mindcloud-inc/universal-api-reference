...
```
GET https://connect.mindcloud.co/v1/universal/vapi/latest/actions/list-assistants
```
...
Through the native Vapi API, this operation is `GET /assistant` (base URL `https://api.vapi.ai`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-assistants.md) for the provider-specific parameters and requirements.
