# Vtiger CRM Universal API Authentication

Every Vtiger CRM API request through MindCloud uses a MindCloud API key and the `connectionId` of a Vtiger CRM connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Vtiger CRM connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Vtiger CRM action](README.md#actions-38) with your API key and `connectionId`.
