...
```
GET https://connect.mindcloud.co/v1/universal/voog/latest/actions/list-my-sites
```
...
Through the native Voog API, this operation is `GET /me/sites` (base URL `{{credentials.siteUrl}}/admin/api`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-my-sites.md) for the provider-specific parameters and requirements.
