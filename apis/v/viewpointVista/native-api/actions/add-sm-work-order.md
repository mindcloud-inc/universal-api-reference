# Add SM Work Order with Viewpoint Vista
...
- **Method:** `POST`
- **Path:** `v1/direct/subscribers/:subscriber_code/vista/:api/2/data/:object/actions/add`
- **Base URL:** `https://api.xchange.trimble.com/connect/`
- **API:** REST
- **Official documentation:** [Add SM Work Order](https://direct-api.xchange.trimble.com/reference/post-directsubscriberssubscriber_codevistasm2datawork_ordersactionsadd)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `SMCo` | body | `number` | yes | — |
| `Service Center` | body | `string` | yes | Enter the Service center that this request is assigned to. |
| `Customer` | body | `number` | yes | The SM Customer for this order.  **Required when `WorkOrderType` is `C-Customer`. |
