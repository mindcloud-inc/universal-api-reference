# List DM Objects with Viewpoint Vista
...
- **API:** REST
- **Official documentation:** [List DM Objects](https://direct-api.xchange.trimble.com/reference/get-directsubscriberssubscriber_codevistasm2datacustomerscache)
