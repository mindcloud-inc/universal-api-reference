# List SM Objects with Viewpoint Vista
...
- **API:** REST
- **Official documentation:** [List SM Objects](https://direct-api.xchange.trimble.com/reference/get-directsubscriberssubscriber_codevistasm2datacustomerscache)
