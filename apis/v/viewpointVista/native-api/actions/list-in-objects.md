# List IN Objects with Viewpoint Vista
...
- **API:** REST
- **Official documentation:** [List IN Objects](https://direct-api.xchange.trimble.com/reference/get-directsubscriberssubscriber_codevistasm2datacustomerscache)
