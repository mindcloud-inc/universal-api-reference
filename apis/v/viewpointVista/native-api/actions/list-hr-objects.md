# List HR Objects with Viewpoint Vista
...
- **API:** REST
- **Official documentation:** [List HR Objects](https://direct-api.xchange.trimble.com/reference/get-directsubscriberssubscriber_codevistasm2datacustomerscache)
