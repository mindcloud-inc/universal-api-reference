# Search GL Objects with Viewpoint Vista
...
- **API:** REST
- **Official documentation:** [Search GL Objects](https://direct-api.xchange.trimble.com/reference/get-directsubscriberssubscriber_codevistasm2datacustomerscache)
