# Viewpoint Vista: Upsert AR Invoice Batch

Upsert Invoice Batch

```
POST https://connect.mindcloud.co/v1/universal/viewpointVista/latest/actions/upsert-ar-invoice-batch
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/viewpointVista/latest/actions/upsert-ar-invoice-batch" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/viewpointVista/latest/actions/upsert-ar-invoice-batch', {
  method: 'POST',
  headers: {
