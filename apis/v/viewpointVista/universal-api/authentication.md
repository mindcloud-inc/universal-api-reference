# Viewpoint Vista Universal API Authentication

Every Viewpoint Vista API request through MindCloud uses a MindCloud API key and the `connectionId` of a Viewpoint Vista connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Viewpoint Vista connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Viewpoint Vista action](README.md#actions-67) with your API key and `connectionId`.
