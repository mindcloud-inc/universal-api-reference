# Vestaboard Universal API Authentication

Every Vestaboard API request through MindCloud uses a MindCloud API key and the `connectionId` of a Vestaboard connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Vestaboard connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Vestaboard action](README.md#actions-4) with your API key and `connectionId`.
