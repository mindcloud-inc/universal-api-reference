# Vybit Universal API Authentication

Every Vybit API request through MindCloud uses a MindCloud API key and the `connectionId` of a Vybit connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Vybit connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Vybit action](README.md#actions-37) with your API key and `connectionId`.
