# Send Notification to Owner with Vybit

## Endpoint

- **Method:** `POST`
- **Path:** `/subscription/following/{{key}}/send-to-owner`
- **Base URL:** `https://api.vybit.net/v1`
- **Official documentation:** [Send Notification to Owner](https://developer.vybit.net/api-reference/)
