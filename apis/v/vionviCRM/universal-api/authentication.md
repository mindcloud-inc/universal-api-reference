# vionvi CRM Universal API Authentication

Every vionvi CRM API request through MindCloud uses a MindCloud API key and the `connectionId` of a vionvi CRM connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your vionvi CRM connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [vionvi CRM action](README.md#actions-24) with your API key and `connectionId`.
