...
| [Create Vendor Invoice (SOAP)](actions/create-vendor-invoice-soap.md) | POST |  |
| [Create Vendor (SOAP)](actions/create-vendor-soap.md) | POST |  |
...
| [Send Timesheet (SOAP)](actions/send-timesheet-soap.md) | POST |  |
