# Viewpoint Spectrum Universal API Authentication

Every Viewpoint Spectrum API request through MindCloud uses a MindCloud API key and the `connectionId` of a Viewpoint Spectrum connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Viewpoint Spectrum connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Viewpoint Spectrum action](README.md#actions-16) with your API key and `connectionId`.
