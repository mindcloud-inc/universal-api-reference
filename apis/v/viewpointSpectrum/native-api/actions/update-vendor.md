# Update Vendor with Viewpoint Spectrum
...
- **Base URL:** `{url}:8482/`
- **Official documentation:** [Update Vendor](https://help.trimble.com/en/spectrum/spectrum/api-web-services/list-of-web-services/accounts-payable-services/update-vendor)
