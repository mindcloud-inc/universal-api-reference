...
```
POST https://connect.mindcloud.co/v1/universal/vibrato/latest/actions/create-call
```
...
Through the native Vibrato API, this operation is `POST /calls/` (base URL `https://api.getvibrato.com/api/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/create-call.md) for the provider-specific parameters and requirements.
