# Vouchsafe Universal API Authentication

Every Vouchsafe API request through MindCloud uses a MindCloud API key and the `connectionId` of a Vouchsafe connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Vouchsafe connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Vouchsafe action](README.md#actions-19) with your API key and `connectionId`.
