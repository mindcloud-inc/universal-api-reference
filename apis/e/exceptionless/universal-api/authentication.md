# Exceptionless Universal API Authentication

Every Exceptionless API request through MindCloud uses a MindCloud API key and the `connectionId` of a Exceptionless connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Exceptionless connection.
