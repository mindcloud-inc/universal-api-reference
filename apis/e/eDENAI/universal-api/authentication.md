# EDEN AI Universal API Authentication

Every EDEN AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a EDEN AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your EDEN AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [EDEN AI action](README.md#actions-37) with your API key and `connectionId`.
