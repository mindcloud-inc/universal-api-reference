# edatalia Sign Online Universal API Authentication

Every edatalia Sign Online API request through MindCloud uses a MindCloud API key and the `connectionId` of a edatalia Sign Online connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your edatalia Sign Online connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [edatalia Sign Online action](README.md#actions-10) with your API key and `connectionId`.
