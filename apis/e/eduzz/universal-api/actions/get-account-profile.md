# Eduzz: Get Account Profile

Retrieves the logged-in user profile from Eduzz.

```
GET https://connect.mindcloud.co/v1/universal/eduzz/latest/actions/get-account-profile
```
...
Through the native Eduzz API, this operation is `GET /accounts/v1/me` (base URL `https://api.eduzz.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-account-profile.md) for the provider-specific parameters and requirements.
