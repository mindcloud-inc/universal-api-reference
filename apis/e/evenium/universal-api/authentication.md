# Evenium Universal API Authentication

Every Evenium API request through MindCloud uses a MindCloud API key and the `connectionId` of a Evenium connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Evenium connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Evenium action](README.md#actions-30) with your API key and `connectionId`.
