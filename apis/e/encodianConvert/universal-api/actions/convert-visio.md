# Encodian - Convert: Convert - Visio

Creates a converted file from a Visio document in Encodian - Convert.

```
POST https://connect.mindcloud.co/v1/universal/encodianConvert/latest/actions/convert-visio
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/encodianConvert/latest/actions/convert-visio" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/encodianConvert/latest/actions/convert-visio', {
  method: 'POST',
  headers: {
...
Through the native Encodian - Convert API, this operation is `POST /api/v1/Conversion/ConvertVisio` (base URL `https://api.apps-encodian.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/convert-visio.md) for the provider-specific parameters and requirements.
