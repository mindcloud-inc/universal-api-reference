# Encodian - Convert: Convert - PDF to Excel

Creates an Excel file from a PDF in Encodian - Convert.

```
POST https://connect.mindcloud.co/v1/universal/encodianConvert/latest/actions/convert-pdf-to-excel
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/encodianConvert/latest/actions/convert-pdf-to-excel" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/encodianConvert/latest/actions/convert-pdf-to-excel', {
  method: 'POST',
  headers: {
