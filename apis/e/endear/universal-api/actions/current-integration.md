# Endear: Current Integration



```
GET https://connect.mindcloud.co/v1/universal/endear/latest/actions/current-integration
```
...
Through the native Endear API, this operation is `POST /graphql` (base URL `https://api.endearhq.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/current-integration.md) for the provider-specific parameters and requirements.
