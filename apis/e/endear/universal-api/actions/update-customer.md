# Endear: Update Customer



```
PUT https://connect.mindcloud.co/v1/universal/endear/latest/actions/update-customer
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/endear/latest/actions/update-customer" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/endear/latest/actions/update-customer', {
  method: 'PUT',
  headers: {
...
| `variables.archived` | boolean | yes | Archived for the Endear GraphQL operation. |
