# Eagle Doc Universal API Authentication

Every Eagle Doc API request through MindCloud uses a MindCloud API key and the `connectionId` of a Eagle Doc connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Eagle Doc connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Eagle Doc action](README.md#actions-24) with your API key and `connectionId`.
