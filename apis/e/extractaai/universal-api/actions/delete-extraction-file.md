# Extracta.ai: Delete Extraction File

Deletes an extraction file from Extracta.ai.

```
DELETE https://connect.mindcloud.co/v1/universal/extractaai/latest/actions/delete-extraction-file
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/extractaai/latest/actions/delete-extraction-file?connectionId=$CONNECTION_ID&extractionId=string&batchId=string&fileId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/extractaai/latest/actions/delete-extraction-file?${params}`, {
  headers: {
