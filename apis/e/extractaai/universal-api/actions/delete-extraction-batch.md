# Extracta.ai: Delete Extraction Batch

Deletes an extraction batch from Extracta.ai.

```
DELETE https://connect.mindcloud.co/v1/universal/extractaai/latest/actions/delete-extraction-batch
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/extractaai/latest/actions/delete-extraction-batch?connectionId=$CONNECTION_ID&extractionId=string&batchId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/extractaai/latest/actions/delete-extraction-batch?${params}`, {
  headers: {
