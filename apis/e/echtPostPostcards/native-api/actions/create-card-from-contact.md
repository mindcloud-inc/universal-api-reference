# Create Card From Contact with EchtPost Postcards
...
- **Official documentation:** [Create Card From Contact](https://hilfe.echtpost.de/article/453/postkartenversand-uber-api-programmierschnittstelle)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `contact_id` | body | `number` | yes | Existing EchtPost contact ID. |
