# Create Card From Contact Group with EchtPost Postcards
...
- **Official documentation:** [Create Card From Contact Group](https://hilfe.echtpost.de/article/453/postkartenversand-uber-api-programmierschnittstelle)
...
| `group_id` | body | `number` | yes | The EchtPost contact group ID. |
