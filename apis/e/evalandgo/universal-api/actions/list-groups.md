# Evalandgo: List Groups

Retrieves groups from Evalandgo.

```
GET https://connect.mindcloud.co/v1/universal/evalandgo/latest/actions/list-groups
```
