# EasyBroker Universal API Authentication

Every EasyBroker API request through MindCloud uses a MindCloud API key and the `connectionId` of a EasyBroker connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your EasyBroker connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [EasyBroker action](README.md#actions-25) with your API key and `connectionId`.
