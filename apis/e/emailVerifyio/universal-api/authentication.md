# EmailVerify.io Universal API Authentication

Every EmailVerify.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a EmailVerify.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your EmailVerify.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [EmailVerify.io action](README.md#actions-5) with your API key and `connectionId`.
