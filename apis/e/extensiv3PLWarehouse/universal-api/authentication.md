# Extensiv 3PL Warehouse Universal API Authentication

Every Extensiv 3PL Warehouse API request through MindCloud uses a MindCloud API key and the `connectionId` of a Extensiv 3PL Warehouse connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Extensiv 3PL Warehouse connection.
