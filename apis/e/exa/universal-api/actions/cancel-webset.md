...
```
PUT https://connect.mindcloud.co/v1/universal/exa/latest/actions/cancel-webset
```
...
Through the native Exa API, this operation is `POST /websets/v0/websets/:id/cancel` (base URL `https://api.exa.ai`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/cancel-webset.md) for the provider-specific parameters and requirements.
