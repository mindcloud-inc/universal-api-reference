# EZICHEQ: Create Label



```
POST https://connect.mindcloud.co/v1/universal/eZICHEQ/latest/actions/create-label
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/eZICHEQ/latest/actions/create-label" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/eZICHEQ/latest/actions/create-label', {
  method: 'POST',
  headers: {
