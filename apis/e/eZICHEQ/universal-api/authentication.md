# EZICHEQ Universal API Authentication

Every EZICHEQ API request through MindCloud uses a MindCloud API key and the `connectionId` of a EZICHEQ connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your EZICHEQ connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [EZICHEQ action](README.md#actions-30) with your API key and `connectionId`.
