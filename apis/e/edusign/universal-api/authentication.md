# Edusign Universal API Authentication

Every Edusign API request through MindCloud uses a MindCloud API key and the `connectionId` of a Edusign connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Edusign connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Edusign action](README.md#actions-40) with your API key and `connectionId`.
