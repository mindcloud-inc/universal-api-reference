# Create Embedded Document with Eversign
...
- **Official documentation:** [Create Embedded Document](https://eversign.com/api/documentation/methods)
...
| `signers[0].deliver_email` | body | `string` | no |
| `signers[0].deliver_email` | body | `string` | no |
