# Eversign: List Draft Documents

Retrieves draft documents from your Eversign account.

```
GET https://connect.mindcloud.co/v1/universal/eversign/latest/actions/list-draft-documents
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/eversign/latest/actions/list-draft-documents?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/eversign/latest/actions/list-draft-documents?${params}`, {
  headers: {
