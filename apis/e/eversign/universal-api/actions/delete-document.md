# Eversign: Delete Document

Deletes an existing document from Eversign.

```
DELETE https://connect.mindcloud.co/v1/universal/eversign/latest/actions/delete-document
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/eversign/latest/actions/delete-document?connectionId=$CONNECTION_ID&documentHash=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/eversign/latest/actions/delete-document?${params}`, {
  headers: {
