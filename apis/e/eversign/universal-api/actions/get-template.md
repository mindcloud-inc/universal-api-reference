# Eversign: Get Template

Retrieves a template from Eversign by hash.

```
GET https://connect.mindcloud.co/v1/universal/eversign/latest/actions/get-template
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/eversign/latest/actions/get-template?connectionId=$CONNECTION_ID&documentHash=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/eversign/latest/actions/get-template?${params}`, {
  headers: {
