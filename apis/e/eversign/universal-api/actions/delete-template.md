# Eversign: Delete Template

Deletes an existing template from Eversign.

```
DELETE https://connect.mindcloud.co/v1/universal/eversign/latest/actions/delete-template
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/eversign/latest/actions/delete-template?connectionId=$CONNECTION_ID&documentHash=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/eversign/latest/actions/delete-template?${params}`, {
  headers: {
