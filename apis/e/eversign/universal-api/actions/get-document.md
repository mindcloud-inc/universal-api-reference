# Eversign: Get Document

Retrieves a document from Eversign by hash.

```
GET https://connect.mindcloud.co/v1/universal/eversign/latest/actions/get-document
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/eversign/latest/actions/get-document?connectionId=$CONNECTION_ID&documentHash=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/eversign/latest/actions/get-document?${params}`, {
  headers: {
