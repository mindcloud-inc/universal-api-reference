# Evil Insult Universal API Authentication

Every Evil Insult API request through MindCloud uses a MindCloud API key and the `connectionId` of a Evil Insult connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Evil Insult connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Evil Insult action](README.md#actions-3) with your API key and `connectionId`.
