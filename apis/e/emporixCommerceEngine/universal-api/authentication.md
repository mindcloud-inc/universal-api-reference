# Emporix Commerce Engine Universal API Authentication

Every Emporix Commerce Engine API request through MindCloud uses a MindCloud API key and the `connectionId` of a Emporix Commerce Engine connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Emporix Commerce Engine connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Emporix Commerce Engine action](README.md#actions-40) with your API key and `connectionId`.
