# Enginemailer Universal API Authentication

Every Enginemailer API request through MindCloud uses a MindCloud API key and the `connectionId` of a Enginemailer connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Enginemailer connection.
