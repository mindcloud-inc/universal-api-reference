# Encodian - Excel Universal API Authentication

Every Encodian - Excel API request through MindCloud uses a MindCloud API key and the `connectionId` of a Encodian - Excel connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Encodian - Excel connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Encodian - Excel action](README.md#actions-19) with your API key and `connectionId`.
