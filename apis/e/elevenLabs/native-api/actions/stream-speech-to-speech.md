# Stream Speech To Speech with ElevenLabs
...
- **Method:** `POST`
- **Path:** `/speech-to-speech/:voice_id/stream`
- **Base URL:** `https://api.elevenlabs.io/v1`
- **Official documentation:** [Stream Speech To Speech](https://elevenlabs.io/docs/api-reference/speech-to-speech/stream)
