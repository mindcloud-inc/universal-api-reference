# Envoice Universal API Authentication

Every Envoice API request through MindCloud uses a MindCloud API key and the `connectionId` of a Envoice connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Envoice connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Envoice action](README.md#actions-61) with your API key and `connectionId`.
