# ExpertEase Universal API Authentication

Every ExpertEase API request through MindCloud uses a MindCloud API key and the `connectionId` of a ExpertEase connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ExpertEase connection.
