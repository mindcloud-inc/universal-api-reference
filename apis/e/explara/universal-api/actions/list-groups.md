...
Retrieves groups from Explara.

```
GET https://connect.mindcloud.co/v1/universal/explara/latest/actions/list-groups
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/explara/latest/actions/list-groups?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/explara/latest/actions/list-groups?${params}`, {
  headers: {
