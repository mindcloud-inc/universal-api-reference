# Explara: Account Profile

Retrieves an account profile from Explara.

```
GET https://connect.mindcloud.co/v1/universal/explara/latest/actions/account-profile
```
...
Through the native Explara API, this operation is `GET /a/api/web/profile` (base URL `https://www.explara.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/account-profile.md) for the provider-specific parameters and requirements.
