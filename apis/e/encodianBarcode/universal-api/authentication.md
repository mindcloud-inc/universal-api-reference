# Encodian - Barcode Universal API Authentication

Every Encodian - Barcode API request through MindCloud uses a MindCloud API key and the `connectionId` of a Encodian - Barcode connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Encodian - Barcode connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Encodian - Barcode action](README.md#actions-11) with your API key and `connectionId`.
