# Easymailing: Get Segment

Retrieves a segment from Easymailing.

```
GET https://connect.mindcloud.co/v1/universal/easymailing/latest/actions/get-segment
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/easymailing/latest/actions/get-segment?connectionId=$CONNECTION_ID&audienceUuid=string&uuid=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/easymailing/latest/actions/get-segment?${params}`, {
  headers: {
