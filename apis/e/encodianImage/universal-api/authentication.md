# Encodian - Image Universal API Authentication

Every Encodian - Image API request through MindCloud uses a MindCloud API key and the `connectionId` of a Encodian - Image connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Encodian - Image connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Encodian - Image action](README.md#actions-15) with your API key and `connectionId`.
