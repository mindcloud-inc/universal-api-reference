# Easy Projects Universal API Authentication

Every Easy Projects API request through MindCloud uses a MindCloud API key and the `connectionId` of a Easy Projects connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Easy Projects connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Easy Projects action](README.md#actions-30) with your API key and `connectionId`.
