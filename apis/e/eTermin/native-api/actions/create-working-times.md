# Create Working Times with eTermin
...
- **Official documentation:** [Create Working Times](https://app.swaggerhub.com/apis-docs/etermin.net/eTermin-API/1.0.0#/WorkingTimes/post_api_workingtimes)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `start` | query | `string` | yes | Start time of the slot, e.g. 09:00 |
| `end` | query | `string` | yes | End time of the slot, e.g. 17:00 |
| `calendarid` | query | `number` | yes | ID of the calendar |
| `weekday` | query | `string` | yes | ID of the weekday 1 = Sunday, 7 = Saturday. You can add several weekdays separated by a comma e.g. 2,3,5 |
