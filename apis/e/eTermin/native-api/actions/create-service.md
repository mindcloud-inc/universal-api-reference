...
- **Official documentation:** [Create Service](https://app.swaggerhub.com/apis-docs/etermin.net/eTermin-API/1.0.0#/Service/post_api_service)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `servicegroupid` | query | `number` | yes | ID of the service group |
| `servicede` | query | `string` | yes | Name of the service in german. For other languages use serviceLANGUAGECODE e.g. serviceen |
| `timeslotminutes` | query | `number` | yes | Duration of the service in minutes |
