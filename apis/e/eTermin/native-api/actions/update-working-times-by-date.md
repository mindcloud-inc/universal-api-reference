# Update Working Times by Date with eTermin
...
- **Official documentation:** [Update Working Times by Date](https://app.swaggerhub.com/apis-docs/etermin.net/eTermin-API/1.0.0#/WorkingTimesDate/put_api_workingtimesdate)
