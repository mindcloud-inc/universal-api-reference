...
- **Official documentation:** [Create Contact](https://app.swaggerhub.com/apis-docs/etermin.net/eTermin-API/1.0.0#/Contact/post_api_contact)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `updatewhenexistsgdt` | query | `number` | no | Set to 1 to check if the contact is already existing. If so the existing contact gets updated. Needs email or firstname, lastname, birthday. |
