# Easy Email Verification Universal API Authentication

Every Easy Email Verification API request through MindCloud uses a MindCloud API key and the `connectionId` of a Easy Email Verification connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Easy Email Verification connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Easy Email Verification action](README.md#actions-7) with your API key and `connectionId`.
