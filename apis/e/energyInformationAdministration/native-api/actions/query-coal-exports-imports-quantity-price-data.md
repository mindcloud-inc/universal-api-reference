# Query Coal Exports Imports Quantity Price Data with Energy Information Administration
...
- **Method:** `GET`
- **Path:** `/coal/exports-imports-quantity-price/data`
- **Base URL:** `https://api.eia.gov/v2`
- **Official documentation:** [Query Coal Exports Imports Quantity Price Data](https://www.eia.gov/opendata/documentation.php)
