# Query AEO Data with Energy Information Administration
...
- **Method:** `GET`
- **Path:** `/aeo/{route1}/data`
- **Base URL:** `https://api.eia.gov/v2`
- **Official documentation:** [Query AEO Data](https://www.eia.gov/opendata/documentation.php)
