# Query Coal Shipments Mine State Aggregates Data with Energy Information Administration
...
- **Method:** `GET`
- **Path:** `/coal/shipments/mine-state-aggregates/data`
- **Base URL:** `https://api.eia.gov/v2`
- **Official documentation:** [Query Coal Shipments Mine State Aggregates Data](https://www.eia.gov/opendata/documentation.php)
