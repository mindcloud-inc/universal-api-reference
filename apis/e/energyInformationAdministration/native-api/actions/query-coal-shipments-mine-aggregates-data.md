# Query Coal Shipments Mine Aggregates Data with Energy Information Administration
...
- **Method:** `GET`
- **Path:** `/coal/shipments/mine-aggregates/data`
- **Base URL:** `https://api.eia.gov/v2`
- **Official documentation:** [Query Coal Shipments Mine Aggregates Data](https://www.eia.gov/opendata/documentation.php)
