# Query Densified Biomass Feedstocks And Cost Data with Energy Information Administration
...
- **Method:** `GET`
- **Path:** `/densified-biomass/feedstocks-and-cost/data`
- **Base URL:** `https://api.eia.gov/v2`
- **Official documentation:** [Query Densified Biomass Feedstocks And Cost Data](https://www.eia.gov/opendata/documentation.php)
