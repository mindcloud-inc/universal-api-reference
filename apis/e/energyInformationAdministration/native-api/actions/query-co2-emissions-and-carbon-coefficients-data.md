# Query CO2 Emissions And Carbon Coefficients Data with Energy Information Administration
...
- **Method:** `GET`
- **Path:** `/co2-emissions/co2-emissions-and-carbon-coefficients/data`
- **Base URL:** `https://api.eia.gov/v2`
- **Official documentation:** [Query CO2 Emissions And Carbon Coefficients Data](https://www.eia.gov/opendata/documentation.php)
