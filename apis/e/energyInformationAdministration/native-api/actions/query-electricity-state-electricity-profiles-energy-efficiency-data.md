# Query Electricity State Electricity Profiles Energy Efficiency Data with Energy Information Administration
...
- **Method:** `GET`
- **Path:** `/electricity/state-electricity-profiles/energy-efficiency/data`
- **Base URL:** `https://api.eia.gov/v2`
- **Official documentation:** [Query Electricity State Electricity Profiles Energy Efficiency Data](https://www.eia.gov/opendata/documentation.php)
