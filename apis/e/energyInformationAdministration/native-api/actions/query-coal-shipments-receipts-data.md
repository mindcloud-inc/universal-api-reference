# Query Coal Shipments Receipts Data with Energy Information Administration
...
- **Method:** `GET`
- **Path:** `/coal/shipments/receipts/data`
- **Base URL:** `https://api.eia.gov/v2`
- **Official documentation:** [Query Coal Shipments Receipts Data](https://www.eia.gov/opendata/documentation.php)
