# Query Densified Biomass Export Sales And Price Data with Energy Information Administration
...
- **Method:** `GET`
- **Path:** `/densified-biomass/export-sales-and-price/data`
- **Base URL:** `https://api.eia.gov/v2`
- **Official documentation:** [Query Densified Biomass Export Sales And Price Data](https://www.eia.gov/opendata/documentation.php)
