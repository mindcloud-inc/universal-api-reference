# Query IEO Data with Energy Information Administration
...
- **Method:** `GET`
- **Path:** `/ieo/{route1}/data`
- **Base URL:** `https://api.eia.gov/v2`
- **Official documentation:** [Query IEO Data](https://www.eia.gov/opendata/documentation.php)
