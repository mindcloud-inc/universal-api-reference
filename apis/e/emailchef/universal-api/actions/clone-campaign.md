# Emailchef: Clone Campaign

Creates a cloned campaign in Emailchef.

```
POST https://connect.mindcloud.co/v1/universal/emailchef/latest/actions/clone-campaign
```
...
Through the native Emailchef API, this operation is `POST newsletters` (base URL `https://app.emailchef.com/apps/api/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/clone-campaign.md) for the provider-specific parameters and requirements.
