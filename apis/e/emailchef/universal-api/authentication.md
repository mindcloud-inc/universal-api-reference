# Emailchef Universal API Authentication

Every Emailchef API request through MindCloud uses a MindCloud API key and the `connectionId` of a Emailchef connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Emailchef connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Emailchef action](README.md#actions-25) with your API key and `connectionId`.
