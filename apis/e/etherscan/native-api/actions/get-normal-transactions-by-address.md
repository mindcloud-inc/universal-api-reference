# Get Normal Transactions By Address with Etherscan
...
- **Official documentation:** [Get Normal Transactions By Address](https://docs.etherscan.io/api-reference/endpoint/txlist)
