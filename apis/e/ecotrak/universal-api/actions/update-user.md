...
```
PUT https://connect.mindcloud.co/v1/universal/ecotrak/latest/actions/update-user
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/ecotrak/latest/actions/update-user" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/ecotrak/latest/actions/update-user', {
  method: 'PUT',
  headers: {
