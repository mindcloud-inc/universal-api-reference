# E2B Universal API Authentication

Every E2B API request through MindCloud uses a MindCloud API key and the `connectionId` of a E2B connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your E2B connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [E2B action](README.md#actions-37) with your API key and `connectionId`.
