# EbulkSMS: Get Account Balance

Retrieves your EbulkSMS account balance.

```
GET https://connect.mindcloud.co/v1/universal/ebulkSMS/latest/actions/get-account-balance
```
