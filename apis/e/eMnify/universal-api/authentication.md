# EMnify Universal API Authentication

Every EMnify API request through MindCloud uses a MindCloud API key and the `connectionId` of a EMnify connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your EMnify connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [EMnify action](README.md#actions-28) with your API key and `connectionId`.
