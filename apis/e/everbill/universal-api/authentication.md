# Everbill Universal API Authentication

Every Everbill API request through MindCloud uses a MindCloud API key and the `connectionId` of a Everbill connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Everbill connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Everbill action](README.md#actions-41) with your API key and `connectionId`.
