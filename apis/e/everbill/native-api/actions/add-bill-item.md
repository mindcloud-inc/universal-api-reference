...
- **Method:** `POST`
- **Path:** `/bills/add_item/:id`
- **Base URL:** `https://api.everbill.eu`
- **Official documentation:** [Add Bill Item](https://api.swaggerhub.com/apis/everbill1/everbill/1.10/swagger.json#/paths/~1bills~1add_item~1{id}/post)
