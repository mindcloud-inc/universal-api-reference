# Encodian Universal API Authentication

Every Encodian API request through MindCloud uses a MindCloud API key and the `connectionId` of a Encodian connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Encodian connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Encodian action](README.md#actions-43) with your API key and `connectionId`.
