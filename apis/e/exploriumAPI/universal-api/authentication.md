# Explorium Universal API Authentication

Every Explorium API request through MindCloud uses a MindCloud API key and the `connectionId` of a Explorium connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Explorium connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Explorium action](README.md#actions-38) with your API key and `connectionId`.
