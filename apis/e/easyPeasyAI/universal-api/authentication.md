# Easy-Peasy.AI Universal API Authentication

Every Easy-Peasy.AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Easy-Peasy.AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Easy-Peasy.AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Easy-Peasy.AI action](README.md#actions-8) with your API key and `connectionId`.
