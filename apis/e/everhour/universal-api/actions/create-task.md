# Everhour: Create Task

Creates a new task in Everhour.

```
POST https://connect.mindcloud.co/v1/universal/everhour/latest/actions/create-task
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/everhour/latest/actions/create-task" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/everhour/latest/actions/create-task', {
  method: 'POST',
  headers: {
