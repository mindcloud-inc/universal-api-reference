# Easyship: Cancel Pickup

Cancels a pickup in Easyship.

```
PUT https://connect.mindcloud.co/v1/universal/easyship/latest/actions/cancel-pickup
```
...
| --- | --- | --- | --- |
| `pickupId` | string | yes | The Easyship pickup ID. |
...
Through the native Easyship API, this operation is `POST /pickups/:pickup_id/cancel` (base URL `https://public-api.easyship.com/2024-09`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/cancel-pickup.md) for the provider-specific parameters and requirements.
