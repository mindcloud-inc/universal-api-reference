...
```
GET https://connect.mindcloud.co/v1/universal/evoliz/latest/actions/get-invoice
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/evoliz/latest/actions/get-invoice?connectionId=$CONNECTION_ID&invoiceId=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/evoliz/latest/actions/get-invoice?${params}`, {
  headers: {
...
Through the native Evoliz API, this operation is `GET /api/v1/invoices/:invoiceid` (base URL `https://www.evoliz.io`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-invoice.md) for the provider-specific parameters and requirements.
