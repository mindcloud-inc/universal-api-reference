# e-Boekhouden.nl Universal API Authentication

Every e-Boekhouden.nl API request through MindCloud uses a MindCloud API key and the `connectionId` of a e-Boekhouden.nl connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your e-Boekhouden.nl connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [e-Boekhouden.nl action](README.md#actions-36) with your API key and `connectionId`.
