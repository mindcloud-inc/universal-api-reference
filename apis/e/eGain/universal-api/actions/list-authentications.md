# eGain: List Authentications

Retrieves a list of authentications from eGain.

```
GET https://connect.mindcloud.co/v1/universal/eGain/latest/actions/list-authentications
```
...
Through the native eGain API, this operation is `GET /authentications` (base URL `https://api.ai.egain.cloud/conversation/conversationmgr/v3`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-authentications.md) for the provider-specific parameters and requirements.
