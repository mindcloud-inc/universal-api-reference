# eGain Universal API Authentication

Every eGain API request through MindCloud uses a MindCloud API key and the `connectionId` of a eGain connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your eGain connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [eGain action](README.md#actions-35) with your API key and `connectionId`.
