# EARLY Universal API Authentication

Every EARLY API request through MindCloud uses a MindCloud API key and the `connectionId` of a EARLY connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your EARLY connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [EARLY action](README.md#actions-48) with your API key and `connectionId`.
