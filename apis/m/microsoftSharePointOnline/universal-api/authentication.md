# Microsoft SharePoint Online Universal API Authentication

Every Microsoft SharePoint Online API request through MindCloud uses a MindCloud API key and the `connectionId` of a Microsoft SharePoint Online connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Microsoft SharePoint Online connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Microsoft SharePoint Online action](README.md#actions-17) with your API key and `connectionId`.
