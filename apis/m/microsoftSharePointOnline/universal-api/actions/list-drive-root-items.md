# Microsoft SharePoint Online: List Drive Root Items

Retrieves root drive items from Microsoft SharePoint Online.

```
GET https://connect.mindcloud.co/v1/universal/microsoftSharePointOnline/latest/actions/list-drive-root-items
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/microsoftSharePointOnline/latest/actions/list-drive-root-items?${params}`, {
  headers: {
