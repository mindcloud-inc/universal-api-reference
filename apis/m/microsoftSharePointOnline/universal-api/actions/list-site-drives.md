# Microsoft SharePoint Online: List Site Drives

Retrieves drives from a site in Microsoft SharePoint Online.

```
GET https://connect.mindcloud.co/v1/universal/microsoftSharePointOnline/latest/actions/list-site-drives
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/microsoftSharePointOnline/latest/actions/list-site-drives?connectionId=$CONNECTION_ID&limit=25&offset=0&siteId=contoso.sharepoint.com%2CsiteCollectionId%2CsiteId" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/microsoftSharePointOnline/latest/actions/list-site-drives?${params}`, {
  headers: {
