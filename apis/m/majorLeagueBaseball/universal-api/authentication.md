# Major League Baseball Universal API Authentication

Every Major League Baseball API request through MindCloud uses a MindCloud API key and the `connectionId` of a Major League Baseball connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Major League Baseball connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Major League Baseball action](README.md#actions-130) with your API key and `connectionId`.
