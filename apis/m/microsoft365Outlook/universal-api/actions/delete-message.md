# Microsoft 365 Outlook: Delete Message

Deletes a message from Microsoft 365 Outlook.

```
DELETE https://connect.mindcloud.co/v1/universal/microsoft365Outlook/latest/actions/delete-message
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/microsoft365Outlook/latest/actions/delete-message?connectionId=$CONNECTION_ID&messageId=AAMkAG..." \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/microsoft365Outlook/latest/actions/delete-message?${params}`, {
  headers: {
