# Microsoft 365 Outlook: Send Draft Message

Sends a draft message in Microsoft 365 Outlook.

```
PUT https://connect.mindcloud.co/v1/universal/microsoft365Outlook/latest/actions/send-draft-message
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/microsoft365Outlook/latest/actions/send-draft-message" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/microsoft365Outlook/latest/actions/send-draft-message', {
  method: 'PUT',
  headers: {
