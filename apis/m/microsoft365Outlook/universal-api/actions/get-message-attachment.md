# Microsoft 365 Outlook: Get Message Attachment

Retrieves an attachment from Microsoft 365 Outlook.

```
GET https://connect.mindcloud.co/v1/universal/microsoft365Outlook/latest/actions/get-message-attachment
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/microsoft365Outlook/latest/actions/get-message-attachment?connectionId=$CONNECTION_ID&messageId=AAMkAG...&attachmentId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/microsoft365Outlook/latest/actions/get-message-attachment?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `messageId` | string | yes | The Outlook message ID that contains the attachment. Example: `AAMkAG...`. |
