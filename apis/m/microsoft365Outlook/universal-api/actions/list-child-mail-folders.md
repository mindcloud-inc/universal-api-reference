# Microsoft 365 Outlook: List Child Mail Folders

Retrieves child mail folders from Microsoft 365 Outlook.

```
GET https://connect.mindcloud.co/v1/universal/microsoft365Outlook/latest/actions/list-child-mail-folders
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/microsoft365Outlook/latest/actions/list-child-mail-folders?connectionId=$CONNECTION_ID&mailFolderId=inbox" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/microsoft365Outlook/latest/actions/list-child-mail-folders?${params}`, {
  headers: {
