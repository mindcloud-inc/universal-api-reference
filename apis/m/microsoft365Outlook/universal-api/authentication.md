# Microsoft 365 Outlook Universal API Authentication

Every Microsoft 365 Outlook API request through MindCloud uses a MindCloud API key and the `connectionId` of a Microsoft 365 Outlook connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Microsoft 365 Outlook connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Microsoft 365 Outlook action](README.md#actions-17) with your API key and `connectionId`.
