# Mime Automation Universal API Authentication

Every Mime Automation API request through MindCloud uses a MindCloud API key and the `connectionId` of a Mime Automation connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Mime Automation connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Mime Automation action](README.md#actions-2) with your API key and `connectionId`.
