# Morningmate: Create Post

Creates a post in a Morningmate project.

```
POST https://connect.mindcloud.co/v1/universal/morningmate/latest/actions/create-post
```
