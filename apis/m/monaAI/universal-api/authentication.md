# Mona AI Universal API Authentication

Every Mona AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Mona AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Mona AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Mona AI action](README.md#actions-39) with your API key and `connectionId`.
