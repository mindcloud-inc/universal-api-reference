# Muna Universal API Authentication

Every Muna API request through MindCloud uses a MindCloud API key and the `connectionId` of a Muna connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Muna connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Muna action](README.md#actions-2) with your API key and `connectionId`.
