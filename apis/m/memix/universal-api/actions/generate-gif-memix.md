# Memix: Generate GIF Memix

Retrieves a generated GIF from Memix.

```
GET https://connect.mindcloud.co/v1/universal/memix/latest/actions/generate-gif-memix
```
...
Through the native Memix API, this operation is `GET /memix-:template_slug.gif` (base URL `https://api.memix.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/generate-gif-memix.md) for the provider-specific parameters and requirements.
