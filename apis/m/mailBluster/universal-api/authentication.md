# MailBluster Universal API Authentication

Every MailBluster API request through MindCloud uses a MindCloud API key and the `connectionId` of a MailBluster connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your MailBluster connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [MailBluster action](README.md#actions-15) with your API key and `connectionId`.
