# MyHR Universal API Authentication

Every MyHR API request through MindCloud uses a MindCloud API key and the `connectionId` of a MyHR connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your MyHR connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [MyHR action](README.md#actions-41) with your API key and `connectionId`.
