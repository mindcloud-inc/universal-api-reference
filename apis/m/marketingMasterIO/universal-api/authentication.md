# Marketing Master IO Universal API Authentication

Every Marketing Master IO API request through MindCloud uses a MindCloud API key and the `connectionId` of a Marketing Master IO connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Marketing Master IO connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Marketing Master IO action](README.md#actions-37) with your API key and `connectionId`.
