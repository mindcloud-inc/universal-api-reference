# Mailmodo Universal API Authentication

Every Mailmodo API request through MindCloud uses a MindCloud API key and the `connectionId` of a Mailmodo connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Mailmodo connection.
