# Meegle Universal API Authentication

Every Meegle API request through MindCloud uses a MindCloud API key and the `connectionId` of a Meegle connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Meegle connection.
