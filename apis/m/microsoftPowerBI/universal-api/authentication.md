# Microsoft Power BI Universal API Authentication

Every Microsoft Power BI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Microsoft Power BI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Microsoft Power BI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Microsoft Power BI action](README.md#actions-289) with your API key and `connectionId`.
