# Microsoft Power BI: Clone Tile



```
POST https://connect.mindcloud.co/v1/universal/microsoftPowerBI/latest/actions/dashboards-clone-tile
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/microsoftPowerBI/latest/actions/dashboards-clone-tile" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/microsoftPowerBI/latest/actions/dashboards-clone-tile', {
  method: 'POST',
  headers: {
...
Through the native Microsoft Power BI API, this operation is `POST dashboards/[:dashboardId]/tiles/[:tileId]/Clone` (base URL `https://api.powerbi.com/v1.0/myorg`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/dashboards-clone-tile.md) for the provider-specific parameters and requirements.
