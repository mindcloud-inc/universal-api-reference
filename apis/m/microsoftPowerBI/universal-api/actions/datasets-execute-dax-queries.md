# Microsoft Power BI: Execute Dax Queries



```
POST https://connect.mindcloud.co/v1/universal/microsoftPowerBI/latest/actions/datasets-execute-dax-queries
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/microsoftPowerBI/latest/actions/datasets-execute-dax-queries" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/microsoftPowerBI/latest/actions/datasets-execute-dax-queries', {
  method: 'POST',
  headers: {
...
Through the native Microsoft Power BI API, this operation is `POST datasets/[:datasetId]/executeDaxQueries` (base URL `https://api.powerbi.com/v1.0/myorg`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/datasets-execute-dax-queries.md) for the provider-specific parameters and requirements.
