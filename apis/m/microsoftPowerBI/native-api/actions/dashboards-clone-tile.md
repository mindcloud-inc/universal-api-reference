# Clone Tile with Microsoft Power BI

## Endpoint

- **Method:** `POST`
- **Path:** `dashboards/[:dashboardId]/tiles/[:tileId]/Clone`
- **Base URL:** `https://api.powerbi.com/v1.0/myorg`
- **Official documentation:** [Clone Tile](https://learn.microsoft.com/en-us/rest/api/power-bi/dashboards/clone-tile)
