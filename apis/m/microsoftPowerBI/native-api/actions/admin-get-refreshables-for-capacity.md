...
- **Method:** `GET`
- **Path:** `admin/capacities/[:capacityId]/refreshables`
- **Base URL:** `https://api.powerbi.com/v1.0/myorg`
- **Official documentation:** [Get Refreshables For Capacity](https://learn.microsoft.com/en-us/rest/api/power-bi/admin/get-refreshables-for-capacity)
