# Tiles GenerateTokenInGroup with Microsoft Power BI

## Endpoint

- **Method:** `POST`
- **Path:** `groups/[:groupId]/dashboards/[:dashboardId]/tiles/[:tileId]/GenerateToken`
- **Base URL:** `https://api.powerbi.com/v1.0/myorg`
- **Official documentation:** [Tiles GenerateTokenInGroup](https://learn.microsoft.com/en-us/rest/api/power-bi/embed-token/tiles-generate-token-in-group)
