...
- **Method:** `GET`
- **Path:** `capacities/[:capacityId]/refreshables/[:refreshableId]`
- **Base URL:** `https://api.powerbi.com/v1.0/myorg`
- **Official documentation:** [Get Refreshable For Capacity](https://learn.microsoft.com/en-us/rest/api/power-bi/capacities/get-refreshable-for-capacity)
