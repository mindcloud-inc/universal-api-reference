# Reports GenerateTokenForCreateInGroup with Microsoft Power BI
...
- **Official documentation:** [Reports GenerateTokenForCreateInGroup](https://learn.microsoft.com/en-us/rest/api/power-bi/embed-token/reports-generate-token-for-create-in-group)
