...
- **Method:** `GET`
- **Path:** `capacities/refreshables`
- **Base URL:** `https://api.powerbi.com/v1.0/myorg`
- **Official documentation:** [Get Refreshables](https://learn.microsoft.com/en-us/rest/api/power-bi/capacities/get-refreshables)
...
| `$expand` | query | `string` | no | Accepts a comma-separated list of data types, which will be expanded inline in the response. Supports capacity and group. |
