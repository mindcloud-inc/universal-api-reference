# Metronome Universal API Authentication

Every Metronome API request through MindCloud uses a MindCloud API key and the `connectionId` of a Metronome connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Metronome connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Metronome action](README.md#actions-24) with your API key and `connectionId`.
