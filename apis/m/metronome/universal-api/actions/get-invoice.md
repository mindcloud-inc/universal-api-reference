# Metronome: Get Invoice

Retrieves an invoice from Metronome.

```
GET https://connect.mindcloud.co/v1/universal/metronome/latest/actions/get-invoice
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/metronome/latest/actions/get-invoice?connectionId=$CONNECTION_ID&customerId=string&invoiceId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/metronome/latest/actions/get-invoice?${params}`, {
  headers: {
