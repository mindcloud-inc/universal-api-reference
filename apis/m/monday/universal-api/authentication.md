# Monday Universal API Authentication

Every Monday API request through MindCloud uses a MindCloud API key and the `connectionId` of a Monday connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Monday connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Monday action](README.md#actions-20) with your API key and `connectionId`.
