...
```
POST https://connect.mindcloud.co/v1/universal/monday/latest/actions/get-all-sub-items-of-of-an-item-by-items-column-value
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/monday/latest/actions/get-all-sub-items-of-of-an-item-by-items-column-value" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/monday/latest/actions/get-all-sub-items-of-of-an-item-by-items-column-value', {
  method: 'POST',
  headers: {
