...
```
POST https://connect.mindcloud.co/v1/universal/monday/latest/actions/update-multiple-column-values
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/monday/latest/actions/update-multiple-column-values" \
