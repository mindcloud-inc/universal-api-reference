...
- **Official documentation:** [Upsert Records](https://developer.mapsly.com/docs/api/reference/REST-API.v1.yaml/paths/~1record/post)
...
| `records[]` | body | `array<object>` | yes | Array of record objects to insert or update. |
