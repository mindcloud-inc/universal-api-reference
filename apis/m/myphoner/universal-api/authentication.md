# Myphoner Universal API Authentication

Every Myphoner API request through MindCloud uses a MindCloud API key and the `connectionId` of a Myphoner connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Myphoner connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Myphoner action](README.md#actions-19) with your API key and `connectionId`.
