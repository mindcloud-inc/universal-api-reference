# Markup AI Universal API Authentication

Every Markup AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Markup AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Markup AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Markup AI action](README.md#actions-26) with your API key and `connectionId`.
