# Microsoft SQL Universal API Authentication

Every Microsoft SQL API request through MindCloud uses a MindCloud API key and the `connectionId` of a Microsoft SQL connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Microsoft SQL connection.
