# MoreApp Universal API Authentication

Every MoreApp API request through MindCloud uses a MindCloud API key and the `connectionId` of a MoreApp connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your MoreApp connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [MoreApp action](README.md#actions-90) with your API key and `connectionId`.
