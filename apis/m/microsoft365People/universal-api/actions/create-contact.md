# Microsoft 365 People: Create Contact

Creates a new contact in Microsoft 365 People.

```
POST https://connect.mindcloud.co/v1/universal/microsoft365People/latest/actions/create-contact
```
