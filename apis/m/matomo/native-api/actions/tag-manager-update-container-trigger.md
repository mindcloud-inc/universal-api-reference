# TagManager update Container Trigger with Matomo
...
- **Official documentation:** [TagManager update Container Trigger](https://developer.matomo.org/api-reference/reporting-api)
...
| `idTrigger` | body | `string` | yes | Matomo API parameter. |
