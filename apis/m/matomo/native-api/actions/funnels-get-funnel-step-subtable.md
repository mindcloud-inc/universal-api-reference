# Funnels get Funnel Step Subtable with Matomo
...
- **Official documentation:** [Funnels get Funnel Step Subtable](https://developer.matomo.org/api-reference/reporting-api)
...
| `stepPosition` | body | `string` | yes | Matomo API parameter. |
