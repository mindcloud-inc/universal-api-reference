# SitesManager add Site with Matomo
...
- **Official documentation:** [SitesManager add Site](https://developer.matomo.org/api-reference/reporting-api)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `siteName` | body | `string` | yes | Matomo API parameter. |
