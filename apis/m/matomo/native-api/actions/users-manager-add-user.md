# UsersManager add User with Matomo
...
- **Official documentation:** [UsersManager add User](https://developer.matomo.org/api-reference/reporting-api)
...
| `password` | body | `string` | yes | Matomo API parameter. |
