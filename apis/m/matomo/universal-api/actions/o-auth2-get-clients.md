# Matomo: OAuth2 get Clients



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-get-clients
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-get-clients?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-get-clients?${params}`, {
  headers: {
