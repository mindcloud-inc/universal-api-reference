# Matomo: Actions get Outlink



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-outlink
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-outlink?connectionId=$CONNECTION_ID&outlinkUrl=https%3A%2F%2Fexample.com&idSite=1&period=day&date=yesterday" \
...
const params = new URLSearchParams({
  connectionId,
  "outlinkUrl": "https://example.com",
  "idSite": "1",
  "period": "day",
  "date": "yesterday"
});

const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-outlink?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `outlinkUrl` | string | yes | Matomo API parameter. |
