# Matomo: AbTesting finish Experiment



```
PUT https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-finish-experiment
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-finish-experiment" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-finish-experiment', {
  method: 'PUT',
  headers: {
