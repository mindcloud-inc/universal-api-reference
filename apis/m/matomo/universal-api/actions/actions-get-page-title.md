# Matomo: Actions get Page Title



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-page-title
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-page-title?connectionId=$CONNECTION_ID&pageName=Ava%20Chen&idSite=1&period=day&date=yesterday" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-page-title?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `pageName` | string | yes | Matomo API parameter. |
