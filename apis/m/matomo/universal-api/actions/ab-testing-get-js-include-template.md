# Matomo: AbTesting get Js Include Template



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-js-include-template
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-js-include-template?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-js-include-template?${params}`, {
  headers: {
