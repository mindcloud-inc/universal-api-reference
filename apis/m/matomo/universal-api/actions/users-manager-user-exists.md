# Matomo: UsersManager user Exists



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-user-exists
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-user-exists?connectionId=$CONNECTION_ID&userLogin=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-user-exists?${params}`, {
  headers: {
