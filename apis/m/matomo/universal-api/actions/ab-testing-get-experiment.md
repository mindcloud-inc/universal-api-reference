# Matomo: AbTesting get Experiment



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-experiment
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-experiment?connectionId=$CONNECTION_ID&idExperiment=string&idSite=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-experiment?${params}`, {
  headers: {
