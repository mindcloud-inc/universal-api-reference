# Matomo: AbTesting get Available Success Metrics



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-available-success-metrics
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-available-success-metrics?connectionId=$CONNECTION_ID&idSite=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-available-success-metrics?${params}`, {
  headers: {
