# Matomo: Actions get Page Url



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-page-url
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-page-url?connectionId=$CONNECTION_ID&pageUrl=https%3A%2F%2Fexample.com&idSite=1&period=day&date=yesterday" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-page-url?${params}`, {
  headers: {
