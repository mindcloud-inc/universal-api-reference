# Matomo: CustomReports get Custom Report



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-custom-report
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-custom-report?connectionId=$CONNECTION_ID&idSite=1&period=day&date=yesterday&idCustomReport=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-custom-report?${params}`, {
  headers: {
