# Matomo: OAuth2 set Client Active



```
PUT https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-set-client-active
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-set-client-active" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-set-client-active', {
  method: 'PUT',
  headers: {
