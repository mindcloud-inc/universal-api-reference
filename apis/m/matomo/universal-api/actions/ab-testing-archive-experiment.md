# Matomo: AbTesting archive Experiment



```
DELETE https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-archive-experiment
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-archive-experiment?connectionId=$CONNECTION_ID&idExperiment=string&idSite=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-archive-experiment?${params}`, {
  headers: {
