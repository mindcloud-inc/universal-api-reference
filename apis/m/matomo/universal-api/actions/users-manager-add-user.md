# Matomo: UsersManager add User



```
POST https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-add-user
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-add-user" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-add-user', {
  method: 'POST',
  headers: {
...
| `password` | string | yes | Matomo API parameter. |
