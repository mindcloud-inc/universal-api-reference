# Matomo: OAuth2 get Client



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-get-client
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-get-client?connectionId=$CONNECTION_ID&clientId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-get-client?${params}`, {
  headers: {
