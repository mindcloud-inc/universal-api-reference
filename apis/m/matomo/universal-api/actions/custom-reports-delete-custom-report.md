# Matomo: CustomReports delete Custom Report



```
DELETE https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-delete-custom-report
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-delete-custom-report?connectionId=$CONNECTION_ID&idSite=1&idCustomReport=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-delete-custom-report?${params}`, {
  headers: {
