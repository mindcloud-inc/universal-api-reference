# Matomo: OAuth2 delete Client



```
DELETE https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-delete-client
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-delete-client?connectionId=$CONNECTION_ID&clientId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-delete-client?${params}`, {
  headers: {
