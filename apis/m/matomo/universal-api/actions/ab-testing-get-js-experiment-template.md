# Matomo: AbTesting get Js Experiment Template



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-js-experiment-template
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-js-experiment-template?connectionId=$CONNECTION_ID&idExperiment=string&idSite=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-js-experiment-template?${params}`, {
  headers: {
