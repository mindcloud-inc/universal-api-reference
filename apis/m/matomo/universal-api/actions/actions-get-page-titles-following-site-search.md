# Matomo: Get Page Titles Following a Site Search



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-page-titles-following-site-search
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-page-titles-following-site-search?connectionId=$CONNECTION_ID&idSite=1&period=day&date=yesterday" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-page-titles-following-site-search?${params}`, {
  headers: {
