# Matomo: UsersManager set User Access



```
PUT https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-set-user-access
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-set-user-access" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-set-user-access', {
  method: 'PUT',
  headers: {
