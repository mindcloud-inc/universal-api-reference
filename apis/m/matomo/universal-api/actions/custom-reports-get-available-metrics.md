# Matomo: CustomReports get Available Metrics



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-available-metrics
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-available-metrics?connectionId=$CONNECTION_ID&idSite=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-available-metrics?${params}`, {
  headers: {
