# Matomo: OAuth2 get Scopes



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-get-scopes
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-get-scopes?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-get-scopes?${params}`, {
  headers: {
