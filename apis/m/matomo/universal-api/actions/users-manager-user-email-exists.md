# Matomo: UsersManager user Email Exists



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-user-email-exists
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-user-email-exists?connectionId=$CONNECTION_ID&userEmail=ava%40example.com" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-user-email-exists?${params}`, {
  headers: {
