# Matomo: AbTesting get Experiments With Reports



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-experiments-with-reports
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-experiments-with-reports?connectionId=$CONNECTION_ID&idSite=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-experiments-with-reports?${params}`, {
  headers: {
