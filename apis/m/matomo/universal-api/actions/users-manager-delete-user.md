# Matomo: UsersManager delete User



```
DELETE https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-delete-user
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-delete-user?connectionId=$CONNECTION_ID&userLogin=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-delete-user?${params}`, {
  headers: {
