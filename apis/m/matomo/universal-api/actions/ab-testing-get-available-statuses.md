# Matomo: AbTesting get Available Statuses



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-available-statuses
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-available-statuses?connectionId=$CONNECTION_ID&idSite=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-available-statuses?${params}`, {
  headers: {
