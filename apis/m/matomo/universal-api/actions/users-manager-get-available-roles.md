# Matomo: UsersManager get Available Roles



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-get-available-roles
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-get-available-roles?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-get-available-roles?${params}`, {
  headers: {
