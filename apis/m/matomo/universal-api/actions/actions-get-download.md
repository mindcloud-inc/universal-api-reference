# Matomo: Actions get Download



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-download
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-download?connectionId=$CONNECTION_ID&downloadUrl=https%3A%2F%2Fexample.com&idSite=1&period=day&date=yesterday" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/actions-get-download?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `downloadUrl` | string | yes | Matomo API parameter. |
