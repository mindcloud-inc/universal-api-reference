# Matomo: OAuth2 rotate Secret



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-rotate-secret
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-rotate-secret?connectionId=$CONNECTION_ID&clientId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-rotate-secret?${params}`, {
  headers: {
