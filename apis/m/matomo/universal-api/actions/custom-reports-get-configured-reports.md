# Matomo: CustomReports get Configured Reports



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-configured-reports
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-configured-reports?connectionId=$CONNECTION_ID&idSite=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-configured-reports?${params}`, {
  headers: {
...
| Key | Type | Required | Description |
| --- | --- | --- | --- |
| `skipCategoryMetadata` | string | no | Matomo API parameter. |
