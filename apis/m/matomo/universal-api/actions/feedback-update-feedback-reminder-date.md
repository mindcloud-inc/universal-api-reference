# Matomo: Feedback update Feedback Reminder Date



```
PUT https://connect.mindcloud.co/v1/universal/matomo/latest/actions/feedback-update-feedback-reminder-date
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/feedback-update-feedback-reminder-date" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/matomo/latest/actions/feedback-update-feedback-reminder-date', {
  method: 'PUT',
  headers: {
