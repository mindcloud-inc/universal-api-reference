# Matomo: UsersManager get User By Email



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-get-user-by-email
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-get-user-by-email?connectionId=$CONNECTION_ID&userEmail=ava%40example.com" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-get-user-by-email?${params}`, {
  headers: {
