# Matomo: AbTesting get All Experiments



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-all-experiments
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-all-experiments?connectionId=$CONNECTION_ID&idSite=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-all-experiments?${params}`, {
  headers: {
