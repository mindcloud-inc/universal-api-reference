# Matomo: AbTesting get Metrics Overview



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-metrics-overview
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-metrics-overview?connectionId=$CONNECTION_ID&idSite=1&period=day&date=yesterday&idExperiment=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-get-metrics-overview?${params}`, {
  headers: {
