# Matomo: CustomReports get Available Dimensions



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-available-dimensions
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-available-dimensions?connectionId=$CONNECTION_ID&idSite=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-available-dimensions?${params}`, {
  headers: {
