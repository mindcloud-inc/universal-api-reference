# Matomo: UsersManager get Users Access From Site



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-get-users-access-from-site
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-get-users-access-from-site?connectionId=$CONNECTION_ID&idSite=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-get-users-access-from-site?${params}`, {
  headers: {
