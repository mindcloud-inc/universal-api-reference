# Matomo: UsersManager resend Invite



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-resend-invite
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-resend-invite?connectionId=$CONNECTION_ID&userLogin=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/users-manager-resend-invite?${params}`, {
  headers: {
