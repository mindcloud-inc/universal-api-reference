# Matomo: Get Browser version



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/devices-detection-get-browser-versions
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/devices-detection-get-browser-versions?connectionId=$CONNECTION_ID&idSite=1&period=day&date=yesterday" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/devices-detection-get-browser-versions?${params}`, {
  headers: {
