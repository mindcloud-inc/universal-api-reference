# Matomo: CustomReports get Available Categories



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-available-categories
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-available-categories?connectionId=$CONNECTION_ID&idSite=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/custom-reports-get-available-categories?${params}`, {
  headers: {
