# Matomo: TagManager update Container Tag



```
PUT https://connect.mindcloud.co/v1/universal/matomo/latest/actions/tag-manager-update-container-tag
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/tag-manager-update-container-tag" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/matomo/latest/actions/tag-manager-update-container-tag', {
  method: 'PUT',
  headers: {
...
Through the native Matomo API, this operation is `POST /index.php` (base URL `https://mindcloud.matomo.cloud`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/tag-manager-update-container-tag.md) for the provider-specific parameters and requirements.
