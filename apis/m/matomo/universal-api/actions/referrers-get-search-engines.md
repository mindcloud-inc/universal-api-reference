# Matomo: Get Search Engines



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/referrers-get-search-engines
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/referrers-get-search-engines?connectionId=$CONNECTION_ID&idSite=1&period=day&date=yesterday" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/referrers-get-search-engines?${params}`, {
  headers: {
