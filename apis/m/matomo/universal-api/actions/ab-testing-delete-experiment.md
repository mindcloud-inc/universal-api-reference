# Matomo: AbTesting delete Experiment



```
DELETE https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-delete-experiment
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-delete-experiment?connectionId=$CONNECTION_ID&idExperiment=string&idSite=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/ab-testing-delete-experiment?${params}`, {
  headers: {
