# Matomo: Get Event Actions



```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/events-get-action
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/events-get-action?connectionId=$CONNECTION_ID&idSite=1&period=day&date=yesterday" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/events-get-action?${params}`, {
  headers: {
