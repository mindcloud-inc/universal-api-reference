...
```
GET https://connect.mindcloud.co/v1/universal/matomo/latest/actions/devices-detection-get-browsers
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/devices-detection-get-browsers?connectionId=$CONNECTION_ID&idSite=1&period=day&date=yesterday" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/matomo/latest/actions/devices-detection-get-browsers?${params}`, {
  headers: {
