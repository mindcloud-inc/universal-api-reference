# Matomo: OAuth2 create Client



```
POST https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-create-client
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-create-client" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/matomo/latest/actions/o-auth2-create-client', {
  method: 'POST',
  headers: {
