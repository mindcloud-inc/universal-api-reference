# Mailcoach: Create Template

Creates a new template in Mailcoach.

```
POST https://connect.mindcloud.co/v1/universal/mailcoach/latest/actions/create-template
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/mailcoach/latest/actions/create-template" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/mailcoach/latest/actions/create-template', {
  method: 'POST',
  headers: {
