# Middesk Universal API Authentication

Every Middesk API request through MindCloud uses a MindCloud API key and the `connectionId` of a Middesk connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Middesk connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Middesk action](README.md#actions-68) with your API key and `connectionId`.
