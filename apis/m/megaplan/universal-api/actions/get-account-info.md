# Megaplan: List Account Info



```
GET https://connect.mindcloud.co/v1/universal/megaplan/latest/actions/get-account-info
```
...
Through the native Megaplan API, this operation is `GET /accountInfo` (base URL `https://m60888876.megaplan.ru/api/v3`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-account-info.md) for the provider-specific parameters and requirements.
