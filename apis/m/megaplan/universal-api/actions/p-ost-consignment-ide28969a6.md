# Megaplan: Create Consignment



```
POST https://connect.mindcloud.co/v1/universal/megaplan/latest/actions/p-ost-consignment-ide28969a6
```
...
| `body` | object | yes | Required request body. RAML type: Consignment |
...
Through the native Megaplan API, this operation is `POST /consignment/:id` (base URL `https://m60888876.megaplan.ru/api/v3`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/p-ost-consignment-ide28969a6.md) for the provider-specific parameters and requirements.
