# Megaplan: List Consignment



```
GET https://connect.mindcloud.co/v1/universal/megaplan/latest/actions/g-et-consignment8475e2fc
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/megaplan/latest/actions/g-et-consignment8475e2fc?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/megaplan/latest/actions/g-et-consignment8475e2fc?${params}`, {
  headers: {
...
Through the native Megaplan API, this operation is `GET /consignment` (base URL `https://m60888876.megaplan.ru/api/v3`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/g-et-consignment8475e2fc.md) for the provider-specific parameters and requirements.
