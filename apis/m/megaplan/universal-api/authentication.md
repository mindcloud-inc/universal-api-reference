# Megaplan Universal API Authentication

Every Megaplan API request through MindCloud uses a MindCloud API key and the `connectionId` of a Megaplan connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Megaplan connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Megaplan action](README.md#actions-60) with your API key and `connectionId`.
