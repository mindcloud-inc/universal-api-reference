# List Contractor Company with Megaplan

## Endpoint

- **Method:** `GET`
- **Path:** `/contractorCompany`
- **Base URL:** `https://m60888876.megaplan.ru/api/v3`
- **Official documentation:** [List Contractor Company](https://m60888876.megaplan.ru/api/v3/docs#contractorCompany)
