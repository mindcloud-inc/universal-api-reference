...
- **Official documentation:** [List Employee](https://m60888876.megaplan.ru/api/v3/docs#employee)
...
| --- | --- | --- | --- | --- |
| `filter` | query | `string` | no | Идентификатор или конфиг фильтра |
