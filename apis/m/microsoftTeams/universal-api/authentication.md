# Microsoft Teams Universal API Authentication

Every Microsoft Teams API request through MindCloud uses a MindCloud API key and the `connectionId` of a Microsoft Teams connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Microsoft Teams connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Microsoft Teams action](README.md#actions-23) with your API key and `connectionId`.
