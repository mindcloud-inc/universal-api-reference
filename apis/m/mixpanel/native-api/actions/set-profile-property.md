# Set Profile Property with Mixpanel
...
- **Official documentation:** [Set Profile Property](https://developer.mixpanel.com/reference/profile-set)
...
| `$set` | body | `object` | yes | Object of profile properties to set. |
