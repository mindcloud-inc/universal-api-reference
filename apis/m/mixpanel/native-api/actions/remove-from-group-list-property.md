# Remove from Group List Property with Mixpanel
...
- **Official documentation:** [Remove from Group List Property](https://developer.mixpanel.com/reference/group-remove-from-list-property)
...
| `$remove` | body | `object` | yes | Object mapping group profile list properties to values to remove. |
