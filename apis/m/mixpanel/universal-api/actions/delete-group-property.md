# Mixpanel: Delete Group Property

Deletes a group property from Mixpanel.

```
PUT https://connect.mindcloud.co/v1/universal/mixpanel/latest/actions/delete-group-property
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/mixpanel/latest/actions/delete-group-property" \
  ...
  "groupKey": "company",
  "groupId": "acme",
  "propertyNames[]": "plan,regions"
}'
```

```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/mixpanel/latest/actions/delete-group-property', {
  method: 'PUT',
  headers: {
...
| `propertyNames[]` | array<string> | yes | List of group profile property names to delete. Example: `plan,regions`. |
...
Through the native Mixpanel API, this operation is `POST https://api.mixpanel.com/groups` (base URL `https://mixpanel.com/api`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/delete-group-property.md) for the provider-specific parameters and requirements.
