# Mixpanel: Increment Profile Numerical Property

Increments a user profile number property in Mixpanel.

```
PUT https://connect.mindcloud.co/v1/universal/mixpanel/latest/actions/increment-profile-numerical-property
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/mixpanel/latest/actions/increment-profile-numerical-property" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/mixpanel/latest/actions/increment-profile-numerical-property', {
  method: 'PUT',
  headers: {
...
| `add` | object | yes | Object mapping numeric profile properties to increment amounts. Example: `[object Object]`. |
