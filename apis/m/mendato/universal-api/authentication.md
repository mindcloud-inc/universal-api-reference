# Mendato Universal API Authentication

Every Mendato API request through MindCloud uses a MindCloud API key and the `connectionId` of a Mendato connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Mendato connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Mendato action](README.md#actions-24) with your API key and `connectionId`.
