# Mendato: Create Customer



```
POST https://connect.mindcloud.co/v1/universal/mendato/latest/actions/create-customer
```
...
| --- | --- | --- |
| `createCustomer.customer.addressSupplement` | string |  |
| `createCustomer.customer.companyName` | string |  |
| `createCustomer.customer.firstName` | string |  |
| `createCustomer.customer.id` | string |  |
| `createCustomer.customer.lastName` | string |  |
| `createCustomer.customer.number` | number |  |
| `createCustomer.customer.salutation` | string |  |
| `createCustomer.customer.type` | string |  |
