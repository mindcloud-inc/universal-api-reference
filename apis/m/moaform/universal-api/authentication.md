# Moaform Universal API Authentication

Every Moaform API request through MindCloud uses a MindCloud API key and the `connectionId` of a Moaform connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Moaform connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Moaform action](README.md#actions-9) with your API key and `connectionId`.
