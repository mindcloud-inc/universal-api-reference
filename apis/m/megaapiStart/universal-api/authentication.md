# Megaapi Start Universal API Authentication

Every Megaapi Start API request through MindCloud uses a MindCloud API key and the `connectionId` of a Megaapi Start connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Megaapi Start connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Megaapi Start action](README.md#actions-1) with your API key and `connectionId`.
