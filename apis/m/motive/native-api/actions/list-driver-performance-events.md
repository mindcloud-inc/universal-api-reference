...
| `event_types` | query | `string` | no | Filter events by Motive event type. |
| `start_date` | query | `string` | no | Fetch events from this date onward. |
| `end_date` | query | `string` | no | Fetch events up to this date. |
