# Motive Universal API Authentication

Every Motive API request through MindCloud uses a MindCloud API key and the `connectionId` of a Motive connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Motive connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Motive action](README.md#actions-7) with your API key and `connectionId`.
