# MoonClerk Universal API Authentication

Every MoonClerk API request through MindCloud uses a MindCloud API key and the `connectionId` of a MoonClerk connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your MoonClerk connection.
