# Create An Action with Moderation API
...
- **Official documentation:** [Create An Action](https://docs.moderationapi.com/api-reference/actions/create-an-action)
...
| `name` | body | `string` | yes | The name of the action. |
