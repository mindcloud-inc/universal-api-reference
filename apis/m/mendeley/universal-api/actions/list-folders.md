# Mendeley: List Folders



```
GET https://connect.mindcloud.co/v1/universal/mendeley/latest/actions/list-folders
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/mendeley/latest/actions/list-folders?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/mendeley/latest/actions/list-folders?${params}`, {
  headers: {
