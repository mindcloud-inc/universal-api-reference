# Mendeley: Trash Document



```
PUT https://connect.mindcloud.co/v1/universal/mendeley/latest/actions/trash-document
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/mendeley/latest/actions/trash-document" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/mendeley/latest/actions/trash-document', {
  method: 'PUT',
  headers: {
