# List User Transitive Memberships with Microsoft Entra

## Endpoint

- **Method:** `GET`
- **Path:** `/users/:userId/transitiveMemberOf`
- **Base URL:** `https://graph.microsoft.com/v1.0`
- **Official documentation:** [List User Transitive Memberships](https://learn.microsoft.com/en-us/graph/api/user-list-transitivememberof?view=graph-rest-1.0)
