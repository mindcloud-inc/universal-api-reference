# Mobile Text Alerts Universal API Authentication

Every Mobile Text Alerts API request through MindCloud uses a MindCloud API key and the `connectionId` of a Mobile Text Alerts connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Mobile Text Alerts connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Mobile Text Alerts action](README.md#actions-9) with your API key and `connectionId`.
