# ManyReach Universal API Authentication

Every ManyReach API request through MindCloud uses a MindCloud API key and the `connectionId` of a ManyReach connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ManyReach connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ManyReach action](README.md#actions-63) with your API key and `connectionId`.
