# ManyReach: Update Workspace

Updates an existing workspace in ManyReach.

```
PUT https://connect.mindcloud.co/v1/universal/manyReach/latest/actions/update-workspace
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/manyReach/latest/actions/update-workspace" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/manyReach/latest/actions/update-workspace', {
  method: 'PUT',
  headers: {
...
| `title` | string | no | Updated workspace title. |
