# ManyReach: List Mailing Lists

Retrieves mailing lists from ManyReach.

```
GET https://connect.mindcloud.co/v1/universal/manyReach/latest/actions/list-mailing-lists
```
