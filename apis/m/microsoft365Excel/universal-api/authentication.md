# Microsoft 365 Excel Universal API Authentication

Every Microsoft 365 Excel API request through MindCloud uses a MindCloud API key and the `connectionId` of a Microsoft 365 Excel connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Microsoft 365 Excel connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Microsoft 365 Excel action](README.md#actions-23) with your API key and `connectionId`.
