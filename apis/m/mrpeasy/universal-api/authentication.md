# MRPeasy Universal API Authentication

Every MRPeasy API request through MindCloud uses a MindCloud API key and the `connectionId` of a MRPeasy connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your MRPeasy connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [MRPeasy action](README.md#actions-38) with your API key and `connectionId`.
