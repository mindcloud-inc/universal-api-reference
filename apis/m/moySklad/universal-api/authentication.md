# MoySklad Universal API Authentication

Every MoySklad API request through MindCloud uses a MindCloud API key and the `connectionId` of a MoySklad connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your MoySklad connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [MoySklad action](README.md#actions-156) with your API key and `connectionId`.
