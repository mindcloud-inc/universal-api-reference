# ME-QR Universal API Authentication

Every ME-QR API request through MindCloud uses a MindCloud API key and the `connectionId` of a ME-QR connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ME-QR connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ME-QR action](README.md#actions-40) with your API key and `connectionId`.
