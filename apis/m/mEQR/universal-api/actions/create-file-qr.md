# ME-QR: Create File QR

Creates a file QR code in ME-QR.

```
POST https://connect.mindcloud.co/v1/universal/mEQR/latest/actions/create-file-qr
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/mEQR/latest/actions/create-file-qr" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/mEQR/latest/actions/create-file-qr', {
  method: 'POST',
  headers: {
