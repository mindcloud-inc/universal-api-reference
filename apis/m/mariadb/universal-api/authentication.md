# MariaDB Universal API Authentication

Every MariaDB API request through MindCloud uses a MindCloud API key and the `connectionId` of a MariaDB connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your MariaDB connection.
