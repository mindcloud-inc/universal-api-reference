# Minelead Universal API Authentication

Every Minelead API request through MindCloud uses a MindCloud API key and the `connectionId` of a Minelead connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Minelead connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Minelead action](README.md#actions-15) with your API key and `connectionId`.
