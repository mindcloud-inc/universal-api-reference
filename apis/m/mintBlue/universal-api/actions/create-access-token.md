# mintBlue: Create Access Token

Creates a new access token in mintBlue.

```
POST https://connect.mindcloud.co/v1/universal/mintBlue/latest/actions/create-access-token
```
...
| --- | --- | --- | --- |
| `params.name` | string | yes | Access token name. |

### Advanced

| Key | Type | Required | Description |
| --- | --- | --- | --- |
| `params.expires_at` | date | no | Optional expiration date. |
| `params.scopes[]` | array<string> | no | Optional scopes array. |
