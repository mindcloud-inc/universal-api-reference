# Mythic Text: Connection Check



```
GET https://connect.mindcloud.co/v1/universal/mythicText/latest/actions/connection-check
```
...
Through the native Mythic Text API, this operation is `POST /convert` (base URL `https://mythictext-api.vercel.app`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/connection-check.md) for the provider-specific parameters and requirements.
