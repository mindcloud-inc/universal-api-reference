# Maildroppa Universal API Authentication

Every Maildroppa API request through MindCloud uses a MindCloud API key and the `connectionId` of a Maildroppa connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Maildroppa connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Maildroppa action](README.md#actions-36) with your API key and `connectionId`.
