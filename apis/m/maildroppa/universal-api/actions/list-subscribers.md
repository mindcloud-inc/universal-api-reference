# Maildroppa: List Subscribers

Retrieves subscribers from Maildroppa with pagination.

```
GET https://connect.mindcloud.co/v1/universal/maildroppa/latest/actions/list-subscribers
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/maildroppa/latest/actions/list-subscribers?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/maildroppa/latest/actions/list-subscribers?${params}`, {
  headers: {
