# Maildroppa: Create Subscriber

Creates a new subscriber in Maildroppa without double opt-in.

```
POST https://connect.mindcloud.co/v1/universal/maildroppa/latest/actions/create-subscriber
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/maildroppa/latest/actions/create-subscriber" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/maildroppa/latest/actions/create-subscriber', {
  method: 'POST',
  headers: {
