# Maildroppa: Create Tag



```
POST https://connect.mindcloud.co/v1/universal/maildroppa/latest/actions/create-tag
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/maildroppa/latest/actions/create-tag" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/maildroppa/latest/actions/create-tag', {
  method: 'POST',
  headers: {
