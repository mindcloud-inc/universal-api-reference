# Modelry Universal API Authentication

Every Modelry API request through MindCloud uses a MindCloud API key and the `connectionId` of a Modelry connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Modelry connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Modelry action](README.md#actions-18) with your API key and `connectionId`.
