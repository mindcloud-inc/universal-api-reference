# mittwald Universal API Authentication

Every mittwald API request through MindCloud uses a MindCloud API key and the `connectionId` of a mittwald connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your mittwald connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [mittwald action](README.md#actions-102) with your API key and `connectionId`.
