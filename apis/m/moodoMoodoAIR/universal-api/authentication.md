# Moodo & Moodo AIR Universal API Authentication

Every Moodo & Moodo AIR API request through MindCloud uses a MindCloud API key and the `connectionId` of a Moodo & Moodo AIR connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Moodo & Moodo AIR connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Moodo & Moodo AIR action](README.md#actions-37) with your API key and `connectionId`.
