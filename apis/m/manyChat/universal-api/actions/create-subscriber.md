...
```
POST https://connect.mindcloud.co/v1/universal/manyChat/latest/actions/create-subscriber
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/manyChat/latest/actions/create-subscriber" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/manyChat/latest/actions/create-subscriber', {
  method: 'POST',
  headers: {
