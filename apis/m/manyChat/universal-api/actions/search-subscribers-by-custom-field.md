# ManyChat: Search Subscribers by Custom Field

Finds subscribers in ManyChat by custom field.

```
GET https://connect.mindcloud.co/v1/universal/manyChat/latest/actions/search-subscribers-by-custom-field
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/manyChat/latest/actions/search-subscribers-by-custom-field?connectionId=$CONNECTION_ID&field_id=1&field_value=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/manyChat/latest/actions/search-subscribers-by-custom-field?${params}`, {
  headers: {
