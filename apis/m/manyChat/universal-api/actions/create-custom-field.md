# ManyChat: Create Custom Field

Creates a new custom field in ManyChat.

```
POST https://connect.mindcloud.co/v1/universal/manyChat/latest/actions/create-custom-field
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/manyChat/latest/actions/create-custom-field" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/manyChat/latest/actions/create-custom-field', {
  method: 'POST',
  headers: {
