# Mapulus: Update Location

Updates an existing location in Mapulus.

```
PUT https://connect.mindcloud.co/v1/universal/mapulus/latest/actions/update-location
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/mapulus/latest/actions/update-location" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/mapulus/latest/actions/update-location', {
  method: 'PUT',
  headers: {
