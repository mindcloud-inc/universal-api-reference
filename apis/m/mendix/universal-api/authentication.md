# Mendix Universal API Authentication

Every Mendix API request through MindCloud uses a MindCloud API key and the `connectionId` of a Mendix connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Mendix connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Mendix action](README.md#actions-14) with your API key and `connectionId`.
