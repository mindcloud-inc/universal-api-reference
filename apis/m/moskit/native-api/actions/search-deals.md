...
- **Official documentation:** [Search Deals](https://moskit.stoplight.io/docs/api-v2/)
...
| `conditions[].field` | body | `string` | yes | Search field key returned by GET /deals/search. |
