...
- **Official documentation:** [Search Projects](https://moskit.stoplight.io/docs/api-v2/)
...
| `conditions[].field` | body | `string` | yes | Search field key returned by GET /projects/search. |
