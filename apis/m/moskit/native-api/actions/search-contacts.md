...
- **Official documentation:** [Search Contacts](https://moskit.stoplight.io/docs/api-v2/)
...
| `conditions[].field` | body | `string` | yes | Search field key returned by GET /contacts/search. |
