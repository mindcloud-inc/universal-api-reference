# Moskit Universal API Authentication

Every Moskit API request through MindCloud uses a MindCloud API key and the `connectionId` of a Moskit connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Moskit connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Moskit action](README.md#actions-26) with your API key and `connectionId`.
