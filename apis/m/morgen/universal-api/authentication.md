# Morgen Universal API Authentication

Every Morgen API request through MindCloud uses a MindCloud API key and the `connectionId` of a Morgen connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Morgen connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Morgen action](README.md#actions-14) with your API key and `connectionId`.
