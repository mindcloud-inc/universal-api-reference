# Mercado Pago Universal API Authentication

Every Mercado Pago API request through MindCloud uses a MindCloud API key and the `connectionId` of a Mercado Pago connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Mercado Pago connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Mercado Pago action](README.md#actions-23) with your API key and `connectionId`.
