# MailSlurp Email Plugin: Create Contact

Creates a new contact in MailSlurp.

```
POST https://connect.mindcloud.co/v1/universal/mailSlurpEmailPlugin/latest/actions/create-contact
```
