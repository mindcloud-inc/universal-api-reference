# Metaphorpsum Universal API Authentication

Every Metaphorpsum API request through MindCloud uses a MindCloud API key and the `connectionId` of a Metaphorpsum connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Metaphorpsum connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Metaphorpsum action](README.md#actions-2) with your API key and `connectionId`.
