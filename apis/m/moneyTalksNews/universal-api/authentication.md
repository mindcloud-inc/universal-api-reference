# Money Talks News Universal API Authentication

Every Money Talks News API request through MindCloud uses a MindCloud API key and the `connectionId` of a Money Talks News connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Money Talks News connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Money Talks News action](README.md#actions-7) with your API key and `connectionId`.
