...
See the full [Get Current User action reference](actions/get-current-user.md), or [try it interactively](https://mindcloud.co/docs/universal/rest/mindCloud/latest/actions/get-current-user).
...
See the full [Cancel Run action reference](actions/cancel-run.md), or [try it interactively](https://mindcloud.co/docs/universal/rest/mindCloud/latest/actions/cancel-run).
