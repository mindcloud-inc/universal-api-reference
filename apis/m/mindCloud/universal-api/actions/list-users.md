# MindCloud: List Users



```
GET https://connect.mindcloud.co/v1/universal/mindCloud/latest/actions/list-users
```
...
Through the native MindCloud API, this operation is `GET v1/users` (base URL `https://embedded.mindcloud.co/`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-users.md) for the provider-specific parameters and requirements.
