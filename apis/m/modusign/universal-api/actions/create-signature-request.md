# Modusign: Create Signature Request

Creates a new signature request in Modusign.

```
POST https://connect.mindcloud.co/v1/universal/modusign/latest/actions/create-signature-request
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/modusign/latest/actions/create-signature-request" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/modusign/latest/actions/create-signature-request', {
  method: 'POST',
  headers: {
