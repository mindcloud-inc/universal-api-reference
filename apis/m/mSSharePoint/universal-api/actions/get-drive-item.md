# MS SharePoint: Get Drive Item

Retrieves a SharePoint drive item.

```
GET https://connect.mindcloud.co/v1/universal/mSSharePoint/latest/actions/get-drive-item
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/mSSharePoint/latest/actions/get-drive-item?connectionId=$CONNECTION_ID&driveId=string&itemId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/mSSharePoint/latest/actions/get-drive-item?${params}`, {
  headers: {
