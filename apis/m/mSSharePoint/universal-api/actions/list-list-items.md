# MS SharePoint: List List Items

Retrieves items from a SharePoint list.

```
GET https://connect.mindcloud.co/v1/universal/mSSharePoint/latest/actions/list-list-items
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/mSSharePoint/latest/actions/list-list-items?connectionId=$CONNECTION_ID&limit=25&offset=0&siteId=string&listId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/mSSharePoint/latest/actions/list-list-items?${params}`, {
  headers: {
