# MoneyBird Universal API Authentication

Every MoneyBird API request through MindCloud uses a MindCloud API key and the `connectionId` of a MoneyBird connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your MoneyBird connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [MoneyBird action](README.md#actions-27) with your API key and `connectionId`.
