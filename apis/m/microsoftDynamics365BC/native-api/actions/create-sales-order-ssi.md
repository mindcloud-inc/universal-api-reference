# Create Sales Order SSI with Microsoft Dynamics 365 BC

## Endpoint

- **Method:** `POST`
- **Path:** `/v2.0/companies(:id)/salesHeadersSSI`
- **Base URL:** `https://api.businesscentral.dynamics.com/v2.0/{tenantId}/{environment}/api/ssi/aapi/`
- **API:** REST (Copy)
- **Official documentation:** [Create Sales Order SSI](https://anotepad.com/notes/ccfg4kec)
