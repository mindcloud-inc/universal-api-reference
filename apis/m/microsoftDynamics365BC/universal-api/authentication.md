# Microsoft Dynamics 365 BC Universal API Authentication

Every Microsoft Dynamics 365 BC API request through MindCloud uses a MindCloud API key and the `connectionId` of a Microsoft Dynamics 365 BC connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Microsoft Dynamics 365 BC connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Microsoft Dynamics 365 BC action](README.md#actions-50) with your API key and `connectionId`.
