...
```
DELETE https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/delete-event
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/delete-event?connectionId=$CONNECTION_ID&eventId=AQMkADAwATNi..." \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/delete-event?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `eventId` | string | yes | The ID of the Outlook event to delete. Example: `AQMkADAwATNi...`. |
