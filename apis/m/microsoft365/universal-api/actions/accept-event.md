# Microsoft 365: Accept Event

Accepts an event in Microsoft 365.

```
PUT https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/accept-event
```
...
| `comment` | string | no | Example: `Looking forward to it`. |
