# Microsoft 365: List Messages in Folder

Retrieves messages in a mail folder from Microsoft 365.

```
GET https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/list-messages-in-folder
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/list-messages-in-folder?connectionId=$CONNECTION_ID&mailFolderId=inbox" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/list-messages-in-folder?${params}`, {
  headers: {
