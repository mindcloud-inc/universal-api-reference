# Microsoft 365: Move Message

Moves a message to another folder in Microsoft 365.

```
PUT https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/move-message
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/move-message" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/move-message', {
  method: 'PUT',
  headers: {
