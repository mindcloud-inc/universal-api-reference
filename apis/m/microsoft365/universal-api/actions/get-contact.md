...
```
GET https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/get-contact
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/get-contact?connectionId=$CONNECTION_ID&contactId=AAMkAG..." \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/get-contact?${params}`, {
  headers: {
