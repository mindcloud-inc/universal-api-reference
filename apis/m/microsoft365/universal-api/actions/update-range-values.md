# Microsoft 365: Update Range Values

Updates worksheet range values in Microsoft 365.

```
PUT https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/update-range-values
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/update-range-values" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/update-range-values', {
  method: 'PUT',
  headers: {
