# Microsoft 365: Delete Contact

Deletes a contact from Microsoft 365.

```
DELETE https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/delete-contact
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/delete-contact?connectionId=$CONNECTION_ID&contactId=AAMkAG..." \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/delete-contact?${params}`, {
  headers: {
