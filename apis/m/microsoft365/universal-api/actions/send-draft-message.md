# Microsoft 365: Send Draft Message

Sends a draft message from Microsoft 365.

```
PUT https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/send-draft-message
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/send-draft-message" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/microsoft365/latest/actions/send-draft-message', {
  method: 'PUT',
  headers: {
