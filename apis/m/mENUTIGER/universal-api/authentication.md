# MENU TIGER Universal API Authentication

Every MENU TIGER API request through MindCloud uses a MindCloud API key and the `connectionId` of a MENU TIGER connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your MENU TIGER connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [MENU TIGER action](README.md#actions-3) with your API key and `connectionId`.
