# MySQL Universal API Authentication

Every MySQL API request through MindCloud uses a MindCloud API key and the `connectionId` of a MySQL connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your MySQL connection.
