# ModelsLab Universal API Authentication

Every ModelsLab API request through MindCloud uses a MindCloud API key and the `connectionId` of a ModelsLab connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ModelsLab connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ModelsLab action](README.md#actions-25) with your API key and `connectionId`.
