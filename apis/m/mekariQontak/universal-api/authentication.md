# Mekari Qontak Universal API Authentication

Every Mekari Qontak API request through MindCloud uses a MindCloud API key and the `connectionId` of a Mekari Qontak connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Mekari Qontak connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Mekari Qontak action](README.md#actions-86) with your API key and `connectionId`.
