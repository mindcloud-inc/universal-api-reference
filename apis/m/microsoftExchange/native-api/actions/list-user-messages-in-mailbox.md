# List User Messages in Mailbox with Microsoft Exchange
...
- **Method:** `GET`
- **Path:** `/v1.0/users/:userIdOrPrincipalName/messages`
- **Base URL:** `https://graph.microsoft.com`
- **Official documentation:** [List User Messages in Mailbox](https://learn.microsoft.com/en-us/graph/api/mailfolder-list-messages?view=graph-rest-1.0&tabs=http)
