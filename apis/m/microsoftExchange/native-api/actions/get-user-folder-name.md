# Get User Folder Name with Microsoft Exchange
...
- **Method:** `GET`
- **Path:** `https://graph.microsoft.com/v1.0/users/:userIdOrPrincipalName/mailFolders/:parentFolderId`
- **Base URL:** `https://graph.microsoft.com`
- **Official documentation:** [Get User Folder Name](https://learn.microsoft.com/en-us/graph/api/mailfolder-get?view=graph-rest-1.0&tabs=http)
...
| `parentFolderId` | path | `string` | yes | — |
