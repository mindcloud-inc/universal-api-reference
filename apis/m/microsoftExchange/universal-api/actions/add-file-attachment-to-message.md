# Microsoft Exchange: Add File Attachment to Message

Creates a file attachment on a message in Microsoft Exchange.

```
POST https://connect.mindcloud.co/v1/universal/microsoftExchange/latest/actions/add-file-attachment-to-message
```
