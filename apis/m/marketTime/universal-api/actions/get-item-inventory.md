# MarketTime: Get Item Inventory



```
GET https://connect.mindcloud.co/v1/universal/marketTime/latest/actions/get-item-inventory
```
...
Through the native MarketTime API, this operation is `GET /mtpublic/api/v1/:whoAmI/items/inventory/:itemID` (base URL `https://publicapi.markettime.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-item-inventory.md) for the provider-specific parameters and requirements.
