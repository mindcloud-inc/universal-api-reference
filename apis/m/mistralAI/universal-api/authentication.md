# Mistral AI Universal API Authentication

Every Mistral AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Mistral AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Mistral AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Mistral AI action](README.md#actions-22) with your API key and `connectionId`.
