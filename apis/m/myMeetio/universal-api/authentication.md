# MyMeet.io Universal API Authentication

Every MyMeet.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a MyMeet.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your MyMeet.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [MyMeet.io action](README.md#actions-1) with your API key and `connectionId`.
