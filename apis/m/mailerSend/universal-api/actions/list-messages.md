# MailerSend: List Messages



```
GET https://connect.mindcloud.co/v1/universal/mailerSend/latest/actions/list-messages
```
...
Through the native MailerSend API, this operation is `GET /messages` (base URL `https://api.mailersend.com/v1`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-messages.md) for the provider-specific parameters and requirements.
