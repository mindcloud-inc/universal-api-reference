# Makeswift: Delete Page

Deletes an existing page from Makeswift.

```
DELETE https://connect.mindcloud.co/v1/universal/makeswift/latest/actions/delete-page
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/makeswift/latest/actions/delete-page?connectionId=$CONNECTION_ID&pageIdOrPathname=Ava%20Chen&siteId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/makeswift/latest/actions/delete-page?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `pageIdOrPathname` | string | yes | Page ID or pathname to delete. |
