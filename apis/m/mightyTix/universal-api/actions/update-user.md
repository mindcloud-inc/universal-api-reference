# Mighty Tix: Update User

Updates an existing user in Mighty Tix.

```
PUT https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/update-user
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/update-user" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/update-user', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `variables.input` | object | yes | UpdateOneUserInput object from the Mighty Tix Admin GraphQL docs. |
