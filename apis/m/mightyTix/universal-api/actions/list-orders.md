# Mighty Tix: List Orders

Retrieves orders from Mighty Tix.

```
GET https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/list-orders
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/list-orders?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/list-orders?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `variables.filter` | object | no | Optional OrderFilter object from the Mighty Tix Admin GraphQL docs. |
| `variables.paging` | object | no | Optional CursorPaging object from the Mighty Tix Admin GraphQL docs. |
| `variables.sorting[]` | array<object> | no | Optional array of OrderSort objects from the Mighty Tix Admin GraphQL docs. |
