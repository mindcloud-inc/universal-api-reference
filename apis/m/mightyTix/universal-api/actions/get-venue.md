# Mighty Tix: Get Venue

Retrieves a venue from Mighty Tix.

```
GET https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/get-venue
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/get-venue?connectionId=$CONNECTION_ID&variables.id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/get-venue?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `variables.id` | string | yes | Venue ID from the Mighty Tix Admin GraphQL docs. |
