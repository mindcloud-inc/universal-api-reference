# Mighty Tix: List Sessions

Retrieves sessions from Mighty Tix.

```
GET https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/list-sessions
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/list-sessions?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/list-sessions?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `variables.filter` | object | no | Optional SessionFilter object from the Mighty Tix Admin GraphQL docs. |
| `variables.paging` | object | no | Optional CursorPaging object from the Mighty Tix Admin GraphQL docs. |
| `variables.sorting[]` | array<object> | no | Optional array of SessionSort objects from the Mighty Tix Admin GraphQL docs. |
