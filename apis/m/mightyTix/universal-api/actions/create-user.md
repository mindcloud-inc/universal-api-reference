# Mighty Tix: Create User

Creates a new user in Mighty Tix.

```
POST https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/create-user
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/create-user" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/create-user', {
  method: 'POST',
  headers: {
...
| --- | --- | --- | --- |
| `variables.input` | object | yes | CreateOneUserInput object from the Mighty Tix Admin GraphQL docs. |
