# Mighty Tix: List Users

Retrieves users from Mighty Tix.

```
GET https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/list-users
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/list-users?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/list-users?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `variables.filter` | object | no | Optional UserFilter object from the Mighty Tix Admin GraphQL docs. |
| `variables.paging` | object | no | Optional CursorPaging object from the Mighty Tix Admin GraphQL docs. |
| `variables.sorting[]` | array<object> | no | Optional array of UserSort objects from the Mighty Tix Admin GraphQL docs. |
