# Mighty Tix: Update Account

Updates account details in Mighty Tix.

```
PUT https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/update-account
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/update-account" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/mightyTix/latest/actions/update-account', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `variables.input` | object | yes | AccountInput object from the Mighty Tix Admin GraphQL docs. |
