# Mighty Tix Universal API Authentication

Every Mighty Tix API request through MindCloud uses a MindCloud API key and the `connectionId` of a Mighty Tix connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Mighty Tix connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Mighty Tix action](README.md#actions-41) with your API key and `connectionId`.
