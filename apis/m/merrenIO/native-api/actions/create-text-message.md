# Create Text Message with MerrenIO
...
- **Official documentation:** [Create Text Message](https://merren.io/api-integration/)
...
| `message` | body | `string` | yes | Text content for the message. |
