# More Good Reviews: Native API Reference

A consolidated summary of More Good Reviews's API configuration and 10 documented operations, with links to official documentation.
...
Response data is read from `data`. The total page count is read from `pagination.last_page`. The current page number is read from `pagination.current_page`.
...
| [List Messages](actions/list-messages.md) | `GET /beacon/messages` |  |
