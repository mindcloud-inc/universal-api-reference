# More Good Reviews: Update Location

Updates a location in More Good Reviews.

```
PUT https://connect.mindcloud.co/v1/universal/moreGoodReviews/latest/actions/update-location
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/moreGoodReviews/latest/actions/update-location" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/moreGoodReviews/latest/actions/update-location', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `id` | string | yes | The location identifier. |
