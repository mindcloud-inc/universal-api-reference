# More Good Reviews: Create Customer Charge

Creates a customer charge in More Good Reviews.

```
POST https://connect.mindcloud.co/v1/universal/moreGoodReviews/latest/actions/create-customer-charge
```
...
| `amount` | number | no | Amount of charge in lowest currency denomination. |
