# More Good Reviews: Create Location

Creates a location in More Good Reviews.

```
POST https://connect.mindcloud.co/v1/universal/moreGoodReviews/latest/actions/create-location
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/moreGoodReviews/latest/actions/create-location" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/moreGoodReviews/latest/actions/create-location', {
  method: 'POST',
  headers: {
