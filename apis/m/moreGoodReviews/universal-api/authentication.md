# More Good Reviews Universal API Authentication

Every More Good Reviews API request through MindCloud uses a MindCloud API key and the `connectionId` of a More Good Reviews connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your More Good Reviews connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [More Good Reviews action](README.md#actions-10) with your API key and `connectionId`.
