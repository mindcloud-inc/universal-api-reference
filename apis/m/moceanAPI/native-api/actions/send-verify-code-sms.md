# Send Verify Code SMS with Mocean API

## Endpoint

- **Method:** `POST`
- **Path:** `/rest/2/verify/req/sms?mocean-resp-format=json`
- **Base URL:** `https://rest.moceanapi.com`
- **Official documentation:** [Send Verify Code SMS](https://moceanapi.com/docs#send-code-over-sms)
