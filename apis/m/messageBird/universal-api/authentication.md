# MessageBird Universal API Authentication

Every MessageBird API request through MindCloud uses a MindCloud API key and the `connectionId` of a MessageBird connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your MessageBird connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [MessageBird action](README.md#actions-50) with your API key and `connectionId`.
