# Mem0 Universal API Authentication

Every Mem0 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Mem0 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Mem0 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Mem0 action](README.md#actions-33) with your API key and `connectionId`.
