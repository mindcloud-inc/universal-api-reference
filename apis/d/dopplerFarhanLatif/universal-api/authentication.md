# Doppler Farhan Latif Universal API Authentication

Every Doppler Farhan Latif API request through MindCloud uses a MindCloud API key and the `connectionId` of a Doppler Farhan Latif connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Doppler Farhan Latif connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Doppler Farhan Latif action](README.md#actions-13) with your API key and `connectionId`.
