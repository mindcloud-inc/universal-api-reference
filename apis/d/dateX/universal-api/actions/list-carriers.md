# DateX (Legacy): List Carriers



```
GET https://connect.mindcloud.co/v1/universal/dateX/latest/actions/list-carriers
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/dateX/latest/actions/list-carriers?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/dateX/latest/actions/list-carriers?${params}`, {
  headers: {
