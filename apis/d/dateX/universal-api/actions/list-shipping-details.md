# DateX (Legacy): List Shipping Details



```
GET https://connect.mindcloud.co/v1/universal/dateX/latest/actions/list-shipping-details
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/dateX/latest/actions/list-shipping-details?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/dateX/latest/actions/list-shipping-details?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `exclude.user_defined_fields` | boolean | no | Default: `True`. |
| `filters` | object | no |  |
| `filters.order_ids[]` | array<number> | no |  |
| `exclude` | object | no |  |
| `filters.order_lookups[]` | array<string> | no |  |
| `filters.shipment_ids[]` | array<number> | no |  |
| `filters.shipment_lookups[]` | array<string> | no |  |
