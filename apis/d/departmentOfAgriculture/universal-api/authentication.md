# Department of Agriculture Universal API Authentication

Every Department of Agriculture API request through MindCloud uses a MindCloud API key and the `connectionId` of a Department of Agriculture connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Department of Agriculture connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Department of Agriculture action](README.md#actions-20) with your API key and `connectionId`.
