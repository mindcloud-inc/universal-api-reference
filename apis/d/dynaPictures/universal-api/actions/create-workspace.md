# DynaPictures: Create Workspace

Creates a workspace in DynaPictures.

```
POST https://connect.mindcloud.co/v1/universal/dynaPictures/latest/actions/create-workspace
```
