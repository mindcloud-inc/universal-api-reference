# DynaPictures: Delete Asset

Deletes an asset from a DynaPictures workspace.

```
DELETE https://connect.mindcloud.co/v1/universal/dynaPictures/latest/actions/delete-asset
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/dynaPictures/latest/actions/delete-asset?connectionId=$CONNECTION_ID&id=string&workspaceId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/dynaPictures/latest/actions/delete-asset?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `id` | string | yes | ID of the asset to delete. |
