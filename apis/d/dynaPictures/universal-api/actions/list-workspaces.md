# DynaPictures: List Workspaces

Retrieves workspaces from DynaPictures.

```
GET https://connect.mindcloud.co/v1/universal/dynaPictures/latest/actions/list-workspaces
```
