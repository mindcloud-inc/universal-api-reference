# DataForms.io Universal API Authentication

Every DataForms.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a DataForms.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DataForms.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [DataForms.io action](README.md#actions-13) with your API key and `connectionId`.
