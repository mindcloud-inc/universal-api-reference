# DirectIQ Universal API Authentication

Every DirectIQ API request through MindCloud uses a MindCloud API key and the `connectionId` of a DirectIQ connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DirectIQ connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [DirectIQ action](README.md#actions-95) with your API key and `connectionId`.
