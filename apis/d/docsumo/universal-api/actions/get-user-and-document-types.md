# Docsumo: Get User And Document Types

Retrieves your Docsumo user details and active document types.

```
GET https://connect.mindcloud.co/v1/universal/docsumo/latest/actions/get-user-and-document-types
```
...
Through the native Docsumo API, this operation is `GET /api/v1/eevee/apikey/limit/` (base URL `https://app.docsumo.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-user-and-document-types.md) for the provider-specific parameters and requirements.
