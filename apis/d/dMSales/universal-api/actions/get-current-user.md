# DMSales: Get Current User

Retrieves the current user from DMSales.

```
GET https://connect.mindcloud.co/v1/universal/dMSales/latest/actions/get-current-user
```
