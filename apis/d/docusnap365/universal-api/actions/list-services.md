# Docusnap365: List Services



```
GET https://connect.mindcloud.co/v1/universal/docusnap365/latest/actions/list-services
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/docusnap365/latest/actions/list-services?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/docusnap365/latest/actions/list-services?${params}`, {
  headers: {
