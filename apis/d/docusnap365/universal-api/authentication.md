# Docusnap365 Universal API Authentication

Every Docusnap365 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Docusnap365 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Docusnap365 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Docusnap365 action](README.md#actions-20) with your API key and `connectionId`.
