# Documint Universal API Authentication

Every Documint API request through MindCloud uses a MindCloud API key and the `connectionId` of a Documint connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Documint connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Documint action](README.md#actions-5) with your API key and `connectionId`.
