# DealMachine: Create Lead Note



```
POST https://connect.mindcloud.co/v1/universal/dealMachine/latest/actions/create-lead-note
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/dealMachine/latest/actions/create-lead-note" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/dealMachine/latest/actions/create-lead-note', {
  method: 'POST',
  headers: {
...
| `note` | string | yes | The note text to create on the lead. |
