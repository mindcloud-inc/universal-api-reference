# DealMachine: List Leads



```
GET https://connect.mindcloud.co/v1/universal/dealMachine/latest/actions/list-leads
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/dealMachine/latest/actions/list-leads?${params}`, {
  headers: {
