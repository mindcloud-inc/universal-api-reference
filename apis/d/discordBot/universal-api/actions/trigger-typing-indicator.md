# Discord-Bot: Trigger Typing Indicator

Triggers a typing indicator in a Discord channel.

```
POST https://connect.mindcloud.co/v1/universal/discordBot/latest/actions/trigger-typing-indicator
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/discordBot/latest/actions/trigger-typing-indicator" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/discordBot/latest/actions/trigger-typing-indicator', {
  method: 'POST',
  headers: {
