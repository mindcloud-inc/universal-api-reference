# D7 Messaging Universal API Authentication

Every D7 Messaging API request through MindCloud uses a MindCloud API key and the `connectionId` of a D7 Messaging connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your D7 Messaging connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [D7 Messaging action](README.md#actions-26) with your API key and `connectionId`.
