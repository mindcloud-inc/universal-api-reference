# DigiCert Universal API Authentication

Every DigiCert API request through MindCloud uses a MindCloud API key and the `connectionId` of a DigiCert connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DigiCert connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [DigiCert action](README.md#actions-38) with your API key and `connectionId`.
