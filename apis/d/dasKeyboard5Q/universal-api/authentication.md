# Das Keyboard 5Q Universal API Authentication

Every Das Keyboard 5Q API request through MindCloud uses a MindCloud API key and the `connectionId` of a Das Keyboard 5Q connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Das Keyboard 5Q connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Das Keyboard 5Q action](README.md#actions-8) with your API key and `connectionId`.
