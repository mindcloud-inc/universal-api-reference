# Direct Mail Manager Universal API Authentication

Every Direct Mail Manager API request through MindCloud uses a MindCloud API key and the `connectionId` of a Direct Mail Manager connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Direct Mail Manager connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Direct Mail Manager action](README.md#actions-30) with your API key and `connectionId`.
