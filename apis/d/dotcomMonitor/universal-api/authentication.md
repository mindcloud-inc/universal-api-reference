# Dotcom Monitor Universal API Authentication

Every Dotcom Monitor API request through MindCloud uses a MindCloud API key and the `connectionId` of a Dotcom Monitor connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Dotcom Monitor connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Dotcom Monitor action](README.md#actions-20) with your API key and `connectionId`.
