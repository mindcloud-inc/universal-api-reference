# Datagma Universal API Authentication

Every Datagma API request through MindCloud uses a MindCloud API key and the `connectionId` of a Datagma connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Datagma connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Datagma action](README.md#actions-10) with your API key and `connectionId`.
