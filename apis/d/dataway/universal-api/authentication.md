# Dataway Universal API Authentication

Every Dataway API request through MindCloud uses a MindCloud API key and the `connectionId` of a Dataway connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Dataway connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Dataway action](README.md#actions-7) with your API key and `connectionId`.
