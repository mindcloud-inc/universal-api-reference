# Search Wikipedia Entities via HTTP POST with Dandelion
...
- **Official documentation:** [Search Wikipedia Entities via HTTP POST](https://dandelion.eu/docs/api/datagraph/wikisearch/)
