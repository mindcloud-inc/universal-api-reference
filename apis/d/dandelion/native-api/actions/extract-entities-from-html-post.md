# Extract Entities From HTML via HTTP POST with Dandelion
...
- **Official documentation:** [Extract Entities From HTML via HTTP POST](https://dandelion.eu/docs/api/datatxt/nex/v1/)
