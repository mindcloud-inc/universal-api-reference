# Autocomplete Wikipedia Entities via HTTP GET with Dandelion
...
- **Official documentation:** [Autocomplete Wikipedia Entities via HTTP GET](https://dandelion.eu/docs/api/datagraph/wikisearch/)
