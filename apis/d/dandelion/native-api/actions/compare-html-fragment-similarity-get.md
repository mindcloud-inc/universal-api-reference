# Compare HTML Fragment Similarity via HTTP GET with Dandelion
...
- **Official documentation:** [Compare HTML Fragment Similarity via HTTP GET](https://dandelion.eu/docs/api/datatxt/sim/v1/)
