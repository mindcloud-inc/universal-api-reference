# Extract Entities From Text via HTTP GET with Dandelion
...
- **Official documentation:** [Extract Entities From Text via HTTP GET](https://dandelion.eu/docs/api/datatxt/nex/v1/)
