# Compare HTML Similarity via HTTP POST with Dandelion
...
- **Official documentation:** [Compare HTML Similarity via HTTP POST](https://dandelion.eu/docs/api/datatxt/sim/v1/)
