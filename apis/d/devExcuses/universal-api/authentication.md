# Dev Excuses Universal API Authentication

Every Dev Excuses API request through MindCloud uses a MindCloud API key and the `connectionId` of a Dev Excuses connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Dev Excuses connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Dev Excuses action](README.md#actions-1) with your API key and `connectionId`.
