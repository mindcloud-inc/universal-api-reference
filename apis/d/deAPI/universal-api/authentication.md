# deAPI Universal API Authentication

Every deAPI API request through MindCloud uses a MindCloud API key and the `connectionId` of a deAPI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your deAPI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [deAPI action](README.md#actions-19) with your API key and `connectionId`.
