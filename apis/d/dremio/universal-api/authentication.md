# Dremio Universal API Authentication

Every Dremio API request through MindCloud uses a MindCloud API key and the `connectionId` of a Dremio connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Dremio connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Dremio action](README.md#actions-63) with your API key and `connectionId`.
