# DataForSEO Universal API Authentication

Every DataForSEO API request through MindCloud uses a MindCloud API key and the `connectionId` of a DataForSEO connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DataForSEO connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [DataForSEO action](README.md#actions-16) with your API key and `connectionId`.
