# DONNAJAMES Easy Universal API Authentication

Every DONNAJAMES Easy API request through MindCloud uses a MindCloud API key and the `connectionId` of a DONNAJAMES Easy connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DONNAJAMES Easy connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [DONNAJAMES Easy action](README.md#actions-29) with your API key and `connectionId`.
