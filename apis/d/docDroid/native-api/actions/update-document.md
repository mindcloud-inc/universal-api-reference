...
- **Official documentation:** [Update Document](https://www.docdroid.com/apidocs)
...
| --- | --- | --- | --- | --- |
| `id` | path | `string` | yes | The ID of the document. |
| `file` | body | `file` | no | Optional replacement file. |
