# Datamuse Universal API Authentication

Every Datamuse API request through MindCloud uses a MindCloud API key and the `connectionId` of a Datamuse connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Datamuse connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Datamuse action](README.md#actions-20) with your API key and `connectionId`.
