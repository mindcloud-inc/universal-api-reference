# DocMaker Universal API Authentication

Every DocMaker API request through MindCloud uses a MindCloud API key and the `connectionId` of a DocMaker connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DocMaker connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [DocMaker action](README.md#actions-35) with your API key and `connectionId`.
