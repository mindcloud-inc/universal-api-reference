# Update Workflow Task Status with Documentum
...
- **Official documentation:** [Update Workflow Task Status](https://opentext.github.io/d2sv-sdk/24.4.0/bundle/pdf/OpenText%20Documentum%20D2FS%20REST%20Services%20Development%20Guide.pdf)
...
| `properties` | body | `object` | yes | JSON task action payload, for example action, comment, next_task_id, user, or signoff fields. |
