# Did You Mean This Universal API Authentication

Every Did You Mean This API request through MindCloud uses a MindCloud API key and the `connectionId` of a Did You Mean This connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Did You Mean This connection.
