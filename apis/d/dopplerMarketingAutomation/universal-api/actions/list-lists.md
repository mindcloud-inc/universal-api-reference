# Doppler Marketing Automation: List Lists

Retrieves lists from Doppler Marketing Automation.

```
GET https://connect.mindcloud.co/v1/universal/dopplerMarketingAutomation/latest/actions/list-lists
```
