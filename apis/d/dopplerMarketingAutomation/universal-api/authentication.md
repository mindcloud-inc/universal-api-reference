# Doppler Marketing Automation Universal API Authentication

Every Doppler Marketing Automation API request through MindCloud uses a MindCloud API key and the `connectionId` of a Doppler Marketing Automation connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Doppler Marketing Automation connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Doppler Marketing Automation action](README.md#actions-18) with your API key and `connectionId`.
