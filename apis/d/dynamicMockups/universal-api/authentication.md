# Dynamic Mockups Universal API Authentication

Every Dynamic Mockups API request through MindCloud uses a MindCloud API key and the `connectionId` of a Dynamic Mockups connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Dynamic Mockups connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Dynamic Mockups action](README.md#actions-11) with your API key and `connectionId`.
