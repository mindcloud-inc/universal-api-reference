# DeepImage Universal API Authentication

Every DeepImage API request through MindCloud uses a MindCloud API key and the `connectionId` of a DeepImage connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DeepImage connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [DeepImage action](README.md#actions-40) with your API key and `connectionId`.
