# Analyze Document with DocuPanda - Document Understanding
...
| `pages` | body | `list<number>` | no | List of page numbers to be analyzed (zero indexed). If not provided, all pages will be analyzed. |
