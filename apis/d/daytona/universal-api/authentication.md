# Daytona Universal API Authentication

Every Daytona API request through MindCloud uses a MindCloud API key and the `connectionId` of a Daytona connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Daytona connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Daytona action](README.md#actions-33) with your API key and `connectionId`.
