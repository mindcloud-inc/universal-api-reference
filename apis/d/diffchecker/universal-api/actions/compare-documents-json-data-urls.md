# Diffchecker: Compare Documents (JSON, Data URLs)

Compares documents in Diffchecker and returns a JSON diff from data URLs.

```
GET https://connect.mindcloud.co/v1/universal/diffchecker/latest/actions/compare-documents-json-data-urls
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/diffchecker/latest/actions/compare-documents-json-data-urls?connectionId=$CONNECTION_ID&leftPdf=string&rightPdf=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/diffchecker/latest/actions/compare-documents-json-data-urls?${params}`, {
  headers: {
