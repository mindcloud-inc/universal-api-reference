# Compare Documents (JSON, Default Word, Uploads) with Diffchecker
...
- **Official documentation:** [Compare Documents (JSON, Default Word, Uploads)](https://www.diffchecker.com/docs/document/)
