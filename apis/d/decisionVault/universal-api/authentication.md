# DecisionVault Universal API Authentication

Every DecisionVault API request through MindCloud uses a MindCloud API key and the `connectionId` of a DecisionVault connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DecisionVault connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [DecisionVault action](README.md#actions-17) with your API key and `connectionId`.
