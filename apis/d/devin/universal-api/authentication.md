# Devin Universal API Authentication

Every Devin API request through MindCloud uses a MindCloud API key and the `connectionId` of a Devin connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Devin connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Devin action](README.md#actions-33) with your API key and `connectionId`.
