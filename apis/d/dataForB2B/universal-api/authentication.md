# DataForB2B Universal API Authentication

Every DataForB2B API request through MindCloud uses a MindCloud API key and the `connectionId` of a DataForB2B connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DataForB2B connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [DataForB2B action](README.md#actions-17) with your API key and `connectionId`.
