# Dubble: Create Collection

Creates a new collection in Dubble.

```
POST https://connect.mindcloud.co/v1/universal/dubble/latest/actions/create-collection
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/dubble/latest/actions/create-collection" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/dubble/latest/actions/create-collection', {
  method: 'POST',
  headers: {
...
| `visibility` | string | no | The visibility setting for the collection |
