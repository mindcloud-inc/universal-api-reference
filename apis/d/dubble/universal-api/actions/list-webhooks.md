# Dubble: List Webhooks

Retrieves a list of webhooks from Dubble.

```
GET https://connect.mindcloud.co/v1/universal/dubble/latest/actions/list-webhooks
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/dubble/latest/actions/list-webhooks?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/dubble/latest/actions/list-webhooks?${params}`, {
  headers: {
