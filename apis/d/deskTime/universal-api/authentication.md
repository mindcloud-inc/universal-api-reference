# DeskTime Universal API Authentication

Every DeskTime API request through MindCloud uses a MindCloud API key and the `connectionId` of a DeskTime connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DeskTime connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [DeskTime action](README.md#actions-11) with your API key and `connectionId`.
