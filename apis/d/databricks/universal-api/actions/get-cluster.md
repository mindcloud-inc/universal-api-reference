...
```
GET https://connect.mindcloud.co/v1/universal/databricks/latest/actions/get-cluster
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/databricks/latest/actions/get-cluster?connectionId=$CONNECTION_ID&clusterId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/databricks/latest/actions/get-cluster?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `clusterId` | string | yes | The cluster about which to retrieve information. |
