...
```
PUT https://connect.mindcloud.co/v1/universal/databricks/latest/actions/restart-cluster
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/databricks/latest/actions/restart-cluster" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/databricks/latest/actions/restart-cluster', {
  method: 'PUT',
  headers: {
