...
```
GET https://connect.mindcloud.co/v1/universal/databricks/latest/actions/get-user
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/databricks/latest/actions/get-user?connectionId=$CONNECTION_ID&userId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/databricks/latest/actions/get-user?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `userId` | string | yes | Unique ID for a user in the Databricks account. |
