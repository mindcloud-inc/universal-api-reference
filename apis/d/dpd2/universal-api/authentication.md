# Dpd2 Universal API Authentication

Every Dpd2 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Dpd2 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Dpd2 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Dpd2 action](README.md#actions-5) with your API key and `connectionId`.
