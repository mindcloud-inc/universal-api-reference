# DocumentPro: List Workflows

Retrieves workflows from DocumentPro.

```
GET https://connect.mindcloud.co/v1/universal/documentPro/latest/actions/list-workflows
```
