# Disable OCR Table Detection with DocumentPro
...
- **Official documentation:** [Disable OCR Table Detection](https://docs.documentpro.ai/docs/using-api/manage-workflows/update-workflow)
