# DigiSigner Universal API Authentication

Every DigiSigner API request through MindCloud uses a MindCloud API key and the `connectionId` of a DigiSigner connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DigiSigner connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [DigiSigner action](README.md#actions-7) with your API key and `connectionId`.
