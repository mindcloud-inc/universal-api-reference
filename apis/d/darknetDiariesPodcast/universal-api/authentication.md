# Darknet Diaries Podcast Universal API Authentication

Every Darknet Diaries Podcast API request through MindCloud uses a MindCloud API key and the `connectionId` of a Darknet Diaries Podcast connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Darknet Diaries Podcast connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Darknet Diaries Podcast action](README.md#actions-20) with your API key and `connectionId`.
