# DSCO Dropship EDI Universal API Authentication

Every DSCO Dropship EDI API request through MindCloud uses a MindCloud API key and the `connectionId` of a DSCO Dropship EDI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DSCO Dropship EDI connection.
