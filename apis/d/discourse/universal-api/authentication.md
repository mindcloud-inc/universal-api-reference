# Discourse Universal API Authentication

Every Discourse API request through MindCloud uses a MindCloud API key and the `connectionId` of a Discourse connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Discourse connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Discourse action](README.md#actions-78) with your API key and `connectionId`.
