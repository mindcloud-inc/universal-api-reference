# DocuWriter.ai Universal API Authentication

Every DocuWriter.ai API request through MindCloud uses a MindCloud API key and the `connectionId` of a DocuWriter.ai connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DocuWriter.ai connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [DocuWriter.ai action](README.md#actions-20) with your API key and `connectionId`.
