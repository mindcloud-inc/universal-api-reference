# DataBridge Universal API Authentication

Every DataBridge API request through MindCloud uses a MindCloud API key and the `connectionId` of a DataBridge connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DataBridge connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [DataBridge action](README.md#actions-71) with your API key and `connectionId`.
