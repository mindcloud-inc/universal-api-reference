# Didit Universal API Authentication

Every Didit API request through MindCloud uses a MindCloud API key and the `connectionId` of a Didit connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Didit connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Didit action](README.md#actions-44) with your API key and `connectionId`.
