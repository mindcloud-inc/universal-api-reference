# Dungeon Fighter Online Universal API Authentication

Every Dungeon Fighter Online API request through MindCloud uses a MindCloud API key and the `connectionId` of a Dungeon Fighter Online connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Dungeon Fighter Online connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Dungeon Fighter Online action](README.md#actions-20) with your API key and `connectionId`.
