# Get Aggregate Report Records with DMARC Report
...
- **Method:** `GET`
- **Path:** `/accounts/:accountId/domains/:domainId/agg_reports/records.json`
- **Base URL:** `https://api.dmarcreport.com/v2`
- **Official documentation:** [Get Aggregate Report Records](https://docs.dmarcreport.com/api/2.0.html)
