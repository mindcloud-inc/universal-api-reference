# Dashcam: Clone Replay

Clones a replay in Dashcam.

```
PUT https://connect.mindcloud.co/v1/universal/dashcam/latest/actions/clone-replay
```
...
Through the native Dashcam API, this operation is `PUT /api/v1/replay/:replayId/clone` (base URL `https://api.testdriver.ai`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/clone-replay.md) for the provider-specific parameters and requirements.
