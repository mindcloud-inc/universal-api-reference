# Dashcam Universal API Authentication

Every Dashcam API request through MindCloud uses a MindCloud API key and the `connectionId` of a Dashcam connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Dashcam connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Dashcam action](README.md#actions-47) with your API key and `connectionId`.
