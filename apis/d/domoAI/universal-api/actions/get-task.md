...
```
GET https://connect.mindcloud.co/v1/universal/domoAI/latest/actions/get-task
```
...
| --- | --- | --- | --- |
| `taskId` | string | yes | The DomoAI task ID to retrieve. |
