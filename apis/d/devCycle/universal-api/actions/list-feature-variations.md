# DevCycle: List Feature Variations

Retrieves feature variations from DevCycle.

```
GET https://connect.mindcloud.co/v1/universal/devCycle/latest/actions/list-feature-variations
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/devCycle/latest/actions/list-feature-variations?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/devCycle/latest/actions/list-feature-variations?${params}`, {
  headers: {
