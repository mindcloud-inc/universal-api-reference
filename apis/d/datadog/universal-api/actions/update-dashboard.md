# Datadog: Update Dashboard

Updates an existing dashboard in Datadog.

```
PUT https://connect.mindcloud.co/v1/universal/datadog/latest/actions/update-dashboard
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/datadog/latest/actions/update-dashboard" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/datadog/latest/actions/update-dashboard', {
  method: 'PUT',
  headers: {
