# DocuGenerate Universal API Authentication

Every DocuGenerate API request through MindCloud uses a MindCloud API key and the `connectionId` of a DocuGenerate connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your DocuGenerate connection.
