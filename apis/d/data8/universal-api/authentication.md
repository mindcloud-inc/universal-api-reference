# Data8 Universal API Authentication

Every Data8 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Data8 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Data8 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Data8 action](README.md#actions-24) with your API key and `connectionId`.
