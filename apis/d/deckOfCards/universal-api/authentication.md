# Deck of Cards Universal API Authentication

Every Deck of Cards API request through MindCloud uses a MindCloud API key and the `connectionId` of a Deck of Cards connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Deck of Cards connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Deck of Cards action](README.md#actions-12) with your API key and `connectionId`.
