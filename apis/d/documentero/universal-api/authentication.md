# Documentero Universal API Authentication

Every Documentero API request through MindCloud uses a MindCloud API key and the `connectionId` of a Documentero connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Documentero connection.
