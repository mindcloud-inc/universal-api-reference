# Disparo PRO Universal API Authentication

Every Disparo PRO API request through MindCloud uses a MindCloud API key and the `connectionId` of a Disparo PRO connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Disparo PRO connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Disparo PRO action](README.md#actions-7) with your API key and `connectionId`.
