# Digital Humani Universal API Authentication

Every Digital Humani API request through MindCloud uses a MindCloud API key and the `connectionId` of a Digital Humani connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Digital Humani connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Digital Humani action](README.md#actions-10) with your API key and `connectionId`.
