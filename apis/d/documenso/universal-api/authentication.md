# Documenso Universal API Authentication

Every Documenso API request through MindCloud uses a MindCloud API key and the `connectionId` of a Documenso connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Documenso connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Documenso action](README.md#actions-20) with your API key and `connectionId`.
