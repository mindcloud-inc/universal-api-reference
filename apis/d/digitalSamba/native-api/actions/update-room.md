# Update room with Digital Samba
...
- **Official documentation:** [Update room](https://developer.digitalsamba.com/rest-api/#rooms-PATCHapi-v1-rooms--room-)
...
| `raise_hand_enabled` | body | `boolean` | no | Allow participants to raise hand to take turns to speak without disrupting this session. |
