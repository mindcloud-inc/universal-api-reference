# D7 Networks Universal API Authentication

Every D7 Networks API request through MindCloud uses a MindCloud API key and the `connectionId` of a D7 Networks connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your D7 Networks connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [D7 Networks action](README.md#actions-12) with your API key and `connectionId`.
