# Drag'n Survey Universal API Authentication

Every Drag'n Survey API request through MindCloud uses a MindCloud API key and the `connectionId` of a Drag'n Survey connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Drag'n Survey connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Drag'n Survey action](README.md#actions-20) with your API key and `connectionId`.
