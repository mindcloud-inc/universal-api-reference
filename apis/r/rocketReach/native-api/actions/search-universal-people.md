# Search Universal People with RocketReach
...
- **Official documentation:** [Search Universal People](https://docs.rocketreach.co/reference/create_universal_person_search)
...
| `query` | body | `object` | no | RocketReach universal people search filter object. Supply the exact documented filter keys inside this object. |
