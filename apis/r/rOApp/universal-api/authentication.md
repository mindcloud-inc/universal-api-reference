# RO App Universal API Authentication

Every RO App API request through MindCloud uses a MindCloud API key and the `connectionId` of a RO App connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your RO App connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [RO App action](README.md#actions-40) with your API key and `connectionId`.
