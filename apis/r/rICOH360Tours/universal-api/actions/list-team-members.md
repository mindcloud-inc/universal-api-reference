# RICOH360 Tours: List Team Members



```
GET https://connect.mindcloud.co/v1/universal/rICOH360Tours/latest/actions/list-team-members
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/rICOH360Tours/latest/actions/list-team-members?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/rICOH360Tours/latest/actions/list-team-members?${params}`, {
  headers: {
