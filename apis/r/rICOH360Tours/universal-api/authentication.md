# RICOH360 Tours Universal API Authentication

Every RICOH360 Tours API request through MindCloud uses a MindCloud API key and the `connectionId` of a RICOH360 Tours connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your RICOH360 Tours connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [RICOH360 Tours action](README.md#actions-41) with your API key and `connectionId`.
