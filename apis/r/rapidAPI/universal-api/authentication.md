# RapidAPI Universal API Authentication

Every RapidAPI API request through MindCloud uses a MindCloud API key and the `connectionId` of a RapidAPI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your RapidAPI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [RapidAPI action](README.md#actions-10) with your API key and `connectionId`.
