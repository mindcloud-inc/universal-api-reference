# ReferralHero Universal API Authentication

Every ReferralHero API request through MindCloud uses a MindCloud API key and the `connectionId` of a ReferralHero connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ReferralHero connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ReferralHero action](README.md#actions-24) with your API key and `connectionId`.
