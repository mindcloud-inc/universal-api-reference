# Reepay Universal API Authentication

Every Reepay API request through MindCloud uses a MindCloud API key and the `connectionId` of a Reepay connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Reepay connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Reepay action](README.md#actions-32) with your API key and `connectionId`.
