# Reepay: Cancel Subscription

Cancels a subscription in Reepay.

```
PUT https://connect.mindcloud.co/v1/universal/reepay/latest/actions/cancel-subscription
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/reepay/latest/actions/cancel-subscription" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/reepay/latest/actions/cancel-subscription', {
  method: 'PUT',
  headers: {
