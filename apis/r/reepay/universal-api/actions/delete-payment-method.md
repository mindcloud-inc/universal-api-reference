# Reepay: Delete Payment Method

Deletes a payment method from Reepay.

```
DELETE https://connect.mindcloud.co/v1/universal/reepay/latest/actions/delete-payment-method
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/reepay/latest/actions/delete-payment-method?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/reepay/latest/actions/delete-payment-method?${params}`, {
  headers: {
