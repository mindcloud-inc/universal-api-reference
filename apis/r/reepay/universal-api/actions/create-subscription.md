# Reepay: Create Subscription

Creates a new subscription in Reepay.

```
POST https://connect.mindcloud.co/v1/universal/reepay/latest/actions/create-subscription
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/reepay/latest/actions/create-subscription" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/reepay/latest/actions/create-subscription', {
  method: 'POST',
  headers: {
...
| `create_customer` | object | no |  |
| `customer` | string | no |  |
| `end_date` | string | no |  |
| `generate_handle` | boolean | no |  |
| `grace_duration` | number | no |  |
| `handle` | string | no |  |
| `metadata` | object | no |  |
| `no_setup_fee` | boolean | no |  |
| `no_trial` | boolean | no |  |
| `notice_period_unit_type` | string | no |  |
| `notice_periods` | number | no |  |
| `plan` | string | yes |  |
| `plan_version` | number | no |  |
| `po_number` | string | no |  |
| `quantity` | number | no |  |
| `show_terms` | boolean | no |  |
| `signup_method` | string | yes |  |
| `source` | string | no |  |
| `start_date` | string | no |  |
| `test` | boolean | no |  |
| `trial_period` | string | no |  |
