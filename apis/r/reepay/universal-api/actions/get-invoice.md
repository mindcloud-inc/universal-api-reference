...
Retrieves an invoice from Reepay.

```
GET https://connect.mindcloud.co/v1/universal/reepay/latest/actions/get-invoice
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/reepay/latest/actions/get-invoice?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/reepay/latest/actions/get-invoice?${params}`, {
  headers: {
