# Reepay: Get Subscription

Retrieves a subscription from Reepay.

```
GET https://connect.mindcloud.co/v1/universal/reepay/latest/actions/get-subscription
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/reepay/latest/actions/get-subscription?connectionId=$CONNECTION_ID&handle=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/reepay/latest/actions/get-subscription?${params}`, {
  headers: {
