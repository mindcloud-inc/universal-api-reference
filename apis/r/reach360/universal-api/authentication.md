# Reach360 Universal API Authentication

Every Reach360 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Reach360 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Reach360 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Reach360 action](README.md#actions-40) with your API key and `connectionId`.
