# Release0 Universal API Authentication

Every Release0 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Release0 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Release0 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Release0 action](README.md#actions-25) with your API key and `connectionId`.
