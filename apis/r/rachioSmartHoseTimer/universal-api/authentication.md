# Rachio Smart Hose Timer Universal API Authentication

Every Rachio Smart Hose Timer API request through MindCloud uses a MindCloud API key and the `connectionId` of a Rachio Smart Hose Timer connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Rachio Smart Hose Timer connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Rachio Smart Hose Timer action](README.md#actions-28) with your API key and `connectionId`.
