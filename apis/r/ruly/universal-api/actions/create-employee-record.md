# Ruly: Create Employee Record



```
POST https://connect.mindcloud.co/v1/universal/ruly/latest/actions/create-employee-record
```
...
Through the native Ruly API, this operation is `POST data/employee/` (base URL `https://mindcloud.api.rulyapp.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/create-employee-record.md) for the provider-specific parameters and requirements.
