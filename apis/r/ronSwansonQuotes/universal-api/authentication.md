# Ron Swanson Quotes Universal API Authentication

Every Ron Swanson Quotes API request through MindCloud uses a MindCloud API key and the `connectionId` of a Ron Swanson Quotes connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Ron Swanson Quotes connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Ron Swanson Quotes action](README.md#actions-3) with your API key and `connectionId`.
