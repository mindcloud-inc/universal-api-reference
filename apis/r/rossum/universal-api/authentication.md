# Rossum Universal API Authentication

Every Rossum API request through MindCloud uses a MindCloud API key and the `connectionId` of a Rossum connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Rossum connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Rossum action](README.md#actions-66) with your API key and `connectionId`.
