# Razorpay: Accept Dispute

Accepts a dispute in Razorpay as lost.

```
PUT https://connect.mindcloud.co/v1/universal/razorpay/latest/actions/accept-dispute
```
...
Through the native Razorpay API, this operation is `POST /v1/disputes/:id/accept` (base URL `https://api.razorpay.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/accept-dispute.md) for the provider-specific parameters and requirements.
