# Get Bib Validation Settings with RunSignup

## Endpoint

- **Method:** `GET`
- **Path:** `/race/:race_id/get-bib-validation-settings`
- **Base URL:** `https://api.runsignup.com/rest`
- **Official documentation:** [Get Bib Validation Settings](https://runsignup.com/API/race/:race_id/get-bib-validation-settings/GET)
