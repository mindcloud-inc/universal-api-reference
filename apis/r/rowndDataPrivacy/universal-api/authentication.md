# Rownd Data Privacy Universal API Authentication

Every Rownd Data Privacy API request through MindCloud uses a MindCloud API key and the `connectionId` of a Rownd Data Privacy connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Rownd Data Privacy connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Rownd Data Privacy action](README.md#actions-32) with your API key and `connectionId`.
