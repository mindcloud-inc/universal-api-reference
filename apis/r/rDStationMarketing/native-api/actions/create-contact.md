# Create Contact with RD Station Marketing
...
- **Official documentation:** [Create Contact](https://developers.rdstation.com/reference/post_platform-contacts)
...
| `email` | body | `string` | yes | Email do contato. |
