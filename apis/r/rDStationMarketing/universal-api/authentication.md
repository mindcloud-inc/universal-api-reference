# RD Station Marketing Universal API Authentication

Every RD Station Marketing API request through MindCloud uses a MindCloud API key and the `connectionId` of a RD Station Marketing connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your RD Station Marketing connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [RD Station Marketing action](README.md#actions-24) with your API key and `connectionId`.
