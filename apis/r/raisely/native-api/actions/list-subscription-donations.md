# List Subscription Donations with Raisely
...
- **Method:** `GET`
- **Path:** `/subscriptions/:uuid/donations`
- **Base URL:** `https://api.raisely.com/v3`
- **Official documentation:** [List Subscription Donations](https://developers.raisely.com/reference/getsubscriptionsdonations)
