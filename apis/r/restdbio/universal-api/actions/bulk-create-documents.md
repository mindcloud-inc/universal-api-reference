# Restdb.io: Bulk Create Documents

Creates multiple documents in Restdb.io.

```
POST https://connect.mindcloud.co/v1/universal/restdbio/latest/actions/bulk-create-documents
```
...
| `documents` | string | yes | Array of JSON documents to insert. |
...
Through the native Restdb.io API, this operation is `POST /rest/:collection` (base URL `https://mindcloudstage0-7934.restdb.io`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/bulk-create-documents.md) for the provider-specific parameters and requirements.
