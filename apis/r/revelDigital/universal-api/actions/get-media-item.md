# Revel Digital: Get Media Item



```
GET https://connect.mindcloud.co/v1/universal/revelDigital/latest/actions/get-media-item
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/revelDigital/latest/actions/get-media-item?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/revelDigital/latest/actions/get-media-item?${params}`, {
  headers: {
