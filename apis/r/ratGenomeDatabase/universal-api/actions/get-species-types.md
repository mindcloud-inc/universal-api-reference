# Rat Genome Database: Get Species Types



```
GET https://connect.mindcloud.co/v1/universal/ratGenomeDatabase/latest/actions/get-species-types
```
...
Through the native Rat Genome Database API, this operation is `GET /lookup/speciesTypeKeys` (base URL `https://rest.rgd.mcw.edu/rgdws`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-species-types.md) for the provider-specific parameters and requirements.
