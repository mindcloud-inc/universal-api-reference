# Rat Genome Database Universal API Authentication

Every Rat Genome Database API request through MindCloud uses a MindCloud API key and the `connectionId` of a Rat Genome Database connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Rat Genome Database connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Rat Genome Database action](README.md#actions-30) with your API key and `connectionId`.
