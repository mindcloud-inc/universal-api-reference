# Rillion Prime Web Service: Insert Purchase Order

Insert a purchase order into the Prime purchase order queue.

```
POST https://connect.mindcloud.co/v1/universal/rillionPrimeWebService/latest/actions/insert-purchase-order
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/rillionPrimeWebService/latest/actions/insert-purchase-order" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/rillionPrimeWebService/latest/actions/insert-purchase-order', {
  method: 'POST',
  headers: {
