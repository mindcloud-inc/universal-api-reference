# Rillion Prime Web Service Universal API Authentication

Every Rillion Prime Web Service API request through MindCloud uses a MindCloud API key and the `connectionId` of a Rillion Prime Web Service connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Rillion Prime Web Service connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Rillion Prime Web Service action](README.md#actions-56) with your API key and `connectionId`.
