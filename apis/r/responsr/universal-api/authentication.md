# Responsr Universal API Authentication

Every Responsr API request through MindCloud uses a MindCloud API key and the `connectionId` of a Responsr connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Responsr connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Responsr action](README.md#actions-41) with your API key and `connectionId`.
