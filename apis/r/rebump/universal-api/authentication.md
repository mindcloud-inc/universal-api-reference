# Rebump Universal API Authentication

Every Rebump API request through MindCloud uses a MindCloud API key and the `connectionId` of a Rebump connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Rebump connection.
