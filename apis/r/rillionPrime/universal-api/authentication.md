# Rillion Prime Pay Universal API Authentication

Every Rillion Prime Pay API request through MindCloud uses a MindCloud API key and the `connectionId` of a Rillion Prime Pay connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Rillion Prime Pay connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Rillion Prime Pay action](README.md#actions-30) with your API key and `connectionId`.
