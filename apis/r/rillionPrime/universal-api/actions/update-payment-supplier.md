# Rillion Prime: Update Payment Supplier
...
Through the native Rillion Prime API, this operation is `PUT /payment/supplier` (base URL `{{credentials.baseUrl}}`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/update-payment-supplier.md) for the provider-specific parameters and requirements.
