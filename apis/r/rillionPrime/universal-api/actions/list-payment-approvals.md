# Rillion Prime: List Payment Approvals
...
Through the native Rillion Prime API, this operation is `GET /payment/approval` (base URL `{{credentials.baseUrl}}`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-payment-approvals.md) for the provider-specific parameters and requirements.
