# Rillion Prime: Update Payment Suppliers
...
Through the native Rillion Prime API, this operation is `PUT /payment/suppliers` (base URL `{{credentials.baseUrl}}`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/update-payment-suppliers.md) for the provider-specific parameters and requirements.
