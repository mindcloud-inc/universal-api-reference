# Rick and Morty Universal API Authentication

Every Rick and Morty API request through MindCloud uses a MindCloud API key and the `connectionId` of a Rick and Morty connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Rick and Morty connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Rick and Morty action](README.md#actions-6) with your API key and `connectionId`.
