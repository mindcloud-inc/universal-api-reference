# RemOnline Universal API Authentication

Every RemOnline API request through MindCloud uses a MindCloud API key and the `connectionId` of a RemOnline connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your RemOnline connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [RemOnline action](README.md#actions-16) with your API key and `connectionId`.
