# Resource Guru Universal API Authentication

Every Resource Guru API request through MindCloud uses a MindCloud API key and the `connectionId` of a Resource Guru connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Resource Guru connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Resource Guru action](README.md#actions-52) with your API key and `connectionId`.
