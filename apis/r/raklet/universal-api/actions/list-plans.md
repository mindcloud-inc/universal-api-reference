...
```
GET https://connect.mindcloud.co/v1/universal/raklet/latest/actions/list-plans
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/raklet/latest/actions/list-plans?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/raklet/latest/actions/list-plans?${params}`, {
  headers: {
