...
```
GET https://connect.mindcloud.co/v1/universal/raklet/latest/actions/get-plan
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/raklet/latest/actions/get-plan?connectionId=$CONNECTION_ID&id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/raklet/latest/actions/get-plan?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `id` | string | yes | Plan identifier in Raklet. |
