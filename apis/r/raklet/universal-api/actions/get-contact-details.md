# Raklet: Get Contact Details



```
GET https://connect.mindcloud.co/v1/universal/raklet/latest/actions/get-contact-details
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/raklet/latest/actions/get-contact-details?connectionId=$CONNECTION_ID&organisationMembershipId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/raklet/latest/actions/get-contact-details?${params}`, {
  headers: {
