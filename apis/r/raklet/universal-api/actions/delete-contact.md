# Raklet: Delete Contact



```
DELETE https://connect.mindcloud.co/v1/universal/raklet/latest/actions/delete-contact
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/raklet/latest/actions/delete-contact?connectionId=$CONNECTION_ID&organisationMembershipId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/raklet/latest/actions/delete-contact?${params}`, {
  headers: {
