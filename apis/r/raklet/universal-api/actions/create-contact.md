# Raklet: Create Contact



```
POST https://connect.mindcloud.co/v1/universal/raklet/latest/actions/create-contact
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/raklet/latest/actions/create-contact" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/raklet/latest/actions/create-contact', {
  method: 'POST',
  headers: {
...
| `language` | string | yes | Contact language code. |
