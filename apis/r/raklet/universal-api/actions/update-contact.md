# Raklet: Update Contact



```
PUT https://connect.mindcloud.co/v1/universal/raklet/latest/actions/update-contact
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/raklet/latest/actions/update-contact" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/raklet/latest/actions/update-contact', {
  method: 'PUT',
  headers: {
