# ReadyCloud Suite: Update Product

Updates an existing product in ReadyCloud Suite.

```
PUT https://connect.mindcloud.co/v1/universal/readyCloudSuite/latest/actions/update-product
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/readyCloudSuite/latest/actions/update-product" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/readyCloudSuite/latest/actions/update-product', {
  method: 'PUT',
  headers: {
