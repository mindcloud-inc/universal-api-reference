# ReadyCloud Suite: List Items

Retrieves items from ReadyCloud Suite.

```
GET https://connect.mindcloud.co/v1/universal/readyCloudSuite/latest/actions/list-items
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/readyCloudSuite/latest/actions/list-items?connectionId=$CONNECTION_ID&boxPk=string&orderPk=string&orgPk=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/readyCloudSuite/latest/actions/list-items?${params}`, {
  headers: {
