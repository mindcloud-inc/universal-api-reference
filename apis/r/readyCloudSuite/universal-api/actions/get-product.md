# ReadyCloud Suite: Get Product

Retrieves a product from ReadyCloud Suite.

```
GET https://connect.mindcloud.co/v1/universal/readyCloudSuite/latest/actions/get-product
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/readyCloudSuite/latest/actions/get-product?connectionId=$CONNECTION_ID&orgPk=string&productPk=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/readyCloudSuite/latest/actions/get-product?${params}`, {
  headers: {
...
| `productPk` | string | yes | ReadyCloud product identifier. |
