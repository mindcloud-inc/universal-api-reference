# ReadyCloud Suite: Get Box

Retrieves a box from ReadyCloud Suite.

```
GET https://connect.mindcloud.co/v1/universal/readyCloudSuite/latest/actions/get-box
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/readyCloudSuite/latest/actions/get-box?connectionId=$CONNECTION_ID&boxPk=string&orderPk=string&orgPk=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/readyCloudSuite/latest/actions/get-box?${params}`, {
  headers: {
