# List Tracking with ReadyCloud Suite
...
- **Method:** `GET`
- **Path:** `/api/v2/orgs/:orgPk/orders/:orderPk/boxes/:boxPk/tracking/`
- **Base URL:** `https://www.readycloud.com`
- **Official documentation:** [List Tracking](https://www.readycloud.com/static/api-doc/v2/02-apireference-v2-04-tracking.html)
