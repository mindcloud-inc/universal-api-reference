# Get Number Analytics with Ringg AI
...
- **Method:** `GET`
- **Path:** `/analytics/number-analytics`
- **Base URL:** `https://prod-api.ringg.ai/ca/api/v0`
- **Official documentation:** [Get Number Analytics](https://docs.ringg.ai/api-reference/endpoint/analytics/get-number-analytics)
