# Recurly: Pause Subscription



```
PUT https://connect.mindcloud.co/v1/universal/recurly/latest/actions/pause-subscription
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/recurly/latest/actions/pause-subscription" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/recurly/latest/actions/pause-subscription', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `remainingPauseCycles` | number | yes |  |
