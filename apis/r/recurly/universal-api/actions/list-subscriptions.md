...
```
GET https://connect.mindcloud.co/v1/universal/recurly/latest/actions/list-subscriptions
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/recurly/latest/actions/list-subscriptions?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/recurly/latest/actions/list-subscriptions?${params}`, {
  headers: {
