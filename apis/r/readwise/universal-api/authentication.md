# Readwise Universal API Authentication

Every Readwise API request through MindCloud uses a MindCloud API key and the `connectionId` of a Readwise connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Readwise connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Readwise action](README.md#actions-43) with your API key and `connectionId`.
