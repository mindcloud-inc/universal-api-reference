# REST Countries Universal API Authentication

Every REST Countries API request through MindCloud uses a MindCloud API key and the `connectionId` of a REST Countries connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your REST Countries connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [REST Countries action](README.md#actions-30) with your API key and `connectionId`.
