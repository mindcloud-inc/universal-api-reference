# Reverse Contact: Fetch Person Posts



```
GET https://connect.mindcloud.co/v1/universal/reverseContact/latest/actions/fetch-person-posts
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/reverseContact/latest/actions/fetch-person-posts?connectionId=$CONNECTION_ID&url=https%3A%2F%2Fexample.com" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/reverseContact/latest/actions/fetch-person-posts?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `url` | string | yes | Public Social profile URL whose posts should be fetched. |
