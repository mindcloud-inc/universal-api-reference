# Reverse Contact: Fetch Person Profile



```
GET https://connect.mindcloud.co/v1/universal/reverseContact/latest/actions/fetch-person-profile
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/reverseContact/latest/actions/fetch-person-profile?connectionId=$CONNECTION_ID&url=https%3A%2F%2Fexample.com" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/reverseContact/latest/actions/fetch-person-profile?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `url` | string | yes | Public Social profile URL to fetch. |
