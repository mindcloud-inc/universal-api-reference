# remberg Universal API Authentication

Every remberg API request through MindCloud uses a MindCloud API key and the `connectionId` of a remberg connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your remberg connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [remberg action](README.md#actions-45) with your API key and `connectionId`.
