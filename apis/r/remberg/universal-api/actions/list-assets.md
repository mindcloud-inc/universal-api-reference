...
```
GET https://connect.mindcloud.co/v1/universal/remberg/latest/actions/list-assets
```
...
Through the native remberg API, this operation is `GET /v2/assets` (base URL `https://api.remberg.de`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-assets.md) for the provider-specific parameters and requirements.
