# Recruitee ATS Universal API Authentication

Every Recruitee ATS API request through MindCloud uses a MindCloud API key and the `connectionId` of a Recruitee ATS connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Recruitee ATS connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Recruitee ATS action](README.md#actions-16) with your API key and `connectionId`.
