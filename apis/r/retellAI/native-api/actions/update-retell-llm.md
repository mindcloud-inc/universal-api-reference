# Update Retell LLM with Retell AI
...
- **Official documentation:** [Update Retell LLM](https://docs.retellai.com/api-references/update-retell-llm)
...
| `version` | query | `number` | no | The version of the LLM. |
| `mcps[]` | body | `array<object>` | no | A list of MCPs to use for this LLM. |
| `mcps[]` | body | `array<object>` | no | A list of MCPs to use for this LLM. |
