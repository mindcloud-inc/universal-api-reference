# Create Chat Agent with Retell AI
...
- **Official documentation:** [Create Chat Agent](https://docs.retellai.com/api-references/create-chat-agent)
...
| `response_engine` | body | `object` | yes | — |
