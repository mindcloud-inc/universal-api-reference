# Retell AI: Create Voice Agent

Creates a voice agent in Retell AI.

```
POST https://connect.mindcloud.co/v1/universal/retellAI/latest/actions/create-voice-agent
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/retellAI/latest/actions/create-voice-agent" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/retellAI/latest/actions/create-voice-agent', {
  method: 'POST',
  headers: {
...
| `voiceId` | string | yes | Unique voice id used for the agent. Find list of available voices and their preview in Dashboard. |
