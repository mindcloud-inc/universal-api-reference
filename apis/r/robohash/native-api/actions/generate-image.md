...
| `set` | query | `list` | no | Optional image set. Official public docs list set1 through set5 and any; the README also documents set6 in the robosets table. Accepted values: `any`, `set1`, `set2`, `set3`, `set4`, `set5`. |
