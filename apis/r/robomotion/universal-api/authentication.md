# Robomotion Universal API Authentication

Every Robomotion API request through MindCloud uses a MindCloud API key and the `connectionId` of a Robomotion connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Robomotion connection.
