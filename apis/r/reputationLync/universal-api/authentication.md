# ReputationLync Universal API Authentication

Every ReputationLync API request through MindCloud uses a MindCloud API key and the `connectionId` of a ReputationLync connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ReputationLync connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ReputationLync action](README.md#actions-3) with your API key and `connectionId`.
