# Rollbar: Assign Team To Project

Assigns a team to a project in Rollbar.

```
PUT https://connect.mindcloud.co/v1/universal/rollbar/latest/actions/assign-team-to-project
```
...
Through the native Rollbar API, this operation is `PUT /project/:projectId/team/:teamId` (base URL `https://api.rollbar.com/api/1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/assign-team-to-project.md) for the provider-specific parameters and requirements.
