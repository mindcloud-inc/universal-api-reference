...
- **Official documentation:** [Update Task](https://developer.rocketlane.com/reference/update-task)
...
| `taskName` | body | `string` | no | The **name** of the task. |
