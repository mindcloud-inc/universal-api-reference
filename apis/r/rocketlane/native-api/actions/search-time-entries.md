# Search Time Entries with Rocketlane
...
- **Official documentation:** [Search Time Entries](https://developer.rocketlane.com/reference/search-time-entries)
...
| --- | --- | --- | --- | --- |
| `includeFields` | query | `string` | no | This query parameter allows you to specify which fields should be returned in the response body by selecting from the drop down. To get the relevant fields, use comma separated values. If the field is left blank, the default properties are returned. |
