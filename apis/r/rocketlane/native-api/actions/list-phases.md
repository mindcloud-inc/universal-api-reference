...
- **Official documentation:** [List Phases](https://developer.rocketlane.com/reference/get-all-phases)
...
| --- | --- | --- | --- | --- |
| `projectId` | query | `number` | yes | The `identifier` of the project is generated by the system and can be used to identify the project globally. |
