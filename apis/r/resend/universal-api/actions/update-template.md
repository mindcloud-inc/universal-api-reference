...
```
PUT https://connect.mindcloud.co/v1/universal/resend/latest/actions/update-template
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/resend/latest/actions/update-template" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/resend/latest/actions/update-template', {
  method: 'PUT',
  headers: {
...
| `html` | string | no | Updated HTML content for the template. |
