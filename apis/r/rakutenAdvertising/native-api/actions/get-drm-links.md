# Get DRM links with Rakuten Advertising
...
- **Method:** `GET`
- **Path:** `/linklocator/1.0/getDRMLinks/{advertiserId}/{categoryId}/{linkStartDate}/{linkEndDate}/{campaignId}/{page}`
- **Base URL:** `https://api.linksynergy.com`
- **Official documentation:** [Get DRM links](https://developers.rakutenadvertising.com/documentation/en-US/affiliate_apis/link_locator)
