# Rakuten Advertising Universal API Authentication

Every Rakuten Advertising API request through MindCloud uses a MindCloud API key and the `connectionId` of a Rakuten Advertising connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Rakuten Advertising connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Rakuten Advertising action](README.md#actions-35) with your API key and `connectionId`.
