# RightSignature Universal API Authentication

Every RightSignature API request through MindCloud uses a MindCloud API key and the `connectionId` of a RightSignature connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your RightSignature connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [RightSignature action](README.md#actions-26) with your API key and `connectionId`.
