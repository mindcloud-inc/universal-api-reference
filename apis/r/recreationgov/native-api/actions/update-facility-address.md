# Update Facility Address with Recreation.gov
...
- **Method:** `PUT`
- **Path:** `/facilities/{id}/facilityaddresses/{addressId}`
- **Base URL:** `https://ridb.recreation.gov/api/v1`
- **Official documentation:** [Update Facility Address](https://ridb.recreation.gov/shared/swagger/dataSteward.yaml)
