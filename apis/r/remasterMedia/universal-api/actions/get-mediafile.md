# RemasterMedia: Get Mediafile

Retrieves mediafile details from RemasterMedia.

```
GET https://connect.mindcloud.co/v1/universal/remasterMedia/latest/actions/get-mediafile
```
...
Through the native RemasterMedia API, this operation is `GET /mediafiles/{{id}}` (base URL `https://api-sandbox.remastermedia.com/v2`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-mediafile.md) for the provider-specific parameters and requirements.
