# Rye Universal API Authentication

Every Rye API request through MindCloud uses a MindCloud API key and the `connectionId` of a Rye connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Rye connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Rye action](README.md#actions-18) with your API key and `connectionId`.
