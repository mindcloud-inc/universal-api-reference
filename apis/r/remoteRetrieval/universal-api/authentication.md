# Remote Retrieval Universal API Authentication

Every Remote Retrieval API request through MindCloud uses a MindCloud API key and the `connectionId` of a Remote Retrieval connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Remote Retrieval connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Remote Retrieval action](README.md#actions-3) with your API key and `connectionId`.
