# Robots for Power BI: Enable playlist

Enables a playlist in Robots for Power BI.

```
PUT https://connect.mindcloud.co/v1/universal/robotsForPowerBI/latest/actions/enable-playlist
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/robotsForPowerBI/latest/actions/enable-playlist" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/robotsForPowerBI/latest/actions/enable-playlist', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `id` | string | yes | PowerBI Robots playlist UUID to enable. Example: `00000000-0000-0000-0000-000000000000`. |
