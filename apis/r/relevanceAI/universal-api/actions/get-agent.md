# Relevance AI: Get Agent



```
GET https://connect.mindcloud.co/v1/universal/relevanceAI/latest/actions/get-agent
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/relevanceAI/latest/actions/get-agent?connectionId=$CONNECTION_ID&agentId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/relevanceAI/latest/actions/get-agent?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `agentId` | string | yes | The Relevance AI agent id to retrieve. |
