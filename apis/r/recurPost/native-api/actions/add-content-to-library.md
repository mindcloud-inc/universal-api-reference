# Add Content to Library with RecurPost
...
- **Method:** `POST`
- **Path:** `/api/add_content_in_library`
- **Base URL:** `https://social.recurpost.com`
- **Official documentation:** [Add Content to Library](https://developers.recurpost.com/)
...
| `content_expiredate` | body | `string` | no | — |
| `content_livedate` | body | `string` | no | — |
...
| `id` | body | `string` | yes | Library ID from List Libraries. |
