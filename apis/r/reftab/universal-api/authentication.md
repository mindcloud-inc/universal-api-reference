# Reftab Universal API Authentication

Every Reftab API request through MindCloud uses a MindCloud API key and the `connectionId` of a Reftab connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Reftab connection.
