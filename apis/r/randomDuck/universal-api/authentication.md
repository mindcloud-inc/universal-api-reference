# Random Duck Universal API Authentication

Every Random Duck API request through MindCloud uses a MindCloud API key and the `connectionId` of a Random Duck connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Random Duck connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Random Duck action](README.md#actions-7) with your API key and `connectionId`.
