# RandomFox Universal API Authentication

Every RandomFox API request through MindCloud uses a MindCloud API key and the `connectionId` of a RandomFox connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your RandomFox connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [RandomFox action](README.md#actions-2) with your API key and `connectionId`.
