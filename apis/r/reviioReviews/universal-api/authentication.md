# Revi.io Reviews Universal API Authentication

Every Revi.io Reviews API request through MindCloud uses a MindCloud API key and the `connectionId` of a Revi.io Reviews connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Revi.io Reviews connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Revi.io Reviews action](README.md#actions-10) with your API key and `connectionId`.
