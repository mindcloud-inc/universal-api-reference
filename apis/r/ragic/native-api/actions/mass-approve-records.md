# Mass Approve Records with Ragic
...
- **Official documentation:** [Mass Approve Records](https://www.ragic.com/docs/api/en/#tag/mass-operations/Mass-Approval)
...
| `comment` | body | `string` | no | Optional comment that accompanies the approval action. |
