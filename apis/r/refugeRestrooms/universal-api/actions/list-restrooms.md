# Refuge Restrooms: List Restrooms



```
GET https://connect.mindcloud.co/v1/universal/refugeRestrooms/latest/actions/list-restrooms
```
...
Through the native Refuge Restrooms API, this operation is `GET /v1/restrooms` (base URL `https://www.refugerestrooms.org/api`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-restrooms.md) for the provider-specific parameters and requirements.
