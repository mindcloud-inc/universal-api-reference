# Refuge Restrooms Universal API Authentication

Every Refuge Restrooms API request through MindCloud uses a MindCloud API key and the `connectionId` of a Refuge Restrooms connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Refuge Restrooms connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Refuge Restrooms action](README.md#actions-4) with your API key and `connectionId`.
