# Rentman Universal API Authentication

Every Rentman API request through MindCloud uses a MindCloud API key and the `connectionId` of a Rentman connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Rentman connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Rentman action](README.md#actions-26) with your API key and `connectionId`.
