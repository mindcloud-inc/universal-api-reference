# Rentman: Update Appointment



```
PUT https://connect.mindcloud.co/v1/universal/rentman/latest/actions/update-appointment
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/rentman/latest/actions/update-appointment" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/rentman/latest/actions/update-appointment', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `id` | number | yes | Numeric ID of the appointment to update. |
...
Through the native Rentman API, this operation is `PUT /appointments/:id` (base URL `https://api.rentman.net`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/update-appointment.md) for the provider-specific parameters and requirements.
