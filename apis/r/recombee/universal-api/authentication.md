# Recombee Universal API Authentication

Every Recombee API request through MindCloud uses a MindCloud API key and the `connectionId` of a Recombee connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Recombee connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Recombee action](README.md#actions-30) with your API key and `connectionId`.
