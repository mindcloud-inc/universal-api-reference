# Rijksmuseum Universal API Authentication

Every Rijksmuseum API request through MindCloud uses a MindCloud API key and the `connectionId` of a Rijksmuseum connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Rijksmuseum connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Rijksmuseum action](README.md#actions-13) with your API key and `connectionId`.
