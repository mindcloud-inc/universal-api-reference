# Remote OK Universal API Authentication

Every Remote OK API request through MindCloud uses a MindCloud API key and the `connectionId` of a Remote OK connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Remote OK connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Remote OK action](README.md#actions-1) with your API key and `connectionId`.
