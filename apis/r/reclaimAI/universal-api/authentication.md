# Reclaim AI Universal API Authentication

Every Reclaim AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Reclaim AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Reclaim AI connection.
