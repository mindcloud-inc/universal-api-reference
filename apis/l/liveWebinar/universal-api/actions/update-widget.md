# LiveWebinar: Update Widget

Updates an existing widget in LiveWebinar.

```
PUT https://connect.mindcloud.co/v1/universal/liveWebinar/latest/actions/update-widget
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/liveWebinar/latest/actions/update-widget" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/liveWebinar/latest/actions/update-widget', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `disableAllNotifications` | string | no |  |
| `name` | string | yes |  |
| `widgetId` | string | yes |  |
