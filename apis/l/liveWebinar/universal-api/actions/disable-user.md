# LiveWebinar: Disable User

Disables a user in LiveWebinar.

```
PUT https://connect.mindcloud.co/v1/universal/liveWebinar/latest/actions/disable-user
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/liveWebinar/latest/actions/disable-user" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/liveWebinar/latest/actions/disable-user', {
  method: 'PUT',
  headers: {
