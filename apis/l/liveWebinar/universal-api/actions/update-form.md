# LiveWebinar: Update Form

Updates an existing form in LiveWebinar.

```
PUT https://connect.mindcloud.co/v1/universal/liveWebinar/latest/actions/update-form
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/liveWebinar/latest/actions/update-form" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/liveWebinar/latest/actions/update-form', {
  method: 'PUT',
  headers: {
