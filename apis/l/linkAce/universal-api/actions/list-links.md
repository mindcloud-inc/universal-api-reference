...
```
GET https://connect.mindcloud.co/v1/universal/linkAce/latest/actions/list-links
```
...
Through the native LinkAce API, this operation is `GET /links` (base URL `https://demo.linkace.org/api/v2`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-links.md) for the provider-specific parameters and requirements.
