# Launch Library 2 Universal API Authentication

Every Launch Library 2 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Launch Library 2 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Launch Library 2 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Launch Library 2 action](README.md#actions-24) with your API key and `connectionId`.
