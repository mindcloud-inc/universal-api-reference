# Lara Translate Universal API Authentication

Every Lara Translate API request through MindCloud uses a MindCloud API key and the `connectionId` of a Lara Translate connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Lara Translate connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Lara Translate action](README.md#actions-11) with your API key and `connectionId`.
