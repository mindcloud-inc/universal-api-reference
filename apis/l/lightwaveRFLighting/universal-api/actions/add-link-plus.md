# LightwaveRF Lighting: Add LinkPlus

Adds a Link Plus to LightwaveRF Lighting.

```
POST https://connect.mindcloud.co/v1/universal/lightwaveRFLighting/latest/actions/add-link-plus
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/lightwaveRFLighting/latest/actions/add-link-plus" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/lightwaveRFLighting/latest/actions/add-link-plus', {
  method: 'POST',
  headers: {
