# LightwaveRF Lighting: Update Favourite

Updates an existing favourite in LightwaveRF Lighting.

```
PUT https://connect.mindcloud.co/v1/universal/lightwaveRFLighting/latest/actions/update-favourite
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/lightwaveRFLighting/latest/actions/update-favourite" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/lightwaveRFLighting/latest/actions/update-favourite', {
  method: 'PUT',
  headers: {
