# Send Plaintext Event with Loggly (Send Data)
...
- **Official documentation:** [Send Plaintext Event](https://documentation.solarwinds.com/en/success_center/loggly/content/admin/api-sending-data.htm)
...
| `message` | body | `string` | yes | Plain-text message content to send to Loggly. |
