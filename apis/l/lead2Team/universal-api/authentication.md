# Lead2Team Universal API Authentication

Every Lead2Team API request through MindCloud uses a MindCloud API key and the `connectionId` of a Lead2Team connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Lead2Team connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Lead2Team action](README.md#actions-4) with your API key and `connectionId`.
