# LiveKit Universal API Authentication

Every LiveKit API request through MindCloud uses a MindCloud API key and the `connectionId` of a LiveKit connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LiveKit connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [LiveKit action](README.md#actions-10) with your API key and `connectionId`.
