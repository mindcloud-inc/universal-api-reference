# Linkkit Universal API Authentication

Every Linkkit API request through MindCloud uses a MindCloud API key and the `connectionId` of a Linkkit connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Linkkit connection.
