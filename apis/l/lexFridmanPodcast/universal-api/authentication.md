# Lex Fridman Podcast Universal API Authentication

Every Lex Fridman Podcast API request through MindCloud uses a MindCloud API key and the `connectionId` of a Lex Fridman Podcast connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Lex Fridman Podcast connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Lex Fridman Podcast action](README.md#actions-34) with your API key and `connectionId`.
