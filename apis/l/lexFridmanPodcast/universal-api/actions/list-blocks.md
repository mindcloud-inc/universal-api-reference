# Lex Fridman Podcast: List Blocks

Retrieves blocks from Lex Fridman Podcast.

```
GET https://connect.mindcloud.co/v1/universal/lexFridmanPodcast/latest/actions/list-blocks
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/lexFridmanPodcast/latest/actions/list-blocks?${params}`, {
  headers: {
