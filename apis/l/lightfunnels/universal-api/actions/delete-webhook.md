# Lightfunnels: Delete Webhook



```
DELETE https://connect.mindcloud.co/v1/universal/lightfunnels/latest/actions/delete-webhook
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/lightfunnels/latest/actions/delete-webhook?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/lightfunnels/latest/actions/delete-webhook?${params}`, {
  headers: {
