# Lightfunnels: Delete Funnel



```
DELETE https://connect.mindcloud.co/v1/universal/lightfunnels/latest/actions/delete-funnel
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/lightfunnels/latest/actions/delete-funnel?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/lightfunnels/latest/actions/delete-funnel?${params}`, {
  headers: {
...
| --- | --- | --- |
| `deleteFunnels` | array<string> | Deleted funnel ids. |
