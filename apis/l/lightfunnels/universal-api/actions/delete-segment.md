# Lightfunnels: Delete Segment



```
DELETE https://connect.mindcloud.co/v1/universal/lightfunnels/latest/actions/delete-segment
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/lightfunnels/latest/actions/delete-segment?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/lightfunnels/latest/actions/delete-segment?${params}`, {
  headers: {
...
| --- | --- | --- |
| `deleteSegments` | array<string> | Deleted segment ids. |
