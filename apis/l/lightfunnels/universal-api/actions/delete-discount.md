# Lightfunnels: Delete Discount



```
DELETE https://connect.mindcloud.co/v1/universal/lightfunnels/latest/actions/delete-discount
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/lightfunnels/latest/actions/delete-discount?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/lightfunnels/latest/actions/delete-discount?${params}`, {
  headers: {
...
| --- | --- | --- |
| `deleteDiscounts` | array<string> | Deleted discount ids. |
