# Labs64 NetLicensing: Delete Bundle



```
DELETE https://connect.mindcloud.co/v1/universal/labs64NetLicensing/latest/actions/delete-bundle
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/labs64NetLicensing/latest/actions/delete-bundle?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/labs64NetLicensing/latest/actions/delete-bundle?${params}`, {
  headers: {
