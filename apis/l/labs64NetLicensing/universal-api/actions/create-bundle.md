# Labs64 NetLicensing: Create Bundle



```
POST https://connect.mindcloud.co/v1/universal/labs64NetLicensing/latest/actions/create-bundle
```
...
Through the native Labs64 NetLicensing API, this operation is `POST /bundle` (base URL `https://go.netlicensing.io/core/v2/rest`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/create-bundle.md) for the provider-specific parameters and requirements.
