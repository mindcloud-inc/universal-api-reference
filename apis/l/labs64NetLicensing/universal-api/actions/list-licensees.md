# Labs64 NetLicensing: List Licensees



```
GET https://connect.mindcloud.co/v1/universal/labs64NetLicensing/latest/actions/list-licensees
```
...
Through the native Labs64 NetLicensing API, this operation is `GET /licensee` (base URL `https://go.netlicensing.io/core/v2/rest`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-licensees.md) for the provider-specific parameters and requirements.
