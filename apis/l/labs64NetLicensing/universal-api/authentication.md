# Labs64 NetLicensing Universal API Authentication

Every Labs64 NetLicensing API request through MindCloud uses a MindCloud API key and the `connectionId` of a Labs64 NetLicensing connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Labs64 NetLicensing connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Labs64 NetLicensing action](README.md#actions-35) with your API key and `connectionId`.
