# Loop Returns Universal API Authentication

Every Loop Returns API request through MindCloud uses a MindCloud API key and the `connectionId` of a Loop Returns connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Loop Returns connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Loop Returns action](README.md#actions-5) with your API key and `connectionId`.
