# Loopy Loyalty Universal API Authentication

Every Loopy Loyalty API request through MindCloud uses a MindCloud API key and the `connectionId` of a Loopy Loyalty connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Loopy Loyalty connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Loopy Loyalty action](README.md#actions-40) with your API key and `connectionId`.
