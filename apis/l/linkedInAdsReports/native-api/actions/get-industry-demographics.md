# Get Industry Demographics with LinkedIn Ads Reports
...
- **Method:** `GET`
- **Path:** `/rest/adAnalytics?q=analytics&pivot=MEMBER_INDUSTRY&dateRange=(start:(year:{{startYear}},month:{{startMonth}},day:{{startDay}}),end:(year:{{endYear}},month:{{endMonth}},day:{{endDay}}))&timeGranularity={{timeGranularity}}&{{facet}}`
- **Base URL:** `https://api.linkedin.com`
- **Official documentation:** [Get Industry Demographics](https://learn.microsoft.com/en-us/linkedin/marketing/integrations/ads-reporting/ads-reporting?view=li-lms-2026-03)
