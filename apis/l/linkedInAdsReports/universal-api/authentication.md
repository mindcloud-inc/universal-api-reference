# LinkedIn Ads Reports Universal API Authentication

Every LinkedIn Ads Reports API request through MindCloud uses a MindCloud API key and the `connectionId` of a LinkedIn Ads Reports connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LinkedIn Ads Reports connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [LinkedIn Ads Reports action](README.md#actions-19) with your API key and `connectionId`.
