# LinkedIn Ads Reports: Get Campaign Analytics

Retrieves campaign analytics from LinkedIn Ads Reports.

```
GET https://connect.mindcloud.co/v1/universal/linkedInAdsReports/latest/actions/get-campaign-analytics
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/linkedInAdsReports/latest/actions/get-campaign-analytics?connectionId=$CONNECTION_ID&facet=campaigns%3DList(urn%253Ali%253AsponsoredCampaign%253A123456)&startYear=2026&startMonth=4&startDay=1&endYear=2026&endMonth=4&endDay=26&timeGranularity=DAILY" \
...
const params = new URLSearchParams({
  connectionId,
  "facet": "campaigns=List(urn%3Ali%3AsponsoredCampaign%3A123456)",
  "startYear": "2026",
  "startMonth": "4",
  "startDay": "1",
  "endYear": "2026",
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/linkedInAdsReports/latest/actions/get-campaign-analytics?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `facet` | string | yes | LinkedIn campaign facet expression, for example campaigns=List(urn%3Ali%3AsponsoredCampaign%3A123456). Default: `campaigns=List(urn%3Ali%3AsponsoredCampaign%3A123456)`. |
