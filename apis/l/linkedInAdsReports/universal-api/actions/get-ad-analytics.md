# LinkedIn Ads Reports: Get Ad Analytics

Retrieves ad analytics from LinkedIn Ads Reports.

```
GET https://connect.mindcloud.co/v1/universal/linkedInAdsReports/latest/actions/get-ad-analytics
```
...
| --- | --- | --- | --- |
| `pivot` | string | yes | LinkedIn ad analytics pivot to group results by. Default: `ACCOUNT`. |
