# LastPass: Get Detailed Shared Folder Data

Retrieves detailed shared folder data from LastPass.

```
GET https://connect.mindcloud.co/v1/universal/lastPass/latest/actions/get-detailed-shared-folder-data
```
...
Through the native LastPass API, this operation is `POST /enterpriseapi.php` (base URL `https://lastpass.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-detailed-shared-folder-data.md) for the provider-specific parameters and requirements.
