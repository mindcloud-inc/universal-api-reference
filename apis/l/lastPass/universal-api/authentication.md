# LastPass Universal API Authentication

Every LastPass API request through MindCloud uses a MindCloud API key and the `connectionId` of a LastPass connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LastPass connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [LastPass action](README.md#actions-13) with your API key and `connectionId`.
