# Lunatask Universal API Authentication

Every Lunatask API request through MindCloud uses a MindCloud API key and the `connectionId` of a Lunatask connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Lunatask connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Lunatask action](README.md#actions-17) with your API key and `connectionId`.
