# Lasso X: List Reports

Retrieves reports for a CVR entity from Lasso X.

```
GET https://connect.mindcloud.co/v1/universal/lassoX/latest/actions/list-reports
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/lassoX/latest/actions/list-reports?connectionId=$CONNECTION_ID&lasso_id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/lassoX/latest/actions/list-reports?${params}`, {
  headers: {
