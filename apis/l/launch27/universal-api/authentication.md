# Launch27 Universal API Authentication

Every Launch27 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Launch27 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Launch27 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Launch27 action](README.md#actions-23) with your API key and `connectionId`.
