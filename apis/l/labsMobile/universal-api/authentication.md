# LabsMobile Universal API Authentication

Every LabsMobile API request through MindCloud uses a MindCloud API key and the `connectionId` of a LabsMobile connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LabsMobile connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [LabsMobile action](README.md#actions-17) with your API key and `connectionId`.
