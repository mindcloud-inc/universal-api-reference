...
Sends an SMS message with LabsMobile.

```
POST https://connect.mindcloud.co/v1/universal/labsMobile/latest/actions/send-sms
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/labsMobile/latest/actions/send-sms" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/labsMobile/latest/actions/send-sms', {
  method: 'POST',
  headers: {
