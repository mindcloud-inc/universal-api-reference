# LeadDyno: Retrieve Lead Purchases

Retrieves purchases for a specific lead in LeadDyno.

```
GET https://connect.mindcloud.co/v1/universal/leadDyno/latest/actions/retrieve-lead-purchases
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/leadDyno/latest/actions/retrieve-lead-purchases?connectionId=$CONNECTION_ID&id=1" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/leadDyno/latest/actions/retrieve-lead-purchases?${params}`, {
  headers: {
