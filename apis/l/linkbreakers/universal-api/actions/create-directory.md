# Linkbreakers: Create a Directory

Creates a new directory in Linkbreakers.

```
POST https://connect.mindcloud.co/v1/universal/linkbreakers/latest/actions/create-directory
```
...
| --- | --- | --- |
| `directory` | object | Created directory. |
