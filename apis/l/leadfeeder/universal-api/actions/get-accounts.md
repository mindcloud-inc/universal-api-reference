# Leadfeeder: Get Accounts

Retrieves accounts the user can access in Leadfeeder.

```
GET https://connect.mindcloud.co/v1/universal/leadfeeder/latest/actions/get-accounts
```
