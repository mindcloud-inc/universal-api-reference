...
```
GET https://connect.mindcloud.co/v1/universal/leadfox/latest/actions/get-contact
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/leadfox/latest/actions/get-contact?connectionId=$CONNECTION_ID&email=person%40example.com" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/leadfox/latest/actions/get-contact?${params}`, {
  headers: {
