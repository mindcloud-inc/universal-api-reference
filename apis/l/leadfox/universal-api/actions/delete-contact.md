# Leadfox: Delete Contact



```
DELETE https://connect.mindcloud.co/v1/universal/leadfox/latest/actions/delete-contact
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/leadfox/latest/actions/delete-contact?connectionId=$CONNECTION_ID&email=person%40example.com" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/leadfox/latest/actions/delete-contact?${params}`, {
  headers: {
