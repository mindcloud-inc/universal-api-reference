# LEADTEX Universal API Authentication

Every LEADTEX API request through MindCloud uses a MindCloud API key and the `connectionId` of a LEADTEX connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LEADTEX connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [LEADTEX action](README.md#actions-51) with your API key and `connectionId`.
