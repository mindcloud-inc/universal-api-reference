# Look Digital Signage Universal API Authentication

Every Look Digital Signage API request through MindCloud uses a MindCloud API key and the `connectionId` of a Look Digital Signage connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Look Digital Signage connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Look Digital Signage action](README.md#actions-1) with your API key and `connectionId`.
