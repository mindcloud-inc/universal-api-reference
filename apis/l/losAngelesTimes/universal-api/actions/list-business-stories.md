# Los Angeles Times: List Business Stories

Retrieves Los Angeles Times business stories.

```
GET https://connect.mindcloud.co/v1/universal/losAngelesTimes/latest/actions/list-business-stories
```
...
Through the native Los Angeles Times API, this operation is `GET /business/rss2.0.xml` (base URL `https://www.latimes.com`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-business-stories.md) for the provider-specific parameters and requirements.
