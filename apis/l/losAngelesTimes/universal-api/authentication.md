# Los Angeles Times Universal API Authentication

Every Los Angeles Times API request through MindCloud uses a MindCloud API key and the `connectionId` of a Los Angeles Times connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Los Angeles Times connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Los Angeles Times action](README.md#actions-30) with your API key and `connectionId`.
