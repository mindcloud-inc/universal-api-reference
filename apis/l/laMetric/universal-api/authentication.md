# LaMetric Universal API Authentication

Every LaMetric API request through MindCloud uses a MindCloud API key and the `connectionId` of a LaMetric connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LaMetric connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [LaMetric action](README.md#actions-2) with your API key and `connectionId`.
