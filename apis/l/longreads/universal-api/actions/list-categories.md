# Longreads: List Categories

Retrieves categories from the Longreads site.

```
GET https://connect.mindcloud.co/v1/universal/longreads/latest/actions/list-categories
```
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/longreads/latest/actions/list-categories?${params}`, {
  headers: {
