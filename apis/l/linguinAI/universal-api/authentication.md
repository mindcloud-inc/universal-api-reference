# Linguin AI Universal API Authentication

Every Linguin AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Linguin AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Linguin AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Linguin AI action](README.md#actions-6) with your API key and `connectionId`.
