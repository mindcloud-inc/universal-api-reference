# leadtributor.cloud Universal API Authentication

Every leadtributor.cloud API request through MindCloud uses a MindCloud API key and the `connectionId` of a leadtributor.cloud connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your leadtributor.cloud connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [leadtributor.cloud action](README.md#actions-11) with your API key and `connectionId`.
