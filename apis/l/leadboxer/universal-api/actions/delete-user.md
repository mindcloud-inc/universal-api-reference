# Leadboxer: Delete User

Deletes an existing user from Leadboxer.

```
DELETE https://connect.mindcloud.co/v1/universal/leadboxer/latest/actions/delete-user
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/leadboxer/latest/actions/delete-user?connectionId=$CONNECTION_ID&userId=1&email=ava%40example.com" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/leadboxer/latest/actions/delete-user?${params}`, {
  headers: {
