# Layer4 Universal API Authentication

Every Layer4 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Layer4 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Layer4 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Layer4 action](README.md#actions-14) with your API key and `connectionId`.
