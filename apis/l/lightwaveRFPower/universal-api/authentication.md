# LightwaveRF Power Universal API Authentication

Every LightwaveRF Power API request through MindCloud uses a MindCloud API key and the `connectionId` of a LightwaveRF Power connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LightwaveRF Power connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [LightwaveRF Power action](README.md#actions-26) with your API key and `connectionId`.
