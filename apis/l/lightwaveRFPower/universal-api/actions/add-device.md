# LightwaveRF Power: Add Device

Creates a new device in LightwaveRF Power.

```
POST https://connect.mindcloud.co/v1/universal/lightwaveRFPower/latest/actions/add-device
```
