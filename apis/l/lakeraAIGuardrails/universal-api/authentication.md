# Lakera AI Guardrails Universal API Authentication

Every Lakera AI Guardrails API request through MindCloud uses a MindCloud API key and the `connectionId` of a Lakera AI Guardrails connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Lakera AI Guardrails connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Lakera AI Guardrails action](README.md#actions-3) with your API key and `connectionId`.
