...
- **Official documentation:** [Update Customer](https://docs.api.jobprogress.com/api/customer.json)
...
| --- | --- | --- | --- | --- |
| `customerId` | path | `number` | yes | Leap customer ID. |
