# List Pack Types (GET) with Logiwa Legacy WMS
...
- **Method:** `POST`
- **Path:** `/en/api/IntegrationApi/InventoryItemPackTypeGET`
- **Base URL:** `https://{uRL}.logiwa.com/`
- **Official documentation:** [List Pack Types (GET)](https://developer.logiwa.com/?id=5e71514fe6466c0c70d9c50a)
