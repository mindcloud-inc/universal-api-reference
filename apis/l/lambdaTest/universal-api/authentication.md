# LambdaTest Universal API Authentication

Every LambdaTest API request through MindCloud uses a MindCloud API key and the `connectionId` of a LambdaTest connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LambdaTest connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [LambdaTest action](README.md#actions-47) with your API key and `connectionId`.
