...
```
GET https://connect.mindcloud.co/v1/universal/loomio/latest/actions/list-groups
```
...
Through the native Loomio API, this operation is `GET /groups` (base URL `https://www.loomio.com/api/v1`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-groups.md) for the provider-specific parameters and requirements.
