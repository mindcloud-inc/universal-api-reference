# Logo.dev Universal API Authentication

Every Logo.dev API request through MindCloud uses a MindCloud API key and the `connectionId` of a Logo.dev connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Logo.dev connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Logo.dev action](README.md#actions-3) with your API key and `connectionId`.
