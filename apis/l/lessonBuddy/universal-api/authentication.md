# LessonBuddy Universal API Authentication

Every LessonBuddy API request through MindCloud uses a MindCloud API key and the `connectionId` of a LessonBuddy connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LessonBuddy connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [LessonBuddy action](README.md#actions-11) with your API key and `connectionId`.
