# Lead Identity Check Universal API Authentication

Every Lead Identity Check API request through MindCloud uses a MindCloud API key and the `connectionId` of a Lead Identity Check connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Lead Identity Check connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Lead Identity Check action](README.md#actions-3) with your API key and `connectionId`.
