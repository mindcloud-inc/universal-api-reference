# LinkTwin Universal API Authentication

Every LinkTwin API request through MindCloud uses a MindCloud API key and the `connectionId` of a LinkTwin connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LinkTwin connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [LinkTwin action](README.md#actions-29) with your API key and `connectionId`.
