# Lokalise Universal API Authentication

Every Lokalise API request through MindCloud uses a MindCloud API key and the `connectionId` of a Lokalise connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Lokalise connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Lokalise action](README.md#actions-32) with your API key and `connectionId`.
