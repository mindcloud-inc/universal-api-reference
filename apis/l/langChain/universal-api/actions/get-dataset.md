# LangChain: Get Dataset



```
GET https://connect.mindcloud.co/v1/universal/langChain/latest/actions/get-dataset
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/langChain/latest/actions/get-dataset?connectionId=$CONNECTION_ID&datasetId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/langChain/latest/actions/get-dataset?${params}`, {
  headers: {
