# Locu Universal API Authentication

Every Locu API request through MindCloud uses a MindCloud API key and the `connectionId` of a Locu connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Locu connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Locu action](README.md#actions-40) with your API key and `connectionId`.
