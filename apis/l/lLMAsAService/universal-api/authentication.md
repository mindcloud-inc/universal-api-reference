# LLM as a Service Universal API Authentication

Every LLM as a Service API request through MindCloud uses a MindCloud API key and the `connectionId` of a LLM as a Service connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LLM as a Service connection.
