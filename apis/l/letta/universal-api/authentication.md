# Letta Universal API Authentication

Every Letta API request through MindCloud uses a MindCloud API key and the `connectionId` of a Letta connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Letta connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Letta action](README.md#actions-25) with your API key and `connectionId`.
