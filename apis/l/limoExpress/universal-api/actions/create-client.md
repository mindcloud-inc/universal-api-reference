# LimoExpress: Create Client

Creates a new client in LimoExpress.

```
POST https://connect.mindcloud.co/v1/universal/limoExpress/latest/actions/create-client
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/limoExpress/latest/actions/create-client" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/limoExpress/latest/actions/create-client', {
  method: 'POST',
  headers: {
