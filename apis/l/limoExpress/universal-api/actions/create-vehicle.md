# LimoExpress: Create Vehicle

Creates a new vehicle in LimoExpress.

```
POST https://connect.mindcloud.co/v1/universal/limoExpress/latest/actions/create-vehicle
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/limoExpress/latest/actions/create-vehicle" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/limoExpress/latest/actions/create-vehicle', {
  method: 'POST',
  headers: {
