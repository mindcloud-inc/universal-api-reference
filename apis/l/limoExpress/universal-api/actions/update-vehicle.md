# LimoExpress: Update Vehicle

Updates an existing vehicle in LimoExpress.

```
PUT https://connect.mindcloud.co/v1/universal/limoExpress/latest/actions/update-vehicle
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/limoExpress/latest/actions/update-vehicle" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/limoExpress/latest/actions/update-vehicle', {
  method: 'PUT',
  headers: {
