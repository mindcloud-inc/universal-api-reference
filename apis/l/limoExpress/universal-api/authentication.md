# LimoExpress Universal API Authentication

Every LimoExpress API request through MindCloud uses a MindCloud API key and the `connectionId` of a LimoExpress connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LimoExpress connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [LimoExpress action](README.md#actions-39) with your API key and `connectionId`.
