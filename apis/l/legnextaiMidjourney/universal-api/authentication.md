# Legnext.ai-Midjourney Universal API Authentication

Every Legnext.ai-Midjourney API request through MindCloud uses a MindCloud API key and the `connectionId` of a Legnext.ai-Midjourney connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Legnext.ai-Midjourney connection.
