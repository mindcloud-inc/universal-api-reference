# LiveChat Universal API Authentication

Every LiveChat API request through MindCloud uses a MindCloud API key and the `connectionId` of a LiveChat connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LiveChat connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [LiveChat action](README.md#actions-24) with your API key and `connectionId`.
