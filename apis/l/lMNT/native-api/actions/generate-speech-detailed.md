# Generate Speech (Detailed) with LMNT
...
- **Official documentation:** [Generate Speech (Detailed)](https://docs.lmnt.com/api-reference/speech/synthesize-speech-post)
...
| `return_durations` | body | `boolean` | no | When true, LMNT includes word-level timing data in the response. |
