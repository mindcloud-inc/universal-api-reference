# LoginRadius Universal API Authentication

Every LoginRadius API request through MindCloud uses a MindCloud API key and the `connectionId` of a LoginRadius connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your LoginRadius connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [LoginRadius action](README.md#actions-40) with your API key and `connectionId`.
