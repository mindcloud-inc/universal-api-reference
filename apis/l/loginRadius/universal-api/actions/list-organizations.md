# LoginRadius: List Organizations

Retrieves organization records from a LoginRadius tenant.

```
GET https://connect.mindcloud.co/v1/universal/loginRadius/latest/actions/list-organizations
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/loginRadius/latest/actions/list-organizations?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/loginRadius/latest/actions/list-organizations?${params}`, {
  headers: {
