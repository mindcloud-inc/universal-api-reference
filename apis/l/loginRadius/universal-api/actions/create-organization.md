# LoginRadius: Create Organization

Creates a new organization in LoginRadius.

```
POST https://connect.mindcloud.co/v1/universal/loginRadius/latest/actions/create-organization
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/loginRadius/latest/actions/create-organization" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/loginRadius/latest/actions/create-organization', {
  method: 'POST',
  headers: {
