# Library of Congress: Get Collection

Retrieves a Library of Congress digital collection.

```
GET https://connect.mindcloud.co/v1/universal/libraryOfCongress/latest/actions/get-collection
```
...
Through the native Library of Congress API, this operation is `GET /collections/{collectionSlug}/` (base URL `https://www.loc.gov`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/get-collection.md) for the provider-specific parameters and requirements.
