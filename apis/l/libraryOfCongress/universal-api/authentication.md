# Library of Congress Universal API Authentication

Every Library of Congress API request through MindCloud uses a MindCloud API key and the `connectionId` of a Library of Congress connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Library of Congress connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Library of Congress action](README.md#actions-31) with your API key and `connectionId`.
