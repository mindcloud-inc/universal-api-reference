# Loyverse Universal API Authentication

Every Loyverse API request through MindCloud uses a MindCloud API key and the `connectionId` of a Loyverse connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Loyverse connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Loyverse action](README.md#actions-30) with your API key and `connectionId`.
