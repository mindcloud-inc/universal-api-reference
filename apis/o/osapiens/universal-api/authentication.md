# Osapiens Universal API Authentication

Every Osapiens API request through MindCloud uses a MindCloud API key and the `connectionId` of a Osapiens connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Osapiens connection.
