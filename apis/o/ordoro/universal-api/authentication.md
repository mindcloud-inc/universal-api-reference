# Ordoro Universal API Authentication

Every Ordoro API request through MindCloud uses a MindCloud API key and the `connectionId` of a Ordoro connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Ordoro connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Ordoro action](README.md#actions-54) with your API key and `connectionId`.
