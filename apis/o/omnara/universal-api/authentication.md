# Omnara Universal API Authentication

Every Omnara API request through MindCloud uses a MindCloud API key and the `connectionId` of a Omnara connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Omnara connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Omnara action](README.md#actions-49) with your API key and `connectionId`.
