# Official Joke API Universal API Authentication

Every Official Joke API API request through MindCloud uses a MindCloud API key and the `connectionId` of a Official Joke API connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Official Joke API connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Official Joke API action](README.md#actions-7) with your API key and `connectionId`.
