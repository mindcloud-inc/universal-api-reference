# Omnisend Universal API Authentication

Every Omnisend API request through MindCloud uses a MindCloud API key and the `connectionId` of a Omnisend connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Omnisend connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Omnisend action](README.md#actions-19) with your API key and `connectionId`.
