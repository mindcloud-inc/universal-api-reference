...
Retrieves products from Omnisend.

```
GET https://connect.mindcloud.co/v1/universal/omnisend/latest/actions/list-products
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/omnisend/latest/actions/list-products?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/omnisend/latest/actions/list-products?${params}`, {
  headers: {
