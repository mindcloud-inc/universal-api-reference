...
Retrieves orders from Omnisend.

```
GET https://connect.mindcloud.co/v1/universal/omnisend/latest/actions/list-orders
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/omnisend/latest/actions/list-orders?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/omnisend/latest/actions/list-orders?${params}`, {
  headers: {
