...
Deletes an existing product from Omnisend.

```
DELETE https://connect.mindcloud.co/v1/universal/omnisend/latest/actions/delete-product
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/omnisend/latest/actions/delete-product?connectionId=$CONNECTION_ID&productID=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/omnisend/latest/actions/delete-product?${params}`, {
  headers: {
