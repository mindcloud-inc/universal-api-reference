# Oracle DB Legacy Universal API Authentication

Every Oracle DB Legacy API request through MindCloud uses a MindCloud API key and the `connectionId` of a Oracle DB Legacy connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Oracle DB Legacy connection.
