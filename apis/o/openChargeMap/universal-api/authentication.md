# Open Charge Map Universal API Authentication

Every Open Charge Map API request through MindCloud uses a MindCloud API key and the `connectionId` of a Open Charge Map connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Open Charge Map connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Open Charge Map action](README.md#actions-20) with your API key and `connectionId`.
