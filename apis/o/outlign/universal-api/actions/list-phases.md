...
Retrieves project phase records from Outlign.

```
GET https://connect.mindcloud.co/v1/universal/outlign/latest/actions/list-phases
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/outlign/latest/actions/list-phases?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/outlign/latest/actions/list-phases?${params}`, {
  headers: {
