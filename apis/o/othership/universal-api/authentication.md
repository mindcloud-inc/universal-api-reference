# Othership Universal API Authentication

Every Othership API request through MindCloud uses a MindCloud API key and the `connectionId` of a Othership connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Othership connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Othership action](README.md#actions-10) with your API key and `connectionId`.
