# Opinion Stage Universal API Authentication

Every Opinion Stage API request through MindCloud uses a MindCloud API key and the `connectionId` of a Opinion Stage connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Opinion Stage connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Opinion Stage action](README.md#actions-1) with your API key and `connectionId`.
