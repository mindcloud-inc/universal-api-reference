# Orbit AI (Forms) Universal API Authentication

Every Orbit AI (Forms) API request through MindCloud uses a MindCloud API key and the `connectionId` of a Orbit AI (Forms) connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Orbit AI (Forms) connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Orbit AI (Forms) action](README.md#actions-30) with your API key and `connectionId`.
