# OpenFDA Universal API Authentication

Every OpenFDA API request through MindCloud uses a MindCloud API key and the `connectionId` of a OpenFDA connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your OpenFDA connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [OpenFDA action](README.md#actions-57) with your API key and `connectionId`.
