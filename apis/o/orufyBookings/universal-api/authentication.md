# Orufy Bookings Universal API Authentication

Every Orufy Bookings API request through MindCloud uses a MindCloud API key and the `connectionId` of a Orufy Bookings connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Orufy Bookings connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Orufy Bookings action](README.md#actions-10) with your API key and `connectionId`.
