# OTO Universal API Authentication

Every OTO API request through MindCloud uses a MindCloud API key and the `connectionId` of a OTO connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your OTO connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [OTO action](README.md#actions-20) with your API key and `connectionId`.
