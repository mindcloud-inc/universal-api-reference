# OneMap SG Universal API Authentication

Every OneMap SG API request through MindCloud uses a MindCloud API key and the `connectionId` of a OneMap SG connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your OneMap SG connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [OneMap SG action](README.md#actions-24) with your API key and `connectionId`.
