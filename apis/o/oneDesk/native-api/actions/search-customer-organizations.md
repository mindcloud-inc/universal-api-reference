# Search Customer Organizations with OneDesk
...
- **Method:** `POST`
- **Path:** `/rest/public/customer-organizations/filter`
- **Base URL:** `https://app.onedesk.com`
- **Official documentation:** [Search Customer Organizations](https://onedesk.com/public-api/swagger.html)
...
| `limit` | body | `number` | no | Maximum number of customer organizations to return. |
