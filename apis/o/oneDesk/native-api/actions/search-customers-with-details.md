# Search Customers With Details with OneDesk
...
- **Method:** `POST`
- **Path:** `/rest/public/customers/filter/details`
- **Base URL:** `https://app.onedesk.com`
- **Official documentation:** [Search Customers With Details](https://onedesk.com/public-api/swagger.html)
...
| `limit` | body | `number` | no | Maximum number of customer detail rows to return. |
