...
- **Method:** `POST`
- **Path:** `/rest/public/projects/filter`
- **Base URL:** `https://app.onedesk.com`
- **Official documentation:** [Search Projects](https://onedesk.com/public-api/swagger.html)
...
| `limit` | body | `number` | no | Maximum number of projects to return. |
