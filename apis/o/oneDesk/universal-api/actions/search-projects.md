# OneDesk: Search Projects

Finds projects in OneDesk by filters.

```
GET https://connect.mindcloud.co/v1/universal/oneDesk/latest/actions/search-projects
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/oneDesk/latest/actions/search-projects?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/oneDesk/latest/actions/search-projects?${params}`, {
  headers: {
