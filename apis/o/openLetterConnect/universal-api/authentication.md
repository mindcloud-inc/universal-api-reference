# Open Letter Connect Universal API Authentication

Every Open Letter Connect API request through MindCloud uses a MindCloud API key and the `connectionId` of a Open Letter Connect connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Open Letter Connect connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Open Letter Connect action](README.md#actions-24) with your API key and `connectionId`.
