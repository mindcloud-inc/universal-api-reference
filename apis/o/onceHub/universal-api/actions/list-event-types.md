# OnceHub: List Event Types



```
GET https://connect.mindcloud.co/v1/universal/onceHub/latest/actions/list-event-types
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/onceHub/latest/actions/list-event-types?connectionId=$CONNECTION_ID&limit=25&offset=0" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/onceHub/latest/actions/list-event-types?${params}`, {
  headers: {
