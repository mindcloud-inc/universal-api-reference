# Otiom Universal API Authentication

Every Otiom API request through MindCloud uses a MindCloud API key and the `connectionId` of a Otiom connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Otiom connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Otiom action](README.md#actions-17) with your API key and `connectionId`.
