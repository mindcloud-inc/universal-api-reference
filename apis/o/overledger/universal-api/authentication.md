# Overledger Universal API Authentication

Every Overledger API request through MindCloud uses a MindCloud API key and the `connectionId` of a Overledger connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Overledger connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Overledger action](README.md#actions-6) with your API key and `connectionId`.
