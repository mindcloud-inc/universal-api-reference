# Open AI Universal API Authentication

Every Open AI API request through MindCloud uses a MindCloud API key and the `connectionId` of a Open AI connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Open AI connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Open AI action](README.md#actions-42) with your API key and `connectionId`.
