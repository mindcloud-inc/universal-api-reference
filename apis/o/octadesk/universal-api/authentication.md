# Octadesk Universal API Authentication

Every Octadesk API request through MindCloud uses a MindCloud API key and the `connectionId` of a Octadesk connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Octadesk connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Octadesk action](README.md#actions-26) with your API key and `connectionId`.
