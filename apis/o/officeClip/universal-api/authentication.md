# OfficeClip Universal API Authentication

Every OfficeClip API request through MindCloud uses a MindCloud API key and the `connectionId` of a OfficeClip connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your OfficeClip connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [OfficeClip action](README.md#actions-92) with your API key and `connectionId`.
