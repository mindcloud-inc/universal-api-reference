# OfficeClip: Create Expense

Creates an expense in OfficeClip.

```
POST https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/create-expense
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/create-expense" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/create-expense', {
  method: 'POST',
  headers: {
