# OfficeClip: Update Note

Updates a note in OfficeClip.

```
PUT https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/update-note
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/update-note" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/update-note', {
  method: 'PUT',
  headers: {
