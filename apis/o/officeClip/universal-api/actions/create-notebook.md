# OfficeClip: Create Notebook

Creates a notebook in OfficeClip.

```
POST https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/create-notebook
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/create-notebook" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/create-notebook', {
  method: 'POST',
  headers: {
