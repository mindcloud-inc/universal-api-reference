# OfficeClip: List Timesheets

Retrieves timesheets from OfficeClip.

```
GET https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/list-timesheets
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/list-timesheets?connectionId=$CONNECTION_ID&limit=25&offset=0&category=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/list-timesheets?${params}`, {
  headers: {
