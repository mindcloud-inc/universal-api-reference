# OfficeClip: Update Expense

Updates an expense in OfficeClip.

```
PUT https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/update-expense
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/update-expense" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/update-expense', {
  method: 'PUT',
  headers: {
