# OfficeClip: Create Note

Creates a note in OfficeClip.

```
POST https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/create-note
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/create-note" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/create-note', {
  method: 'POST',
  headers: {
