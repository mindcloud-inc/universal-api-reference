# OfficeClip: List Users

Retrieves users from OfficeClip.

```
GET https://connect.mindcloud.co/v1/universal/officeClip/latest/actions/list-users
```
