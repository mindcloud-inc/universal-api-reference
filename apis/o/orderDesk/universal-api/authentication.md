# Order Desk Universal API Authentication

Every Order Desk API request through MindCloud uses a MindCloud API key and the `connectionId` of a Order Desk connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Order Desk connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Order Desk action](README.md#actions-18) with your API key and `connectionId`.
