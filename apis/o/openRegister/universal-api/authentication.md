# OpenRegister Universal API Authentication

Every OpenRegister API request through MindCloud uses a MindCloud API key and the `connectionId` of a OpenRegister connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your OpenRegister connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [OpenRegister action](README.md#actions-16) with your API key and `connectionId`.
