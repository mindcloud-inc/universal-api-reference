# Update Person Custom Field with Ortto

## Endpoint

- **Method:** `PUT`
- **Path:** `/person/custom-field/update`
- **Base URL:** `{apiBaseUrl}/v1`
- **Official documentation:** [Update Person Custom Field](https://help.ortto.com/a-752-updating-custom-fields-via-the-api)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `field_id` | body | `string` | yes | Ortto custom field identifier such as str:cm:favorite-color. |
