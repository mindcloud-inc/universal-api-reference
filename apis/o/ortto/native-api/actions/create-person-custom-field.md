# Create Person Custom Field with Ortto

## Endpoint

- **Method:** `POST`
- **Path:** `/person/custom-field/create`
- **Base URL:** `{apiBaseUrl}/v1`
- **Official documentation:** [Create Person Custom Field](https://help.ortto.com/a-265-create-a-custom-field-create)
