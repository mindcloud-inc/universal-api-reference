...
Retrieves LoudVoice author details from OneAll.

```
GET https://connect.mindcloud.co/v1/universal/oneAll/latest/actions/get-author
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/oneAll/latest/actions/get-author?connectionId=$CONNECTION_ID&authorToken=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/oneAll/latest/actions/get-author?${params}`, {
  headers: {
