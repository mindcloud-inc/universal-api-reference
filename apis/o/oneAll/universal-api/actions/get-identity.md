...
Retrieves social identity details from OneAll.

```
GET https://connect.mindcloud.co/v1/universal/oneAll/latest/actions/get-identity
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/oneAll/latest/actions/get-identity?connectionId=$CONNECTION_ID&identityToken=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/oneAll/latest/actions/get-identity?${params}`, {
  headers: {
