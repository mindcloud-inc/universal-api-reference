# Orderry Universal API Authentication

Every Orderry API request through MindCloud uses a MindCloud API key and the `connectionId` of a Orderry connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Orderry connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Orderry action](README.md#actions-45) with your API key and `connectionId`.
