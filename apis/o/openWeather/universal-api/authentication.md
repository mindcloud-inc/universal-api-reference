# OpenWeather Universal API Authentication

Every OpenWeather API request through MindCloud uses a MindCloud API key and the `connectionId` of a OpenWeather connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your OpenWeather connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [OpenWeather action](README.md#actions-58) with your API key and `connectionId`.
