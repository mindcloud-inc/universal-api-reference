# Olakai Universal API Authentication

Every Olakai API request through MindCloud uses a MindCloud API key and the `connectionId` of a Olakai connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Olakai connection.
