# Office Ladies Podcast Universal API Authentication

Every Office Ladies Podcast API request through MindCloud uses a MindCloud API key and the `connectionId` of a Office Ladies Podcast connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Office Ladies Podcast connection.
