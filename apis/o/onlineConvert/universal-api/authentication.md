# Online-Convert Universal API Authentication

Every Online-Convert API request through MindCloud uses a MindCloud API key and the `connectionId` of a Online-Convert connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Online-Convert connection.
