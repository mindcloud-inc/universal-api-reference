# OneSignal Universal API Authentication

Every OneSignal API request through MindCloud uses a MindCloud API key and the `connectionId` of a OneSignal connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your OneSignal connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [OneSignal action](README.md#actions-19) with your API key and `connectionId`.
