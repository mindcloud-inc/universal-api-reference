# Open Data DC Universal API Authentication

Every Open Data DC API request through MindCloud uses a MindCloud API key and the `connectionId` of a Open Data DC connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Open Data DC connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Open Data DC action](README.md#actions-34) with your API key and `connectionId`.
