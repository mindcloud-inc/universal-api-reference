# Outlook Universal API Authentication

Every Outlook API request through MindCloud uses a MindCloud API key and the `connectionId` of a Outlook connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Outlook connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Outlook action](README.md#actions-11) with your API key and `connectionId`.
