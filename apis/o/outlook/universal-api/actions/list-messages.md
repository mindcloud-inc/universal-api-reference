...
```
GET https://connect.mindcloud.co/v1/universal/outlook/latest/actions/list-messages
```
...
Through the native Outlook API, this operation is `GET /me/messages` (base URL `https://graph.microsoft.com/v1.0`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/list-messages.md) for the provider-specific parameters and requirements.
