# Unbounce: List Sub Account Pages

Retrieves pages for an Unbounce sub-account.

```
GET https://connect.mindcloud.co/v1/universal/unbounce/latest/actions/list-sub-account-pages
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/unbounce/latest/actions/list-sub-account-pages?connectionId=$CONNECTION_ID&sub_account_id=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/unbounce/latest/actions/list-sub-account-pages?${params}`, {
  headers: {
