# USGS Earthquake Hazards Universal API Authentication

Every USGS Earthquake Hazards API request through MindCloud uses a MindCloud API key and the `connectionId` of a USGS Earthquake Hazards connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your USGS Earthquake Hazards connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [USGS Earthquake Hazards action](README.md#actions-24) with your API key and `connectionId`.
