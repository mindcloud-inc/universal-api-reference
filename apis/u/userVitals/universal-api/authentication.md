# UserVitals Universal API Authentication

Every UserVitals API request through MindCloud uses a MindCloud API key and the `connectionId` of a UserVitals connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your UserVitals connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [UserVitals action](README.md#actions-23) with your API key and `connectionId`.
