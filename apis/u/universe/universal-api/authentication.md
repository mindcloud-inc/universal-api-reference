# Universe Universal API Authentication

Every Universe API request through MindCloud uses a MindCloud API key and the `connectionId` of a Universe connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Universe connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Universe action](README.md#actions-34) with your API key and `connectionId`.
