# Unstructured Universal API Authentication

Every Unstructured API request through MindCloud uses a MindCloud API key and the `connectionId` of a Unstructured connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Unstructured connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Unstructured action](README.md#actions-49) with your API key and `connectionId`.
