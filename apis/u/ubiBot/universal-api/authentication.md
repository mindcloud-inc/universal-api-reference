# UbiBot Universal API Authentication

Every UbiBot API request through MindCloud uses a MindCloud API key and the `connectionId` of a UbiBot connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your UbiBot connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [UbiBot action](README.md#actions-10) with your API key and `connectionId`.
