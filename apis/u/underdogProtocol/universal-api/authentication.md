# Underdog Protocol Universal API Authentication

Every Underdog Protocol API request through MindCloud uses a MindCloud API key and the `connectionId` of a Underdog Protocol connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Underdog Protocol connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Underdog Protocol action](README.md#actions-30) with your API key and `connectionId`.
