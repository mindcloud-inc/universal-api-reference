# Underdog Protocol: List Projects

Retrieves a list of projects from Underdog Protocol.

```
GET https://connect.mindcloud.co/v1/universal/underdogProtocol/latest/actions/list-projects
```
