# URL.dev Universal API Authentication

Every URL.dev API request through MindCloud uses a MindCloud API key and the `connectionId` of a URL.dev connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your URL.dev connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [URL.dev action](README.md#actions-1) with your API key and `connectionId`.
