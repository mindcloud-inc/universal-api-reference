# Useless Facts Universal API Authentication

Every Useless Facts API request through MindCloud uses a MindCloud API key and the `connectionId` of a Useless Facts connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Useless Facts connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Useless Facts action](README.md#actions-2) with your API key and `connectionId`.
