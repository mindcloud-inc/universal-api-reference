# Get Website Pageviews with Umami
...
- **Official documentation:** [Get Website Pageviews](https://docs.umami.is/docs/api/website-stats)
...
| `timezone` | query | `string` | no | Timezone like America/Los_Angeles. |
