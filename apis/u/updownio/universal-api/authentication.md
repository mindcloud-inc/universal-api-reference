# updown.io Universal API Authentication

Every updown.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a updown.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your updown.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [updown.io action](README.md#actions-18) with your API key and `connectionId`.
