# US Congress CRS Universal API Authentication

Every US Congress CRS API request through MindCloud uses a MindCloud API key and the `connectionId` of a US Congress CRS connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your US Congress CRS connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [US Congress CRS action](README.md#actions-2) with your API key and `connectionId`.
