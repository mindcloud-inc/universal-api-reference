...
```
POST https://connect.mindcloud.co/v1/universal/upstashRedis/latest/actions/acl
```
...
Through the native Upstash Redis API, this operation is `GET /acl` (base URL `https://choice-oriole-98954.upstash.io`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/acl.md) for the provider-specific parameters and requirements.
