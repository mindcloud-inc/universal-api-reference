# Unkey Universal API Authentication

Every Unkey API request through MindCloud uses a MindCloud API key and the `connectionId` of a Unkey connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Unkey connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Unkey action](README.md#actions-38) with your API key and `connectionId`.
