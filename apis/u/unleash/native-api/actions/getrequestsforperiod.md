# [Beta] Get Aggregated Metered Requests For A Given Time Period. with Unleash
...
- **Official documentation:** [[Beta] Get Aggregated Metered Requests For A Given Time Period.](https://docs.getunleash.io/api)
