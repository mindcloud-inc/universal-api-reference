# [Beta] Get Aggregated Metered Connections For A Given Time Period. with Unleash
...
- **Official documentation:** [[Beta] Get Aggregated Metered Connections For A Given Time Period.](https://docs.getunleash.io/api)
