# Unleash Universal API Authentication

Every Unleash API request through MindCloud uses a MindCloud API key and the `connectionId` of a Unleash connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Unleash connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Unleash action](README.md#actions-376) with your API key and `connectionId`.
