# Ubiqod by Skiply: List Badge Lists



```
GET https://connect.mindcloud.co/v1/universal/ubiqodBySkiply/latest/actions/list-badge-lists
```
...
Through the native Ubiqod by Skiply API, this operation is `GET /badges/` (base URL `https://api.ubiqod.com`). The Universal API call above is translated to it by MindCloud, including authentication and pagination. See the [native action reference](../../native-api/actions/list-badge-lists.md) for the provider-specific parameters and requirements.
