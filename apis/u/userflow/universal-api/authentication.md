# Userflow Universal API Authentication

Every Userflow API request through MindCloud uses a MindCloud API key and the `connectionId` of a Userflow connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Userflow connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Userflow action](README.md#actions-17) with your API key and `connectionId`.
