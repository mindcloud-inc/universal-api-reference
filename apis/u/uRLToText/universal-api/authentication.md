# URL to Text Universal API Authentication

Every URL to Text API request through MindCloud uses a MindCloud API key and the `connectionId` of a URL to Text connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your URL to Text connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [URL to Text action](README.md#actions-1) with your API key and `connectionId`.
