# List Opportunities with Upnify
...
- **Official documentation:** [List Opportunities](https://desarrollo.upnify.com/api-rest/oportunidades/#api-Oportunidades-GetOportunidades)
...
| `periodoCierre` | query | `string` | no | Permite filtrar los registros por fecha de cierre estimado. |
| `tkCerteza` | query | `string` | no | Permite filtrar los registros por una certeza de cierre en particular. |
