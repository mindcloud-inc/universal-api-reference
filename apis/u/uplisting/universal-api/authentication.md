# Uplisting Universal API Authentication

Every Uplisting API request through MindCloud uses a MindCloud API key and the `connectionId` of a Uplisting connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Uplisting connection.
