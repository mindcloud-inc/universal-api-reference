...
```
GET https://connect.mindcloud.co/v1/universal/uploadcare/latest/actions/get-file
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/uploadcare/latest/actions/get-file?connectionId=$CONNECTION_ID&uuid=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/uploadcare/latest/actions/get-file?${params}`, {
  headers: {
...
| --- | --- | --- | --- |
| `include` | string | no | Include additional file fields such as appdata. |
