# Uploadcare: Delete Group

Deletes an existing group from Uploadcare.

```
DELETE https://connect.mindcloud.co/v1/universal/uploadcare/latest/actions/delete-group
```
...
```bash
curl -X DELETE "https://connect.mindcloud.co/v1/universal/uploadcare/latest/actions/delete-group?connectionId=$CONNECTION_ID&uuid=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/uploadcare/latest/actions/delete-group?${params}`, {
  headers: {
