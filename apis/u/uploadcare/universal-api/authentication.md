# Uploadcare Universal API Authentication

Every Uploadcare API request through MindCloud uses a MindCloud API key and the `connectionId` of a Uploadcare connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Uploadcare connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Uploadcare action](README.md#actions-23) with your API key and `connectionId`.
