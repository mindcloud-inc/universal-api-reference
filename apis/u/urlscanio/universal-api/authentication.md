# urlscan.io Universal API Authentication

Every urlscan.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a urlscan.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your urlscan.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [urlscan.io action](README.md#actions-50) with your API key and `connectionId`.
