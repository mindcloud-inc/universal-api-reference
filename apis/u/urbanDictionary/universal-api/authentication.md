# Urban Dictionary Universal API Authentication

Every Urban Dictionary API request through MindCloud uses a MindCloud API key and the `connectionId` of a Urban Dictionary connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Urban Dictionary connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Urban Dictionary action](README.md#actions-1) with your API key and `connectionId`.
