# Umbrella: List Integrations

Retrieves integration records from your Umbrella organization.

```
GET https://connect.mindcloud.co/v1/universal/umbrella/latest/actions/list-integrations
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/umbrella/latest/actions/list-integrations?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/umbrella/latest/actions/list-integrations?${params}`, {
  headers: {
