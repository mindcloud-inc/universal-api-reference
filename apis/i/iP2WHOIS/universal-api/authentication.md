# IP2WHOIS Universal API Authentication

Every IP2WHOIS API request through MindCloud uses a MindCloud API key and the `connectionId` of a IP2WHOIS connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your IP2WHOIS connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [IP2WHOIS action](README.md#actions-2) with your API key and `connectionId`.
