# Ice and Fire (Game of Thrones) Universal API Authentication

Every Ice and Fire (Game of Thrones) API request through MindCloud uses a MindCloud API key and the `connectionId` of a Ice and Fire (Game of Thrones) connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Ice and Fire (Game of Thrones) connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Ice and Fire (Game of Thrones) action](README.md#actions-6) with your API key and `connectionId`.
