# INBOX: Get All Campaigns

Retrieves all campaign records from INBOX.

```
GET https://connect.mindcloud.co/v1/universal/iNBOX/latest/actions/get-all-campaigns
```
