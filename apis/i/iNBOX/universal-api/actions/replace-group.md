...
Replaces an existing group in INBOX.

```
PUT https://connect.mindcloud.co/v1/universal/iNBOX/latest/actions/replace-group
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/iNBOX/latest/actions/replace-group" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/iNBOX/latest/actions/replace-group', {
  method: 'PUT',
  headers: {
