...
Creates a new group in INBOX.

```
POST https://connect.mindcloud.co/v1/universal/iNBOX/latest/actions/create-group
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/iNBOX/latest/actions/create-group" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/iNBOX/latest/actions/create-group', {
  method: 'POST',
  headers: {
