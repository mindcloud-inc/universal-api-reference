# Invision Community Universal API Authentication

Every Invision Community API request through MindCloud uses a MindCloud API key and the `connectionId` of a Invision Community connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Invision Community connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Invision Community action](README.md#actions-116) with your API key and `connectionId`.
