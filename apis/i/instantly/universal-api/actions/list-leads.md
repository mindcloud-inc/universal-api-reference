...
| --- | --- | --- | --- |
| `queries[].actionType` | list<string> | no | Available options: `reply`, `email-open`, `last-contacted`, `link-click`, `lead-status`, `lead-status-change` One of: `email-open`, `last-contacted`, `lead-status`, `lead-status-change`, `link-click`, `reply`. |
| `queries[].values.leadStatus.condition` | list<string> | no | Available options: `is`, `is-not` One of: `is`, `is-not`. Example: `is-not`. |
| `queries[].values.occurrenceCount.condition` | list<string> | no | Available options: "more", "less", "equal" One of: `equal`, `less`, `more`. |
...
| `queries[].values.leadStatus.status` | list<number> | no | Enter a numeric status code: Numeric Code (status) Status Label Category Description 1 Interested Positive Prospect indicated interest in your offer 2 Meeting Booked Positive Prospect scheduled a meeting/call 3 Meeting Completed Positive Meeting took place 4 Closed Positive Deal won / customer converted 0 Out of Office Neutral Auto-responder or out-of-office message received -1 Not Interested Negative Prospect explicitly declined or passed -2 Wrong Person Negative Contact indicated they are not the relevant person -3 Lost Negative Deal lost / opportunity closed without conversion -4 No Show Negative Prospect missed scheduled meeting One of: `-1`, `-2`, `-3`, `-4`, `0`, `1`, `2`, `3`, `4`. Example: `1`. |
