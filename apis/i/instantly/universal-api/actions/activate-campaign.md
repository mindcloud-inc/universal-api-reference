...
```
PUT https://connect.mindcloud.co/v1/universal/instantly/latest/actions/activate-campaign
```
...
Through the native Instantly API, this operation is `POST /api/v2/campaigns/:id/activate` (base URL `https://api.instantly.ai`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/activate-campaign.md) for the provider-specific parameters and requirements.
