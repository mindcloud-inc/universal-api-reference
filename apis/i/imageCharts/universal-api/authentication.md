# Image-Charts Universal API Authentication

Every Image-Charts API request through MindCloud uses a MindCloud API key and the `connectionId` of a Image-Charts connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Image-Charts connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Image-Charts action](README.md#actions-30) with your API key and `connectionId`.
