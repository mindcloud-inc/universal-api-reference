...
- **Official documentation:** [Update Contact](https://api.insightly.com/v3.1/Help#!/Contacts/UpdateEntity)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `CONTACT_ID` | body | `number` | yes | The Contact ID to update. |
