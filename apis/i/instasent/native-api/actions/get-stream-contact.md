# Get Stream Contact with Instasent

## Endpoint

- **Method:** `GET`
- **Path:** `/project/:project/datasource/:datasource/stream/contacts/:userId`
- **Base URL:** `https://api.instasent.com/v1`
- **Official documentation:** [Get Stream Contact](https://instasent.stoplight.io/docs/instasent/8j57yi7wown1z-instasent-product-api)
