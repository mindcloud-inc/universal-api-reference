# IQAir AirVisual Universal API Authentication

Every IQAir AirVisual API request through MindCloud uses a MindCloud API key and the `connectionId` of a IQAir AirVisual connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your IQAir AirVisual connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [IQAir AirVisual action](README.md#actions-11) with your API key and `connectionId`.
