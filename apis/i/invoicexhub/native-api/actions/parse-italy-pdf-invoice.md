# Parse Italy PDF Invoice with Invoice.xhub

## Endpoint

- **Method:** `POST`
- **Path:** `/api/v1/invoice/IT/pdf/parse`
- **Base URL:** `https://service.invoice-api.xhub.io`
- **Official documentation:** [Parse Italy PDF Invoice](https://invoice-api.xhub.io/en/docs/api/parser)
