# Parse Romania PDF Invoice with Invoice.xhub

## Endpoint

- **Method:** `POST`
- **Path:** `/api/v1/invoice/RO/pdf/parse`
- **Base URL:** `https://service.invoice-api.xhub.io`
- **Official documentation:** [Parse Romania PDF Invoice](https://invoice-api.xhub.io/en/docs/api/parser)
