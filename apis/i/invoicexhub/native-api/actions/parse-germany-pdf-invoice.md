# Parse Germany PDF Invoice with Invoice.xhub

## Endpoint

- **Method:** `POST`
- **Path:** `/api/v1/invoice/DE/pdf/parse`
- **Base URL:** `https://service.invoice-api.xhub.io`
- **Official documentation:** [Parse Germany PDF Invoice](https://invoice-api.xhub.io/en/docs/api/parser)
