# Parse Belgium UBL Invoice with Invoice.xhub

## Endpoint

- **Method:** `POST`
- **Path:** `/api/v1/invoice/BE/UBL/parse`
- **Base URL:** `https://service.invoice-api.xhub.io`
- **Official documentation:** [Parse Belgium UBL Invoice](https://invoice-api.xhub.io/en/docs/api/parser)
