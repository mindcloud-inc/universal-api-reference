# iLovePDFv2 Universal API Authentication

Every iLovePDFv2 API request through MindCloud uses a MindCloud API key and the `connectionId` of a iLovePDFv2 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your iLovePDFv2 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [iLovePDFv2 action](README.md#actions-39) with your API key and `connectionId`.
