# Update Mailing List Recipient with Intelliprint
...
- **Official documentation:** [Update Mailing List Recipient](https://docs.intelliprint.net/api)
...
| `address.line` | body | `string` | no | The full mailing address line. |
