# iLovePDF: Increase Expiration Days

Extends signature request expiration in iLovePDF.

```
PUT https://connect.mindcloud.co/v1/universal/iLovePDF/latest/actions/increase-expiration-days
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/iLovePDF/latest/actions/increase-expiration-days" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/iLovePDF/latest/actions/increase-expiration-days', {
  method: 'PUT',
  headers: {
