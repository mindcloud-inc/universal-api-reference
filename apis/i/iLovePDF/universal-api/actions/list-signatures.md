# iLovePDF: List Signatures

Retrieves signature requests from iLovePDF.

```
GET https://connect.mindcloud.co/v1/universal/iLovePDF/latest/actions/list-signatures
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/iLovePDF/latest/actions/list-signatures?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/iLovePDF/latest/actions/list-signatures?${params}`, {
  headers: {
