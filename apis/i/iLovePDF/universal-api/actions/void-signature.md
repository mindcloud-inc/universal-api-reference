# iLovePDF: Void Signature

Voids a signature request in iLovePDF.

```
PUT https://connect.mindcloud.co/v1/universal/iLovePDF/latest/actions/void-signature
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/iLovePDF/latest/actions/void-signature" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/iLovePDF/latest/actions/void-signature', {
  method: 'PUT',
  headers: {
