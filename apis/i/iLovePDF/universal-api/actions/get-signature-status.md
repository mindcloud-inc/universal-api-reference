# iLovePDF: Get Signature Status

Retrieves a signature request from iLovePDF.

```
GET https://connect.mindcloud.co/v1/universal/iLovePDF/latest/actions/get-signature-status
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/iLovePDF/latest/actions/get-signature-status?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/iLovePDF/latest/actions/get-signature-status?${params}`, {
  headers: {
