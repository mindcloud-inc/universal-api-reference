# iLovePDF Universal API Authentication

Every iLovePDF API request through MindCloud uses a MindCloud API key and the `connectionId` of a iLovePDF connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your iLovePDF connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [iLovePDF action](README.md#actions-40) with your API key and `connectionId`.
