# IPQS Fraud and Risk Scoring Universal API Authentication

Every IPQS Fraud and Risk Scoring API request through MindCloud uses a MindCloud API key and the `connectionId` of a IPQS Fraud and Risk Scoring connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your IPQS Fraud and Risk Scoring connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [IPQS Fraud and Risk Scoring action](README.md#actions-40) with your API key and `connectionId`.
