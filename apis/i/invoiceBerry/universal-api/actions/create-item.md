# InvoiceBerry: Create Item



```
POST https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/create-item
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/create-item" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/create-item', {
  method: 'POST',
  headers: {
