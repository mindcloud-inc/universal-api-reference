# InvoiceBerry: Get Item



```
GET https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/get-item
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/get-item?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/get-item?${params}`, {
  headers: {
