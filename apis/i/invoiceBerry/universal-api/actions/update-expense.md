# InvoiceBerry: Update Expense



```
PUT https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/update-expense
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/update-expense" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/update-expense', {
  method: 'PUT',
  headers: {
