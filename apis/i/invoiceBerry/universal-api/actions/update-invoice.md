# InvoiceBerry: Update Invoice



```
PUT https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/update-invoice
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/update-invoice" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/update-invoice', {
  method: 'PUT',
  headers: {
