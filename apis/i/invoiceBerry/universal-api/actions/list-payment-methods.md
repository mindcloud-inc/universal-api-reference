# InvoiceBerry: List Payment Methods



```
GET https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/list-payment-methods
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/list-payment-methods?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/list-payment-methods?${params}`, {
  headers: {
