# InvoiceBerry: Update Quote



```
PUT https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/update-quote
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/update-quote" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/invoiceBerry/latest/actions/update-quote', {
  method: 'PUT',
  headers: {
