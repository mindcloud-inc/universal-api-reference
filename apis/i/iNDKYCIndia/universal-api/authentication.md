# IN-D KYC India Universal API Authentication

Every IN-D KYC India API request through MindCloud uses a MindCloud API key and the `connectionId` of a IN-D KYC India connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your IN-D KYC India connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [IN-D KYC India action](README.md#actions-15) with your API key and `connectionId`.
