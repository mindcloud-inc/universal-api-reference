# Ideal Postcodes Universal API Authentication

Every Ideal Postcodes API request through MindCloud uses a MindCloud API key and the `connectionId` of a Ideal Postcodes connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Ideal Postcodes connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Ideal Postcodes action](README.md#actions-13) with your API key and `connectionId`.
