# iLoveSign: Download Original Files



```
GET https://connect.mindcloud.co/v1/universal/iLoveSign/latest/actions/download-original-files
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/iLoveSign/latest/actions/download-original-files?connectionId=$CONNECTION_ID&server=api11.ilovepdf.com&tokenRequester=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/iLoveSign/latest/actions/download-original-files?${params}`, {
  headers: {
