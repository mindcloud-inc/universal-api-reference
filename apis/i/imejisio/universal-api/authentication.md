# Imejis.io Universal API Authentication

Every Imejis.io API request through MindCloud uses a MindCloud API key and the `connectionId` of a Imejis.io connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Imejis.io connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Imejis.io action](README.md#actions-1) with your API key and `connectionId`.
