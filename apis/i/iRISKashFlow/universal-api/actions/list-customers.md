# IRIS KashFlow: List Customers



```
GET https://connect.mindcloud.co/v1/universal/iRISKashFlow/latest/actions/list-customers
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/iRISKashFlow/latest/actions/list-customers?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/iRISKashFlow/latest/actions/list-customers?${params}`, {
  headers: {
