# IRIS KashFlow Universal API Authentication

Every IRIS KashFlow API request through MindCloud uses a MindCloud API key and the `connectionId` of a IRIS KashFlow connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your IRIS KashFlow connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [IRIS KashFlow action](README.md#actions-14) with your API key and `connectionId`.
