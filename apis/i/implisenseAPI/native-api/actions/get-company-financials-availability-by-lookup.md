# Get Company Financials Availability By Lookup with Implisense
...
- **Method:** `POST`
- **Path:** `/companies/financials/exists`
- **Base URL:** `https://german-company-data.p.rapidapi.com`
- **Official documentation:** [Get Company Financials Availability By Lookup](https://docs.implisense.com/api/)
