# innoChat Universal API Authentication

Every innoChat API request through MindCloud uses a MindCloud API key and the `connectionId` of a innoChat connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your innoChat connection.
