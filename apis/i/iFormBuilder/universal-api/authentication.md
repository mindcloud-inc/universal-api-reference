# iFormBuilder Universal API Authentication

Every iFormBuilder API request through MindCloud uses a MindCloud API key and the `connectionId` of a iFormBuilder connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your iFormBuilder connection.
