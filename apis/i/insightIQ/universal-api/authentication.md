# InsightIQ Universal API Authentication

Every InsightIQ API request through MindCloud uses a MindCloud API key and the `connectionId` of a InsightIQ connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your InsightIQ connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [InsightIQ action](README.md#actions-38) with your API key and `connectionId`.
