# InventoryBase: Update Inspection Contact

Updates an existing inspection contact in InventoryBase.

```
PUT https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/update-inspection-contact
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/update-inspection-contact" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/update-inspection-contact', {
  method: 'PUT',
  headers: {
