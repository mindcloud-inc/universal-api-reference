# InventoryBase: Create Custom Field

Creates a new custom field in InventoryBase.

```
POST https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/create-custom-field
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/create-custom-field" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/create-custom-field', {
  method: 'POST',
  headers: {
