# InventoryBase: Create Property Contact

Creates a new contact for a property in InventoryBase.

```
POST https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/create-property-contact
```
...
```bash
curl -X POST "https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/create-property-contact" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/create-property-contact', {
  method: 'POST',
  headers: {
