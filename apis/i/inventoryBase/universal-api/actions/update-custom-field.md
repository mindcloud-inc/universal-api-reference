# InventoryBase: Update Custom Field

Updates an existing custom field in InventoryBase.

```
PUT https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/update-custom-field
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/update-custom-field" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/update-custom-field', {
  method: 'PUT',
  headers: {
