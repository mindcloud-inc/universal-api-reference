# InventoryBase: List Custom Fields

Retrieves all custom fields from InventoryBase.

```
GET https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/list-custom-fields
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/list-custom-fields?connectionId=$CONNECTION_ID" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/inventoryBase/latest/actions/list-custom-fields?${params}`, {
  headers: {
