# i2i Universal API Authentication

Every i2i API request through MindCloud uses a MindCloud API key and the `connectionId` of a i2i connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your i2i connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [i2i action](README.md#actions-3) with your API key and `connectionId`.
