# ITM Platform Universal API Authentication

Every ITM Platform API request through MindCloud uses a MindCloud API key and the `connectionId` of a ITM Platform connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your ITM Platform connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [ITM Platform action](README.md#actions-40) with your API key and `connectionId`.
