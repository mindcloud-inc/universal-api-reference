# Infoplus Universal API Authentication

Every Infoplus API request through MindCloud uses a MindCloud API key and the `connectionId` of a Infoplus connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Infoplus connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Infoplus action](README.md#actions-115) with your API key and `connectionId`.
