# Inextrack Universal API Authentication

Every Inextrack API request through MindCloud uses a MindCloud API key and the `connectionId` of a Inextrack connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Inextrack connection.
