# Ipregistry Universal API Authentication

Every Ipregistry API request through MindCloud uses a MindCloud API key and the `connectionId` of a Ipregistry connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Ipregistry connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Ipregistry action](README.md#actions-8) with your API key and `connectionId`.
