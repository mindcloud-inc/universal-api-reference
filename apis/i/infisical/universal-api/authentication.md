# Infisical Universal API Authentication

Every Infisical API request through MindCloud uses a MindCloud API key and the `connectionId` of a Infisical connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Infisical connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Infisical action](README.md#actions-21) with your API key and `connectionId`.
