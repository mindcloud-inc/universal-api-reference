# inFlow Inventory Universal API Authentication

Every inFlow Inventory API request through MindCloud uses a MindCloud API key and the `connectionId` of a inFlow Inventory connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your inFlow Inventory connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [inFlow Inventory action](README.md#actions-24) with your API key and `connectionId`.
