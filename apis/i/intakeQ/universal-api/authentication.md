# IntakeQ Universal API Authentication

Every IntakeQ API request through MindCloud uses a MindCloud API key and the `connectionId` of a IntakeQ connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your IntakeQ connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [IntakeQ action](README.md#actions-45) with your API key and `connectionId`.
