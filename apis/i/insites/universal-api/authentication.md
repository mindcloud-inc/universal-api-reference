# Insites Universal API Authentication

Every Insites API request through MindCloud uses a MindCloud API key and the `connectionId` of a Insites connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Insites connection.
