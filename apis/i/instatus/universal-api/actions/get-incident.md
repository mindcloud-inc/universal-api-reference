...
```
GET https://connect.mindcloud.co/v1/universal/instatus/latest/actions/get-incident
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/instatus/latest/actions/get-incident?connectionId=$CONNECTION_ID&pageId=string&incidentId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/instatus/latest/actions/get-incident?${params}`, {
  headers: {
