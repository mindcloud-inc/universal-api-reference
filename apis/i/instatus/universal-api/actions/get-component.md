...
```
GET https://connect.mindcloud.co/v1/universal/instatus/latest/actions/get-component
```
...
```bash
curl -X GET "https://connect.mindcloud.co/v1/universal/instatus/latest/actions/get-component?connectionId=$CONNECTION_ID&pageId=string&componentId=string" \
...
const response = await fetch(`https://connect.mindcloud.co/v1/universal/instatus/latest/actions/get-component?${params}`, {
  headers: {
