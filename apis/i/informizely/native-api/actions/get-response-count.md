# Get Response Count with Informizely
...
- **Official documentation:** [Get Response Count](https://www.informizely.com/help/report-api)

## Parameters

| Parameter | Location | Type | Required | Description |
| --- | --- | --- | --- | --- |
| `id` | query | `string` | yes | The ID of the survey whose response count you want to retrieve. |
