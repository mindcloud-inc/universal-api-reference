# Is It Christmas? Universal API Authentication

Every Is It Christmas? API request through MindCloud uses a MindCloud API key and the `connectionId` of a Is It Christmas? connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Is It Christmas? connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Is It Christmas? action](README.md#actions-1) with your API key and `connectionId`.
