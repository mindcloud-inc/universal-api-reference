# Influenza and Covid-19 Universal API Authentication

Every Influenza and Covid-19 API request through MindCloud uses a MindCloud API key and the `connectionId` of a Influenza and Covid-19 connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Influenza and Covid-19 connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Influenza and Covid-19 action](README.md#actions-4) with your API key and `connectionId`.
