# Instructure Universal API Authentication

Every Instructure API request through MindCloud uses a MindCloud API key and the `connectionId` of a Instructure connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Instructure connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Instructure action](README.md#actions-115) with your API key and `connectionId`.
