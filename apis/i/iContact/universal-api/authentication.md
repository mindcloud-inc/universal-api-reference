# iContact Universal API Authentication

Every iContact API request through MindCloud uses a MindCloud API key and the `connectionId` of a iContact connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your iContact connection.
