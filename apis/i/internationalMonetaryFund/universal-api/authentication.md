# International Monetary Fund Universal API Authentication

Every International Monetary Fund API request through MindCloud uses a MindCloud API key and the `connectionId` of a International Monetary Fund connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your International Monetary Fund connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [International Monetary Fund action](README.md#actions-6) with your API key and `connectionId`.
