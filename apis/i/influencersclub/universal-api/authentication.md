# Influencers.club Universal API Authentication

Every Influencers.club API request through MindCloud uses a MindCloud API key and the `connectionId` of a Influencers.club connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your Influencers.club connection.
4. Close the connection modal, open the connection’s `•••` menu, and select **Copy Connection ID**.
5. Call any [Influencers.club action](README.md#actions-23) with your API key and `connectionId`.
