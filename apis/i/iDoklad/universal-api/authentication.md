# iDoklad Universal API Authentication

Every iDoklad API request through MindCloud uses a MindCloud API key and the `connectionId` of a iDoklad connection.
...
3. Open [Connections](https://app.mindcloud.co/credentials) and create your iDoklad connection.
