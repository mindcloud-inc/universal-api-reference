# Sage Intacct: Check GLBATCH Duplicate



```
POST https://connect.mindcloud.co/v1/universal/intacct/latest/actions/check-glbatch-duplicate
```
...
Through the native Sage Intacct API, this operation is `POST` (base URL `https://api.intacct.com/ia/xml/xmlgw.phtml`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/check-glbatch-duplicate.md) for the provider-specific parameters and requirements.
