# Intercom: Merge Contact



```
PUT https://connect.mindcloud.co/v1/universal/intercom/latest/actions/merge-contact
```
...
```bash
curl -X PUT "https://connect.mindcloud.co/v1/universal/intercom/latest/actions/merge-contact" \
...
```js
const response = await fetch('https://connect.mindcloud.co/v1/universal/intercom/latest/actions/merge-contact', {
  method: 'PUT',
  headers: {
...
| --- | --- | --- | --- |
| `from` | string | yes | Intercom lead contact ID to merge from |
| `into` | string | yes | Intercom user contact ID to merge into |
...
Through the native Intercom API, this operation is `POST /contacts/merge` (base URL `https://api.intercom.io`). The Universal API call above is translated to it by MindCloud, including authentication. See the [native action reference](../../native-api/actions/merge-contact.md) for the provider-specific parameters and requirements.
